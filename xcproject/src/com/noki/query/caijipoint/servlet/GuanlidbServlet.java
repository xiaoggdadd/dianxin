...
import com.noki.query.caijipoint.javabean.GuanliChart;

public class GuanlidbServlet extends HttpServlet {

	public GuanlidbServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(bz=="1"||"1".equals(bz)){
			...
			BufferedImage chartImage = gl.getChart(diqu,months, dataArray);
