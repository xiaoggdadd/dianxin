...
public class NewExcelImp extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		   ...
		   url = path + "/web/dataedit/stationPointQuerya.jsp";
		   msg = "电量电费批量导入失败！";
		   ...
		   Map map=new HashMap();
		    ...
		    ReadFile temp = new ReadFileFactory().getReadFile(filename);
		      ...
		      long a =new Date().getTime();
		  	 ...
		  	 map= sellin.getls(content,cform,accountname,loginId);
		  	 Vector wrong =null;
