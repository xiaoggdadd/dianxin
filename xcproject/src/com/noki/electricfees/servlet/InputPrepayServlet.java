 ...
 * @version 1.0
 */
public class InputPrepayServlet
    extends HttpServlet {
  public InputPrepayServlet() {
  }
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws
    ...
    RequestDispatcher dispatcher = request.getRequestDispatcher("/servlet/indataprepay");
  ...
  public void upload(HttpServletRequest request, HttpServletResponse response) throws
    ...
    while (iter.hasNext()) {
      ...
      if (!item.isFormField()) {
        ...
        extName   =   extName.substring(0,extName.lastIndexOf(".xls")); 
        extName   =   extName + ".xls";
