		  ...
		  List<Object[]>  dataList = new ArrayList<Object[]>();
		   ...
		   for(T t : entitys){
		       ...
		       try{
		            ...
		            HSSFCellStyle columnTopStyle = ExportExcelError.getColumnTopStyle(workbook);//获取列头样式对象
		            HSSFCellStyle style = ExportExcelError.getStyle(workbook);                    //单元格样式对象
		            
		            sheet.addMergedRegion(new CellRangeAddress(0, 1, 0, (rowName.length-1)));  
		            cellTiltle.setCellStyle(columnTopStyle);
		            cellTiltle.setCellValue("为空或错误");
