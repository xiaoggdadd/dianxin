...
public class yidDaoruServlet extends HttpServlet {

	 public yidDaoruServlet() {
	  }
	  ...
	  public void doPost(HttpServletRequest request, HttpServletResponse response) throws
	    ...
	    RequestDispatcher dispatcher = request.getRequestDispatcher("/servlet/yidDaoruElectricfeesServlet");//电费单导入
