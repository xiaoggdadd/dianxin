...
public class zbDaoruServlet extends HttpServlet {

	public zbDaoruServlet() {
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request
				.getRequestDispatcher("/servlet/zbDaoruElectricfeesServlet?biaoji="
						+ biaoji);// 通过自报电用户号电费单导入
	...
	public void upload(HttpServletRequest request, HttpServletResponse response)
		...
		while (iter.hasNext()) {
			...
			if (!item.isFormField()) {
				...
				/*
				 * Matcher m = p.matcher(name); boolean result = m.find();
