...
public class DaoruZhandiandanjiaServlet extends HttpServlet {

	
	 public DaoruZhandiandanjiaServlet() {
	  }
	  ...
	  public void doPost(HttpServletRequest request, HttpServletResponse response) throws
	    ...
	    request.setAttribute("action", "indata1");
System.out.println("111111111111111111111ssss");
	    RequestDispatcher dispatcher = request.getRequestDispatcher("/servlet/DaoruuZhandiandanjia");//电费单导入
	    //RequestDispatcher dispatcher = request.getRequestDispatcher("/servlet/sellmantype.do");
	    System.out.println("2222222222222ssss");
