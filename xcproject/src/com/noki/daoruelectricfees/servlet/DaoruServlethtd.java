...
public class DaoruServlethtd extends HttpServlet {



	 public DaoruServlethtd() {
	  }
	  ...
	  public void doPost(HttpServletRequest request, HttpServletResponse response) throws
	    ...
	    RequestDispatcher dispatcher = request.getRequestDispatcher("/servlet/Daoruhtd");//合同单导入
