...
public class NewDaoruServlet extends HttpServlet {

	 public NewDaoruServlet() {
	  }
	  ...
	  public void doPost(HttpServletRequest request, HttpServletResponse response) throws
	    ...
	    RequestDispatcher dispatcher = request.getRequestDispatcher("/servlet/NewDaoruElectricfeesServlet");//电费单导入
