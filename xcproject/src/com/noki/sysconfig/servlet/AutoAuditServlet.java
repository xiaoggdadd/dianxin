...
import com.noki.sysconfig.javabean.AutoAuditFormBean;
...
public class AutoAuditServlet
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse resp) throws
    ...
    AutoAuditFormBean formBean= new AutoAuditFormBean();
 ...
 if (action.equals("modify")) {
      ...
      url = path + "/web/sysconfig/autoAuditList.jsp";
	  formBean = formBean.getAutoAuditInfo(ItemID);
	  formBean.setItemValue(req.getParameter("ItemValue"));     
      msg = bean.modifyAutoAudit(formBean);
      log.write(msg, formBean.getItemID(), req.getRemoteAddr(), "ÕË»§Î¬»¤");
      session.setAttribute("url", url);
      session.setAttribute("msg", msg);
      resp.sendRedirect(path + "/web/sysconfig/autoAuditList.jsp");
