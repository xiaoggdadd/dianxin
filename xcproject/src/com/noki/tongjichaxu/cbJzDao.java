...
public class cbJzDao {
	...
	public synchronized ArrayList<cbJzBean> getData(String whereStr,String property,String whereyf,String whereyf01,String whereyf02,String month,Properties pro,String bzyf,String loginId,String rolename){
		...
		StringBuffer cbgksql_1410 = new StringBuffer();//2014/10后新超标比例sql
		StringBuffer cbzdsql = new StringBuffer();
		StringBuffer cbzdsql01 = new StringBuffer();
		StringBuffer cbzdsql02 = new StringBuffer();
		StringBuffer cbzdsql_1410 = new StringBuffer();//2014/10后新超标比例sql
		...
		StringBuffer lxcbsql_boss_1410 = new StringBuffer();//2014/10后boss专用新超标比例sql
		StringBuffer lxcbsql_1410 = new StringBuffer();//2014/10后新超标比例sql
		...
		StringBuffer lxzzcbsql_boss_1410 = new StringBuffer();//2014/10后boss专用新超标比例sql
		StringBuffer lxzzcbsql_1410 = new StringBuffer();//2014/10后新超标比例sql
		...
		StringBuffer jsdbsql_boss_1410 = new StringBuffer();//2014/10后boss专用新超标比例sql
		StringBuffer jsdbsql_1410 = new StringBuffer();//2014/10后新超标比例sql
		StringBuffer bzdlsql = new StringBuffer();
		StringBuffer bzdlsql01 = new StringBuffer();
		StringBuffer bzdlsql_1410 = new StringBuffer();//2014/10后新超标比例sql
		StringBuffer waqzgsql = new StringBuffer();
		StringBuffer waqzgsql01 = new StringBuffer();
		StringBuffer waqzgsql02 = new StringBuffer();
		StringBuffer waqzgsql_1410 = new StringBuffer();//2014/10后新超标比例sql
		...
		scnhsql.append("select  ft.shiname agname, count(*) scnhcount from (select zd.shi, (select agname from d_area_grade where agcode = zd.shi) as shiname, (select agname" +
				...
				" where zd.property in ('zdsx06', 'zdsx01') and zd.id = db.zdid  and zd.qyzt = '1'  and db.dbqyzt = '1' " +
		...
		//cbgksql_1410为2014年10月之后用的新超标比例(((电表用电量—标准值)/标准值)*100%)
		cbgksql_1410.append("select cbqk.agname, count(*) cbgkcount from (select zd.shi,  s.agname, zd.id,  zd.jzname," +
				" dl.dbydl as dl1,  dl.dbgldl as dl2 from zhandian zd left join d_area_grade s on zd.shi = s.agcode," +
				" (select zdid, dbydl, dbgldl from jzxx where 1 = 1 "+whereyf01+") dl  where" +
				" to_char(zd.id) = dl.zdid  AND zd.property = '"+property+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM" +
				" PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))) cbqk where cbqk.dl1 is null and cbqk.dl2 is null " +
				"group by cbqk.shi, cbqk.agname");
		//-----------
		cbzdsql.append("select bb.shi agname ,sum(case when bb.countbz>="+cbbl+" then 1 else  0 end) cbzdcount from(select ab.shi,(ab.dl-ab.bz)/ab.bz as countbz from" +
				...
				"AND jz.zdid=to_char(zd1.id) AND zd1.property='"+property+"' AND (zd1.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) "+whereyf01+")ab)bb " +
		" group by bb.shi");
		...
		cbzdsql01.append("select bb.shi agname, sum(case when bb.countbz >= "+cbbl+" then 1 else  0  end) cbzdcount from (select ab.shi," +
				...
				"AND zd.property='"+property+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) "+whereyf01+") ab) bb group by bb.shi");
		...
		//----------------
		//cbzdsql_1410为2014年10月之后用的新超标比例(((电表用电量—标准值)/标准值)*100%)
		cbzdsql_1410.append("select bb.shi agname, sum(case when bb.countbz >= "+cbbl+" then 1 else 0  end) cbzdcount" +
				" from (select ab.shi, decode(ab.bz, '0', ab.dl, (ab.dl - ab.bz) / ab.bz) as countbz " +
				" from (select jz.zdid, jz.shi, jz.dbydl as dl, jz.bzz as bz from jzxx jz, zhandian zd " +
				" where 1 = 1  AND jz.zdid = to_char(zd.id) AND zd.property = '"+property+"' AND (zd.xiaoqu " +
				"IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) "+whereyf01+") ab) bb" +
				" group by bb.shi");
		...
		lxcbsql033.append("select a.shi agname, count(a.countbz) lxcbcount from (select ab.shi,ab.zdid," +
				...
				"and a.countbz >= "+cbblsyc+" and b.countbz >= "+cbbl+" group by a.shi");
		//------------------
		//lxcbsq_1410为2014年10月之后用的新超标比例(((电表用电量—标准值)/标准值)*100%)
		lxcbsql_1410.append("select a.shi agname, count(a.countbz) lxcbcount from (select ab.shi, ab.zdid, decode(ab.bz, '0'," +
				" ab.dl, (ab.dl - ab.bz) / ab.bz) as countbz from (select jz.zdid, jz.shi, jz.dbydl as dl," +
				" jz.bzz bz from jzxx jz where 1 = 1 "+whereyf02+") ab) a, (select ab.zdid,ab.shi," +
				" decode(ab.bz, '0', ab.dl, (ab.dl - ab.bz) / ab.bz) as countbz from (select jz.zdid, jz.shi," +
				" jz.dbydl as dl, jz.bzz as bz from jzxx jz where 1 = 1 "+whereyf01+") ab) b, " +
				"zhandian zd where a.zdid = b.zdid AND b.zdid = to_char(zd.id) AND zd.property = '"+property+"'" +
				" AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) " +
				"and a.countbz >= "+cbblsyc+" and b.countbz >= "+cbbl+" group by a.shi");
		
		
		//lxcbsq_boss_1410为2014年10月之后用的新超标比例(((电表用电量—标准值)/标准值)*100%)
		lxcbsql_boss_1410.append("select a.shi agname, count(a.countbz) lxcbcount from (select ab.shi, ab.zdid, decode(ab.bz, '0'," +
				" ab.dl, (ab.dl - ab.bz) / ab.bz) as countbz from (select jz.zdid, jz.shi, jz.dbydl as dl," +
				" jz.bzz bz from jzxx jz where 1 = 1 "+whereyf02+") ab) a, (select ab.zdid,ab.shi," +
				" decode(ab.bz, '0', ab.dl, (ab.dl - ab.bz) / ab.bz) as countbz from (select jz.zdid, jz.shi," +
				" jz.dbydl as dl, jz.bzz as bz from jzxx jz where 1 = 1 "+whereyf01+") ab) b, " +
		...
		//lxzzcbsql_1410为2014年10月之后用的新超标比例(((电表用电量—标准值)/标准值)*100%)
		lxzzcbsql_1410.append(" select a.shi agname, count(a.countbz) lxzzcbcount from (select ab.shi,ab.zdid, ab.dl, " +
				"decode(ab.bzz, '0', ab.dl, (ab.dl - ab.bzz) / ab.bzz) as countbz  from (select jz.zdid, jz.shi, jz.dbydl as dl," +
				" jz.bzz as bzz from jzxx jz  where 1 = 1  "+whereyf02+") ab) a, (select ab.zdid,ab.shi,ab.dl, " +
				"decode(ab.bzz, '0', ab.dl, (ab.dl - ab.bzz) / ab.bzz) as countbz from (select jz.zdid, jz.shi, jz.dbydl as dl," +
				" jz.bzz as bzz  from jzxx jz where 1 = 1  "+whereyf01+") ab) b, zhandian zd where a.zdid = b.zdid " +
				"AND b.zdid = to_char(zd.id) AND zd.property = '"+property+"'" +
				" AND (zd.xiaoqu IN(SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))" +
				" and a.countbz >= "+cbblsyc+" and b.countbz >= "+cbbl+" and b.dl > a.dl group by a.shi");
		
		
		//lxzzcbsql_boss_1410为2014年10月之后用的新超标比例(((电表用电量—标准值)/标准值)*100%)
		lxzzcbsql_boss_1410.append(" select a.shi agname, count(a.countbz) lxzzcbcount from (select ab.shi,ab.zdid, ab.dl, " +
				"decode(ab.bzz, '0', ab.dl, (ab.dl - ab.bzz) / ab.bzz) as countbz  from (select jz.zdid, jz.shi, jz.dbydl as dl," +
				" jz.bzz as bzz from jzxx jz  where 1 = 1 "+whereyf02+") ab) a, (select ab.zdid,ab.shi,ab.dl, " +
				"decode(ab.bzz, '0', ab.dl, (ab.dl - ab.bzz) / ab.bzz) as countbz from (select jz.zdid, jz.shi, jz.dbydl as dl," +
				" jz.bzz as bzz  from jzxx jz where 1 = 1 "+whereyf01+") ab) b, zhandian zd where a.zdid = b.zdid " +
		...
		//---------------------
		//jsdbsql_1410为2014年10月之后用的新超标比例(((电表用电量—标准值)/标准值)*100%)
		jsdbsql_1410.append("select aa.shi agname, count(*) jsdbcount from (select dl.shi, dl.zdid, dl.jzname, dl.dbydl, " +
				"dl.bzz from (select t.shi, t.zdid, t.jzname, t.dbydl, t.bzz from jzxx t where 1 = 1 " +
				" "+whereyf01+") dl where (dl.dbydl - dl.bzz) / decode(dl.bzz, '0', '1', dl.bzz) >= "+cbbl+") aa," +
				" (select dl.shi, dl.zdid, dl.jzname, dl.dbgldl, dl.bzz from (select t.shi, t.zdid, t.jzname, t.dbgldl," +
				" t.bzz from jzxx t where 1 = 1 "+whereyf02+") dl where (dl.dbgldl - dl.bzz) / " +
				"decode(dl.bzz, '0', '1', dl.bzz) < "+cbblsyc+") bb, zhandian zd where aa.zdid = bb.zdid AND" +
				" bb.zdid = to_char(zd.id) AND zd.property = '"+property+"' AND (zd.xiaoqu IN(SELECT T.AGCODE " +
				"FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) group by aa.shi");
		
		//jsdbsql_boss_1410为2014年10月之后用的新超标比例(((电表用电量—标准值)/标准值)*100%)
		jsdbsql_boss_1410.append("select aa.shi agname, count(*) jsdbcount from (select dl.shi, dl.zdid, dl.jzname, dl.dbydl, " +
				"dl.bzz from (select t.shi, t.zdid, t.jzname, t.dbydl, t.bzz from jzxx t where 1 = 1 " +
				" "+whereyf01+") dl where (dl.dbydl - dl.bzz) / decode(dl.bzz, '0', '1', dl.bzz) >= "+cbbl+") aa," +
				" (select dl.shi, dl.zdid, dl.jzname, dl.dbgldl, dl.bzz from (select t.shi, t.zdid, t.jzname, t.dbgldl," +
				" t.bzz from jzxx t where 1 = 1  "+whereyf02+") dl where (dl.dbgldl - dl.bzz) / " +
				"decode(dl.bzz, '0', '1', dl.bzz) < "+cbblsyc+") bb, zhandian zd where aa.zdid = bb.zdid AND" +
				" bb.zdid = to_char(zd.id) AND zd.property = '"+property+"' group by aa.shi");
		...
		//bzdlsql_1410为2014年10月之后用的新超标比例(((电表用电量—标准值)/标准值)*100%)
	/*	bzdlsql_1410.append("select dsdl.shi agname, sum(dsdl.bzz) as bzdlcount, sum(dl1) as sjdlcount," +
				" decode(sum(dsdl.bzz),'0', sum(dl1), (sum(dl1) - sum(dsdl.bzz)) / sum(dsdl.bzz)) as bzpld " +
				"from (select dl.shi, dl.zdid, dl.jzname, dl.dl1, dl.bzz from (select zd.shi, zd.zdid," +
				" zd.jzname, sum(zd.dbydl) / count(zd.zdid) as dl1,  zd.qsdbdl as bzz from jzxx zd, zhandian zd1 " +
				"where 1 = 1  AND zd.zdid = to_char(zd1.id) AND zd1.property = '"+property+"'  AND (zd1.xiaoqu IN " +
				"(SELECT T.AGCODE  FROM PER_AREA T  WHERE T.ACCOUNTID = '"+loginId+"')) "+whereyf01+" " +
				"and zd.dbydl is not null and zd.dbydl > 0 and zd.bzw <> '2' group by zd.shi, zd.zdid, " +
				"zd.jzname, zd.qsdbdl) dl) dsdl group by dsdl.shi");
		
	**/	
		bzdlsql_1410.append(" select dsdl.shi agname, sum(dsdl.bzz) as bzdlcount, sum(dl1) as sjdlcount," +
				" decode(sum(dsdl.bzz), '0',  sum(dl1), (sum(dl1) - sum(dsdl.bzz)) / sum(dsdl.bzz)) as bzpld from" +
				" (select dl.shi, dl.zdid, dl.jzname, dl.dl1, dl.bzz from (select zd.shi,zd.zdid,  zd.jzname, " +
				"sum(zd.dbydl) as dl1,  zd.bzz as bzz from jzxx zd, zhandian zd1  where 1 = 1  AND zd.zdid = to_char(zd1.id)  " +
				"AND zd1.property = '"+property+"' AND (zd1.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) " +
				""+whereyf01+" and zd.dbydl is not null and zd.dbydl > 0 and zd.bzw <> '2' group by zd.shi, zd.zdid, " +
				"zd.jzname, zd.bzz) dl) dsdl group by dsdl.shi");
		...
		//waqzgsql_1410为2014年10月之后用的新超标比例(((电表用电量—标准值)/标准值)*100%)
		waqzgsql_1410.append("select aa.shi agname, count(distinct aa.zdid) waqzgcount from (select dls.* from (select c.* from cbzd c " +
				"where c.cbsj <= '"+bzyf02+"') mdz, (select dl3.* from (select zd.shi, zd.zdid,zd.jzname,zd.dbydl as dl3, zd.bzz as month3 " +
				"from jzxx zd, zhandian zd1  where 1 = 1 AND zd.zdid = to_char(zd1.id) AND zd1.property = '"+property+"' AND (zd1.xiaoqu " +
				"IN (SELECT T.AGCODE FROM PER_AREA T  WHERE T.ACCOUNTID = '"+loginId+"'))  "+whereyf01+") dl3 where 1 = 1 and " +
				"decode(dl3.month3, '0', dl3.dl3, (dl3.dl3 - dl3.month3) / dl3.month3) >= "+cbbl+") dls where mdz.zdid = dls.zdid) aa group by aa.shi");
		...
		if(bzdate.after(date9)){
			if(bzdate.after(date1410)){
				System.out.println("基站属性错误：" + zdsxsql.toString());
				System.out.println("生产能耗分摊:"+scnhsql1.toString());
				System.out.println("每月抄表管控2014/10月份后"+cbgksql_1410.toString());
			}else{
				System.out.println("基站属性错误：" + zdsxsql.toString());
				System.out.println("生产能耗分摊"+scnhsql1.toString());
				System.out.println("每月抄表管控2013/10月份至2014/10月份:"+cbgksql.toString());
			}
		}else{
			System.out.println("基站属性错误：" + zdsxsql.toString());
			System.out.println("生产能耗分摊2013/10月份前:"+scnhsql.toString());
			System.out.println("每月抄表管控"+cbgksql.toString());
		}
        	...
        	if(bzdate.after(date8)){
        		if(bzdate.after(date1410)){
        			if(rolename.equals("sd_lingjin")||rolename.equals("admins")){
	        			System.out.println("---------------2014/10月份后boss专用新超标比例---------------------");
	        			System.out.println("超标站点2014/10:"+cbzdsql_1410.toString());
		    			System.out.println("每月抄表但结算电表超标2014/10后(jsdbsql_boss_1410)："+jsdbsql_boss_1410.toString());
		    			System.out.println("连续超标2014/10后(lxcbsql_boss_1410)："+lxcbsql_boss_1410.toString());
		    			System.out.println("连续增长超标2014/10后(lxzzcbsql_boss_1410)："+lxzzcbsql_boss_1410.toString());
		    			System.out.println("未按期整改2014/10后："+waqzgsql_1410.toString());
		    			System.out.println("标准电量2014/10后:"+bzdlsql_1410.toString());
        			}else{
		    			System.out.println("---------------2014/10月份后新超标比例---------------------");
	        			System.out.println("超标站点2014/10:"+cbzdsql_1410.toString());
		    			System.out.println("每月抄表但结算电表超标2014/10后："+jsdbsql_1410.toString());
		    			System.out.println("连续超标2014/10后："+lxcbsql_1410.toString());
		    			System.out.println("连续增长超标2014/10后："+lxzzcbsql_1410.toString());
		    			System.out.println("未按期整改2014/10后："+waqzgsql_1410.toString());
		    			System.out.println("标准电量2014/10后:"+bzdlsql_1410.toString());
        			}
        		}else{
        			if(rolename.equals("sd_lingjin")||rolename.equals("admins")){
	        			System.out.println("超标站点:"+cbzdsql02.toString());
	        			System.out.println("每月抄表但结算电表超标:"+jsdbsql033.toString());
	        			System.out.println("连续超标:"+lxcbsql033.toString());
	        			System.out.println("连续增长超标"+lxzzcbsql033.toString());
	        			System.out.println("未按期整改"+waqzgsql02.toString());
	        			System.out.println("标准电量"+bzdlsql01.toString());
        			}else{
	        			System.out.println("超标站点:"+cbzdsql02.toString());
	        			System.out.println("每月抄表但结算电表超标:"+jsdbsql03.toString());
	        			System.out.println("连续超标:"+lxcbsql03.toString());
	        			System.out.println("连续增长超标"+lxzzcbsql03.toString());
	        			System.out.println("未按期整改"+waqzgsql02.toString());
	        			System.out.println("标准电量"+bzdlsql01.toString());
        			}
        		}
    			...
    			System.out.println("超标站点02:"+cbzdsql02.toString());
    			System.out.println("每月抄表但结算电表超标01111："+jsdbsql03.toString());
    			System.out.println("连续超标033333："+lxcbsql03.toString());
    			System.out.println("连续增长超标03333："+lxzzcbsql03.toString());
    			System.out.println("未按期整改02："+waqzgsql02.toString());
    			System.out.println("标准电量01:"+bzdlsql01.toString());
        	}
    	}else{
			System.out.println("99999911111");
			System.out.println("超标站点01:"+cbzdsql01.toString());
        	System.out.println("标准电量01:"+bzdlsql01.toString());
    		System.out.println("未按期整改01："+waqzgsql01.toString());
    		if(bzdate.equals(date2)){
    			System.out.println("999999111112222");
    			System.out.println("连续增长超标："+lxzzcbsql02.toString());
    			System.out.println("每月抄表但结算电表超标02："+jsdbsql02.toString());
    			System.out.println("连续超标："+lxcbsql02.toString());
    		}else{
    			System.out.println("9999991111133333");
		...
		try{
			...
			if(bzdate.after(date9)){
				if(bzdate.after(date1410)){
					...
					cbgkrs	= db.queryAll(cbgksql_1410.toString());
				}else{
					jzsxrs = db.queryAll(zdsxsql.toString());
					scnhsrs = db.queryAll(scnhsql1.toString());
			...
			if(bzdate.after(date1)){
				if(bzdate.after(date8)){
					if(bzdate.after(date1410)){
						if(rolename.equals("sd_lingjin")||rolename.equals("admins")){
							cbzdrs = db.queryAll(cbzdsql_1410.toString());
							jsdbrs = db.queryAll(jsdbsql_boss_1410.toString());
							lxcbrs = db.queryAll(lxcbsql_boss_1410.toString());
							lxzzcbrs = db.queryAll(lxzzcbsql_boss_1410.toString());
							waqzgrs = db.queryAll(waqzgsql_1410.toString());
							bzdlrs = db.queryAll(bzdlsql_1410.toString());
						}else{
							cbzdrs = db.queryAll(cbzdsql_1410.toString());
							jsdbrs = db.queryAll(jsdbsql_1410.toString());
							lxcbrs = db.queryAll(lxcbsql_1410.toString());
							lxzzcbrs = db.queryAll(lxzzcbsql_1410.toString());
							waqzgrs = db.queryAll(waqzgsql_1410.toString());
							bzdlrs = db.queryAll(bzdlsql_1410.toString());
						}
					}else{
			...
			for(cbJzBean cb:list){
				if(cb.getShiname().equals(scnhsrs.getString("agname"))){
			...
			while(cbgkrs.next()){
				for(cbJzBean cb:list){
					if(cb.getShiname().equals(cbgkrs.getString("agname"))){
			...
			while(cbzdrs.next()){
				for(cbJzBean cb:list){
					if(cb.getShiname().equals(cbzdrs.getString("agname"))){
			...
			while(lxcbrs.next()){
				for(cbJzBean cb:list){
					if(cb.getShiname().equals(lxcbrs.getString("agname"))){
			...
			while(lxzzcbrs.next()){
				for(cbJzBean cb:list){
					if(cb.getShiname().equals(lxzzcbrs.getString("agname"))){
			...
			while(jsdbrs.next()){
				for(cbJzBean cb:list){
					if(cb.getShiname().equals(jsdbrs.getString("agname"))){
			...
			while(bzdlrs.next()){
				for(cbJzBean cb:list){
					if(cb.getShiname().equals(bzdlrs.getString("agname"))){
			...
			while(waqzgrs.next()){
				for(cbJzBean cb:list){
					if(cb.getShiname().equals(waqzgrs.getString("agname"))){
	...
	//基站属性错误查询
	public synchronized ArrayList getJzcw(String shi,String loginId ) {
		...
		sql = "select d.agname as shi,x.agname as xian,xq.agname as xiaoqu,zd.id," +
				...
				"where zs.name is null or st.name is null and zd.qyzt = '1' and zd.shi = '"+shi+"' " +
				"AND (ZD.XIAOQU IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))";
	...
	//生产分摊查询
public synchronized ArrayList getScft(String shi,String loginId,String bzyf) {
		...
		if(bzyff.after(scftt)){
			try {
				...
				sql = " select  ft.shiname,ft.xian,ft.xiaoqu,ft.zdid,ft.jzname,ft.zdsx,ft.zdlx,ft.sc " +
						...
						"and  zd.id = db.zdid  " +
						"and zd.qyzt = '1'  and db.dbqyzt = '1' and db.dbid = s.dianbiaoid  and db.dbyt = 'dbyt01' and zd.shi='"+shi+"'  " +
...
//超标管控查询
public synchronized ArrayList getCbgk(String shi,String bzyf,String loginId,String property ) {
	...
	DataBase db = new DataBase();
	try {
	sql = "  select cbqk.agname,cbqk.dagname,cbqk.gagname,cbqk.zdid,cbqk.jzname,cbqk.property from (select zd.shi,s.agname as agname,d.agname as dagname,g.agname as gagname,zd.id as zdid,zd.jzname as jzname,i.name as property,dl.DBYDL as dl1,dl.DBGLDL as dl2 from zhandian zd left join d_area_grade s on zd.shi = s.agcode left join d_area_grade d on zd.xian = d.agcode left join d_area_grade g on zd.xiaoqu = g.agcode left join indexs i on i.code=zd.property,(select zdid, DBYDL, DBGLDL from jzxx where 1 = 1 AND symonth = '"+bzyf+"') dl where to_char(zd.id) = dl.zdid AND zd.property = '"+property+"' AND (zd.xiaoqu IN(SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))) cbqk where cbqk.dl1 is null and cbqk.dl2 is null and cbqk.shi = '"+shi+"'";
...
//超标站点
public synchronized ArrayList getCbzd(String shi,String bzyf,String cbbl,String loginId,String property ) {
    ...
    if(bzyf.equals("2013-03")||bzyf.equals("2013-04")){
    	...
    	try{
    	sql1=" select bb.shi,bb.xian,bb.xiaoqu,bb.zdid,bb.jzname,bb.property,bb.dl,bb.bz,round(((bb.dl-bb.bz)/bb.bz),4)*100 || '%'as bl from (select ab.*,(ab.dl - ab.bz) / ab.bz countbz from (select jz.sfgx, d.agname as shi, s.agname as xian, a.agname as xiaoqu, jz.zdid,zd1.jzname, i.name as property, round(decode(jz.jsdl, '', jz.gldl, '0', jz.gldl, jz.jsdl),4)dl, decode( trim(jz.sfgx), '1', zd."+bmonth+" + (23 * jz.gxgwsl), '0', zd."+bmonth+", '', zd."+bmonth+", 0) bz from jzxx jz, zdnhbz zd, zhandian zd1 left join D_AREA_GRADE d on zd1.shi=d.agcode left join D_AREA_GRADE s on zd1.xian=s.agcode left join D_AREA_GRADE a on zd1.xiaoqu=a.agcode left join indexs i on zd1.property=i.code where jz.changjia = zd.changjia and jz.g2 = zd.g2 and jz.g3 = zd.g3 and jz.zp = zd.zp and jz.zs = zd.zs AND jz.zdid = to_char(zd1.id) AND zd1.property = '"+property+"' AND (zd1.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) AND symonth = '"+bzyf+"' AND zd1.shi='"+shi+"') ab) bb where bb.countbz >= "+cbbll+" ";
    	ResultSet rs = null;
    ...
    if(bzyf.equals("2013-05")){
    	...
    	try{
    	sql2=" select bb.shi,bb.xian,bb.xiaoqu,bb.zdid,bb.jzname,bb.property,bb.dl,bb.bz,round(bb.countbz, 4) * 100 || '%' as bl from (select ab.*, decode(ab.bz, '0', ab.dl, (ab.dl - ab.bz) / ab.bz) as countbz from (select d.agname as shi, s.agname as xian,a.agname as xiaoqu,jz.zdid,zd.jzname,i.name as property,round( decode(jz.jsdl,'',jz.gldl,'0',jz.gldl,jz.jsdl),4) dl, jz.qsdbdl as bz from jzxx jz, zhandian zd left join D_AREA_GRADE d on zd.shi=d.agcode left join D_AREA_GRADE s on zd.xian=s.agcode left join D_AREA_GRADE a on zd.xiaoqu=a.agcode left join indexs i on zd.property=i.code where 1 = 1 AND jz.zdid = to_char(zd.id) AND zd.property = '"+property+"' AND zd.shi='"+shi+"' AND (zd.xiaoqu IN(SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) AND symonth = '"+bzyf+"') ab) bb where bb.countbz >= "+cbbll+"";
    	ResultSet rs = null;
	...
	try {
	sql = " select aa.shi,aa.xian,aa.xiaoqu, aa.zdid,aa.jzname, aa.property, aa.dl,aa.qsdbdl,(round(decode(aa.qsdbdl,'0',aa.dl,(aa.dl - aa.qsdbdl) / aa.qsdbdl), 4)) * 100 || '%' as cbbl from (select jz.shi as shi,(select agname from d_area_grade where agcode = zd.xian) as xian,(select agname from d_area_grade where agcode = zd.xiaoqu) as xiaoqu,zd.id as zdid,zd.jzname as jzname, (select i.name from indexs i where i.code = zd.property) as property,round(decode(jz.jsdl, '', jz.gldl, '0', jz.gldl, jz.jsdl), 4) dl,jz.qsdbdl as qsdbdl from jzxx jz left join zhandian zd on jz.zdid = zd.id where 1 = 1 AND symonth = '"+bzyf+"' AND zd.shi = '"+shi+"' AND jz.zdid = to_char(zd.id) AND zd.property = '"+property+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))) aa where decode(aa.qsdbdl,'0',aa.dl, (aa.dl - aa.qsdbdl) / aa.qsdbdl) >= "+cbbll+"";
    ...
    //超标站点9月份之后
    try {
    	sql = " select aa.shi,aa.xian,aa.xiaoqu, aa.zdid,aa.jzname, aa.property, aa.dl,aa.qsdbdl,(round(decode(aa.qsdbdl,'0',aa.dl," +
    			"(aa.dl - aa.qsdbdl) / aa.qsdbdl), 4)) * 100 || '%' as cbbl from (select jz.shi as shi,(select agname from d_area_grade where agcode = zd.xian) as xian," +
    			...
    			"round( jz.jsdl, 4) dl,jz.qsdbdl as qsdbdl from jzxx jz left join zhandian zd on jz.zdid = zd.id where 1 = 1 AND symonth = '"+bzyf+"' AND zd.shi = '"+shi+"' AND jz.zdid = to_char(zd.id) " +
    		    "AND zd.property = '"+property+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))) aa where decode(aa.qsdbdl,'0',aa.dl, (aa.dl - aa.qsdbdl) / aa.qsdbdl) >= "+cbbll+"";
...
public synchronized ArrayList getCbzdNew(String shi,String bzyf,String cbbl,String loginId,String property ) {
	...
	DataBase db = new DataBase();
	  //超标站点2014-08月份之后
    try {
    	sql = "select aa.shi,aa.xian, aa.xiaoqu,aa.zdid, aa.jzname, aa.property, aa.dbydl,aa.bzz," +
    			"(round(decode(aa.bzz, '0', aa.dbydl, (aa.dbydl - aa.bzz) / aa.bzz), 4)) * 100 || '%' as cbbl " +
    			"from (select jz.shi as shi, (select agname from d_area_grade where agcode = zd.xian) as xian," +
    			" (select agname from d_area_grade where agcode = zd.xiaoqu) as xiaoqu,  zd.id as zdid, zd.jzname as jzname," +
    			" (select i.name from indexs i where i.code = zd.property) as property, round(jz.dbydl, 4) dbydl, jz.bzz as bzz" +
    			" from jzxx jz left join zhandian zd on jz.zdid = zd.id where 1 = 1 AND JZ.BZZ>0 AND symonth = '"+bzyf+"' AND zd.shi = '"+shi+"'" +
    			" AND jz.zdid = to_char(zd.id) AND zd.property = '"+property+"' " +
    			"AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))) aa " +
    			"where decode(aa.bzz, '0', aa.dbydl, (aa.dbydl - aa.bzz) / aa.bzz) >= "+cbbll+"";
    				

    	ResultSet rs = null;
    	System.out.println("超标站点201408月之后"+sql.toString());
    		db.connectDb();
    		rs = db.queryAll(sql);
            while(rs.next()){
            	cbJzBean c = new cbJzBean();
...
//结算电量超标
public synchronized ArrayList getJsdlcb(String shi,String bzyf,String bzyf02,String cbbl,String cbblsyc,String loginId ,String property) {
	...
	if(bzyf.equals("2013-03")||bzyf.equals("2013-04")){
		...
		try {
			...
			sql3="select d.agname,s.agname,a.agname,zd.id, zd.jzname,i.name,round(aa.jsdl, 4),aa.bz,round((aa.jsdl - aa.bz) / aa.bz, 4) * 100," +
					...
					"AND zd.shi = '"+shi+"' AND zd.property = '"+property+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))";
			ResultSet rs = null;
	...
	if(bzyf.equals("2013-05")){
		...
		try {
			...
			sql1 = "select d.agname as shi,s.agname as xian,a.agname as xiaoqu,zd.id,zd.jzname as jzname,i.name as property,aa.jsdl,aa.qsdbdl," +
					...
					" left join d_area_grade s on zd.xian = s.agcode left join d_area_grade a on zd.xiaoqu = a.agcode " +
					"left join indexs i on zd.property = i.code where aa.zdid = bb.zdid AND zd.shi = '"+shi+"' AND bb.zdid = to_char(zd.id)" +
					" AND zd.property = '"+property+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))";
			ResultSet rs = null;
	...
	sql = "select d.agname,s.agname,a.agname,zd.id,zd.jzname,i.name,round(aa.jsdl,4),aa.qsdbdl,round((aa.jsdl-aa.qsdbdl)/aa.qsdbdl,4)*100," +
			...
			" zd.property = i.code where aa.zdid = bb.zdid AND bb.zdid = to_char(zd.id)AND zd.property = '"+property+"' AND zd.shi = '"+shi+"'AND (zd.xiaoqu IN " +
	...
	//结算电量超标9月以后查询
	try {
	sql4 = "select d.agname,s.agname,a.agname,zd.id,zd.jzname,i.name,round(aa.jsdl,4),aa.qsdbdl,round((aa.jsdl-aa.qsdbdl)/aa.qsdbdl,4)*100," +
			"round(bb.gldl,4),bb.qsdbdl,round((bb.gldl-bb.qsdbdl)/bb.qsdbdl,4)*100 from (select dl.shi, dl.zdid, dl.jzname, dl.jsdl, dl.qsdbdl " +
			"from (select t.shi, t.zdid, t.jzname, t.jsdl, t.qsdbdl from jzxx t where 1 = 1  AND symonth = '"+bzyf+"') dl" +
			" where (dl.jsdl - dl.qsdbdl) / decode(dl.qsdbdl, '0', dl.jsdl, dl.qsdbdl) >= "+cbbll+") aa,(select dl.shi, dl.zdid, dl.jzname, dl.gldl, dl.qsdbdl " +
			"from (select t.shi, t.zdid, t.jzname,t.gldl gldl, t.qsdbdl  from jzxx t where 1 = 1 AND" +
			" symonth = '"+bzyf02+"') dl where (dl.gldl - dl.qsdbdl) / decode(dl.qsdbdl, '0', dl.gldl, dl.qsdbdl) < "+cbblsyc_zd+") bb,zhandian zd left join d_area_grade d " +
			"on zd.shi = d.agcode left join d_area_grade s on zd.xian = s.agcode left join d_area_grade a on zd.xiaoqu = a.agcode left join indexs i on" +
			" zd.property = i.code where aa.zdid = bb.zdid AND bb.zdid = to_char(zd.id)AND zd.property = '"+property+"' AND zd.shi = '"+shi+"'AND (zd.xiaoqu IN " +
			"(SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))";
...
public synchronized ArrayList getJsdlcbNew(String shi,String bzyf,String bzyf02,String cbbl,String cbblsyc,String loginId ,String property) {
	...
	//结算电量超标201408月以后查询
	try {
	sql4 = "select d.agname, s.agname, a.agname, zd.id, zd.jzname,i.name,round(aa.dbydl, 4), aa.bzz," +
			"round((aa.dbydl - aa.bzz) / aa.bzz, 4) * 100, round(bb.dbgldl, 4), bb.bzz, round((bb.dbgldl - bb.bzz) / bb.bzz, 4) * 100" +
			" from (select dl.shi, dl.zdid, dl.jzname, dl.dbydl, dl.bzz from (select t.shi, t.zdid, t.jzname, t.dbydl, t.bzz " +
			"from jzxx t where 1 = 1 AND T.BZZ>0 AND symonth = '"+bzyf+"') dl where (dl.dbydl - dl.bzz) / decode(dl.bzz, '0', dl.dbydl, dl.bzz) >=  "+cbbll+") aa," +
			"(select dl.shi, dl.zdid, dl.jzname, dl.dbgldl, dl.bzz from (select t.shi, t.zdid, t.jzname, t.dbgldl dbgldl, t.bzz from jzxx t" +
			" where 1 = 1 AND T.BZZ>0 AND symonth = '"+bzyf02+"') dl where (dl.dbgldl - dl.bzz) / decode(dl.bzz, '0', dl.dbgldl, dl.bzz) < "+cbblsyc_zd+") bb, zhandian zd " +
			"left join d_area_grade d on zd.shi = d.agcode left join d_area_grade s on zd.xian = s.agcode left join d_area_grade a" +
			" on zd.xiaoqu = a.agcode left join indexs i on zd.property = i.code where aa.zdid = bb.zdid AND bb.zdid = to_char(zd.id)" +
			" AND zd.property = '"+property+"' AND zd.shi = '"+shi+"' AND (zd.xiaoqu IN(SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))";
				

	ResultSet rs = null;
	System.out.println("结算电量超标201408月之后"+sql4.toString());
		db.connectDb();
		rs = db.queryAll(sql4);
        while(rs.next()){
        	cbJzBean c = new cbJzBean();
...
//连续超标
public synchronized ArrayList getLxcb(String shi,String bzyf,String bzyf02,String cbbl,String cbblsyc,String loginId,String property ) {
	...
	if(bzyf.equals("2013-03")||bzyf.equals("2013-04")){
		...
		try {
			sql2 = " select d.agname, s.agname, a.agname, zd.id, zd.jzname, i.name," +
					...
					" AND b.zdid = to_char(zd.id) AND zd.shi = '"+shi+"' AND zd.property = '"+property+"' AND (zd.xiaoqu IN(SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) and a.countbz >= "+cbblsyc_zd+" and b.countbz >= "+cbbll+"";
	...
	if(bzyf.equals("2013-06")||bzyf.equals("2013-07")||bzyf.equals("2013-08")){
	try {
	sql = "select d.agname,a.agname,s.agname,zd.id,zd.jzname,i.name,round(b.dl,4),b.bz,round(b.countbz,4)*100 || '%' as thismonth,round(a.dl,4),a.bz,round(a.countbz,4)*100 || '%' as lastmonth from (select ab.shi, ab.zdid,ab.dl,ab.bz,decode(ab.bz, '0', ab.dl, (ab.dl - ab.bz) / ab.bz) as countbz from (select jz.zdid, jz.shi, decode(jz.jsdl, '', jz.gldl, '0', jz.gldl, jz.jsdl) dl,jz.qsdbdl as bz from jzxx jz where 1 = 1 AND symonth = '"+bzyf02+"') ab) a,(select ab.zdid, ab.shi, ab.dl,ab.bz,(ab.dl - ab.bz) / ab.bz as countbz from (select jz.zdid,jz.shi,decode(jz.jsdl, '', jz.gldl, '0', jz.gldl, jz.jsdl) dl, jz.qsdbdl as bz from jzxx jz where 1 = 1 AND symonth = '"+bzyf+"') ab) b, zhandian zd left join  D_AREA_GRADE d on zd.shi=d.agcode left join  D_AREA_GRADE a on zd.xian=a.agcode left join  D_AREA_GRADE s on zd.xiaoqu=s.agcode left join  indexs i on zd.property=i.code where a.zdid = b.zdid AND b.zdid = to_char(zd.id) AND zd.property = '"+property+"' AND zd.shi='"+shi+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) and a.countbz >= "+cbblsyc_zd+" and b.countbz >= "+cbbll+"";
...
//连续超标9月份之后
	try {
		sql = "select d.agname,a.agname,s.agname,zd.id,zd.jzname,i.name,round(b.dl,4),b.bz,round(b.countbz,4)*100 || '%' as thismonth," +
				...
				"decode(ab.bz, '0', ab.dl, (ab.dl - ab.bz) / ab.bz) as countbz from (select jz.zdid, jz.shi, jz.jsdl as dl,jz.qsdbdl as bz from jzxx jz " +
				"where 1 = 1 AND symonth = '"+bzyf02+"') ab) a,(select ab.zdid, ab.shi, ab.dl,ab.bz,(ab.dl - ab.bz) / ab.bz as countbz from" +
				" (select jz.zdid,jz.shi,jz.jsdl as dl, jz.qsdbdl as bz from jzxx jz where 1 = 1 AND symonth = '"+bzyf+"') ab) b, zhandian zd " +
				...
				"left join  indexs i on zd.property=i.code where a.zdid = b.zdid AND b.zdid = to_char(zd.id) AND zd.property = '"+property+"' AND zd.shi='"+shi+"'" +
...
public synchronized ArrayList getLxcbNew(String shi,String bzyf,String bzyf02,String cbbl,String cbblsyc,String loginId,String property ) {
	...
	//连续超标201408月份之后
	try {
		sql = "select d.agname,a.agname, s.agname, zd.id, zd.jzname, i.name, round(b.dbydl, 4), b.bzz, round(b.countbz, 4) * 100 || '%' as thismonth," +
				"round(a.dbydl, 4), a.bzz, round(a.countbz, 4) * 100 || '%' as lastmonth from (select ab.shi, ab.zdid,ab.dbydl, ab.bzz," +
				"decode(ab.bzz, '0', ab.dbydl, (ab.dbydl - ab.bzz) / ab.bzz) as countbz from (select jz.zdid, jz.shi, jz.dbydl as dbydl," +
				" jz.bzz as bzz from jzxx jz where 1 = 1 and jz.bzz>0  AND symonth = '"+bzyf02+"') ab) a,(select ab.zdid,ab.shi,ab.dbydl, ab.bzz," +
				"(ab.dbydl - ab.bzz) / ab.bzz as countbz from (select jz.zdid, jz.shi, jz.dbydl as dbydl, jz.bzz as bzz from jzxx jz" +
				" where 1 = 1 and jz.bzz>0 AND symonth = '"+bzyf+"') ab) b, zhandian zd left join D_AREA_GRADE d on zd.shi = d.agcode left join D_AREA_GRADE a " +
				"on zd.xian = a.agcode left join D_AREA_GRADE s on zd.xiaoqu = s.agcode left join indexs i on zd.property = i.code " +
				"where a.zdid = b.zdid AND b.zdid = to_char(zd.id) AND zd.property = '"+property+"' AND zd.shi = '"+shi+"' " +
				"AND (zd.xiaoqu IN(SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) and a.countbz >= "+cbblsyc_zd+" and b.countbz >= "+cbbll+"";
		
		ResultSet rs = null;
		System.out.println("连续超标201408月份"+sql.toString());
			db.connectDb();
			rs = db.queryAll(sql);
	        while(rs.next()){
	        	cbJzBean c = new cbJzBean();
...
//连续超标且电量增加
public synchronized ArrayList getLxcbzj(String shi,String bzyf,String bzyf02,String cbbl,String cbblsyc,String loginId,String property) {
	...
	if(bzyf.equals("2013-05")){
		...
		try {
	    	sql2 = "select d.agname, s.agname, a.agname, zd.id, zd.jzname, i.name,b.dl,b.bz,round((b.dl-b.bz)/b.bz,4)*100||'%'," +
	    			...
	    			"AND b.zdid = to_char(zd.id) AND zd.shi='"+shi+"' AND zd.property = '"+property+"' " +
	...
	if(bzyf.equals("2013-03")||bzyf.equals("2013-04")){
	    ...
	    try {
	    	sql1 = "select d.agname, s.agname, a.agname, zd.id, zd.jzname, i.name," +
	    			...
	    			" left join indexs i on zd.property = i.code where a.zdid = b.zdid AND b.zdid = to_char(zd.id) AND zd.shi = '"+shi+"' AND zd.property = '"+property+"'" +
	    			" AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) and a.countbz >= "+cbblsyc_zd+"  and b.countbz >= "+cbbll+" and b.dl > a.dl";
	...
	if(bzyf.equals("2013-06")||bzyf.equals("2013-07")||bzyf.equals("2013-08")){
	try {
	sql = "select d.agname, a.agname, s.agname, zd.id, zd.jzname, i.name, round(b.dl, 4), b.bz, round(b.countbz, 4) * 100 || '%' as thismonth, round(a.dl, 4),a.bz,round(a.countbz, 4) * 100 || '%' as lastmonth from (select ab.shi, ab.zdid, ab.dl,ab.bz,decode(ab.bz, '0', ab.dl,(ab.dl - ab.bz) / ab.bz )as countbz from (select jz.zdid,jz.shi, decode(jz.jsdl, '', jz.gldl, '0', jz.gldl, jz.jsdl) dl,jz.qsdbdl as bz from jzxx jz where 1 = 1 AND symonth = '"+bzyf02+"') ab) a, (select ab.zdid, ab.shi, ab.dl,ab.bz, decode(ab.bz, '0', ab.dl,(ab.dl - ab.bz) / ab.bz) as countbz from (select jz.zdid, jz.shi, decode(jz.jsdl, '', jz.gldl, '0', jz.gldl, jz.jsdl) dl, jz.qsdbdl as bz from jzxx jz where 1 = 1 AND symonth = '"+bzyf+"') ab) b,zhandian zd left join D_AREA_GRADE d on zd.shi = d.agcode left join D_AREA_GRADE a on zd.xian = a.agcode left join D_AREA_GRADE s on zd.xiaoqu = s.agcode left join indexs i on zd.property = i.code where a.zdid = b.zdid AND zd.shi='"+shi+"' AND b.zdid = to_char(zd.id) AND zd.property = '"+property+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) and a.countbz >= "+cbblsyc_zd+" and b.countbz >= "+cbbll+" and b.dl > a.dl";
	...
	try {
		sql = "select d.agname, a.agname, s.agname, zd.id, zd.jzname, i.name, round(b.dl, 4), b.bz, round(b.countbz, 4) * 100 || '%' as thismonth, round(a.dl, 4),a.bz,round(a.countbz, 4) * 100 || '%' as lastmonth from (select ab.shi, ab.zdid, ab.dl,ab.bz,decode(ab.bz, '0', ab.dl,(ab.dl - ab.bz) / ab.bz )as countbz from (select jz.zdid,jz.shi,jz.jsdl as dl,jz.qsdbdl as bz from jzxx jz where 1 = 1 AND symonth = '"+bzyf02+"') ab) a, (select ab.zdid, ab.shi, ab.dl,ab.bz, decode(ab.bz, '0', ab.dl,(ab.dl - ab.bz) / ab.bz) as countbz from (select jz.zdid, jz.shi,jz.jsdl as dl, jz.qsdbdl as bz from jzxx jz where 1 = 1 AND symonth = '"+bzyf+"') ab) b,zhandian zd left join D_AREA_GRADE d on zd.shi = d.agcode left join D_AREA_GRADE a on zd.xian = a.agcode left join D_AREA_GRADE s on zd.xiaoqu = s.agcode left join indexs i on zd.property = i.code where a.zdid = b.zdid AND zd.shi='"+shi+"' AND b.zdid = to_char(zd.id) AND zd.property = '"+property+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) and a.countbz >= "+cbblsyc_zd+" and b.countbz >= "+cbbll+" and b.dl > a.dl";
...
public synchronized ArrayList getLxcbzjNew(String shi,String bzyf,String bzyf02,String cbbl,String cbblsyc,String loginId,String property) {
	...
	try {
		sql =	"select d.agname, a.agname, s.agname,  zd.id, zd.jzname, i.name, round(b.dbydl, 4), b.bzz, round(b.countbz, 4) * 100 || '%' as thismonth," +
				" round(a.dbydl, 4), a.bzz, round(a.countbz, 4) * 100 || '%' as lastmonth  from (select ab.shi,  ab.zdid,ab.dbydl, ab.bzz, " +
				"decode(ab.bzz, '0', ab.dbydl, (ab.dbydl - ab.bzz) / ab.bzz) as countbz from (select jz.zdid, jz.shi, jz.dbydl as dbydl, jz.bzz as bzz " +
				" from jzxx jz where 1 = 1 and jz.bzz>0  AND symonth = '"+bzyf02+"') ab) a, (select ab.zdid, ab.shi, ab.dbydl, ab.bzz, decode(ab.bzz, '0', ab.dbydl," +
				" (ab.dbydl - ab.bzz) / ab.bzz) as countbz from (select jz.zdid, jz.shi, jz.dbydl as dbydl, jz.bzz as bzz from jzxx jz  where 1 = 1 and jz.bzz>0  " +
				" AND symonth = '"+bzyf+"') ab) b, zhandian zd left join D_AREA_GRADE d on zd.shi = d.agcode left join D_AREA_GRADE a" +
				" on zd.xian = a.agcode left join D_AREA_GRADE s on zd.xiaoqu = s.agcode left join indexs i " +
				"on zd.property = i.code where a.zdid = b.zdid AND zd.shi = '"+shi+"'  AND b.zdid = to_char(zd.id) " +
				"AND zd.property = '"+property+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"'))" +
				" and a.countbz >= "+cbblsyc_zd+" and b.countbz >= "+cbbll+"  and b.dbydl > a.dbydl";		

		ResultSet rs = null;
		System.out.println("连续超标增加201408月份之后"+sql.toString());
			db.connectDb();
			rs = db.queryAll(sql);
	        while(rs.next()){
	        	cbJzBean c = new cbJzBean();
...
//未按期整改
public synchronized ArrayList getWaq(String shi,String bzyf,String cbbl,String loginId,String property) {
	...
	if(bzyf.equals("2013-03")||bzyf.equals("2013-04")){
	    ...
	    try {
			sql2 = "select aa.shi,aa.xian,aa.xiaoqu,aa.zdid,aa.jzname,aa.property,aa.yf,aa.dl3,aa."+bmonth+",aa.bbl,aa.cbsj,aa.sjdl,aa.nhbz,aa.bzpld " +
					...
					"left join indexs i on zd1.property = i.code where 1 = 1 AND zd.zdid = to_char(zd1.id) AND zd1.property = '"+property+"' AND zd1.shi='"+shi+"' " +
	...
	try {
		...
		"where zd.shi = '"+shi+"'  AND zd.property = '"+property+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) AND decode(aa.month3, '0', aa.dl3, (aa.dl3 - aa.month3) / aa.month3) >= "+cbbll+"";		
	...
	try {
		sql = "select b.agname, a.agname,s.agname,zd.id,zd.jzname,i.name, aa.yf,round(aa.dl3,2) dl3,aa.month3,aa.cbbl*100||'%',aa.cbsj,aa.sjdl,aa.nhbz,aa.bzpld *100||'%'" +
				" from zhandian zd left join (select dls.zdid   as zdid,dls.yf as yf,dls.dl3 as dl3, dls.month3 as month3,dls.cbbl as cbbl,mdz.cbsj   as cbsj," +
				" mdz.sjdl   as sjdl,mdz.nhbz   as nhbz, mdz.bzpld  as bzpld from (select c.zdid,c.cbsj as cbsj,c.sjdl as sjdl,c.nhbz as nhbz,c.bzpld as bzpld from cbzd c where c.cbsj <= '"+bzyf02+"') mdz," +
				"(select dl3.* from (select jz.zdid as zdid,'"+bzyf+"' as yf,jz.jsdl as dl3,jz.qsdbdl as month3,round((jz.jsdl - jz.qsdbdl) / jz.qsdbdl, 4) as cbbl from jzxx jz  where 1 = 1 AND symonth = '"+bzyf+"') dl3) dls" +
				" where mdz.zdid = dls.zdid) aa on zd.id = aa.zdid left join D_AREA_GRADE b on zd.shi = b.agcode left join D_AREA_GRADE a on zd.xian = a.agcode left join D_AREA_GRADE s on zd.xiaoqu = s.agcode left join indexs i on zd.property = i.code " +
				"where zd.shi = '"+shi+"'  AND zd.property = '"+property+"' AND (zd.xiaoqu IN (SELECT T.AGCODE FROM PER_AREA T WHERE T.ACCOUNTID = '"+loginId+"')) AND decode(aa.month3, '0', aa.dl3, (aa.dl3 - aa.month3) / aa.month3) >= "+cbbll+"";		
		ResultSet rs = null;
