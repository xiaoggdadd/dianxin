...
public class WydfftAdd extends HttpServlet {
...
//		try {
//			t_zq1 = mdFormat.format(ymdFormat.parse(t_zq1));
...
//		try {
//			t_zq2 = mdFormat.format(ymdFormat.parse(t_zq2));
//		} catch (ParseException e) {
//			e.printStackTrace();
//		}
...
//		boolean flag1 = cwManage.insertCwdfft(cwybx);
		boolean flag2 = wyManage.insertWydfft(wydfft);
