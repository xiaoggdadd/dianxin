...
/*	public static AipgReq makeNotify(String qsn)
	...
	{
		xs.alias("BASEINFO", BaseInfoReq.class);
		xs.alias("MESSAGE", Message.class);
		xs.alias("requestMessage", RequestMessage.class);
		xs.alias("item", BZItem.class);
		xs.alias("lineItem", BZLineItem.class);
		xs.alias("relateSupplier", RelateSupplier.class);
