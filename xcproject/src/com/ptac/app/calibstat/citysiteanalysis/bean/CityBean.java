package com.ptac.app.calibstat.citysiteanalysis.bean;
...
public class CityBean {
		...
		private String county;//区县(汉字,用于页面显示)
		private String xian;//区县(code码,用于查询)
		...
		private String hdl1;//1月耗电量(度/天)	
		private String hdl2;//2月耗电量(度/天)	
		private String hdl3;//3月耗电量(度/天)	
		private String hdl4;//4月耗电量(度/天)	
		private String hdl5;//5月耗电量(度/天)	
		private String hdl6;//6月耗电量(度/天)	
		private String hdl7;//7月耗电量(度/天)	
		private String hdl8;//8月耗电量(度/天)	
		private String hdl9;//9月耗电量(度/天)	
		private String hdl10;//10月耗电量(度/天)	
		private String hdl11;//11月耗电量(度/天)	
		private String hdl12;//12月耗电量(度/天)
		private String cbbl01;//超标比例1月
		private String cbbl02;//超标比例2月
		private String cbbl03;//超标比例3月
		private String cbbl04;//超标比例4月
		private String cbbl05;//超标比例5月
		private String cbbl06;//超标比例6月
		private String cbbl07;//超标比例7月
		private String cbbl08;//超标比例8月
		private String cbbl09;//超标比例9月
		private String cbbl10;//超标比例10月
		private String cbbl11;//超标比例11月
		private String cbbl12;//超标比例12月
