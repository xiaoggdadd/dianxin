package com.ptac.app.priceover.citycheck.bean;
...
public class CityCheckBean {
	...
	private String shbzw;//省审核标志位
	
	public String getShbzw() {
		return shbzw;
	}
	public void setShbzw(String shbzw) {
		this.shbzw = shbzw;
	}
