package com.ptac.app.collectanalysis.onesitedbshi.util;
...
public class UtilIneSiteDbShi {
	public long[] getSum(List<OneSiteDbShi> list){
		long[] sum = new long[5];
		long zds = 0;
		long yzyb = 0;
		long yzdb = 0;
