package com.ptac.app.basisquery.electricdetail.bean;
/**
 * @author lijing
 * @see 电费缴纳明细页面所需的字段
 * @update 添加"财务审核状态"字段 ZengJin 2014-1-16
 */
public class ElectricDetail {
	...
	private double totalmoney;//电量合计	
	private double totalelectric;//电费合计
	private double sdbdf;//省定标电费
	private double csdbdfe;//超省定标电费额
	private double dbydl;//电表用电量
	private double dedhdl;//电费超市标比例
	private double csdb;//电费超省标比例
	...
	public double getDedhdl() {
		return dedhdl;
	}
	public void setDedhdl(double dedhdl) {
		this.dedhdl = dedhdl;
	}
	public double getCsdb() {
		return csdb;
	}
	public void setCsdb(double csdb) {
		this.csdb = csdb;
	}
