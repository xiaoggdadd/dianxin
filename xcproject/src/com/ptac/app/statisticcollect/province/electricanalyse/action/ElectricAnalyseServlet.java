package com.ptac.app.statisticcollect.province.electricanalyse.action;
...
import com.ptac.app.statisticcollect.province.electricanalyse.dao.ElectricAnalyseDao;
import com.ptac.app.statisticcollect.province.electricanalyse.dao.ElectricAnalyseDaoImpl;
...
public class ElectricAnalyseServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if("chaxun".equals(action)){
			request.getRequestDispatcher("/web/appJSP/statisticscollect/province/electricanalyse/electricanalyse.jsp").forward(request, response);
		}else{
			request.getRequestDispatcher("/web/appJSP/statisticscollect/province/electricanalyse/electricanalyseExport.jsp").forward(request, response);
		}
	}
