package com.ptac.app.statisticcollect.city.elecfeesanalyse.action;
...
import com.ptac.app.statisticcollect.city.elecfeesanalyse.dao.ElecfeesAnalyseDao;
import com.ptac.app.statisticcollect.city.elecfeesanalyse.dao.ElecfeesAnalyseDaoImpl;
...
public class ElecfeesAnalyseServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if("chaxun".equals(action)){
			request.getRequestDispatcher("/web/appJSP/statisticscollect/city/elecfeesanalyse/elecfeesanalyse.jsp").forward(request, response);
		}else{
			request.getRequestDispatcher("/web/appJSP/statisticscollect/city/elecfeesanalyse/elecfeesanalyseExport.jsp").forward(request, response);
		}
	}
