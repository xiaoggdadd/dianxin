...
FrameContent+="<img src='Public/-.gif' width='16' height='16' border='0' alt='上一年' style='cursor:hand' onclick=\"parent.ForwardYear (window.parent.document.all."+InputBox.name+","+Now_Year+","+Now_Month+","+Now_Day+")\">";
FrameContent+="</td>\n";
...
FrameContent+="</td>\n";
FrameContent+="<td width=8>";
FrameContent+="<img src='Public/+.gif' width='16' height='16' border='0' alt='下一年' style='cursor:hand' onclick=\"parent.NextYear (window.parent.document.all."+InputBox.name+","+Now_Year+","+Now_Month+","+Now_Day+")\">";
FrameContent+="</td>\n";
FrameContent+="<td width=8>";
FrameContent+="<img src='Public/-.gif' width='16' height='16' border='0' alt='上一月' style='cursor:hand' onclick=\"parent.ForwardMonth (window.parent.document.all."+InputBox.name+","+Now_Year+","+Now_Month+","+Now_Day+")\">";
FrameContent+="</td>\n";
...
FrameContent+="</td>\n";
FrameContent+="<td width=8>";
FrameContent+="<img src='Public/+.gif' width='16' height='16' border='0' alt='下一月' style='cursor:hand' onclick=\"parent.NextMonth (window.parent.document.all."+InputBox.name+","+Now_Year+","+Now_Month+","+Now_Day+")\">";
FrameContent+="</td>"+"\n";
FrameContent+="</tr>"+"\n";
FrameContent+="</table>"+"\n";
...
FrameContent+="<td><center>星期一</center></td>"+"\n";
FrameContent+="<td><center>星期二</center></td>"+"\n";
FrameContent+="<td><center>星期三</center></td>"+"\n";
FrameContent+="<td><center>星期四</center></td>"+"\n";
FrameContent+="<td><center>星期五</center></td>"+"\n";
FrameContent+="<td><center><font color='#FF0000'>星期六</font></center></td>"+"\n";
FrameContent+="<td><center><font color='#FF0000'>星期日</font></center></td>"+"\n";
FrameContent+="</tr>"+"\n";
