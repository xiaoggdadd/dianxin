...
.form_la{
  ...
  function dfinfo1(zdcode,startmonth,endmonth){
    var url=path+"/web/sightcing/sitebenchmarkingc3.jsp?zdcode="+zdcode+"&startmonth="+startmonth+"&endmonth="+endmonth;	
	var obj = new Object();
	obj.mid='mid';
    var obj=showModalDialog(url,obj,'dialogWidth:1000px;dialogHeight:1000px;status:auto;scroll:auto');	
}
    function dfinfo(zdcode){
    var url=path+"/web/sightcing/sitebenchmarkingc4.jsp?zdcode="+zdcode;		
	var obj = new Object();
	obj.mid='mid';
    var obj=showModalDialog(url,obj,'dialogWidth:1000px;dialogHeight:1000px;status:auto;scroll:auto');	
}
  ...
  <body class="body" style="overflow: scroll;">
    <form action="" name="form1" method="post">
       <table width="100%" height="30%"  border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
 		 ...
 		 if(dl!=null&&!"null".equals(dl)&&!" ".equals(dl)&&!"".equals(dl)&&dl!=""){
           List<SiteBeanchmark> list=bean.getsitec3(loginId,zdlx,dl,bl,startmonth,endmonth,wherestr,site,code);
           DecimalFormat mat=new DecimalFormat("0.00");
           DecimalFormat mat1=new DecimalFormat("0.0000");
           int intnum=0;
           for(SiteBeanchmark bean1:list){
        	   String color="";
        	   String zdname="",zdcode="",ratio="",szdq="",df="",jtlx="",fkzq="",beilv="",xslx="",xsz="",pue="";
