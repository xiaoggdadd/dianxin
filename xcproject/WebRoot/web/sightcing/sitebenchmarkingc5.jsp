...
<body  class="body" style="overflow-x:hidden;">
  ...
  <table width="100%" border="0" class="form_label" cellspacing="1" cellpadding="1">
		<tr>	 
		<td colspan="8"><span style="color:black;font-weight:bold;font-size=14;">站点电量明细</span></td>
	</tr>
	<tr>
		<td>
  	...
  	<div style="width:100%;height:430px;overflow-x:auto;overflow-y:auto;border:1px">
  	  <table width="100%" height="30%"  border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
      	<tr height = "23" class="relativeTag ">
            			...
            			<td width="10%" height="20" bgcolor="#DDDDDD"><div align="center" class="bttcn">电表名称</div>
            			</td>
       ...
       <%
            ...
            String color="";           
             List<SiteBeanchmark> list = bean.getsitec5(zdcode,startmonth,endmonth);
       	     String zdname="",dbname="",lasttime="",thistime="",lastdegree="",thisdegree="",start="",end="",floatdegree="",blhdl="",floatpay="",actualpay="",accountmonth="";
