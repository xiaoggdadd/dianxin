...
.form_la{
  ...
  function dfinfo1(zdcode,startmonth,endmonth){
    var url=path+"/web/sightcing/sitebenchmarkingc5.jsp?zdcode="+zdcode+"&startmonth="+startmonth+"&endmonth="+endmonth;	
	var obj = new Object();
	obj.mid='mid';
    ...
    <form action="" name="form1" method="post">
       <table width="100%" height="30%"  border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
 		 ...
 		 System.out.println("where"+wherestr);
           List<SiteBeanchmark> list=bean.getsitec2(loginId,zdlx,startmonth,endmonth,wherestr,code);
