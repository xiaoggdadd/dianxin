...
var path = '<%=path%>';    
    function modifyad(stationtype){
    	var b=path+"/web/sightcing/sightcingquery2.jsp?stationtype="+stationtype;			
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#666666">
     ...
     <tr height = "20" class= "relativeTag " >
       ...
       <%
		...
		String stationtype = "",haodian="",caiji="",fou="";
		int linenum=0; 
		double df=0.0;
		 if(fylist!=null)
		{
       ...
       <tr bgcolor="<%=color%>">
       		<td>
       			<div align="center" class="form_label"><a href="javascript:modifyad('<%=stationtype%>')" ><%=stationtype%></div>
       		</td>
       		<td>
