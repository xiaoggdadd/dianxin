...
<%@ page import="com.noki.util.CTime,com.noki.sysconfig.javabean.AutoAuditBean" %>
...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function toedit(ItemID,curpage){
          document.form1.action=path+"/web/sysconfig/autoAuditList.jsp?ItemID="+ItemID+"&curpage1="+curpage;
                                document.form1.submit();
  }
    //取消
  function quxiao(ItemID,curpage){
          document.form1.action=path+"/web/sysconfig/autoAuditList.jsp"+"?curpage1="+curpage;
                                document.form1.submit();
  }
  //修改
   function modifysys(ItemID,curpage){
          document.form1.action=path+"/servlet/autoaudit?action=modify&ItemID="+ItemID+"&curpage1="+curpage;
          document.form1.submit();
