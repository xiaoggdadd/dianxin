...
function getDictList(maxrow,minrow){
	...
	var params ="&key=value";
	 Url = getPublicPath()+"/servlet/ProFileInfoServlet?action=getSelData&roleFlg=PERMISSION_SEARCH";
...
//增加数据
 function add(){
 window.location.href=getPublicPath()+"/"+"web/proFileInfo/add.jsp";
   ...
   function open1(url){
   window.location.href=getPublicPath()+"/"+"web/proFileInfo/"+url;
...
//
   function del(id){
     if(confirm("确定删除")){
       var params = "?&xmmch="+id;
       var Url=getPublicPath()+"/servlet/ProFileInfoServlet?action=del&roleFlg=PERMISSION_DELETE";
	    new Ajax.Request(Url,{
	      		method : 'post',
				asynchronous: false,
			    parameters : params,
														...
														<br>
													     ...
													     <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" id ="dict">
													         <tr>
													             ...
													             <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">文件标题</div></td>
													             <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">文件类型</div></td>
