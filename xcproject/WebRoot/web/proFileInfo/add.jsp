   ...
   function waitThenDoIt(){
	    if (window.document.readyState){//IE
		      if (window.document.readyState=='complete'){ 
		        ...
		        var Url=getPublicPath()+"/servlet/ProFileInfoServlet?action=optionSele&roleFlg=PERMISSION_SEARCH";
    ...
    function addDate(){
       var Url=getPublicPath()+"/servlet/ProFileInfoServlet?action=insert&roleFlg=PERMISSION_ADD";
...
<%--////////////////////////////////////////////////////////////////////////////////////////////////////--%>
	    ...
	    <tr bgcolor="F9F9F9">
	       ...
	       <td>	     
	       <select name="xmmch" id="xmmch" style="width:130" style="width:130;">
		   </select>
		   </td>
	       <td bgcolor="#DDDDDD">文件标题:</td>
	       <td><input type="text" id="wjbt" name="wjbt"  class="form" style="width: 130px;"/></td>
	    </tr>
	    <tr bgcolor="F9F9F9">
	       <td bgcolor="#DDDDDD">文件类型:</td>
	       <td><input type="text" id="wjlx" name="wjlx"  class="form" style="width: 130px;"></td>
	       <td bgcolor="#DDDDDD">文件简介:</td>
	       <td><input type="text" id="wjjj" name="wjjj"  class="form" style="width: 130px;"/></td>
    ...
    <tr>
       ...
       <a href="javascript:fanhui()">
          <div id="cancelBtn" style="width:60px;height:23px;cursor:pointer;float:right;position:relative;right:-270px">
         ...
         <a href="javascript:addDate()"> 
          <div id="saveBtn" style="width:60px;height:23px;cursor:pointer;float:right;position:relative;right:-260px">
