...
.bttcn {
	...
	font-weight: bold;
		...
		<script type="text/javascript" src="<%=path%>/extjs/ext-all.js">
</script>
		<script type="text/javascript"
			src="<%=path%>/extjs/locale/ext-lang-zh_CN.js">
</script>
...
<script type='text/javascript' src='/energy/dwr/interface/zdyzhandianServise.js'></script>
		...
		<form action="" name="form1" method="POST">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<td colspan="4" width="50">
						<div style="width: 700px;">
							<img alt="" src="<%=path%>/images/btt.bmp" width="100%"
								height="100%" />
							<span
								style="font-size: 14px; font-weight: bold; position: absolute; left: 25px; top: 15px; color: black">基站每月缴费情况</span>
						</div>
					</td>
				</tr>
				<tr>
				...
				out.print(request.getParameter("endTime"));%>"
								...
								<td>
									<input type="button" value="分裂" onclick="mess()">
								</td>
								<td>
									<div id="query"
			...
			<div id='hello' style="width: 100%; height: 90%;" />
...
function mess() {
	alert("d");
	zdyzhandianServise.getZdyXML(callMess);
}
function callMess(data) {
	alert(data);
}
Ext.onReady(function() {
	alert("33");
	var pt =  '<%=path%>';
///servlet/zdyzhandianServlet
	//定义数据集对象
		var store = new Ext.data.Store({
			...
			proxy : new Ext.data.HttpProxy({
				url :pt+ 'servlet/zdyzhandianServlet'
			})
		});
