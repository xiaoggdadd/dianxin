...
function daoru(){
	...
	document.form1.action=path+"/servlet/DaoruZhandiandanjiaServlet";
...
function exportModel(){
            ...
            document.form1.action=path+"/servlet/download?action=downloaddj&templetname="+encodeURIComponent("站点单价批量修改导入模版");
            document.form1.submit();
   }
 $(function(){
