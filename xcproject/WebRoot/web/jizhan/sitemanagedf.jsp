...
<%
    ...
    String sj=request.getParameter("entrytimeQS")!=null?request.getParameter("entrytimeQS"):"";
    String dfhs_yys=request.getParameter("dfhs_yys")!=null?request.getParameter("dfhs_yys"):"0";
    String c="";
    ...
    int count=0,pagesize=17,curpage=1,nextpage=1,prepage=1,allpage=1,xh=1;
...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
					document.form1.action=path+"/web/jizhan/sitemanagedf.jsp?command=chaxun";
	...
	function addJz(){
		document.form1.action=path+"/web/jizhan/addsitedf.jsp";
		document.form1.submit();
	}
	//新导入
	function daorujz(){
...
<body  class="body" style="overflow-x:hidden;">
		 ...
		 <tr>
					    	<td colspan="4" width="50" >
											 ...
											 <!--   <img alt="" src="<%=path%>/images/btt.bmp" width="100%" height="100%" />-->
											  <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">电费垫付回收管理</span>	
												</div>
											</td>
			...
			<tr>
				<td>
         		...
         		%>
         		  ...
         		  <td>运营商</td>
         <td width="">
          	<select name="dfhs_yys" id="dfhs_yys" style="width:130" class="selected_font">
         		<option value="0">请选择</option>
         		<%
    ...
    <td>区县： </td>
        <td> <select name="xian" id="xian" style="width:130;"  onchange="changeCountry()" class="selected_font">
				...
				-->
			     ...
			     <td colspan="5">
					...
					<table>
							...
							<!--  <td>站点属性：</td>-->
         	<td>
         	<select name="jzproperty" style="width:130" style="display:none;"  class="selected_font">
         		<option value="0">请选择</option>
         		<%
         ...
         <!--    <td>是否标杆：</td>	-->
         	<td><select name="bgsign" style="display:none;" style="width:130" class="selected_font">
       ...
       <!--  <td>集团报表类型：</td> -->
         	<td>
         	<select name="jztype" style="width:130" style="display:none;"   class="selected_font">
         		<option value="0">请选择</option>
         		<%
           ...
           <!--  <td>是否采集：</td>	 -->
         	<td><select name="caijidian"  style="display:none;"   style="width:130" class="selected_font">
...
<tr><td height="5"  colspan="4"><div id="parent" style="display:inline">
  ...
  String yf="";
         /*  if(sheng != null && !sheng.equals("")&& !sheng.equals("0")){
			...
			//String entrytime=mat.format(new Date());
		   //	String yue=entrytime.substring(5,7);
			//int a =Integer.parseInt(yue);		
	     if (!shi.equals("0")) {
			whereStr=whereStr+" AND Z.SHI='" + shi + "'";
			str=str+" AND Z.SHI='" + shi + "'";
		    }
		if (!dfhs_yys.equals("0")&&dfhs_yys!=null) {
			whereStr=whereStr+" AND Z.DFHS_YYS ='" + dfhs_yys + "'";
			str=str+" AND Z.DFHS_YYS = '" + dfhs_yys + "'";
		}
		if (!sj.equals("")&&sj!=null) {
			whereStr=whereStr+" AND TO_CHAR(Z.ENTRYTIME,'YYYY-MM-DD')='"+sj+"'";
			str=str+" AND TO_CHAR(Z.ENTRYTIME,'YYYY-MM-DD')='"+sj+"'";
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
             ...
             <tr height="23">
		          ...
		          <td  height="23" width="3%" bgcolor="#DDDDDD" ><div align="center" class="btt">地市</div></td>
                  <td  height="23" width="9%" bgcolor="#DDDDDD" ><div align="center" class="btt"><%=a-1%>月底前垫付未收回资金</div></td>
                  <td  height="23" width="14%" bgcolor="#DDDDDD" ><div align="center" class="btt"><%=a-1%>月底前垫付未收回资金:<%=a%>月已回款</div></td>
                  <td  height="23" width="5%"  bgcolor="#DDDDDD"><div align="center"  class="btt">待回收资金</div></td>
                  <td  height="23" width="14%"  bgcolor="#DDDDDD" ><div align="center" class="btt">待回收资金:已和运营商完成明细核对</div></td>
                  <td  height="23" width="9%"  bgcolor="#DDDDDD" ><div align="center" class="btt">待回收资金:已开票</div></td>
                  <td  height="23" width="6%"  bgcolor="#DDDDDD" ><div align="center" class="btt">已核对占比</div></td>
                  <td  height="23" width="6%"  bgcolor="#DDDDDD" ><div align="center" class="btt">已开票占比</div></td>
                  <td  height="23" width="5%"  bgcolor="#DDDDDD"><div align="center" class="btt">运营商</div></td>
       ...
       <%
     	...
     	if("chaxun".equals(request.getParameter("command"))||"daochu".equals(request.getParameter("command"))){
            fylist =bean.getPageDatadf(curpage,loginName,loginId,whereStr);
...
,entrytimea,updatetime,shia,entryperson,updateperson;
       			...
       			//num为序号，不同页中序号是连续的
       			//ID DFWHSZJ DFWHSZJ_BYHS
//DHSZJ DHSZJ_YYSHD DHSZJ_YKP DFHS_YYS DFHS_HDZB DFHS_KPZB  SHI
       ...
       <tr bgcolor="<%=color%>">
       		...
       		<td >
       			<div align="center"  ><%=shia%></div>
       		</td>
       		<td >
       			<div align="right"  ><%=dfwhszj%></div>
       		</td>
       		<td >
       			<div align="right"  ><%=dfwhszj_byhs%></div>
       		</td>
       		<td>
       			<div align="right"  ><%=dhszj%></div>
       		</td>
       			<td >
       			<div align="right"  ><%=dhszj_yyshd%></div>
       		</td>
       		<td>
       			<div align="right"  ><%=dhszj_ykp%></div>
       		</td>
       		<td >
       			<div align="right"  ><%=dfhs_hdzb%>%</div>
       		</td>
       		<td >
       			<div align="right"  ><%=dfhs_kpzb%>% </div>
       		</td >
     <td>
       			<div align="center"  ><%=dfhs_yysa%></div>
       		</td>
       		...
       		<td >
       			<div align="center" ><a href="#" onclick="modifyjzdf('<%=id%>','<%=intnum-2%>')"><font  style="font-size: 12px;">修改</font></a></div>
...
<script language="javascript">
	var path = '<%=path%>';
		function exportad(){
            var whereStr ="<%=str%>";
            var sj="<%=sj%>";
        	document.form1.action=path+"/web/query/basequery/电费垫付信息.jsp?whereStr="+whereStr+"&command=daochu&entrytime="+sj;
            document.form1.submit();
   }
	function gopage()
     {
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      else
      {
        ...
        var curpage='<%=(curpage - 1)%>';
      		document.form1.action=path+"/web/jizhan/sitemanagedf.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+curpage+"&command=chaxun";
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/jizhan/sitemanagedf.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+pageno+"&command=chaxun";
      document.form1.submit();
     }
     function delzd(id){
    // alert(id);
     if(confirm("您确定删除此站点信息？")){
     	<%if (permissionRights.indexOf("PERMISSION_DELETE") >= 0) {%> //权限
     		document.form1.action=path+"/servlet/zhandian?action=delsitedf&id="+id;
      document.form1.submit();
      <%} else {%>
      alert("您没有删除站点的权限");
    <%}%>
    ...
    function modifyjzdf(id,intnum){
    	
    //alert(intnum);
     		document.form1.action=path+"/web/jizhan/modifysitedf.jsp?id="+id+"&nums="+intnum;
      document.form1.submit();
...
document.form1.dfhs_yys.value='<%=dfhs_yys%>';
