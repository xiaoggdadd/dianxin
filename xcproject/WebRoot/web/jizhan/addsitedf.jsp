	...
	function saveAccount(){
        	...
        	function addzhandian(){
        		if(confirm("您将要添加站点信息！确认信息正确！")){
          		...
          		document.form1.action=path+"/servlet/zhandian?action=addSitedf";
	   ...
	   function fanhui(){       
              document.form1.action=path+"/web/jizhan/sitemanagedf.jsp";
              document.form1.submit();
        }
        function queding(){
...
<form action="" name="form1" method="POST">
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0" >
	                      ...
	                      <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="left">
							...
							<span style="color:black;font-weight:bold;font-size=15;">电费垫付资金(单位：万元)</span></td>
      ...
      <tr class="form_label">
		...
		<td height="8%" style="left: 1800px" bgcolor="#DDDDDD" width="152px"><div align="left"><%=a-1%>月底前垫付未收回资金</div>
         </td>
         <td width="">
         	<input type="text" name="dfwhszj" onchange="changehszj()" style="width:130px"/><span class="style1">&nbsp;*</span>
       </td>
       <td height="8%" style="left: 1800px" bgcolor="#DDDDDD" width="152px"><div align="left"><%=a-1%>月底前垫付未收回资金：<%=a%>月已回款</div>
         </td>
         <td width="">
         	<input type="text" name="dfwhszj_byhs" onchange="changehszj()" style="width:130px"/><span class="style1">&nbsp;*</span>
       </td>
      </tr>
      ...
      <tr class="form_label">
       ...
       <td height="8%" style="left: 1800px" bgcolor="#DDDDDD" width="152px"><div align="left">待回收资金：</div>
         </td>
         <td width="">
         	<input type="text" name="dhszj" readonly="readonly" title="自动计算，不可修改" onchange="changebl()" style="width:130px"/><span class="style1">&nbsp;*</span>
       </td>
       <td height="8%" style="left: 1800px" bgcolor="#DDDDDD" width="152px"><div align="left">待回收资金：已和运营商完成明细核对</div>
         </td>
         <td width="">
         	<input type="text" name="dhszj_yyshd" onchange="changebl()" style="width:130px"/><span class="style1">&nbsp;*</span>
       </td>
       
        <td height="8%" style="left: 1800px" bgcolor="#DDDDDD" width="152px"><div align="left">待回收资金：已开票</div>
         </td>
         <td width="">
         	<input type="text" name="dhszj_ykp" onchange="changebl()" style="width:130px"/><span class="style1">&nbsp;*</span>
       </td>
      ...
      <tr class="form_label">
        <td height="8%" style="left: 1800px" bgcolor="#DDDDDD" width="152px"><div align="left">运营商</div>
         </td>
         <td width="">
 ...
 <td height="8%" style="left: 1800px" bgcolor="#DDDDDD" width="152px"><div align="left">已核对占比：</div>
         </td>
         <td width="">
         	<input type="text" readonly="readonly" title="自动计算，不可修改" name="dfhs_hdzb" style="width:130px"/>
       </td>
       
        <td height="8%" style="left: 1800px" bgcolor="#DDDDDD" width="152px"><div align="left">已开票占比：</div>
         </td>
         <td width="">
         	<input type="text" name="dfhs_kpzb" readonly="readonly" title="自动计算，不可修改" style="width:130px"/>
       </td>
