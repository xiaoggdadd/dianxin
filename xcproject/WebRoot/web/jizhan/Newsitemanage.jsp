...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
	...
	function addJz(){
		document.form1.action=path+"/web/jizhan/Newaddsite.jsp";
		document.form1.submit();
	}
	function daorujz(){
		document.form1.action=path+"/web/jizhan/Newzhandiandaoru.jsp?servletname=zhandiandaoru&action=newupzhandian";
		document.form1.submit();
	}
	  function vName(){//电表Id
...
<tr><td height="5"  colspan="4"><div id="parent" style="display:inline">
  ...
  String xuni="0";
		...
		if (szdcode.length() > 0 && szdcode != null) {
			whereStr=whereStr+" and z.zdcode like '%" + szdcode + "%'";
			str=str+" and z.zdcode like= '" + szdcode + "'";
		}
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
             ...
             <tr height="23">
                  ...
                  <td  height="23" width="6%" bgcolor="#DDDDDD" ><div align="center" class="btt">集团报表类型</div></td>
                  <td  height="23" width="6%"bgcolor="#DDDDDD" ><div align="center" class="btt">用房类型</div></td>
			      <td  height="23" width="6%" bgcolor="#DDDDDD" ><div align="center" class="btt">节能设备</div></td>
                  ...
                  <td  height="23" width="6%" bgcolor="#DDDDDD" ><div align="center" class="btt">站点代码</div></td>
       ...
       <%
		...
		String jzname = "",szdq = "",jzproperty = "", jztype= "",yflx = "",jnglmk="",gdfs="",area="",id="",dianfei="",zdcode="",xunisign="",shsignxs="",dbid="";
      ...
      <td >
       		...
       		<td >
       			<div align="center" ><a href="#" onclick="modifyjz('<%=id%>','<%=intnum-2%>','<%=shi%>','<%=xian%>','<%=xiaoqu%>','<%=jztype1%>','<%=bgsign%>','<%=sname%>','<%=szdcode%>','<%=jzproperty1%>','<%=qyzt%>','<%=sitetype%>','<%=rgsh2%>','<%=rgsh%>','<%=caijid %>')"><font  style="font-size: 12px;">修改</font></a></div>
...
<script language="javascript">
	...
	function gopage()
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      else
      {
        ...
        var curpage='<%=(curpage - 1)%>';
      		document.form1.action=path+"/web/jizhan/Newsitemanage.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/jizhan/Newsitemanage.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+pageno;
      document.form1.submit();
     }
     function delzd(id){
     if(confirm("您确定删除此电费信息？")){
     	
     		document.form1.action=path+"/servlet/zhandian?action=newdelsite&id="+id
      document.form1.submit();
      showdiv("请稍等..............");
    ...
    function modifyjz(id,intnum,shi,xian,xiaoqu,jztype,bgsign,sname,szdcode,jzproperty,qyzt,sitetype,rgsh2,rgsh,caijid){
    //alert(str);
    	
     		document.form1.action=path+"/web/jizhan/Newmodifysite.jsp?id="+id+"&nums="+intnum+"&shi1="+shi+"&xian1="+xian+"&xiaoqu1="+xiaoqu+"&jztype1="+jztype+"&bgsign1="+bgsign+"&sname1="+sname+"&szdcode1="+szdcode+"&jzproperty1="+jzproperty+"&qyzt1="+qyzt+"&sitetype1="+sitetype+"&rgsh2="+rgsh2+"&rgsh1="+rgsh+"&caijid1="+caijid;
      document.form1.submit();
