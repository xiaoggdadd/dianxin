...
<%
	...
	if(ys==null||"null".equals(ys)){
		ys="";
	}
	String wj= form.getWjts();
	if(wj==null||"null".equals(wj)){
		wj="";
	}
	String yybg= form.getYybgkt();
	if(yybg==null||"null".equals(yybg)){
		yybg="";
	}
	String jf= form.getJfsckt();
	if(jf==null||"null".equals(jf)){
		jf="";
	}
	...
	function ShowHideSearchRegion(trObject,SelfObject)
{
	...
	function saveAccount(){
			...
			var gx1 = document.form1.gxxx.value;
			...
			if(dddf==""||dddf==null){
				...
				document.form1.bu.value="0";
			}
			if(ru==""||ru==null){
				document.form1.ru.value="0";
			}
			if(yd==""||yd==null){
				document.form1.yd.value="0";
			}
			if(gx==""||gx==null){
				document.form1.gx.value="0";
			}
			if(g2==""||g2==null){
		        ...
		        var jsjssj = document.form1.jsjssj.value;	//建设结束时间
                       ...
                       if(checkNotSelected(document.form1.shi,"城市")&&
                    	  ...
                    	  checkNotSelected(document.form1.dfzflx,"电费支付类型")&&
                     	  ...
                     	  checkNotnull(document.form1.fkzq,"付款周期")&&
          		  				...
          		  				if( isNaN(document.form1.beilv.value)==false&&
          		  					...
          		  					if( isNaN(document.form1.zpslzd.value)==false&&
							    			...
							    			//}
					     					...
					     					if((gx1=="gxxx03"||gx1=="0")&&(gx!="0"||yd!="0")){
		          		 					 	alert("固移共享设备数量和他网共享设备数量必须为0");
		          		 				 	}else if(gx1=="gxxx05"&&gx=="0"){
		          		 					 	alert("固移共享设备数量不为0");
		          		 				 	}else if((gx1=="gxxx01")&&(gx=="0"||yd=="0")){
		          		 				 		alert("固移共享设备数量和他网共享设备数量必须不为0");
		          		 				 	}else if(confirm("您将要修改站点信息！确认信息正确！")){
	 ...
	 <tr class="form_label"><%--
	  ...
	  <tr class="form_label">
			...
			<tr class="form_label">
        		...
        		<select name="cj" style="width:130" >
         		<option value="0">请选择</option>
         		<%
	         ...
	         %>
        		 ...
        		 <td  height="8%" bgcolor="#DDDDDD" width="15%">设备类型：</td>
        		 		<td width="25%">
        		 		 <%if(roleid.equals("81")||roleid.equals("82")||roleid.equals("83")||roleid.equals("84")||roleid.equals("85")||roleid.equals("1")){ %>
        		 		<select name="sblx" style="width:130" >
         		<option value="0">请选择</option>
         		<%
       ...
       <tr bgcolor="F9F9F9" class="form_label">
          ...
          -->
			...
			<tr class="form_label">
        		 ...
        		 <td width="25%">
        		  <%if(roleid.equals("81")||roleid.equals("82")||roleid.equals("83")||roleid.equals("84")||roleid.equals("85")||roleid.equals("1")){ %>
        		 <select name="jzlx2" style="width:130" >
         		<option value="0">请选择</option>
         		<%
       ...
       <tr>
       	<td>&nbsp;</td>
        	 			...
        	 			<%}%>
        		 					...
        		 					<td width="25%">
        		 					<%if(roleid.equals("81")||roleid.equals("82")||roleid.equals("83")||roleid.equals("84")||roleid.equals("85")||roleid.equals("1")){ %>
        		 					<input type="text" name="dxgxsbsl" value="<%=dx%>" style="width:130px" />
        		 					<%}else{ %>
        	 	 		<input readonly="readonly" type="text" name="dxgxsbsl" value="<%=dx%>" style="width:130px" />
        	 			<%}%>
        		 					</td>
        		 					</tr>
									<tr class="form_label">
...
document.form1.cj.value='<%=form.getChangjia()%>';//厂家
if(document.form1.cj.value==""||document.form1.cj.value==null){
 document.form1.cj.value="0";
}
document.form1.jzlx2.value='<%=form.getJzlx()%>';//基站类型2
if(document.form1.jzlx2.value==""||document.form1.jzlx2.value==null){
 document.form1.jzlx2.value="0";
}

document.form1.sblx.value='<%=form.getShebei()%>';//设备类型
if(document.form1.sblx.value==""||document.form1.sblx.value==null){
 document.form1.sblx.value="0";
}
...
document.form1.ysd.value='<%=form.getYsd()%>';//
