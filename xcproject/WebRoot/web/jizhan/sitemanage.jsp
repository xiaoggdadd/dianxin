...
<body  class="body" style="overflow-x:hidden;">
	<form action="" name="form1" method="POST">
		...
		<!-- Title -->
		<tr>
			<td style="font-size:14px;height:30px;font-famliy: 微软雅黑;color:#ffffff;font-weight:bold;background-color:#C91717;">&nbsp;站点管理
	    	</td>
	    </tr>	
	    
	    <!-- Search -->	
		<tr>
			<td height="100%" width="1000px">
				<table width="700px">
					<tr class="form_label">
						<td align="right" width="120px">城市：</td>
                        <td align="left">
                            <select name="shi" id="shi" style="width:80px;" onchange="changeCity()" class="selected_font">
    				...
    				<td align="right" width="120px">区县： </td>
        			<td align="left">
         			...
         			<td align="right" width="120px">乡镇：</td>
         			<td align="left">
		         	...
		         	<td align="right" width="120px">站点名称：</td>
			        <td>
			        <input type="text" name="sname" value=""  style="width:120px" class="selected_font"/>
			        </td>
				</tr>
				<tr>
					<td width="1000px">
					<button id="query" class="buttonstyle" align="right" >查询</button>&nbsp;&nbsp;
					</td>
				</tr>
				</table>
			</td>
...
<tr>
<td style="font-size:14px;height:30px;font-famliy: 微软雅黑;color:#000000;font-weight:bold;background-color:#F5F5F5;">&nbsp;站点信息一览
</td>
</tr>
</table>
 <%
  ...
  String xuni="0";
   ...
   %>
   &nbsp;
<button id="add" class="buttonstyle">新增</button>&nbsp;&nbsp;
<br><br>
<table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">

             <tr height="23" bgcolor="#ADD8E6">
		          <td  height="23" width="3%"><div align="center" class="btt" >序号</div></td>
                  <td  height="23" width="13%"><div align="center" class="btt">站点名称</div></td>
                  <td  height="23" width="10%"><div align="center" class="btt">所在地区</div></td>
                  <td  height="23" width="6%"><div align="center"  class="btt">站点属性</div></td>
                  <td  height="23" width="6%"  ><div align="center" class="btt">站点类型</div></td>
                  <td  height="23" width="6%"><div align="center" class="btt">用房类型</div></td>
                  <td  height="23" width="6%"><div align="center" class="btt">供电方式</div></td>
                  <td  height="23" width="6%"><div align="center" class="btt">站点面积</div></td>
                  <td  height="23" width="5%"><div align="center" class="btt">删除</div></td>
                  <td  height="23" width="5%"><div align="center" class="btt">修改</div></td>
            </tr>
       <%
					...
					<td colspan="15" align="left" >
						<div align="left">
					     ...
					     &nbsp;&nbsp;
						     ...
						     <%
						     	if (curpage != 1) {
						     			out.print("<a href='javascript:previouspage()'><img src='../tree/img/cd.gif'/></a>");
						     		} else {
						     			out.print("<font size='3' style='font-family:微软雅黑'>◄</font>");
						     		}
						     %>
						   </font>
						   &nbsp;&nbsp;
