...
function daoru(){
	document.form1.action='<%=path%>/servlet/<%=servletName%>?action=<%=action%>';
...
function exportModel(){
             var path = '<%=path%>';
            document.form1.action=path+"/servlet/download?action=downtemplet&templetname="+encodeURIComponent("站点批量导入模板");
            document.form1.submit();
   }
 $(function(){
          ...
          <tbody>
            <tr id="SearchRegion">
                              ...
                              <td width="95%" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  <td height="145" colspan="3" rowspan="2"><div align="center"><img src="../../images/dao.gif" width="132" height="119" /></div></td>
                                  <td width="66%" height="64"><p> 请选择您要导入的数据文件，此文件包含您要导入的数据.请点<a href="javascript:exportModel()"><此处></a>下载导入模版.
 </p>                                  </td>
                                </tr>
                                <%}%>
                                <tr>
