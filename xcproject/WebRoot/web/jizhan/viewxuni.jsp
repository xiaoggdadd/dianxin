...
<jsp:useBean id="xunibean" scope="page" class="com.noki.jizhan.XuniZhandianBean">
</jsp:useBean>
...
<tr><td colspan="3"><div id="parent" style="display:inline">
	...
	<div style="width:50px;display:inline;"><hr></div>&nbsp;站点信息&nbsp;<div style="width:300px;display:inline;"><hr></div>
        </div>
</td></tr>
      ...
      <tr>
         ...
         <td width="25%">
         <select name="shi" style="width:130">
         ...
         <td width="26%">
         <select name="xian" style="width:130" >
         		<option value="0">请选择</option>
         		<%
      ...
      <tr>
         ...
         <td width="25%"><input type="text" name="bieming" value=""  class="form" style="width:130px"/></td>
				<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">站点代码：</div>
         </td>
         <td width="25%"><input type="text" name="zdcode" value=""  class="form" style="width:130px"/></td>
      </tr>
      ...
      <tr>
        ...
        <td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">地址：</div>
         ...
         <td width="25%"><input type="text" name="address" value=""  class="form" style="width:130px"/></td>
      </tr>
      ...
      <tr>
         ...
         <td width="25%">
         	<input type="text" name="dianfei" value=""  style="width:130px"/>
         </td>
      ...
      <tr>
         ...
         <td width="25%"><input type="checkbox" name="xuni"  checked="checked"/>
         </td>
         
      </tr>
      <tr>
      	<td colspan=6>
      		<div align="center" id="IDXUNI" style="display:block;">
      			...
      			<table width="100%">
      				<tr>
				         ...
				         <td width="25%"><input type="text" name="PUE" value=""  class="form" style="width:130px"/>
				         	
				         </td>
				         <td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">组织机构编码：</div>
				         </td>
				         <td width="25%"><input type="text" name="zzjgbm" value=""  class="form"style="width:130px"/></td>
								<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">参照站点：</div>
				         </td>
				         <td width="25%"><input type="text" name="czzd" value=""  class="form" style="width:130px"/>
				         	</td>
				      </tr>
				      <tr>
				      ...
				      <tr>
				         ...
				         <td width="25%"><input type="text" name="zlfh" value=""  class="form" style="width:130px"/></td>
								<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">节能技术描述：</div>
				         </td>
				         <td width="25%"><input type="text" name="jnjsms" value=""  class="form" style="width:130px"/></td>
				      </tr>
      			</table>
      		</div>
      	</td>
	...
	<tr><td>&nbsp;</td></tr>
	<tr><td colspan="3"><div id="parent" style="display:inline">
                          </div><div style="width:50px;display:inline;"><hr></div>&nbsp;电表信息&nbsp;<div style="width:300px;display:inline;"><hr></div>
                      </div></td></tr>
                      ...
                      <tr>
                                ...
                                <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">所在地区</div>
                                    ...
                                    <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">所属专业</div>
            			</td>
				<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">电表用途</div>
            			</td>
				<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">初始读数</div>
            			</td>
            			<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">初始读数时间</div>
                                </td>
                                	<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">倍率</div>
                                </td>
                                	<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">电表型号</div>
                                </td>
                                <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">备注</div>
                                </td>
       ...
       <%
       	 ...
       	 fylist = xunibean.getXnzdDianBiao(Integer.parseInt(id));
       	 
		 if(fylist!=null)
		{
		String dbid = "",zdname = "",area = "", sszy= "",dbyt = "",csds="",cssytime="",beilv="",dbxh="",memo="";
	...
	<tr><td>&nbsp;</td></tr>
	<tr><td colspan="3"><div id="parent" style="display:inline">
                          </div><div style="width:50px;display:inline;"><hr></div>&nbsp;设备信息&nbsp;<div style="width:300px;display:inline;"><hr></div>
                      </div></td></tr>  
                       ...
                       <tr>
                                ...
                                <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">设备ID</div>
            			</td>
                                <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">设备名称</div>
            			</td>

                                    <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">规格</div>
            			</td>
				<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">所属电表占比</div>
            			</td>
				<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">生产厂家</div>
            			</td>
            			<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">资产编码</div>
                                </td>
                                	<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">标称耗电（度/天）</div>
                                </td>
                                	<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">所属专业</div>
                                </td>                              
            </tr>
       <%
       	 ...
       	 sblist = xunibean.getXnzdShebei(Integer.parseInt(id));
       	 if(sblist!=null)
		{
		String dbid = "",sbid = "",sbmc = "", guige= "",bili = "",sccj="",zcbm="",haodian="",sszy="";
		
		 
		int intnum= 0;
			int fycount = ((Integer)sblist.get(0)).intValue();
			for( int k = fycount;k<sblist.size()-1;k+=fycount){
					intnum++;
		     //num为序号，不同页中序号是连续的
				dbid = (String)sblist.get(k+sblist.indexOf("DIANBIAOID"));
		    sbid = (String)sblist.get(k+sblist.indexOf("SHEIEBANID"));
		    sbmc = (String)sblist.get(k+sblist.indexOf("MINGCHENG"));
		    guige = (String)sblist.get(k+sblist.indexOf("GUIGE"));
				bili = (String)sblist.get(k+sblist.indexOf("BILI"));
				sccj = (String)sblist.get(k+sblist.indexOf("SCCJ"));
				zcbm = (String)sblist.get(k+sblist.indexOf("ZCBH"));
				haodian = (String)sblist.get(k+sblist.indexOf("BCCD"));
				sszy = (String)sblist.get(k+sblist.indexOf("SSZY"));
			if(guige==null)guige="";
			if(sccj==null)sccj="";
			if(zcbm==null)zcbm="";
       ...
       <tr bgcolor="<%=color%>">
       		...
       		<td>
       			<div align="center" ><%=sbid%></div>
       		</td>
       		<td>
       			<div align="center" ><%=sbmc%></div>
       		</td>
       		<td>
       			<div align="center" ><%=guige%></div>
       		</td>
       		<td>
       			<div align="center" ><%=bili%></div>
       		</td>
       		<td>
       			<div align="center" ><%=sccj%></div>
       		</td>
       		<td>
       			<div align="center" ><%=zcbm%></div>
       		</td>
       		<td>
       			<div align="center" ><%=haodian%></div>
       		</td>
       	<td>
       			<div align="center" ><%=sszy%></div>
       		</td>
