...
<%
    ...
    String zdsx=request.getParameter("str")!=null?request.getParameter("str"):"";
...
var path = '<%=path%>'; 
    function modifyad(code,shi,xian,zdsx,gsf,bgsign,caiji,dfzflx){
    	var b=path+"/web/jizhan/siteAnalysisSheetright.jsp?code="+code+"&shi="+shi+"&xian="+xian+"&zdsx="+zdsx+"&gsf="+gsf+"&bgsign="+bgsign+"&caiji="+caiji+"&dfzflx="+dfzflx;;			
...
<body  class="body" >
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label" >
     ...
     <tr class="form_label" height = "20">
         <td width="7%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">详细属性</div></td>     
         <td width="7%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">站点个数</div></td>
     </tr>
       <%
       String str="",whereStr="";
       if(zdsx.equals("zdsx01")){
    	   str="  z.property = 'zdsx01'  and z.jflx = i.code  and i.type = 'JFLX' ";
       }else if(zdsx.equals("zdsx02")){
    	   str="  z.property = 'zdsx02'  and z.xlx = i.code  and i.type = 'XLX' "; 
       }else if(zdsx.equals("zdsx05")){
    	   str="  z.property = 'zdsx05'  and z.jrwtype = i.code  and i.type = 'jrwlx' "; 
       }
       if(null !=shi  && !shi.equals("") && !shi.equals("-1")){
        ...
        SiteAnalysisSheet bean=new SiteAnalysisSheet();
       	...
       	fylist = bean.getCountinfor(whereStr,loginId,str);
       
		String type="",sum="",code="";
		 ...
		 if(fylist!=null)
		{
		    ...
		    sum = (String)fylist.get(k+fylist.indexOf("ACOUNT"));	
		    sum = sum != null ? sum : "";
       ...
       <tr bgcolor="<%=color%>">
       		...
       		<td>
       			<div align="center" ><a href="javascript:modifyad('<%=code%>','<%=shi%>','<%=xian%>','<%=zdsx%>','<%=gsf%>','<%=bgsign%>','<%=caiji%>','<%=dfzflx%>')" ><%=type%></a></div>
       		</td>
       		<td>
