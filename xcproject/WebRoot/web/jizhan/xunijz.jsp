...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
					document.form1.action=path+"/web/jizhan/xunijz.jsp";
...
<div id="parent" style="display:inline">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#666666">
             <tr >
             <td width="35" height="23" bgcolor="#888888"><div align="center" class="bttcn">序号</div></td>
             <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">站点代码</div></td>
                                ...
                                <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">所在地区</div>
                                    ...
                                    <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">站点属性</div>
            			</td>
				<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">集团报表类型</div>
            			</td>
				<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">用房类型</div>
            			</td>
            			<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">节能设备</div>
                                </td>
                                	<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">供电方式</div>
                                </td>
                                	<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">站点面积</div>
                                </td>
                                <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">虚拟站点</div>
                                </td>
                                <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">电费</div>
                                </td>
                                 <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">租赁</div>
                                </td>
       ...
       JiZhanBean bean = new JiZhanBean();
       	 ...
       	 fylist = bean.getPageData(curpage,sheng,shi,xian,xiaoqu,sname,szdcode,loginName,"1",loginId,"","","","","");
		 ...
		 if(fylist!=null)
		{
		    ...
		    jztype = (String)fylist.get(k+fylist.indexOf("JZTYPE"));
				...
				if(zdcode==null)zdcode="";
				if(area==null)area="";
				if(dianfei==null)dianfei="";
			String color=null;
                          ...
                          <div style="width:300px;display:inline;" align="right"><hr></div>
										...
										<tr bgcolor="#FFFFFF">
											...
											<td>
												...
												%>
												<div id="xinzengBtn" style="width:60px;height:23px;cursor:pointer;float:right;position:relative;right:62px">
	 <img src="<%=path %>/images/xinzeng.png" width="100%" height="100%">
	 <span style="font-size:12px;position: absolute;left:27px;top:5px;color:white">新增</span>      
</div>
							         	
							        	<div id="daoruBtn" style="width:60px;height:23px;cursor:pointer;float:right;position:relative;right:40px">
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/jizhan/xunijz.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/jizhan/xunijz.jsp?curpage="+pageno;
      document.form1.submit();
     }
     function delzd(id){
     	<%
