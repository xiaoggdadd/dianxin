...
<script language="javascript">
	...
	function exportad() {
		document.form1.action = path+ "/servlet/DxdfftfxDownload";
		document.form1.submit();
	}
	$(function() {
...
function nextpage() {
	...
	document.form1.action = path + "/web/bgfenxi/dxdfftfx_search.jsp?curpage="
			+ curpage;
	document.form1.submit();
}
function previouspage() {
	if ((parseInt(document.form1.page.value)) < 1)
		...
		document.form1.page.value = parseInt(document.form1.page.value) - 1;
		var curpage = '<%=(curpage - 1)%>';
		document.form1.action = path + "/web/bgfenxi/dxdfftfx_search.jsp?curpage="+ curpage;
		document.form1.submit();
	}
}
function gopagebyno(pageno) {
	...
	document.form1.action = path + "/web/bgfenxi/dxdfftfx_search.jsp?curpage=" + pageno;
	document.form1.submit();
}
</script>
...
<!-- 				<td width="80" height="23"><div align="center" class="bttcn">确认状态</div></td> -->
				...
				<td nowrap height="23" style="background-color: #82898d;"><div align="center" class="bttcn">缴费起始日期</div>
				</td>
				<td nowrap height="23" style="background-color: #82898d;"><div align="center" class="bttcn">缴费终止日期</div>
				</td>
				<td width="200" height="23" style="background-color: #82898d;"><div align="center" class="bttcn">天数</div>
				</td>
				<td width="200" height="23" style="background-color: #82898d;"><div align="center" class="bttcn">起码</div>
				</td>
				<td width="200" height="23" style="background-color: #82898d;"><div align="center" class="bttcn">止码</div>
				</td>
				...
				<td nowrap height="23" style="background-color: #ab9f98;"><div align="center" class="bttcn">差异</div>
				</td>
			</tr>
			<%
				Dxdffxmanage wyManage = new Dxdffxmanage();
			
				List<DxdffxBean> wydfftList = wyManage.searchWydfft_dxdfftqr(loginName,loginId,pageSize,curpage,sheng,shi,xian,xiaoqu,yysqrzt,pc);
...
<!-- 					<div align="center"><%=wydfft.getYYSZT()%></div></td> -->
				...
				<td>
					<div align="center"><%=wydfft.getZzlx()%></div></td>
				<td>
