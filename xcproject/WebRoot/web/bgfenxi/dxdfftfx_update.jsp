...
<%
	...
	String sql = "select * from tbl_tt_wy_dfft_tdbg where id="+id+"";
	...
	while(rs.next()){
		...
		dh=rs.getString("dh");
		jfqs=rs.getString("lastcbsj");
		jfzz=rs.getString("thiscbsj");
...
if(
	...
	document.form1.action=path+"/servlet/Dxdfftfx?action=dxupdate";
