...
<div id="div_left">
		<div><table cellpadding="0" cellspacing="10" >
 		<tr><td>&nbsp;</td></tr>
...
<tr class="form_label">
     ...
     <td>
     名称</td><td><input type="text" id="zdmc" name="zdmc"  class="selected_font"/>
  </td>
     </tr>
 ...
 <tr><td height="5"  colspan="6">
    <div id="parent" style="display:inline">
      <div style="width:50px;display:inline;"><hr></div><font size="2">&nbsp;信息列表&nbsp;</font><div style="width:100px;display:inline;"><hr></div>
    </div></td>
</tr>
</table>
