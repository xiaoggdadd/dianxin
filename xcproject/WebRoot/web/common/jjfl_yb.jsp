...
<table  width="100%"  border="0" cellspacing="0" cellpadding="0">
    ...
    <td valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="169" background="../../images/a_22.gif"> <span class="style10">经济分类
</span></td>
...
<script type="text/javascript">
	...
	function ztest(id){
          ...
          var rowid='<%=rowid%>'
          window.opener.jjfl_value(rowid,id);
          window.close();
        }
</script>
</form></td>
