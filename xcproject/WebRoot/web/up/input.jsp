...
<form name="form1" method="post" action="/IDA/servlet/upload"  enctype="multipart/form-data" >
            ...
            <tr id="SearchRegion">
                              ...
                              <td width="95%" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  ...
                                  <td width="66%" height="64"><p> 请选择您要导入的数据文件，此文件包含您要导入的数据.请点<a href="/IDA/web/up/template.xls" target="docfilePage"><此处></a>下载导入模版.
 </p>                                  </td>
                                </tr>
                                <tr>
                                  <td height="39" valign="top"><input  name="textfield" type="file" class="form"  />　
                                 　                                  
                                    <input name="textfiel2d" type="submit" id="id1" class="form" value=" 确 定 " />
                                </tr>
                                <tr>
