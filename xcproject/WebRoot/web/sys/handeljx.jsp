...
<body  class="body" style="overflow-x:hidden;">
    ...
    <td valign="top">
      ...
      <table width="60%" border="0" cellspacing="1" cellpadding="1" >
            ...
            <td align="center">
            	<input type="text" name="btime" value="" onFocus="getDateString(this,oCalendarChs)"/>
            </td>
            ...
            <td align="center">
            	<input type="text" name="etime" value="" onFocus="getDateString(this,oCalendarChs)"/>
            </td>
            	...
            	<input type="button" name="savejgday3" value="开始解析" onclick="savedb()"/>
            </td>
      			</tr>
...
function savedb(){
	url = path+"/servlet/tabpara?action=handel";
	tijiao();
}
function tijiao(){
