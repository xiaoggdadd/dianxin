...
<table x:str border=1 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>  
  ...
  <td class=xl25 width=165 style='border-left:none;width:124pt'>年月日</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>录入量</td>
 </tr>
 <%int i=1; %>
<c:forEach items="${list}"  var="list" varStatus="status">
 <tr height=19 style='height:14.25pt'>
  <td class=xl26 align=center style='border-top:none;border-left:none' x:num><%=i++ %></td>
  <td class=xl26 align=center style='border-top:none;border-left:none' x:num>${list.year}</td>
  <td class=xl26 align=center style='border-top:none;border-left:none' x:num>${list.lcount}</td>
 </tr>
</c:forEach>         
 <![endif]>
</table>
