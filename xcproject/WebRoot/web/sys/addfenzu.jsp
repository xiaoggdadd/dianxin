		...
		function ShowHideSearchRegion(trObject,SelfObject)
{
	...
	function baocun(){
        ...
        document.form1.action=path+"/servlet/fenzu?action=add";
			...
			<tr>
				<td colspan="3">
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td colspan=1 width="500" background="<%=path%>/images/btt2.bmp" height=63><span style="color:black;font-weight:bold;font-size=16;">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;增加新分组</span></td>
									...
									<table width="100%" border="0" align="right" cellpadding="1" cellspacing="1" bgcolor="7C92B7">
										<tr>
										  <td height="49" bgcolor="#FFFFFF">										  <table width="80%" border="0" cellspacing="1" cellpadding="1" align="center">
                                            <tr>
                                              <td width="30%" align="center" bgcolor="#DDDDDD">新分组名称：</td>
                                              <td width="70%">
                                                <input type="text" name="name" value=""  class="form" />
                                                <span class="style1">&nbsp;*</span> </td>
                                            </tr>
                                            <tr>
                                              <td width="30%" align="center" bgcolor="#DDDDDD">说明：</td>
                                              <td width="70%">
                                                <input type="text" name="memo" value=""  class="form" />
                                                <span class="style1">&nbsp;*</span> </td>
                                            </tr>
                                             <tr>
                                              <td width="30%" align="center" bgcolor="#DDDDDD">排序：</td>
                                              <td width="70%">
                                                <input type="text" name="orderid" value=""  class="form" />
                                                <span class="style1">&nbsp;*</span> </td>
                                            </tr>
                                            <tr>
                                             <td>&nbsp;</td>
                                            <td>
                                            <div id="baocun12" style="position: relative; width: 63px; height: 23px; cursor: pointer; float: left; left: 49.5%">
