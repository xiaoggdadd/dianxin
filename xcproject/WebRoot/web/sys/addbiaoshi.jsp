		...
		function ShowHideSearchRegion(trObject,SelfObject)
{
	...
	function baocun(){
        ...
        var biaoshi = document.form1.biaoshi.value;
        if(biaoshi==""){
        		alert("标识不能为空！");
                 document.form1.biaoshi.focus();
                 return
        }
        document.form1.action=path+"/servlet/fenzu?action=add_qx";
				...
				<td colspan="3">
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td width="169" background="../../images/a_22.gif"><span class="style1"> 增加新权限标识</span></td>
									...
									<table width="100%" border="0" align="right" cellpadding="1" cellspacing="1" bgcolor="7C92B7">
										<tr>
										  <td height="49" bgcolor="#FFFFFF">										  <table width="80%" border="0" cellspacing="1" cellpadding="1" align="center">
                                            <tr>
                                              <td width="30%" bgcolor="C8E1FB">名称：</td>
                                              <td width="70%">
                                                <input type="text" name="name" value=""  class="form" />
                                                <span class="style1">&nbsp;*</span> </td>
                                            </tr>
                                            <tr>
                                              <td width="30%" bgcolor="C8E1FB">标识：</td>
                                              <td width="70%">
                                                <input type="text" name="biaoshi" value=""  class="form" />
                                                <span class="style1">&nbsp;*</span> </td>
                                            </tr>
                                            <tr>
                                              <td width="30%" bgcolor="C8E1FB">说明：</td>
                                              <td width="70%">
                                                <input type="text" name="memo" value=""  class="form" />
                                                <span class="style1">&nbsp;*</span> </td>
                                            </tr>
                                             <tr>
                                              <td width="30%" bgcolor="C8E1FB">排序：</td>
                                              <td width="70%">
