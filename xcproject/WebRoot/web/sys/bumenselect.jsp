															...
															<table width="100%" border="0" cellspacing="1" cellpadding="1">
																<tr bgcolor="F9F9F9">
											                      <td height="19" colspan="4">　<img src="../../images/v.gif" width="8" height="9" /></td>
															         ...
															         <td colspan=4>
															        公司:
															         <select name="gongsi" id="gongsi" style="width:130" style="width:130;font-weight:bold;" onchange="getDictList(1,15,1)">
															         <option value="0">请选择</option>
															         	</select>
															         部门：
															         <select name="bumen" id="bumen" style="width:130" style="width:130;font-weight:bold; "onchange="getDictList(2,15,1)">
																           <option value="0">请选择</option>
															         </select>
															    一级班组：
															         <select name="yibanzu" id="yibanzu" style="width:130" style="width:130;font-weight:bold; "onchange="getDictList(3,15,1)">
																           <option value="0">请选择</option>
															         </select>
