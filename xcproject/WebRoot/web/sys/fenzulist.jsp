...
function addRole(){
		window.open('addfenzu.jsp','','width=600,height=300,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
}
function bianji(roleid){
		
 	 window.open('modifyfenzu.jsp?id='+roleid,'','width=600,height=300,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
}
function delRole(){
	...
	var i = 0;
		...
		if(i>0){
			if(confirm("确定要删除这些分组么！不可恢复")){
                                document.form1.action=path+"/servlet/fenzu?action=del";
...
<jsp:useBean id="bean" scope="page" class="com.noki.mobi.sys.javabean.FenzuBean">
</jsp:useBean>
				...
				<td colspan="3">
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="4"></td>
								<td>
									<table width="100%" border="0" align="right" cellpadding="1" cellspacing="0" bgcolor="7C92B7">
										<tr>
...
<%--////////////////////////////////////////////////////////////////////////////////////////////////////--%>
       ...
       <td align="right" colspan="6">
        ...
        <tr>
         ...
         <td height="23" bgcolor="#888888"><div align="center" class="bttcn">名称</div>
         </td>
         <td height="23" bgcolor="#888888"><div align="center" class="bttcn">说明</div>
         </td>
          <td height="23" bgcolor="#888888"><div align="center" class="bttcn">排序</div>
         </td>
   	...
   	ArrayList list = new ArrayList();
        list = bean.getAllFenzu();
        int num = 1;
        int countColum = ((Integer)list.get(0)).intValue();
        String roleName = "",roleId = "",orderid = "",memo="";
        String color = "F3F3F3";
   ...
   %>
   	<tr>
              ...
              <td bgcolor="<%=color%>"><div align="center"><%=roleName%></div>
               ...
               <td bgcolor="<%=color%>"><div align="center"><%=orderid%></div>
              </td>
            <td bgcolor="<%=color%>"><div align="center"><a href="javascript:bianji('<%=roleId%>')">编辑</a></div>
              </td>
