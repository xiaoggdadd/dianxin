								...
								<td>
									<table width="100%" border="0" align="right" cellpadding="1" cellspacing="1" >
										<tr>
										  ...
										  <tr>
                                              <td width="30%" bgcolor="#DDDDDD" align="center">分组：</td>
                                              <td width="70%">
                                               <%
                                            ...
                                            <tr>
                                              <td width="30%" bgcolor="#DDDDDD" align="center">新角色名称：</td>
                                              <td width="70%">
                                                <input type="text" name="roleName" value=""  class="form" style="width:130"/>
                                                <span class="style1">&nbsp;*</span> </td>
                                            </tr>
                                            <tr>
                                              <td width="30%" bgcolor="#DDDDDD" align="center">角色说明：</td>
                                              <td width="70%">
                                                <input type="text" name="memo" value=""  class="form"  style="width:130"/>
                                                <span class="style1">&nbsp;*</span> </td>
