...
<%
	...
	List<LuRuLiangBean> fylist = null;
...
function queryDegree(command){
        ...
        if(""!=startyear && ""!=endyear && startyear<endyear){
        	document.form1.action=path+"/servlet/FangWenLiangServlet?command="+command;
           ...
           <td width="50" >
             <div style="width:700px;height:50px">
                <img src="<%=path%>/images/btt.bmp" width="100%" height="100%" />
			     <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">访问量</span>
	         </div>
	        </td>
		  </tr>
		  <tr>
...
<table border="0" align="center" width="97%">
  	...
  	<tr>
				...
				<legend><b><font size="2">数据信息</font></b></legend>
	 			<table width="100%" align="center" CellSpacing="0" style="BORDER-COLLAPSE: collapse" borderColor=#eaeaea bgColor=#ffffff border=1>
		           <tr> 
		             ...
		             <td class="form_label"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px">访问量</div></td>
		         	</tr>
		         	<% int i=1, b=0; %>
					...
					<tr>
						...
						<td class="form_label"><DIV align=center>${list.fcount}</DIV></td>
					</tr>
         			</c:forEach>
         			<tr>
		...
		<br/>
		<fieldset>
			<legend><b><font size="2"><a href="javascript:fangwenliangmx('<%=shi%>','<%=startyear%>','<%=endyear%>')">点击查看图表信息</a></font></b></legend>
				<DIV id="chartdiv"></DIV>
...
function fangwenliangmx(shi,startyear,endyear) {//查看详情
	document.form1.attributes["action"].value = path
			+ "/servlet/FangWenLiangServlet?command=fangwenliangmx&startyear="
