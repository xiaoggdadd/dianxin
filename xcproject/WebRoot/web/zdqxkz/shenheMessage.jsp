...
String newqsdb="";//不含空调（省定标）
String oldqsdb="";//2014-9-1 WangYiXiao 旧不含空调（省定标）
String dbds="";//电表读数
								...
								<!--<td colspan="8">
									<table>
								        ...
								        <td bgcolor="#DDDDDD" class="form_label">
											...
											<td widt>
												<input type="text" name="dfzflxlast" readonly="readonly"
													value="<%=olddfzflx%>" class="form4" />
											</td><td bgcolor="#DDDDDD" class="form_label"><div>改为</div></td>
											<%if(newdfzflx.equals(olddfzflx)){ %>
											<td >
												<input type="text" name="dfzflxnew" readonly="true"
							...
							<td bgcolor="#DDDDDD" class="form_label">
											...
											<td>
												<input type="text" name="newqsdb" 
													value="<%=newqsdb%>" class="form3" style="color: red"/>
											</td>
										...
										<!-- 	<td bgcolor="#DDDDDD" class="form_label">
											...
											<td width="5%">
												<input type="text" name="g2last" readonly="true"
													value="<%=oldqsdbdl%>" class="form3" style="color: red"/>
											</td>
											<%} %>
											 -->
