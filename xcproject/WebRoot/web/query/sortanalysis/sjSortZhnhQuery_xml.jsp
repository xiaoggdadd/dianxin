...
<jsp:useBean id="bean" scope="page" class="com.noki.query.sortanalysis.javabean.SortAnalysisBean">
</jsp:useBean>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
  <td class=xl25 width=142 height=19  style='height:14.25pt;width:107pt'>排名</td>
  ...
  <td class=xl25 width=152 style='border-left:none;width:114pt'>总耗能（吨标煤）</td>
 </tr>
 <%   
 ...
 <tr height=19 style='height:14.25pt'>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=sortby%></td> 
