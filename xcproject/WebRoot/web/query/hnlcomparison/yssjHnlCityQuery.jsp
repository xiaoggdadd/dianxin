        ...
        for (var i = 0; i < l; i++) {  
          if(m[i].checked == true){
             ...
             chooseIdStr = chooseIdStr + "0" +","; 
                   ...
                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/hnlcomparison/yssjHnlCityQuery.jsp"+canshuStr;
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
           <tr>
             <td width="10%" height="23" bgcolor="#888888"><div align="center">地市</div>
                                ...
                                <div align="center">实际能耗（吨标煤）</div>                                                        
            			        </td>
            			                           <td nowrap height="23" bgcolor="#888888">
                                <div align="center">预算能耗（吨标煤）</div>                                                        
            			        </td>
       ...
       <%
         ...
         HnlComparisonBean bean = new HnlComparisonBean();
       	 ...
       	 fylist = bean.getPageDataZhnSjysCity(curpage,whereStr);
		 ...
		 if(fylist!=null)
		{
		    ...
		    sj = sj != null ? sj : "";
		    hnlsj = (String)fylist.get(k+fylist.indexOf("HNL_SJ"));	
		    hnlsj = hnlsj != null ? hnlsj : "";	    
		    hnlys = (String)fylist.get(k+fylist.indexOf("HNL_YS"));
		    hnlys = hnlys != null ? hnlys : "";
            
            dataStrhnlsj = dataStrhnlsj+hnlsj+";"; 
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/hnlcomparison/yssjHnlCityQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/hnlcomparison/yssjHnlCityQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/hnlcomparison/yssjHnlCityQuery_xml.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
   function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/hnlcomparison/yssjHnlCityQuery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
