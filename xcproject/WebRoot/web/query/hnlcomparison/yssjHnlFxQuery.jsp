...
function ShowHideSearchRegion(trObject,SelfObject)
{
   ...
   function queryDegree(){
                   ...
                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/hnlcomparison/yssjHnlFxQuery.jsp"+canshuStr;
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
 <jsp:include flush="true" page="huanbi_comparison.jsp">
  <jsp:param name="timeStr" value="<%=timeStr%>"/>
  <jsp:param name="dataStr" value="<%=dataStr%>"/>
  <jsp:param name="bz" value="sheng"/>
 </jsp:include> 
</table>
 </tr>
  <tr>
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/hnlcomparison/yssjHnlFxQuery_xml.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
   function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/hnlcomparison/yssjHnlFxQuery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
