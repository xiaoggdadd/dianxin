...
<%@page import="com.noki.query.hnlcomparison.javabean.HnlComparisonBean;"%>
...
function ShowHideSearchRegion(trObject,SelfObject)
{
   ...
   function queryDegree(){
                   ...
                   //var zhandian = document.form1.zhandian.value;
                   ...
                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjFxCityQuery.jsp"+canshuStr;
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
           <tr>
             <td width="10%" height="23" bgcolor="#888888"><div align="center">地市</div>
                                ...
                                <td width="10%" height="23" bgcolor="#888888"><div align="center">站点</div>
            			        </td>
                                <td width="10%" height="23" bgcolor="#888888"><div align="center">时间段</div>
            			        </td>
                                <td width="10%" height="23" bgcolor="#888888">
                                <div align="center">实际耗电量/预算耗电量</div>                                                           
            			        </td>
                                  
                                <td width="10%" height="23" bgcolor="#888888">
                                 <div align="center">实际水消耗量/预算水消耗量</div>                               
            			        </td>
            			         
				                <td width="10%" height="23" bgcolor="#888888">
				                <div align="center">实际汽油消耗量/预算汽油消耗量</div>				                
            			        </td>
            			        
				                <td width="10%" height="23" bgcolor="#888888">
				                <div align="center">实际柴油消耗量/预算柴油消耗量</div>				             
            			        </td>
            			         
            			        <td width="10%" height="23" bgcolor="#888888">
            			        <div align="center">实际天然气消耗量/预算天然气消耗量</div>
            			         </td>
       ...
       <%
         ...
         HnlComparisonBean bean = new HnlComparisonBean();
       	 ...
       	 fylist = bean.getPageDataNhYsGjCityFX(curpage,whereStr);
		 ...
		 if(fylist!=null)
		{
		    ...
		    sj = sj != null ? sj : "";
		    hdl = Double.parseDouble((String)fylist.get(k+fylist.indexOf("HDL_SJ_YS")));
		    sxhl = Double.parseDouble((String)fylist.get(k+fylist.indexOf("SXHL_SJ_YS")));
			qyxhl = Double.parseDouble((String)fylist.get(k+fylist.indexOf("QYXHL_SJ_YS")));
			cyxhl = Double.parseDouble((String)fylist.get(k+fylist.indexOf("CYXHL_SJ_YS")));
			trqxhl = Double.parseDouble((String)fylist.get(k+fylist.indexOf("TRQXHL_SJ_YS")));
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjFxCityQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjFxCityQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjFxCityQuery_xml.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
   function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/hnlcomparison/yssjNhYsGjFxCityQuery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
