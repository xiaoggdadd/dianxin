        ...
        for (var i = 0; i < l; i++) {  
          if(m[i].checked == true){
             ...
             chooseIdStr = chooseIdStr + "0" +","; 
                   ...
                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjQuery.jsp"+canshuStr;
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
       ...
       <%
         ...
         HnlComparisonBean bean = new HnlComparisonBean();
       	 ...
       	 fylist = bean.getPageDataNhYsGj(curpage,whereStr);
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjQuery_xml.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
   function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/hnlcomparison/yssjNhYsGjQuery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
