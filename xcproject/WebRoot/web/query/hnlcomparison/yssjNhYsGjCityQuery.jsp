        ...
        for (var i = 0; i < l; i++) {  
          if(m[i].checked == true){
             ...
             chooseIdStr = chooseIdStr + "0" +","; 
                   ...
                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjCityQuery.jsp"+canshuStr;
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
           <tr>
             <td width="10%" height="23" bgcolor="#888888"><div align="center">地市</div>
                                 ...
                                 <td nowrap height="23" bgcolor="#888888"><div align="center">站点</div>
            			        </td>                             
                                <td nowrap height="23" bgcolor="#888888"><div align="center">时间段</div>
            			        </td>
            			                           <td nowrap height="23" bgcolor="#888888">
                                <div align="center">实际能耗/预算能耗</div>                                                        
            			        </td>
            			                           <td nowrap height="23" bgcolor="#888888">
                                <div align="center">告警级别</div>                                                        
            			        </td>
       ...
       <%
         ...
         HnlComparisonBean bean = new HnlComparisonBean();
       	 ...
       	 fylist = bean.getPageDataNhYsCityGj(curpage,whereStr);
		 ...
		 if(fylist!=null)
		{
		    ...
		    shi = shi != null ? shi : "";
			zhandian = (String)fylist.get(k+fylist.indexOf("JZNAME"));
			zhandian = zhandian != null ? zhandian : "";			
		    sj = (String)fylist.get(k+fylist.indexOf("SJ"));
		    sj = sj != null ? sj : "";
		    hnlsjys = Double.parseDouble((String)fylist.get(k+fylist.indexOf("HNL_SJ_YS")));	
		    //hnlsjys = hnlsjys != null ? hnlsjys : "";	    
		    //hnlys = (String)fylist.get(k+fylist.indexOf("HNL_YS"));
            if(hnlsjys>80&&hnlsjys<90){
              hnlys = "橙色";
            }else if(hnlsjys>90){
              hnlys = "红色";
            }
            //dataStrhnlsj = dataStrhnlsj+hnlsjys+";"; 
            dataStrhnlys = dataStrhnlys+hnlys+";"; 
            //timeStr = timeStr + sheng+"-"+sj+";";
            String color=null;
       ...
       <tr bgcolor="<%=color%>">      		
       		...
       		<td>
       			<div align="center" ><%=zhandian%></div>
       		</td>       	
       		<td>
       			<div align="center" ><%=sj%></div>
       		</td>
       		<td>
       			<div align="center" ><%=hnlsjys%>%</div>
       		</td>
       		<td>
       			<div align="center" ><%=hnlys%></div>
       		</td> 		
       </tr>
       <%} 	
       dataStr = dataStrhnlsj + "/"+dataStrhnlys;
       %>
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjCityQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjCityQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/hnlcomparison/yssjNhYsGjCityQuery_xml.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
   function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/hnlcomparison/yssjNhYsGjCityQuery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
