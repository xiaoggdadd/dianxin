  ...
  function chaxun(){
	...
	closediv();
    	...
    	if(("3"==y&&"3"==b)||(("2"==y&&"3"==b)||("2"==y&&"2"==b))){
			var a = "<a href='<%=path %>/web/query/caijipoint/collectQueryleft1S.jsp?";
...
<body  class="body">
		<form action="" name="form1" method="POST">
			...
			<tr>
				...
				<table>
					<tr class="form_label">
					<td>标准月份：</td>
					<td><input type="text" name="bzmonth" class="selected_font"  value=<%=crym%> onFocus="getDatenyString(this,oCalendarChsny)"/></td>	
						<td>超标比例：</td>
					...
					<option value="2">开始月份</option>
	         		...
	         		<td><input type="text" name="sjyf" class="selected_font"  value="<%=crym%>" onFocus="getDatenyString(this,oCalendarChsny)"/></td>
					 <td>电表用途：</td> 
  ...
  <input type=hidden value="true" name="processBarDisplayFlag" />
		...
		<iframe name="treeMap" width="600px" height="200px" frameborder="0" src="<%=path%>/web/query/caijipoint/collectQueryleft1S.jsp"></iframe>
  	<span style="width:20px"></span>
	<iframe name="treeNodeInfo" width="500px" height="200px" frameborder="0" src="<%=path%>/web/query/caijipoint/collectQueryright1S.jsp"></iframe>
    <br/>
