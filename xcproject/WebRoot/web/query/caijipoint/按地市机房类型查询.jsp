...
<jsp:useBean id="bean" scope="page" class="com.noki.query.caijipoint.javabean.CaijiPointBean">
</jsp:useBean>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
  ...
  <td class=xl25 width=72 style='border-left:none;width:54pt'>采集点数量</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>采集点覆盖的机房数量</td> 
  <td class=xl25 width=142 height=19  style='height:14.25pt;width:107pt'>机房数量</td>
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=housenum%></td>
