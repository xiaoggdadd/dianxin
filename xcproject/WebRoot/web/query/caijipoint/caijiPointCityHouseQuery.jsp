        ...
        for (var i = 0; i < l; i++) {  
          if(m[i].checked == true){
             ...
             //chooseIdStr = chooseIdStr + "0" +","; 
                   ...
                   var canshuStr = "?beginTime="+beginTime+"&shi="+shi+"&chooseIdStr="+chooseIdStr; 

                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/caijipoint/caijiPointCityHouseQuery.jsp"+canshuStr;
...
<tr bgcolor="F9F9F9">
         ...
         &nbsp;&nbsp;&nbsp;
           时间段：<input type="text" name="BeginTime" value="" onFocus="getDatenyString(this,oCalendarChsny)"  class="form"/>          
	       &nbsp;&nbsp;&nbsp;&nbsp;
	      城市：             
	   ...
	   <tr>
         <td height="8%" width="1000">        
          ...
          <input type="button" name="chaxunlogs0" id="id1" value="查询" onclick="queryDegree()"  style="color:#014F8A"/>
         </td>
      </tr>
<tr bgcolor="F9F9F9">
                      <td height="19" colspan="4"><div id="parent" style="display:inline">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
       ...
       <%
         ...
         for(int k=0;k<chooseId.length;k++){
           chooseIdWhere=chooseIdWhere+" cjpoint.jztype='"+chooseId[k]+"' or ";
         }
           ...
           String beginTimeQ = request.getParameter("beginTime");
			if(beginTimeQ != null && !beginTimeQ.equals("")){
				whereStr=whereStr+" and cjpoint.sj='"+beginTimeQ+"'";
			}
			
			String shicode = request.getParameter("shi");
			if(shicode != null && !shicode.equals("")&& !shicode.equals("0")){
				whereStr=whereStr+" and cjpoint.shi='"+shicode+"'";
			}
			      
         CaijiPointBean bean = new CaijiPointBean();
       	 ArrayList fylist = new ArrayList();
       	 fylist = bean.getPageDataCityHouse(curpage,whereStr);
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/caijipoint/caijiPointCityHouseQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/caijipoint/caijiPointCityHouseQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/caijipoint/按地市机房类型查询.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
    function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/caijipoint/caijiPointCityHouseQuery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
