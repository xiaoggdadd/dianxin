...
String ammeterid_fk=request.getParameter("ammeterid_fk");
...
BORDER-RIGHT: #2C59AA 1px solid; PADDING-RIGHT: 2px; BORDER-TOP: #2C59AA 1px solid; PADDING-LEFT: 2px; FONT-SIZE: 12px; FILTER: progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#ffffff, EndColorStr=#D7E7FA); BORDER-LEFT: #2C59AA 1px solid; CURSOR: hand; COLOR: black; PADDING-TOP: 2px; BORDER-BOTTOM: #2C59AA 1px solid
  ...
  <table border="0" cellspacing="1" cellpadding="1">
     ...
     <tr height = "20" class= "relativeTag ">
         ...
         <td width="10%" height="23" bgcolor="#DDDDDD" class="form_label"><div align="center" style="color:black;font-weight:bold">起始时间</div></td>
         <td width="10%" height="23" bgcolor="#DDDDDD" class="form_label"><div align="center" style="color:black;font-weight:bold">结束时间</div></td>        
         <td width="10%" height="23" bgcolor="#DDDDDD" class="form_label"><div align="center" style="color:black;font-weight:bold">耗电量</div></td>
     </tr>
      <%
      String whereStr = "";
      ...
      System.out.println(ammeterid_fk+"id");
      haodianliangBean bean = new haodianliangBean();
     	ArrayList fylist = new ArrayList();

     	fylist = bean.getHaodianliang(curpage,whereStr,ammeterid_fk);
     	allpage=bean.getAllPage();
     	System.out.println("ALLLLLLL"+allpage);
		String last = "",thisd = "",actualdegree="",actualpay="",dbname="";
		 ...
		 if(fylist!=null)
		{
          ...
          if(actualdegree!=""&&actualdegree!=" "&&actualdegree!=null&&actualdegree!="null"){
     ...
     %>
        <tr bgcolor="<%=color%>">
            ...
            <td><div align="center" class="form_label"><%=ammeterid_fk%></div></td>
            <td><div align="center" class="form_label"><%=last %></div></td> 
            <td><div align="center" class="form_label"><%=thisd %></div></td>
            <td><div align="center" class="form_label"><%=actualdegree %></div></td>      
