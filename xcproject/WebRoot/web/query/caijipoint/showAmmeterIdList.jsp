...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
    ...
    function queryDegree(){          
                  document.form1.action=path+"/web/query/caijipoint/showAmmeterIdList.jsp?";
                   document.form1.submit();
...
<tr bgcolor="F9F9F9">
      ...
      <tr>
         <td width="1000">
          &nbsp;&nbsp;&nbsp;
            ...
            <input type="hidden" name="zdmc" value="<%if(null!=request.getParameter("zdmc")) out.print(request.getParameter("zdmc")); %>" class="form"/>
           &nbsp;&nbsp;&nbsp;
            抄表起始时间：<input type="text" name="beginTime" value="<%if(null!=request.getParameter("beginTime")) out.print(request.getParameter("beginTime")); %>" onFocus="getDateString(this,oCalendarChs)"  class="form" style="width: 130px;"/>
           &nbsp;&nbsp;&nbsp;
            抄表结束时间：<input type="text" name="endTime" value="<%if(null!=request.getParameter("endTime")) out.print(request.getParameter("endTime")); %>" onFocus="getDateString(this,oCalendarChs)"  class="form" style="width: 130px;"/>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
                      ...
                      <tr  height = "20">
                           <td width="5%" height="23" bgcolor="#DDDDDD"><div align="center" style="color:white;font-weight:bold;"></div>
                           <td width="10%" height="23" bgcolor="#DDDDDD"><div align="center" style="color:white;font-weight:bold;">电表ID</div>
                           	<td width="10%" height="23" bgcolor="#DDDDDD"><div align="center" style="color:white;font-weight:bold;">站点名称</div>
                               <td width="15%" height="23" bgcolor="#DDDDDD"><div align="center" style="color:white;font-weight:bold;">地区</div>
                                </td>
                                <td width="10%" height="23" bgcolor="#DDDDDD"><div align="center" style="color:white;font-weight:bold;">所属专业</div>
            			</td>
            			<td width="10%" height="23" bgcolor="#DDDDDD"><div align="center" style="color:white;font-weight:bold;">电表用途</div>
            			</td>
            			<td width="10%" height="23" bgcolor="#DDDDDD"><div align="center" style="color:white;font-weight:bold;">初始读数</div>
            			</td>
            			<td width="10%" height="23" bgcolor="#DDDDDD"><div align="center" style="color:white;font-weight:bold;">初始使用时间</div>
            			</td>
                        <td width="10%" height="23" bgcolor="#DDDDDD"><div align="center" style="color:white;font-weight:bold;">倍率</div></td>
       ...
       <%
		 ...
		 if(fylist!=null)
		{
			...
			initialdegree = (String)fylist.get(k+fylist.indexOf("INITIALDEGREE"));
			initialdegree = initialdegree != null ? initialdegree : "";			
			initialdate = (String)fylist.get(k+fylist.indexOf("INITIALDATE"));
       ...
       <tr bgcolor="<%=color%>">
            <td  align = "center" >
       		...
       		<td>
       			<div align="center" ><%=initialdegree%></div>
       		</td>
 ...
 <input type="hidden" name = "ammeterid2" id = "ammeterid2" value=""/>
</form>
</body>
</html>
<script language="javascript">
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/caijipoint/showAmmeterIdList.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/caijipoint/showAmmeterIdList.jsp?curpage="+pageno;
      document.form1.submit();
     }
     ...
     function chooseOne(cb){   
         ...
         for (i=0; i<obj.length; i++){   
             ...
             if (obj[i]!=cb){
              ...
              obj[i].checked = true;
              document.getElementsByName("ammeterid2").value = obj[i].value;
             }                     
         } 
                      //alert(document.all.ammeterid2.value);   
     }   
     function queding(){
       if(document.getElementsByName("ammeterid2").value==undefined){
         alert("请选择一个电表！");
       } else {
         window.opener.document.form1.action=path+"/web/query/caijipoint/exceptionReport.jsp?ammeterid="+document.getElementsByName("ammeterid2").value+"&reback=1";
