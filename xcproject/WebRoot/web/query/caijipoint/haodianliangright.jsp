...
BORDER-RIGHT: #2C59AA 1px solid; PADDING-RIGHT: 2px; BORDER-TOP: #2C59AA 1px solid; PADDING-LEFT: 2px; FONT-SIZE: 12px; FILTER: progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#ffffff, EndColorStr=#D7E7FA); BORDER-LEFT: #2C59AA 1px solid; CURSOR: hand; COLOR: black; PADDING-TOP: 2px; BORDER-BOTTOM: #2C59AA 1px solid
  ...
  <table border="0" cellspacing="1" cellpadding="1" bgcolor="#666666">
     ...
     <tr height = "20">
         <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;font-size:14px">起始时间</div></td>
         <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;font-size:14px">结束时间</div></td>        
         <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;font-size:14px">耗电量</div></td>
     </tr>
      <%
      String whereStr = "";
      ...
      haodianliangBean bean = new haodianliangBean();
		...
		String last = "",thisd = "",actualdegree="",actualpay="";
     ...
     %>
        <tr bgcolor="<%=color%>">
            ...
            <td><div align="center" style="font-size:14px"><%=actualdegree %></div></td>      
