...
var path = '<%=path%>';   
    ...
    if(g3=="是"){g3="1";}
     if(g3=="否"){g3="0";}
      if(g2=="是"){g2="1";}
     if(g2=="否"){g2="0";}
    	var b=path+"/web/query/caijipoint/collectQueryright1.jsp?zp="+zp+"&zs="+zs+"&cj="+cj+"&g2="+g2+"&g3="+g3+"&shi="+shi+"&xian="+xian+"&bl="+bla+"&bd="+bd+"&bl="+bla+"&yf="+yf+"&bzmonth="+bzmonth+"&dyt="+dyt+"&sjyf="+sjyf+"&gxbzw="+gxbzw+"&";			
