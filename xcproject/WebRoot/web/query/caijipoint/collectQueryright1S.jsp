  ...
  <table border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
   ...
   <td colspan="7" bgcolor="#DDDDDD"><div align="center" style="font-weight:bold">站点/电量信息</div></td>
     ...
     <td width="10%" height="23" bgcolor="#DDDDDD"><div align="center" style="font-weight:bold">超标比例</div></td>
              	...
              	whereStr=whereStr+" and c.shi='"+shiaa+"'";
              		}
              		if(null != xianaa && !xianaa.equals("") && !xianaa.equals("0")){
              	
              	whereStr=whereStr+" and c.xian='"+xianaa+"'";
              		}	
              		...
              		whereStr=whereStr+" AND c.g2='"+g2+"'";
              		whereStr=whereStr+" AND c.g3='"+g3+"'";
              		whereStr=whereStr+" AND c.ZP='"+zp1+"'";
              		whereStr=whereStr+" AND c.ZS='"+zs1+"'";
              		whereStr=whereStr+" and c.CHANGJIA='"+cj1+"'";
      ...
      <tr bgcolor="<%=color%>" class="form_label">
          <td><div align="center" ><%=intnum-1%></div></td> 
            <td><div align="center" ><%=shia%></div></td> 
            <td><div align="center" ><%=xiana%></div></td>
            <td><div align="center" ><%=xiaoqua%></div></td> 
            <td><div align="left"  ><%=sname%></a></div></div></td> 
            <td><div align="center" ><%=blhdl%></div></td> 
            <td><div align="right" ><%=bili%>%</a></div></td>        
        </tr>   
        <%
       }}}%>     
