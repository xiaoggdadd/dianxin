...
<%
   ...
   // String endTime = request.getParameter("endTime")!=null?request.getParameter("endTime"):"";
    ...
    String whereStr="";
    String canshuStr="";
     if((shi!=null)||(xian!=null)||(xiaoqu!=null)||(zdlx!=null)||(beginTime!=null)){
            canshuStr= "&shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu+"&zdlx="+zdlx+"&BeginTime"+beginTime;
        }
...
function ShowHideSearchRegion(trObject,SelfObject)
{
   ...
   function chaxun(){
        ...
        document.form1.action=path+"/web/query/caijipoint/zdhdlpmQuery.jsp";
...
<tr bgcolor="F9F9F9">
    ...
    月份：&nbsp; &nbsp;<input type="text" name="BeginTime" value="" onFocus="getDateString(this,oCalendarChsny)"  class="form" style="width: 130px;"/>   
        &nbsp;&nbsp;市：&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
	      ...
	      <%
	         ...
	         %>
	     <td>
         <div id="chaxun-1" style="position: relative; width: 60px; height: 23px; cursor: pointer; float: right; right: 530px; TOP:15PX"> 
  ...
  <tr bgcolor="F9F9F9">
                      <td height="19" colspan="4"><div id="parent" style="display:inline">
                        <br>  <div style="width:50px;display:inline;"><hr></div>&nbsp;信息列表&nbsp;<div style="width:300px;display:inline;"><hr></div>
                      </div></td>
                    </tr>
  </table>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
       ...
       <%
         ...
         CaijiPointBean bean = new CaijiPointBean();
       	 ...
       	 if(!whereStr.equals("")){
       	    fylist = bean.getPageDataZDHDLQuery(curpage,whereStr,account.getAccountId());
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/caijipoint/zdhdlpmQuery.jsp?curpage="+curpage+"<%=canshuStr%>";
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/caijipoint/zdhdlpmQuery.jsp?curpage="+pageno+"<%=canshuStr%>";
      document.form1.submit();
     }
