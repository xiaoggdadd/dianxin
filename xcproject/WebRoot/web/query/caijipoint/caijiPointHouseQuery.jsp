        ...
        for (var i = 0; i < l; i++) {  
          if(m[i].checked == true){
             ...
             //chooseIdStr = chooseIdStr + "0" +","; 
                   ...
                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/caijipoint/caijiPointHouseQuery.jsp"+canshuStr;
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
       ...
       <%
         ...
         CaijiPointBean bean = new CaijiPointBean();
       	 ...
       	 fylist = bean.getPageDataHouse(curpage,whereStr);
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/caijipoint/caijiPointHouseQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/caijipoint/caijiPointHouseQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/caijipoint/按机房类型查询.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
   function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/caijipoint/caijiPointHouseQuery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
