...
<jsp:useBean id="bean" scope="page" class="com.noki.query.jcanalysis.javabean.JcAnalysisBean">
</jsp:useBean>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
  ...
  <td class=xl25 width=174 style='border-left:none;width:131pt'>总站点数</td>
  <td class=xl25 width=165 style='border-left:none;width:124pt'>节能站点数</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>非节能站点数</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>节能站点占比(%)</td>
 </tr>
 <%   
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=zdnum_sum%></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=zdnum_jn%></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=zdnum_fjn%></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=zdnum_bl%></td>
