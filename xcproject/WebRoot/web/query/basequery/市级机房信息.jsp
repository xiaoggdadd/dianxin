...
<jsp:useBean id="bean" scope="page" class="com.noki.query.basequery.javabean.CityHouseBean">
</jsp:useBean>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
  <td class=xl25 width=142 height=19  style='height:14.25pt;width:107pt'>站点代码</td>
  <td class=xl25 width=152 style='border-left:none;width:114pt'>站点名称</td>
  <td class=xl25 width=174 style='border-left:none;width:131pt'>所在地区</td>
  <td class=xl25 width=165 style='border-left:none;width:124pt'>站点属性</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>集团报表类型</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>用房类型</td>
  
  <td class=xl25 width=142 height=19  style='height:14.25pt;width:107pt'>节能设备</td>
  <td class=xl25 width=152 style='border-left:none;width:114pt'>供电方式</td>
  <td class=xl25 width=174 style='border-left:none;width:131pt'>站点面积</td>
 </tr>
 <%   
 ...
 <tr height=19 style='height:14.25pt'>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=zdcode%></td> 
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=jzproperty%></td>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=jnglmk%></td>
