...
<table width="1400" height="60%" border="0" cellspacing="1" cellpadding="1" class="form_label">
 	  <tr height = "23" class="relativeTag">
 	     ...
 	     <td class=xl26 align=right style='border-top:none;border-left:none' x:num>市</td>                   	
 	   ...
 	   <% 
			...
			if(zgjssj != null && !zgjssj.equals("")){
			    Wstr=Wstr+" AND G.ZANGUENDMONTH LIKE '"+zgjssj+"%'";//
				Str=Str+" AND G.ZANGUENDMONTH  LIKE '"+zgjssj+"%'";//暂估结束月份
			}
