...
<jsp:useBean id="bean" scope="page" class="com.noki.query.basequery.javabean.CityStationPointQueryBean">
</jsp:useBean>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
  ...
  <td class=xl25 width=174 style='border-left:none;width:131pt'>代表站点</td>
  <td class=xl25 width=165 style='border-left:none;width:124pt'>集团报表类型</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>房屋类型</td>
