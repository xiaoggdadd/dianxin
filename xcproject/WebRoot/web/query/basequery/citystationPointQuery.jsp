...
<%@page import="com.noki.query.basequery.javabean.CityStationPointQueryBean;"%>
...
<%
	...
	System.out.println("operName="+operName);
        ...
        String canshuStr="";
        if((shi!=null)||(xian!=null)||(sptype!=null)||((chanquan!=null)&&fwlx!=null)){
            canshuStr= "&shi="+shi+"&xian="+xian+"&sptype="+sptype+"& chanquan="+ chanquan+"&fwlx="+fwlx;
        }
  ...
  function chaxun(){
    ...
    function queryDegree(){
                  /* var sheng = document.form1.sheng2.value;
                   ...
                   var chanquan = document.form1.chanquan2.value;
                   var fwlx = document.form1.fwlx2.value;
                   var canshuStr = "?sheng="+sheng+"&shi="+shi+"&xian="+xian+"&sptype="+sptype+"&chanquan="+chanquan+"&fwlx="+fwlx;
                  */
                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/basequery/citystationPointQuery.jsp";
                   document.form1.submit();
...
<%
permissionRights=commBean.getPermissionRight(roleId,"0506");
...
<tr bgcolor="F9F9F9">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
         ...
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         产权性质：            
         	<select name="chanquan" style="width:130" onchange="javascript:document.form1.chanquan2.value=document.form1.chanquan.value">
         		<option value="0">请选择</option>
	         <%
	         	ArrayList cqtypelist = new ArrayList();
	         	cqtypelist = commBean.getChanQuanType();
	         	if(cqtypelist!=null){
	         		String sfid="",sfnm="";
	         		int scount = ((Integer)cqtypelist.get(0)).intValue();
	         		for(int i=scount;i<cqtypelist.size()-1;i+=scount)
                    {
                    	sfid=(String)cqtypelist.get(i+cqtypelist.indexOf("CODE"));
                    	sfnm=(String)cqtypelist.get(i+cqtypelist.indexOf("NAME"));
                    %>
                    <option value="<%=sfid%>"><%=sfnm%></option>
                    <%}
	         	}
         ...
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         房屋类型：
            <select name="fwlx" style="width:130" onchange="javascript:document.form1.fwlx2.value=document.form1.fwlx.value">
         		<option value="0">请选择</option>
	         <%
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
       ...
       <%
         ...
         System.out.println("dianliangListjsp:"+sptype+chanquan+fwlx);
			...
			if(chanquan != null && chanquan != ""&&!chanquan.equals("0")){
				whereStr=whereStr+" and CHANQUAN='"+chanquan+"'";
			}
			if(fwlx != null && fwlx != ""&&!fwlx.equals("0")){
				whereStr=whereStr+" and YFLX='"+fwlx+"'";
			}
			if(htmlsql != null && !htmlsql.equals("") && !htmlsql.equals("0")){
				whereStr = whereStr+htmlsql;
			}  
		//}
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/basequery/citystationPointQuery.jsp?curpage="+curpage+"<%=canshuStr%>";
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/basequery/citystationPointQuery.jsp?curpage="+pageno+"<%=canshuStr%>";
      document.form1.submit();
     }
     </script>
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/basequery/市级站点信息.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
   function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/basequery/citystationpointquery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
