        ...
        for (var i = 0; i < l; i++) {  
          if(m[i].checked == true){
             ...
             //chooseIdStr = chooseIdStr + "0" +","; 
                   ...
                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/gaojingmanage/caijiDataYichangQuery.jsp"+canshuStr;
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
           <tr>
             <td width="10%" height="23" bgcolor="#888888"><div align="center">省份</div>
                                ...
                                <div align="center">机房类型</div>                                                        
            			                           ...
            			                           <td nowrap height="23" bgcolor="#888888">
                                <div align="center">异常类型</div>                                                        
            			        </td>
            			                           <td nowrap height="23" bgcolor="#888888">
                                <div align="center">发生次数</div>                                                        
            			        </td>
       ...
       <%
         ...
         System.out.println("ammeterDegreeQueryList:"+chooseIdWhere);                
           String beginTimeQ = request.getParameter("beginTime");
			if(beginTimeQ != null && !beginTimeQ.equals("")){
				whereStr=whereStr+" and substr(cj.GETDATETIME, 0, 7)='"+beginTimeQ+"'";
			}
         ...
         GaojingManageBean bean = new GaojingManageBean();
       	 ...
       	 fylist = bean.getPageDataYichang(curpage,whereStr);
		 ...
		 if(fylist!=null)
		{
		    ...
		    cjmun = (String)fylist.get(k+fylist.indexOf("CJEQU_YCTYPE"));
		    cjmun = cjmun != null ? cjmun : "";
		    
			cjfghousenum = (String)fylist.get(k+fylist.indexOf("CJCG_FSCS"));
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/gaojingmanage/caijiDataYichangQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/gaojingmanage/caijiDataYichangQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/gaojingmanage/采集设备数据异常统计.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
   function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/gaojingmanage/caijiDataYichangQuery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
