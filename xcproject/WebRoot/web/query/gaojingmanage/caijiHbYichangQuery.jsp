        ...
        for (var i = 0; i < l; i++) {  
          if(m[i].checked == true){
             ...
             chooseIdStr = chooseIdStr + "0" +","; 
                   ...
                   var canshuStr = "?beginTime="+beginTime+"&chooseIdStr="+chooseIdStr; 

                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/gaojingmanage/caijiHbYichangQuery.jsp"+canshuStr;
...
<tr bgcolor="F9F9F9">
         ...
         &nbsp;&nbsp;&nbsp;
	       ...
	       &nbsp;&nbsp;&nbsp;&nbsp;
	       地市：<input type="text" name="city" value="" onFocus=""  class="form"/>  
	     </td>
       </tr>
	   <tr>
         <td height="8%" width="1000">        
...
<tr bgcolor="F9F9F9">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
       ...
       <%
         ...
         if(request.getParameter("chooseIdStr") != null){
         ...
         for(int k=0;k<chooseId.length;k++){
           chooseIdWhere=chooseIdWhere+" t.housetype="+chooseId[k]+" or ";
         }
         ...
         GaojingManageBean bean = new GaojingManageBean();
       	 ...
       	 fylist = bean.getPageDataHbYichang(curpage,whereStr);
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/gaojingmanage/caijiHbYichangQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/gaojingmanage/caijiHbYichangQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/gaojingmanage/caijiHbYichangQuery_xml.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
   function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/gaojingmanage/caijiHbYichangQuery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
