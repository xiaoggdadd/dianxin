...
<jsp:useBean id="bean" scope="page" class="com.noki.query.gaojingmanage.javabean.GaojingManageBean">
</jsp:useBean>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
  <td class=xl25 width=152 style='border-left:none;width:114pt'>省份</td>
  ...
  <td class=xl25 width=165 style='border-left:none;width:124pt'>机房类型</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>采集设备故障次数</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>采集成功率（%）</td>
 </tr>
 <%   
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=housename%></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=cjmun%></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=cjfghousenum%></td>
 </tr>
         <%}%>        
   <% } %>
