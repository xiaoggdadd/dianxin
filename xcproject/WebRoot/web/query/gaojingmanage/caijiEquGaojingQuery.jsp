...
<%@page import="com.noki.query.gaojingmanage.javabean.GaojingManageBean;"%>
        ...
        for (var i = 0; i < l; i++) {  
          if(m[i].checked == true){
             ...
             //chooseIdStr = chooseIdStr + "0" +","; 
                   ...
                   var canshuStr = "?beginTime="+beginTime+"&chooseIdStr="+chooseIdStr+"&shi="+shi; 

                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/gaojingmanage/caijiEquGaojingQuery.jsp"+canshuStr;
...
<body  class="body" style="overflow-x:hidden;">
    ...
    <td valign="top">
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
         ...
         &nbsp;&nbsp;&nbsp;
            时间段：<input type="text" name="BeginTime" value="" onFocus="getDateString(this,oCalendarChsny)"  class="form"/>          
	       &nbsp;&nbsp;&nbsp;&nbsp;
	        城市：             
         ...
         <td height="8%" width="1000">        
	      ...
	      <%
	         	...
	         	if(feetypelist!=null){
                    ...
                    %>
                    <input type="checkbox" name="test[]" value="<%=sfid%>" /><%=sfnm%>
                    <%}
	         	}
	         %>
	        &nbsp;&nbsp;&nbsp;&nbsp;
          <!--img src="../../images/search.gif" width="18" height="20" /-->
          <div id="query" style="position:relative;width:59px;height:23px;cursor: pointer;left:84%;TOP:-20PX">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
           <tr>
             <td width="10%" height="23" bgcolor="#888888"><div align="center">省份</div>
                                ...
                                <div align="center">机房类型</div>                                                        
            			        </td>
            			                           <td nowrap height="23" bgcolor="#888888">
                                <div align="center">采集设备故障次数</div>                                                        
            			        </td>
            			                           <td nowrap height="23" bgcolor="#888888">
                                <div align="center">采集成功率(%)</div>                                                        
            			        </td>
       ...
       <%
         ...
         String chooseIdStr = "";
         String chooseIdWhere = "";
         String whereStr = "";
  	     String[] chooseId = new String[8];
         if(request.getParameter("chooseIdStr") != null&&request.getParameter("chooseIdStr") != ""){
            chooseIdStr = request.getParameter("chooseIdStr");
            chooseId = chooseIdStr.split(",");
            System.out.println("chooseId:"+chooseId[0]);
         for(int k=0;k<chooseId.length;k++){
           chooseIdWhere=chooseIdWhere+" zd.jztype='"+chooseId[k]+"' or ";
         }
           chooseIdWhere=" and ("+chooseIdWhere.substring(0,chooseIdWhere.length()-3)+")";
           whereStr=whereStr+chooseIdWhere;
        }
         
         System.out.println("ammeterDegreeQueryList:"+chooseIdWhere);                
           String beginTimeQ = request.getParameter("beginTime");
			if(beginTimeQ != null && !beginTimeQ.equals("")){
				whereStr=whereStr+" and GETDATETIME='"+beginTimeQ+"'";
			}
			    String shicode = request.getParameter("shi");
			if(shicode != null && !shicode.equals("")&& !shicode.equals("0")){
				whereStr=whereStr+" and shi='"+shicode+"'";
			}   
         GaojingManageBean bean = new GaojingManageBean();
       	 ArrayList fylist = new ArrayList();
       	 fylist = bean.getPageDataCaijiEqu(curpage,whereStr);
		 ...
		 if(fylist!=null)
		{
		    ...
		    cjmun = (String)fylist.get(k+fylist.indexOf("CJEQU_GZNUM"));
		    cjmun = cjmun != null ? cjmun : "";
		    
			cjfghousenum = (String)fylist.get(k+fylist.indexOf("CJCG_BL"));
       ...
       <tr bgcolor="<%=color%>">      		
       		...
       		<td>
       			<div align="center" ><%=housename%></div>
       		</td>
       		<td>
  ...
  <tr>
   <td align="right">                              
                               <div id="dayinBtn" style="width:60px;height:23px;cursor:pointer;float:right;position:relative;right:15px">
								...
								<div id="daochuBtn" style="width:60px;height:23px;cursor:pointer;float:right;position:relative;right:40px">
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/gaojingmanage/caijiEquGaojingQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/gaojingmanage/caijiEquGaojingQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/gaojingmanage/采集设备告警查询.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
   function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/gaojingmanage/caijiEquGaojingQuery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
