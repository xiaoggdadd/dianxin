...
<head>
	...
	<script language="JavaScript">
		...
		{
			//alert(o);
			document.form1.action="../tjhzquery/cityNhtjNhlquery_print.jsp?pageNum="+o;
		...
		function inputin()
		{
			document.form1.action="../tjhzquery/cityNhtjNhlquery_print.jsp?pageNum=1";
			document.form1.submit();
		}
		...
		function showAll()
		{
			...
			document.form1.action="../tjhzquery/cityNhtjNhlquery_print.jsp";
		    document.form1.submit();
		}
