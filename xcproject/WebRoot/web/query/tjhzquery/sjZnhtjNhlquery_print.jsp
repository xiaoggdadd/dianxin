...
<head>
	...
	<script language="JavaScript">
		...
		{
			//alert(o);
			document.form1.action="../tjhzquery/sjZnhtjNhlquery_print.jsp?pageNum="+o;
		...
		function inputin()
		{
			document.form1.action="../tjhzquery/sjZnhtjNhlquery_print.jsp?pageNum=1";
			document.form1.submit();
		}
		...
		function showAll()
		{
			...
			document.form1.action="../basequery/sjZnhtjNhlquery_print.jsp";
		    document.form1.submit();
		}
