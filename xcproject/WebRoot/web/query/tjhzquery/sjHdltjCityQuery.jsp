...
<%@page import="com.noki.query.tjhzquery.javabean.SjZnhtjBean;"%>
...
function ShowHideSearchRegion(trObject,SelfObject)
{
   ...
   function queryDegree(){
                   ...
                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/tjhzquery/sjHdltjCityQuery.jsp"+canshuStr;
...
<tr bgcolor="F9F9F9">
         ...
         &nbsp;&nbsp;&nbsp;
            月份：<input type="text" name="BeginTime" value="<%if(null!=request.getParameter("BeginTime")) out.print(request.getParameter("BeginTime")); %>" 
            		readonly="readonly" class="Wdate" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM'})"  class="form"/>    
         </td>
         <td>
           <div id="query" style="position:relative;width:59px;height:23px;cursor: pointer;left:-550px;">
			 <img alt="" src="<%=request.getContextPath() %>/images/chaxun.png" width="100%" height="100%" />
			 <span style="font-size:12px;position: absolute;left:27px;top:5px;color:white">查询</span>
		   </div> 
         </td>
      </tr>
...
<tr bgcolor="F9F9F9">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
           <tr>
             <td width="7%" height="23" bgcolor="#888888"><div align="center" class="bttcn">省份</div>
                                </td>
                                <td width="7%" height="23" bgcolor="#888888">                              
                                <div align="center" class="bttcn">地市</div>
            			        </td>
                                <td width="7%" height="15" bgcolor="#888888"><div align="center" class="bttcn">月份</div>
            			</td>
                                ...
                                <td width="7%" height="15" bgcolor="#888888">
                                 <div align="center" class="bttcn">机房耗电量</div>                                
            			        </td>
				                <td width="7%" height="15" bgcolor="#888888">
				                <div align="center" class="bttcn">基站耗电量</div>				                
            			        </td>
				                <td width="7%" height="15" bgcolor="#888888">
				                <div align="center" class="bttcn">营业网点耗电量</div>				               
            			        </td>
            			        <td width="7%" height="15" bgcolor="#888888">
            			        <div align="center" class="bttcn">其它耗电量</div>
            			         </td>
       ...
       <%
         ...
         SjZnhtjBean bean = new SjZnhtjBean();
       	 ...
       	 fylist = bean.getPageDatahdl(curpage,whereStr);
		...
		{     
			...
			sum_zhj+=Double.parseDouble(sum_hj);
			sum_SCYFHDL+=Double.parseDouble(SCYFHDL);
			sum_TXJFHDL+=Double.parseDouble(TXJFHDL);
			sum_JZHDL+=Double.parseDouble(JZHDL);
			sum_SJZXHDL+=Double.parseDouble(SJZXHDL);
			DecimalFormat mat=new DecimalFormat("0.0");
			sum_SWJUHDL=mat.format(sum_zhj);
			sum_FSCYFHDL=mat.format(sum_SCYFHDL);
			sum_GLYFHDL=mat.format(sum_TXJFHDL);
			sum_QDYFHDL=mat.format(sum_JZHDL);
			sum_QTFSCYFHDL=mat.format(sum_SJZXHDL);
       ...
       <tr bgcolor="<%=color%>">      		
       		...
       		<td>
       			<div align="center" ><a href="huanbi_hdl_city.jsp?dataStr=<%=hStr%>" target="chart"><%=shi%></a></div>
       		</td>
       		<td>
       ...
       <%} %>
        <tr bgcolor="F2F9FF">      		
       		...
       		<td>
       			<div align="center" ><%=sum_SWJUHDL%></div>
       		</td>
       		<td>
       			<div align="center" ><%=sum_FSCYFHDL%></div>
       		</td>
       		<td>
       			<div align="center" ><%=sum_GLYFHDL%></div>
       		</td>
       		<td>
       			<div align="center" ><%=sum_QDYFHDL%></div>
       		</td>
       		<td>
       			<div align="center" ><%=sum_QTFSCYFHDL%></div>
       		</td>  
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/tjhzquery/sjHdltjCityQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/tjhzquery/sjHdltjCityQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/tjhzquery/各地市耗电量统计查询.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
       function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/tjhzquery/sjHdltjCityquery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
