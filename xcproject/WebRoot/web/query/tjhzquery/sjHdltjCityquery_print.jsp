...
<head>
	...
	<script language="JavaScript">
		...
		{
			//alert(o);
			document.form1.action="../tjhzquery/sjHdltjCityquery_print.jsp?pageNum="+o;
		...
		function inputin()
		{
			document.form1.action="../tjhzquery/sjHdltjCityquery_print.jsp?pageNum=1";
			document.form1.submit();
		}
		...
		function showAll()
		{
			...
			document.form1.action="../basequery/sjHdltjCityquery_print.jsp";
		    document.form1.submit();
		}
...
cellpadding="0" cellspacing="0" align="center" bordercolor="#000000" style="border-collapse:collapse"  id="theObjTable">
                       <tr>
             <td width="7%" height="23" bgcolor="#888888"><div align="center">省份</div>
                                </td>
