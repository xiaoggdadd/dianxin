...
function ShowHideSearchRegion(trObject,SelfObject)
{
   ...
   function queryDegree(){
                   ...
                   var canshuStr = "?beginTime="+beginTime+"&zhandian"+zhandian; 

                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/tjhzquery/cityStationPointHdlQuery.jsp"+canshuStr;
                   document.form1.submit();
       
    }
function showhb(hStr){
     //alert(hStr);
     window.open("huanbi_hdl.jsp?dataStr="+hStr,'','width=600,height=400,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
...
<tr bgcolor="F9F9F9">
         ...
         &nbsp;&nbsp;&nbsp;
            月份：<input type="text" name="BeginTime" value="" onFocus="getDateString(this,oCalendarChsny)"  class="form"/>          
	       &nbsp;&nbsp;&nbsp;&nbsp;
	       站点：<input type="text" name="zhandian" value="" class="form"/>        
         &nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
           <tr>
             <td width="7%" height="23" bgcolor="#888888"><div align="center">地市</div>
                                ...
                                <td width="7%" height="15" bgcolor="#888888"><div align="center">月份</div>
            			        </td>
       ...
       <%
         ...
         System.out.println("ammeterDegreeQueryList:"+beginTimeQ);
			...
			if(zhandian != null && !zhandian.equals("")){
				whereStr=whereStr+" and zdlxhdl.jzname like '%"+zhandian+"%'";
			}      
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/tjhzquery/cityStationPointHdlQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/tjhzquery/cityStationPointHdlQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/tjhzquery/站点耗电量分析统计.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
   function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/tjhzquery/cityStationPointHdlQuer_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
