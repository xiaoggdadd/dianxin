...
function ShowHideSearchRegion(trObject,SelfObject)
{
   ...
   function queryDegree(){
                   ...
                   //alert(canshuStr);
                   document.form1.action=path+"/web/query/tjhzquery/cityNhtjNhlQuery.jsp"+canshuStr;
...
<tr bgcolor="F9F9F9">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
           <tr>
             <td width="10%" height="23" bgcolor="#888888"><div align="center">地市</div>
                                ...
                                <td nowrap height="23" bgcolor="#888888">
                                <div align="center">耗电量</div>
                                <hr>
                                <div align="center">度</div>                              
            			        </td>

                                <td nowrap height="23" bgcolor="#888888">
                                 <div align="center">水消耗量</div>
                                <hr>
                                <div align="center">吨</div>
            			        </td>
				                <td nowrap height="23" bgcolor="#888888">
				                <div align="center">汽油消耗量</div>
				                 <hr>
                                <div align="center">升</div>
            			        </td>
				                <td nowrap height="23" bgcolor="#888888">
				                <div align="center">柴油消耗量</div>
				                <hr>
                                <div align="center">升</div>
            			        </td>
            			        <td nowrap height="23" bgcolor="#888888">
            			        <div align="center">天然气消耗量</div>
            			         <hr>
       ...
       <%} %>
        <tr bgcolor="F2F9FF">      		
       		...
       		<td>
       			<div align="center" ><%=sum_hdl%></div>
       		</td>
       		<td>
       			<div align="center" ><%=sum_sxhl%></div>
       		</td>
       		<td>
       			<div align="center" ><%=sum_qyxhl%></div>
       		</td>
       		<td>
       			<div align="center" ><%=sum_cyxhl%></div>
       		</td>  
       		<td>
       			<div align="center" ><%=sum_trqxhl%></div>
       		</td>        		
       </tr>
  ...
  <tr bgcolor="F9F9F9">
                      <td align="right" height="19" colspan="4"><div id="parent" style="display:inline">
                          <div style="width:50px;display:inline;"><hr></div>&nbsp;功能区域&nbsp;<div style="width:300px;display:inline;"><hr></div>
                      </div></td>
                    </tr>
  <tr>
   <td align="right">                              
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/query/tjhzquery/cityNhtjNhlQuery.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/query/tjhzquery/cityNhtjNhlQuery.jsp?curpage="+pageno;
      document.form1.submit();
     }
...
function exportad(){
            ...
            //alert(canshuStr);
        	document.form1.action=path+"/web/query/tjhzquery/cityNhtjNhlquery_xml.jsp?curpage="+curpage+"&whereStr="+whereStr;
            document.form1.submit();
   }
    function printad(){
            var curpage = <%=curpage%>;
            var whereStr ="<%=whereStr%>";
            //alert(canshuStr);
            window.open(path+"/web/query/tjhzquery/cityNhtjNhlquery_print.jsp?curpage="+curpage+"&whereStr="+whereStr,'','width=800,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
