...
<table x:str border=0 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
  ...
  <td class=xl25 width=165 style='border-left:none;width:124pt'>耗电量<hr>吨标煤</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>水消耗量<hr>吨标煤</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>汽油消耗量<hr>吨标煤</td>
  
  <td class=xl25 width=142 height=19  style='height:14.25pt;width:107pt'>柴油消耗量<hr>吨标煤</td>
  <td class=xl25 width=152 style='border-left:none;width:114pt'>天然气消耗量<hr>吨标煤</td>
  <td class=xl25 width=152 style='border-left:none;width:114pt'>总耗能<hr>吨标煤</td>
 </tr>
 <%   
         ...
         System.out.println("ammeterDegreeQueryList:"+beginTimeQ);
       	 ...
       	 fylist = bean.getPageDataZhnlCity(curpage,whereStr);
		 ...
		 if(fylist!=null)
		{
			...
			sum_hz_hj = (String)fylist.get(k+fylist.indexOf("SUM_HZ_HJ"));
			sum_hz_hj = sum_hz_hj != null ? sum_hz_hj : "";

            //城市、总耗能串成字符串
            cityStr = cityStr + zdname+";";
            dataStr = dataStr + sum_hz+";";
       %>
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=sum_hz%></td>
 </tr>
         <%}%>
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=sum_hz_hj%></td>
 </tr>     
