...
<table x:str border=0 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
  ...
  <td class=xl25 width=165 style='border-left:none;width:124pt'>耗电量（总）</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>机房耗电量</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>基站耗电量</td>
  
  <td class=xl25 width=142 height=19  style='height:14.25pt;width:107pt'>营业网点耗电量</td>
  <td class=xl25 width=152 style='border-left:none;width:114pt'>其它耗电量</td>
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=sum_hj%></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=SCYFHDL%></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=TXJFHDL%></td>
  
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=JZHDL%></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=SJZXHDL%></td>
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=sum_zhj%></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=sum_SCYFHDL%></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=sum_TXJFHDL%></td>
  
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=sum_JZHDL%></td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=sum_SJZXHDL%></td>
