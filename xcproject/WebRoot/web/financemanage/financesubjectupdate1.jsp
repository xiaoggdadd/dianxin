    ...
    function updataDate(){
     ...
     // var kmName =document.getElementById("kmName").value;
      var params = "?fqcbCode="+fqcbCode+"&qcbCode="+qcbCode+"&qcbName="+qcbName;
       ...
       var Url=getPublicPath()+"/servlet/FinanceSubject1?action=insert";
		     ...
		     //  var kmCode = <%=kmCode%>;
		      // var fkmCode = <%=fkmCode%>;
		       // var idd='<%=idd%>';
		        ...
		        var params = "?&qcbCode="+qcbCode+"&fqcbCode="+fqcbCode+"&idd="+idd;
		        var Url=getPublicPath()+"/servlet/FinanceSubject1?action=updateSele";
			    new Ajax.Request(Url,{
			      		method : 'post',
						asynchronous: false,
					    parameters : params,
			 			 ...
			 			 var msg = result.split("|");
			 			  ...
			 			  var item = result.split("|");
		               	  ...
		               	  document.getElementById("qcbgrade").value = item[3];
		               	    var item1 = item[4].split(",");
		               	  document.getElementById("id").value =item1[0];
			 			}
			 	}) 
		      }else{
...
*/
             ...
             +"&qcbgrade="+document.getElementById("qcbgrade").value
             +"&id="+document.getElementById("id").value;
            var Url=getPublicPath()+"/servlet/FinanceSubject1?action=updata";
