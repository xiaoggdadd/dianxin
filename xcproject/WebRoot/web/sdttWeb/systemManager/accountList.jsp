...
function fzqy() {
	...
	if (i == 1) {
		document.form1.action = path + "/web/sdttWeb/sys/per_area.jsp?accountid="
				+ accountid;
		document.form1.submit();
				...
				<div class="content01_1">
					...
					<div class="tbtitle01"><b>用户查询统计一览</b></div>
						...
						String whereStr = "";
		                   ...
		                   list = bean.getAllAccount(whereStr, usename, adminsname, curpage,ssagcode);//获取 用户的分页数据  ssagcode登录用户所属的区域 编码 
