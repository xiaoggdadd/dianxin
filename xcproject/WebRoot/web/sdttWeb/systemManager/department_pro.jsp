...
<body>
	<form action="" name="form1" method="post">
		<ul class="tab">
			...
			<li class="cur"><a href="department_pro.jsp">部门管理</a>
			</li>
			<li class="end"></li>
		</ul>
							...
							<table width="800px" border="0" cellpadding="0" cellspacing="0"
								...
								<tr align="right">
									<td colspan="5" align="right" valign="middle"><input
										name="button2" type="button" class="btn_c1" id="button2"
								...
								String whereStr = "";
						         ...
						         fylist = bean.getDept(curpage,whereStr);
 						       	
 						       	 allpage=bean.getAllPage();
						       	
							     String agcode="",agname="",id = "" ,fagname="", shidisplay="";
								 ...
								 if(fylist!=null)
 									...
 									for( int k = fycount;k<fylist.size()-1;k+=fycount){
						       			...
						       			fagname = (String) fylist.get(k + fylist.indexOf("FDEPTNAME"));
						       			shidisplay = (String) fylist.get(k + fylist.indexOf("SHIDISPLAY"));
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage - 1)%>';
      		document.form1.action=path+"/web/sdttWeb/systemManager/department_pro.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      ...
      document.form1.action=path+"/web/sdttWeb/systemManager/department_pro.jsp?curpage="+pageno;
      document.form1.submit();
     }
     function delzd(id){
...
function addjz(){
    window.open("../systemManager/addDepartment_pro.jsp?sheng=<%=sheng%>",newwindow, height=500, width=900, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no,scrollbars=yes");  
}
function update(id){
	window.open("../systemManager/addDepartment_pro.jsp?id="+id+"&sheng=<%=sheng%>", newwindow, height=500, width=900, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no,scrollbars=yes");  
}
function query(){
