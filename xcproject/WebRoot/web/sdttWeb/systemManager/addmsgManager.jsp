...
var id='<%=id%>';
function addggao(){
var dbname=document.form1.dbname.value;
var nr=document.form1.nr.value;
	if(dbname!="null"&&dbname!=""&&nr!="null"&&nr!=""){
				...
				<div class="content01_1">
					...
					<tr>
						...
						<tr>
							...
							<td width="60px">
								<input type="text" name="dbname" value="<%=bt%>"  maxlength="100"/>
							</td>
						</tr>
						...
						<tr>
							<td align="right" colspan="8" height="60px">
								<input  type="button" class="btn_c1" name="baocun" onclick="addggao()" id="baocun" value="保存" />&nbsp;&nbsp;&nbsp; 

								<input  type="button" class="btn_c1" onclick="fanhui()" value="返回" />&nbsp; 
