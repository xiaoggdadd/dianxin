...
<link href="../css/content.css" rel="stylesheet" type="text/css" />
	...
	String ammertId = request.getParameter("ammertId");
%>
...
function chaxun() {
	document.form1.action = path + "/web/sdttWeb/GaojingManager/DifenShujuShenpi.jsp";
	document.form1.submit();
}
function accountOn() {
	var i = 0;
		...
		<td>
			<div class="content01">
				...
				<div class="content01_1">
					...
					<div class="tbtitle01"><b>电费超标告警一览</b></div>
						<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="tb_list1" >
								...
								<%
										String whereStr = "";
											...
											if(ammertId!=null){
												whereStr = whereStr + " and am.AMMETERDEGREEID = '"+ammertId+"'";
											}
		                    ArrayList list = new ArrayList();
		                   list = bean.getAllinfoGj(whereStr, usename, adminsname, curpage,ssagcode);//获取 用户的分页数据  ssagcode登录用户所属的区域 编码 
...
function daochu(){
	document.form1.action=path+"/servlet/PlDownload?bz=DFCB";
	document.form1.submit();
}
