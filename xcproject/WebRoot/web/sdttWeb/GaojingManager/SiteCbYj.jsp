...
<link href="../css/content.css" rel="stylesheet" type="text/css" />
	...
	String id =request.getParameter("ammertId");
...
function chaxun() {
	document.form1.action = path + "/web/sdttWeb/GaojingManager/SiteCbYj.jsp";
	document.form1.submit();
}
function accountOn() {
	var i = 0;
					...
					<div class="tbtitle01"><b>电费超标告警一览</b></div>
						<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="tb_list1" >
									<tr align="right">
										...
										<input name="button2" type="submit" class="btn_c1" id="button2" value="Excel导出" />&nbsp; 
									     </td>
									</tr>
									<tr align="center">
									      <th width="10">序号</th>
