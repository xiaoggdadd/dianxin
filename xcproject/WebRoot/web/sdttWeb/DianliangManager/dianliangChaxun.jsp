					...
					<table width="100%" border="0" cellpadding="2" cellspacing="0" class="tb_select" >
						<tr >
							...
							城市&nbsp; <select name="shi" id="shi"
									style="width:80px;" onchange="changeCity()">
										...
										%>
								</select>&nbsp;&nbsp;&nbsp; 区县&nbsp; <select name="xian" id="xian" style="width:80px;">
										<option value="0">请选择</option>
										<%
							...
							&nbsp;&nbsp; 
							标杆比较状态：&nbsp;
							<select name="bgState" id="bgState" style="width:100px;">
						...
						<tr>
							<td colspan="2" align="right">
								<input name="button2" type="submit" class="btn_c1" id="button2" value="查询" />&nbsp; 
							</td>
						</tr>
					</table>
					
					<div class="tbtitle01"><b>基站电量数据查询一览</b></div>
						<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="tb_list1" >
									...
									%>
										...
										<td align="right">&nbsp;<%=de.format(dl)%></td>
										<td align="right">&nbsp;<%=de.format(bg)%></td>
										<td align="right">&nbsp;<%=de.format(cbbl)%></td>
									</tr>
									<%		
										}
									%>
