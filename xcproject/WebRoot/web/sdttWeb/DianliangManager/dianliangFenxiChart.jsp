...
function changeChart(){
	...
	$('#container').highcharts({
            title: {
                text:  '['+smc+qxmc+zdmc+']'+year+'年度电量数据分析图',
                x: -20 			//center
            },
            subtitle: {
                text: '',
...
<ul class="tab">
	  <li class="first"></li>
	  <li class="cur"><a href="dianliangFengxiChart.jsp">全年各站点电量走势分析</a></li>
	  <li ><a href="dianliangFengxiChart2.jsp">某月全站点电量比较</a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr valign="top">
		...
		<td>
			<div class="content01">
				<div class="tit01">全年基站电量数据分析折线图</div>
