...
<%
	...
	if (jzcode != null && !jzcode.equals("") && !jzcode.equals("null")&& !jzcode.equals("0")) {
		...
		List<ZhandianBean> zhandianList = systemManage.searchZhandianZX(shi,xian);
		String zd = "";
...
function changeChart(){
	...
	$("#container").highcharts({
            title: {
                text: '['+smc+qxmc+zdmc+']'+year+'年度标杆数据分析图',
                x: -20 			//center
            },
            subtitle: {
                text: '',
...
<body>
	<ul class="tab">
	  <li class="first"></li>
	  <li class="cur"><a href="biaoganFengxiChart.jsp">全年各站点标杆走势分析</a></li>
	  <li ><a href="biaoganFengxiChart2.jsp">某月全站点标杆比较</a></li>
	  <li ><a href="biaoganFengxiChart3.jsp">超标杆比例分析</a></li>
	  <li class="end"></li>
	</ul>
	<form action="" name="form1" method="post">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				...
				<td>
					<div class="content01">
						<div class="tit01">全年基站标杆数据分析折线图</div>
