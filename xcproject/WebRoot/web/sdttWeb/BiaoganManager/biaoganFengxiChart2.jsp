...
function changeChart(){
	...
	$("#container").highcharts({
        ...
        series: [{
            ...
            name: '超标电量',
            data: [-33.7, 7.3, -7.9, -35.8, -38]
        }, {
            name: '超标增幅(%)',
            data: [0, 12.2, -4.7, -10.5, -0.1]
        }]
    });
}
...
<body>
	<ul class="tab">
	  ...
	  <li class="cur"><a href="biaoganFengxiChart2.jsp">某月全站点标杆比较</a></li>
	...
	<form action="" name="form1" method="post">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				...
				<td>
					<div class="content01">
						<div class="tit01">某月全站点标杆比较柱状图</div>
