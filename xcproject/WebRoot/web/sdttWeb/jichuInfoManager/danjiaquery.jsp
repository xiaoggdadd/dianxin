...
<script>
	...
	String nianyue = request.getParameter("yearmonth")!=null?request.getParameter("yearmonth"):"";
...
<%
  ...
  String xuni="0";
		if (!xiaoqu.equals("0")) {
		    ...
		    if(!nianyue.equals("0")&&nianyue!=null&&nianyue!=""&&!nianyue.equals("")){
		    	whereStr=whereStr+" and d.yearmonth='"+nianyue+"'";
		    	str = str+" and d.yearmonth='"+nianyue+"'";
		    }
   %>
	<tr valign="top">
				...
				<div class="content01_1">
					<table width="800px" border="0" cellpadding="1" cellspacing="0" class="tb_select" >
						<tr>
							...
							<td>
							<input onfocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM'})" name="yearmonth"  />
							</td>
						</tr>
<!-- 						<tr> -->
...
<!-- 						</tr> -->
					...
					<div class="tbtitle01"><b>电价查询统计一览</b></div>
...
<!-- 										    <input name="button2" type="submit" onclick="addjz()" class="btn_c1" value="新增" />&nbsp;&nbsp; -->
         ...
         fylist = bean.getDj(curpage,loginName,loginId,whereStr);
...
<script>
	...
	function gopage()
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      else
      {
        ...
        var curpage='<%=(curpage - 1)%>';
      		document.form1.action=path+"/web/sdttWeb/jichuInfoManager/danjiaquery.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      document.form1.action=path+"/web/sdttWeb/jichuInfoManager/danjiaquery.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+pageno;
      document.form1.submit();
     }
     function delzd(id){
    // alert(id);
...
function query(){
	document.form1.action=path+"/web/sdttWeb/jichuInfoManager/danjiaquery.jsp";
}
function daochu(){
	document.form1.action=path+"/servlet/CbDownload?bz=danjiaquery";
	document.form1.submit();
}
document.form1.shi.value='<%=shi%>';
document.form1.xian.value='<%=xian%>';
document.form1.xiaoqu.value='<%=xiaoqu%>';
document.form1.yearmonth.value='<%=nianyue%>';
</script>
