		...
		<td>
			<div class="content01">
				...
				<div class="content01_1">
					...
					<div class="tbtitle01"><b>抄表员信息查询统计一览</b></div>
...
<!-- 										<th width="80">单价</th> -->
         ...
         fylist = bean.getCbyuan(curpage,loginName,loginId,whereStr);
...
<script>
	...
	function gopage()
     ...
     if(confirm("您确定删除此条信息？")){
     		document.form1.action=path+"/servlet/Cbyuanservlet?action=delete&id="+id;
      		document.form1.submit();
   		 }
    }
    function xiangxi(id){
...
function addjz(){
	window.open("../jichuInfoManager/addCByuan.jsp", "newwindow", "height=500, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");  
}
function daochu(){
...
function update(id){
	window.open("../jichuInfoManager/addCByuan.jsp?id="+id+"+&bz="+"1", "newwindow", "height=500, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");  
}
function query(){
	document.form1.action=path+"/web/sdttWeb/jichuInfoManager/cbyuanmanage.jsp";
}
