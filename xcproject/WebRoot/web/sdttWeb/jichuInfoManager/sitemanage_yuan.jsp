...
<ul class="tab">
  <li class="first"></li>
  <li class="cur"><a href="sitemanage.jsp">基站管理</a></li>
  <li><a href="dianbiaolist.jsp">电表管理</a></li>
  <li><a href="siteDBChaxun.jsp">基站电表查询</a></li>
  <li class="end"></li>
</ul>
				...
				<div class="content01_1">
					<table width="800px" border="0" cellpadding="1" cellspacing="0" class="tb_select" >
						<tr>
							...
							<td align="left" width="60px">
							<input type="text" name="txtKeyword" id="txtKeyword" style="width:80px" />
							</td>
						</tr>
						<tr>
       ...
       %>
									...
									<tr align="center">
										...
										<td width="80">
											...
											<a href="#" onclick="update('<%=id%>','<%=zdqyzt%>')"><img src="../images/accept.png" width="16" height="16"  title="修改" /></a>
