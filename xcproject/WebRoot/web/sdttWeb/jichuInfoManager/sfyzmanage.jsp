...
<ul class="tab">
  <li class="first"></li>
  <li><a href="ftblmanage.jsp">分摊比例管理</a></li>
  <li class="cur"><a href="sfyzmanage.jsp">税负因子管理</a></li>
  <li class="end"></li>
</ul>
		...
		<td>
			<div class="content01">
				...
				<div class="content01_1">
					...
					<div class="tbtitle01"><b>税负因子查询统计一览</b></div>
         ...
         fylist = bean.getSfyz(curpage,loginName,loginId,whereStr);
       	 DecimalFormat df1 = new DecimalFormat("0.00");
       	 allpage=bean.getAllPage();
       	double a=0;
		String id="", yearmonth="",zdmc="",sfyz="",dbbm="";
...
<script>
	...
	function gopage()
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      else
      {
        ...
        var curpage='<%=(curpage - 1)%>';
      		document.form1.action=path+"/web/sdttWeb/jichuInfoManager/sfyzmanage.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      document.form1.action=path+"/web/sdttWeb/jichuInfoManager/sfyzmanage.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+pageno;
      document.form1.submit();
     }
     function delzd(id){
    // alert(id);
     if(confirm("您确定删除此稅負因子信息？")){
     	//<if (permissionRights.indexOf("PERMISSION_DELETE") >= 0) {%> //权限
     		document.form1.action=path+"/servlet/SfyzServlet?action=delsite&id="+id;
      		document.form1.submit();
      //<} else {%>
      //alert("您没有删除站点的权限");
    //<}%>
...
function addjz(){
	window.open("../jichuInfoManager/addSfyz.jsp", "newwindow", "height=500, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");  
}
function update(id){
	window.open("../jichuInfoManager/addSfyz.jsp?id="+id+"&bz="+"1", "newwindow", "height=500, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");  
}
function query(){
	document.form1.action=path+"/web/sdttWeb/jichuInfoManager/sfyzmanage.jsp";
}
function daochu(){
	document.form1.action=path+"/servlet/CbDownload?bz=sfyz";
	document.form1.submit();
}
