				...
				<div class="content01_1">
					<table width="1000px" border="0" cellpadding="2" cellspacing="0" class="tb_select" >
						...
						<tr>
							...
							<td width="100px">
								<select id = "XIANCODE" name="xian" style="width: 130px" onchange="changeCountry()">
									<option value="0">请选择</option>
									<%
						...
						<td align="right" width="100px">实体类型</td>
							<td width="100px">
								<select name="stationType" id="stationType" style="width: 130px;">
									<option value="0">请选择</option>
									<%
							...
							<td width="100px">
								<input type="text" name="ascriptionUnit" value="<%=station.getAscriptionUnit() %>" maxlength="20" style="width: 130px;"/>
								<span>&nbsp;*</span>
							</td>
...
function saveStation() {
	debugger;
		...
		if(!(checkNotSelected(document.form1.shi, "地市") 
				...
				&& checkNotSelected(document.form1.flowName, "流程名称") //end 添加流程名称不为空判断
				)){
			return;
		}
		if(approvestatus!='' && !checkNotSelected(document.form1.flowName, "流程名称")){
			return;
		}	
