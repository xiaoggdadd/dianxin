...
<script>
    ...
    String ssf = request.getParameter("ssf")!=null?request.getParameter("ssf"):"";
...
<%
  ...
  String xuni="0";
		...
		if(ssf!=""){
			whereStr = whereStr + " and d.SSF= '"+ ssf + "'";
		}
		if(textdbbm!=""){
									...
									<tr align="left">
										<td colspan="12" align="left">
										 ...
										 <!--   <span class="btn_c1 fileinput-button">
										    ...
										    -->
										     <!--  <input name="button2" type="button" onclick="daoru()" class="btn_c1" id="button2" value="导入数据" />&nbsp;&nbsp; 
											...
											<input name="button2" type="submit" onclick="daochu()"  class="btn_c1" id="button2" value="导出" />
										</td>
									</tr>
      ...
      <%
       ...
       %>
									...
									<tr align="center">
										...
										<td width="80">
										<a href="#" onclick="ch('<%=id%>','<%=shzt%>')"><img src="../images/ch.png" width="16" height="16"  title="撤回" /></a>
...
<!-- 				    </select> -->
	...
	<input type="hidden" name="whereStr"/>
		...
		<input type="hidden"  name="templetname" value="电表基础表导入模板"/>
		</form>
</body>
</html>
<script>
 ...
 function ch(id,s){	
	//  alert(id);
		...
		if(confirm("您确认要撤回本条信息？")){
		     		document.form1.action=path+"/servlet/dianbiao?action=chdianbiao&id="+id;
		      		document.form1.submit();
		      		showdiv("请稍等..............");
		      	}
     }  
    function xiangxi(id,zdid){
     	  window.open("../jizan/dbxxquery_new.jsp?bz=1&id="+id+"&zdid="+zdid, "newwindow", "height=600, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no,scrollbars=yes");  
	...
	window.open("../jizan/dianbiaoSub.jsp?id="+id+"&zdid="+zdid, "newwindow", "height=500, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no,scrollbars=yes");
}
...
function addjz(){
	window.open("../jizan/adddianbiao_new.jsp", "newwindow", "height=600, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no,scrollbars=yes");  
}
function daochu(){
...
function update(id,zdid,s){
	if(s==1){
     ...
     window.open("../jizan/adddianbiao_new.jsp?bz=1&id="+id+"&zdid="+zdid+"&shzt="+s, "newwindow", "height=600, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no,scrollbars=yes");  
     document.form1.submit();
    }
function updateSX(id,s){
	if(s!=2){
     ...
     window.open("../jizan/updateDianbiaoSx.jsp?id="+id, "newwindow", "height=500, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no,scrollbars=yes");  
     document.form1.submit();
    }
function query(){
...
function downloadTemp(){
   document.form1.action=path+"/servlet/FileUpServlet?action=download";
   document.form1.submit();
}
function openUpload(){
	window.open("uploadEx.jsp", "newwindowUp", "height=550, width=900, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no,scrollbars=yes");
}
function daoru(){ //document.form1.action=path+"/web/sdttWeb/jichuInfoManager/inputdegreefees.jsp";
window.open("inputdegreefees.jsp", "newwindowUp", "height=500, width=400, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no,scrollbars=yes");
}
$(function(){
	$('#importExcel').fileupload({
		url: '<%=path%>/servlet/FileUpServlet?action=upload',
