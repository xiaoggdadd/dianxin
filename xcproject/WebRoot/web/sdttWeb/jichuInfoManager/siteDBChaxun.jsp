...
<ul class="tab">
  <li class="first"></li>
  <li><a href="sitemanage.jsp">基站管理</a></li>
  <li><a href="dianbiaolist.jsp">电表管理</a></li>
  <li class="cur"><a href="siteDBChaxun.jsp">基站电表查询</a></li>
  <li class="end"></li>
</ul>
		...
		<td>
			<div class="content01">
				...
				<div class="content01_1">
					...
					<div class="tbtitle01"><b>基站查询统计一览</b></div>
...
<!-- 										    <input name="button2" type="submit" onclick="addjz()" class="btn_c1" value="新增" />&nbsp;&nbsp; -->
									...
									<tr align="center">
										...
										<th width="100">电表编号</th>
										<th width="80">电表名称</th>
										<th width="80">报账人</th>
										<th width="80">电表用途</th>
										<th width="80">倍率</th>
<!-- 										<th width="80">供电方式</th> -->
<!-- 										<th width="80">站点面积(平米)</th> -->
<!-- 										<th>操作</th> -->
									</tr>
						<%
		 SiteManage bean = new SiteManage();
       	 ArrayList fylist = new ArrayList();
         fylist = bean.getSiteDB(curpage,loginName,loginId,whereStr);
       	 DecimalFormat df1 = new DecimalFormat("0.00");
       	 allpage=bean.getAllPage();
       	double a=0;
		String zdmc="",dbbm="",dbmc="",dbyt="",beilv="",bzr="";
		int intnum = pagesize*(curpage-1)+1;
		 ...
		 if(fylist!=null)
			...
			for( int k = fycount;k<fylist.size()-1;k+=fycount){
       			...
       			bzr = (String) fylist.get(k+ fylist.indexOf("A"));
       			if(beilv!=null&&beilv!=""){
				a=Double.valueOf(beilv);
				}
       			if (intnum % 2 == 0) {
       				color = "#DDDDDD";
...
<script>
	...
	function gopage()
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      else
      {
        ...
        var curpage='<%=(curpage - 1)%>';
      		document.form1.action=path+"/web/sdttWeb/jichuInfoManager/siteDBChaxun.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      document.form1.action=path+"/web/sdttWeb/jichuInfoManager/siteDBChaxun.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+pageno;
      document.form1.submit();
     }
     function delzd(id){
    // alert(id);
...
function daochu(){
	document.form1.action=path+"/servlet/CbDownload?bz=siteDB";
	document.form1.submit();
}
function addjz(){
...
function query(){
	document.form1.action=path+"/web/sdttWeb/jichuInfoManager/siteDBChaxun.jsp";
}
