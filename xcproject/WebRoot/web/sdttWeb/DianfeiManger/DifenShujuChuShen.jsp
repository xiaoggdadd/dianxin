...
<link href="../css/content.css" rel="stylesheet" type="text/css" />
	...
	String permissionRights = "";//登录者的导出按钮 权限
		...
		<td>
			<div class="content01">
				...
				<div class="content01_1">
					...
					<div class="tbtitle01"><b>电费数据初审一览</b></div>
       ...
       %>
									...
									<tr align="center">
										...
										<td width="80" align="center"><div >
											&nbsp;<input name="button2" type="submit" class="btn_c1" onclick="sh(<%=ida%>)" id="button2" value="审批" />&nbsp; 
												</div></td>
									</tr><% } %>
