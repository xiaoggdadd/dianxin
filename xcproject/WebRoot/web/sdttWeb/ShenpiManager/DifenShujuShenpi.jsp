...
<!-- 									       <input name="button2" type="submit" class="btn_c1" id="button2" value="批量审批" />&nbsp;  -->
						...
						String whereStr = "";
		                   ...
		                   list = bean.getAllinfo(whereStr, usename, adminsname, curpage,ssagcode);//获取 用户的分页数据  ssagcode登录用户所属的区域 编码 
		                             allpage = bean.getAllPage();
											...
											String yf="",jzname="",dl="",bzdl="",df="",dx="",lt="",yd="",qt="",zt="",ida="",gjbz="";
										String color = "F3F3F3";
		 //System.out.println(intnum);
											...
											for (int i = countColum; i < list.size() - 1; i += countColum) {
												...
												gjbz=(String)list.get(i+list.indexOf("CB_ALERT"));
       ...
       %>
									...
									<tr align="center" bgcolor="<%=color%>">
										...
										<td width="80" align="center"><div >
											&nbsp;<input name="button2" type="button" class="btn_c1" onclick="sh(<%=ida%>)"  id="button2" disabled="disabled" value="审批" />&nbsp; 
												</div></td>
												<%}else {%>
												<td width="80" align="center"><div >
											&nbsp;<input name="button2" type="button" class="btn_c1" onclick="sh(<%=ida%>)" id="button2" value="审批" />&nbsp; 
												</div></td>
												<%}%>
									</tr><% } %>
...
function daochu(){
	document.form1.action=path+"/servlet/PlDownload?bz=DFSP";
	document.form1.submit();
}
