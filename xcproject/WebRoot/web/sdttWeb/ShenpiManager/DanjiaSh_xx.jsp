...
var nr=document.form1.memo.value;
	if(nr!=null&&nr!=""){
		if (confirm("确定要审核！")) {
			...
			document.form1.action = path + "/servlet/account?action=shdj&id="+id+"&zt="+zt;
			document.form1.submit();
		} else {
			return;
		}
				...
				<div class="content01_1">
					<div class="tbtitle01"><b>电价变更审批一览</b></div>
						...
						String whereStr = "";
		                   ...
		                   list = bean.getAllJzdjsh(id);//获取 用户的分页数据  ssagcode登录用户所属的区域 编码 
											...
											String ida="", yf="",dbbm="",dbname="",dfzflx="",bl="",dj="",shzt="";
											String color = "F3F3F3";
		 									double a=0,b=0;
			                                  if(list!=null){
											 ...
											 for(int i = countColum; i < list.size() - 1; i += countColum) {
												ida=(String) list.get(i + list.indexOf("ID"));
