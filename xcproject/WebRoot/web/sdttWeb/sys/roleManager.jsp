...
function qxsz(para){
 ...
 window.open(path+'/web/sys/rightManage.jsp?roleId='+para,'qxszwindow','width=700,height=500,status=yes,scrollbars=yes,resizable=yes,left=200,top=200')
	// document.form1.action=path+"/web/sys/rightManage.jsp?roleId="+para;
                                document.form1.submit();
}
function daochu(){
...
<ul class="tab">
  ...
  <li class="cur"><a href="roleManager.jsp">角色管理</a></li>
  <li class="end"></li>
</ul>
