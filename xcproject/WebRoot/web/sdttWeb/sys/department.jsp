	 				 ...
	 				 if (rowDate!=""){
		 				  for(var i=0;i<rowDate.length;i++){
			 			    	...
			 			    	curRow = cellDate[5]
				 			     ...
				 			     var url="'"+"departmentupdate.jsp?deptCode="+cellDate[0]+"&fdeptCode="+cellDate[2]+"'";
...
//增加数据
 function add(){
   ...
   if (gongsiVal==0 && bumenVal == 0 && yibanzuVal ==0){
    ...
    window.open("departmentadd.jsp?fatherAreaName="+fatherAreaName+"&fatherCode="+fatherCode, 'newwindow', 'height=200, width=500,top=0,left=200,toolbar=no,menubar=no, scrollbars=no, resizable=no,location=n o, status=no');
 } 
   function open1(url){
...
//
   function del(id){
     if(confirm("确定删除")){
       var params = "?&deptCode="+id;
       var Url=getPublicPath()+"/servlet/DepartmentServlet?action=del";
	    new Ajax.Request(Url,{
	      		method : 'post',
				asynchronous: false,
			    parameters : params,
					...
					<tr>
						<td colspan="3">
							<table width="100%"  border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td colspan=3 width="600"  height=63><span style="color:black;font-weight:bold;font-size=16;">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;部门管理</span></td>
