...
<table  width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="100%">
      <tr>
         ...
         <td width="35%"><input type="text" name="name" value="<%=bean.getName()%>" maxlength="25" class="form" style="width: 130px;"/><span class="style1">&nbsp;*</span>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
		<select name="shi"  id="shi"  style="width:130" onchange="changeCity()">
         		<option value="0">请选择</option>
         		<%
	         	ArrayList shilist = new ArrayList();
	         	//shilist = ztcommon.getAgcode(ssagcode,5);
	         	shilist = commBean.getAgcode(shengId,"0",loginName);
	         	if(shilist!=null){
      ...
      <tr>
         ...
         <td><select name="xian"  id="xian"  style="width:130" onchange="changeCountry()" >
         		<option value="0">请选择</option>
         		<%
      ...
      <tr>
         ...
         <td><input type="text" name="tel" value="<%=bean.getTel()%>" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="11" class="form" style="width: 130px;"/>
         </td>
         <td height="19" bgcolor="#DDDDDD"><div align="center">手机</div>
         </td>
         <td><input type="text" name="mobile" value="<%=bean.getMobile()%>" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="11"  maxlength="11" class="form" style="width: 130px;"/>
    ...
    <tr>
      ...
      <tr>
		 ...
		 <td height="19" bgcolor="#DDDDDD"><div align="center">财辅人力账号(@SD)</div>
         </td>
         <td><input type="text" name="msd"  id="msd" value="<%=bean.getCTHRNUMBER()%>"  class="form" style="width: 130px;"/>
      ...
      <tr>
         ...
         <td>
             <select name="bumen" style="width: 120px;">
                 <option value="0">请选择</option>
                 <%
                	ArrayList deptlist = new ArrayList();
         			deptlist = commBean.getDept(shi, shi);
	         		if(deptlist!=null){
	         			String code="",name1="";
	         			int dcount = ((Integer)deptlist.get(0)).intValue();
	         			for(int i=dcount;i<deptlist.size()-1;i+=dcount){
                    		code=(String)deptlist.get(i+deptlist.indexOf("DEPTCODE"));
                    		name1=(String)deptlist.get(i+deptlist.indexOf("DEPTNAME"));
                    %>
                    	<option value="<%=code%>"><%=name1%></option>
                   	<%}
	         		}
         ...
         <td><input type="text" name="zip" value="<%=bean.getZip()%>"onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="6"  class="form" style="width: 130px;"/>
         </td>
      </tr>
         ...
         <td ><input size="60" type="text" name="address" value="<%=bean.getAddress()%>"  class="form" style="width: 290px;"/>
         </td>
...
var path = '<%=path%>';
	...
	function baocunxiugai(){
		...
		//定义正则表达式
           ...
           if(document.form1.shi.value=="0"||document.form1.shi.value==""){
                         	alert("请选择市！");
                                 return
                     	}
                  /*   if(document.form1.xian.value=="0"||document.form1.xian.value==""){
                         	alert("请选择区县！");
                                 return
                     	}
                     	
                     	if(document.form1.xiaoqu.value=="0"||document.form1.xiaoqu.value==""){
                         	alert("请选择乡镇！");
                                 return
                     	} */
               ...
               if(document.form1.bumen.value=="0"||document.form1.bumen.value==""){
                         	alert("请选择部门！");
                                 return
                     	}
               if(document.form1.msd.value=="0"||document.form1.msd.value==""){
...
function changeSheng(){
		...
		function changeShi(){
			...
			if(shi=="0"){
				...
				sendRequest(path+"/servlet/area?action=shitoxian&pid="+shi+"&ssagcode="+ssagcode,"shi");
			}
		}
		...
		function changeXian(){
			...
			if(shi=="0"){
				...
				sendRequest(path+"/servlet/area?action=xiantoxiaoqu&pid="+shi+"&ssagcode="+ssagcode,"xian");
			}
		}
...
document.form1.bumen.value='<%=bean.getBuMen()%>';
</script>
