...
<%	
		...
		//数据遍历获取
		Bdsyswcjdbb stl = new Bdsyswcjdbb();//实体类
		BaoBiaoHuiZongDao dao = new BaoBiaoHuiZongDao();//DAO方法
		List<Bdsyswcjdbb> al = new ArrayList<Bdsyswcjdbb>();//泛型集合
		//获取共有几页
		//allpage = dao.pagesBdsyswcjdbb(shi,xian,xiaoqu);
		allpage = dao.pagesBdsyswcjdbb(shi); //共有几页
		...
		//al = dao.queryBdsyswcjdbb(curpage,shi,xian,xiaoqu);
		al = dao.queryBdsyswcjdbb(curpage,shi);//根据条件获取要显示的内容 
...
<script type="text/javascript">
			...
			function previouspage() {
				...
				document.form1.action = path +
					"/web/sdttWeb/baobiaohuizong/bdsyswcjdbb_4.jsp?rgsh=" + rgsh +
			...
			function daochu(){
				//可以直接获取操作者选择的导出条件
				var shi = '<%=shi%>';
				document.form1.action=path+"/servlet/CbDownload?bz=bdsyswcjdbb&shi="+shi+"";
				document.form1.submit();
			}
			function query(){
				document.form1.action=path+"/web/sdttWeb/baobiaohuizong/bdsyswcjdbb_4.jsp";
				document.form1.submit();
			}
		</script>
</head>
...
<body>
	<ul class="tab">
		...
		<li class="cur"><a href="bdsyswcjdbb_4.jsp">本地市预算完成进度报表</a></li>
		<li><a href="bsdpjpuebb_5.jsp">本地市平均PUE报表</a></li>
		<li class="end"></li>
	</ul>
						...
						<div class="content01_1">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr align="center">
									...
									<th width="50">日期</th>
									<th width="50">地市</th>
									<th width="50">预算电费金额</th>
									<th width="50">报账电费费用</th>
									<th width="50">预算完成进行</th>
								</tr>
								<%
										for(int i=0;i<al.size();i++){
										//为null的话默认为空
										String costtime = al.get(i).getCosttime()!= null ?al.get(i).getCosttime():"";//时间段
										String datetime = al.get(i).getDatetime()!= null ?al.get(i).getCosttime():"";//日期
										String shi_code = al.get(i).getShi()!= null ? al.get(i).getShi():"";//地市
										String ysdfje = al.get(i).getYsdfje()!= null ? al.get(i).getYsdfje():"";//预算电费金额
										String allmoney = al.get(i).getAllmoney()!= null ? al.get(i).getAllmoney():"";//报账电费费用
										String yswcjx = al.get(i).getYswcjx()!= null ? al.get(i).getYswcjx():"";//预算完成进行
								...
								<tr align="center">
									...
									<td align="left"><%=ysdfje%></td>
									<td align="left"><%=allmoney%></td>
									<td align="left"><%=yswcjx%></td>
								</tr>
								<%
									}
									 %>
