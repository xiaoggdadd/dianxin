...
<%@ page import="java.util.List,java.util.ArrayList,com.noki.mobi.common.Account"%>
<%@ page import="com.noki.mobi.common.CommonBean"%>
<%@ page import="com.noki.baobiaohuizong.bean.Dfcypldbg"%>
<%@ page import="com.noki.baobiaohuizong.BaoBiaoHuiZongDao"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<title>电费差异偏离度报告</title>
		...
		//数据遍历获取
		Dfcypldbg stl = new Dfcypldbg();//实体类
		BaoBiaoHuiZongDao dao = new BaoBiaoHuiZongDao();//DAO方法
		List<Dfcypldbg> al = new ArrayList<Dfcypldbg>();//泛型集合
		//获取共有几页
		allpage = dao.pagesDfcypldbg(shi,xian,xiaoqu); //共有几页
		...
		al = dao.queryDfcypldbg(curpage,shi,xian,xiaoqu);//根据条件获取要显示的内容 
		...
		<script type="text/javascript">
			...
			function previouspage() {
				...
				document.form1.action = path +
					"/web/sdttWeb/baobiaohuizong/dfcypldbg_2.jsp?rgsh=" + rgsh +
			...
			function daochu(){
				...
				var xian = '<%=xian%>';
				var xiaoqu = '<%=xiaoqu%>';
				document.form1.action=path+"/servlet/CbDownload?bz=dfcypldbg&shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu+"";
				document.form1.submit();
			}
			function query(){
				document.form1.action=path+"/web/sdttWeb/baobiaohuizong/dfcypldbg_2.jsp";
				document.form1.submit();
			}
		</script>
	</head>
							...
							<div class="content01_1">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb_list1">
									<tr align="center">
										...
										<th width="50">实际电费</th>
										<th width="50">定额电费</th>
										<th width="50">差异偏离度（实际电费-定额电费）/定额电费</th>
									</tr>
									<%
										...
										String allmoney = al.get(i).getAllmoney() != null ?al.get(i).getAllmoney():"";//实际电费
										String dedf = al.get(i).getDedf() != null ? al.get(i).getDedf():"";//定额电费
										String cypld = al.get(i).getCypld() != null ? al.get(i).getCypld():"";//差异偏离度（实际电费-定额电费）/定额电费
									...
									<tr align="center">
										...
										<td align="left"><%=dedf%></td>
										<td align="left"><%=cypld%></td>
									</tr>
									<%
									}
									 %>
