...
<%@ page import="com.noki.baobiaohuizong.bean.Ydxzzdslcx"%>
...
<%	
		...
		//数据遍历获取
		Ydxzzdslcx stl = new Ydxzzdslcx();//实体类
		BaoBiaoHuiZongDao dao = new BaoBiaoHuiZongDao();//DAO方法
		List<Ydxzzdslcx> al = new ArrayList<Ydxzzdslcx>();//泛型集合
		//获取共有几页
		allpage = dao.pagesYdxzzdslcx(shi,xian,xiaoqu); //共有几页
		...
		al = dao.queryYdxzzdslcx(curpage,shi,xian,xiaoqu);//根据条件获取要显示的内容 
...
<script type="text/javascript">
			...
			function previouspage() {
				...
				document.form1.action = path +
					"/web/sdttWeb/baobiaohuizong/ydxzzdslcx_7.jsp?rgsh=" + rgsh +
			...
			function daochu(){
				...
				var xian = '<%=xian%>';
				var xiaoqu = '<%=xiaoqu%>';
				document.form1.action=path+"/servlet/CbDownload?bz=ydxzzdslcx&shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu+"";
				document.form1.submit();
			}
			function query(){
				document.form1.action=path+"/web/sdttWeb/baobiaohuizong/ydxzzdslcx_7.jsp";
				document.form1.submit();
			}
		</script>
</head>
...
<body>
	<ul class="tab">
		<li class="first"></li>
		<li><a href="zdshl_6.jsp">自动审核率</a></li>
		<li class="cur"><a href="ydxzzdslcx_7.jsp">月度新增站点数量查询</a></li>
		<li><a href="ydxgdjcx_8.jsp">月度修改单价查询</a></li>
		<li><a href="ydshbtgzdcx_9.jsp">月度审核不通过站点查询</a></li>
		<li><a href="sjcqwbgzdtj_10.jsp">市级长期未报账站点统计</a></li>
		<li class="end"></li>
	</ul>
						...
						<div class="content01_1">
							<table width="800px" border="0" cellpadding="1" cellspacing="0"
								...
								<tr>
									...
									<td><input type="button" class="btn_c1" onclick="daochu()"
										value="导出Excel" /></td>
								</tr>
							</table>
							<div class="tbtitle01">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<%
										...
										//为null的话默认为空
										String cjtime = al.get(i).getCjtime()!= null ?al.get(i).getCjtime():"";//年月
										String shi_code = al.get(i).getShi()!= null ? al.get(i).getShi():"";//地市
										String xian_code = al.get(i).getXian()!= null ? al.get(i).getXian():"";//区县
										String xiaoqu_code = al.get(i).getXiaoqu() != null ? al.get(i).getXian():"";//乡镇
										String jzname = al.get(i).getJzname()!= null ? al.get(i).getJzname():"";//新增局站名称
										String jfdj = al.get(i).getJfdj()!= null ? al.get(i).getJfdj():"";//局站等级
										String stationtype = al.get(i).getStationtype()!= null ? al.get(i).getStationtype():"";//局站类型
										String zdcq = al.get(i).getZdcq()!= null ? al.get(i).getZdcq():"";//产权
										String longitude = al.get(i).getLongitude()!= null ? al.get(i).getLongitude():"";//经度
										String latitude = al.get(i).getLatitude()!= null ? al.get(i).getLatitude():"";//纬度
