							...
							<div class="content01_1">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb_list1">
									<tr align="center">
										...
										<th width="50">地市</th>
										<th width="50">区县</th>
										<th width="50">审核不通过站点总数</th>
										<th width="50">系统结算电表数</th>
										<th width="50">报账条数</th>
										<th width="50">报账率</th>
										<th width="50">自动审核不通过条数</th>
										<th width="50">自动审核不通过率</th>
										<th width="50">县区管理员审核不通过条数</th>
										<th width="50">县区管理员审核不通过率</th>
										<th width="50">县区主任审核不通过条数</th>
										<th width="50">县区主任审核不通过率</th>
										<th width="50">市级管理员审核不通过条数</th>
										<th width="50">市级管理员审核不通过率</th>
										<th width="50">市级主任审核不通过条数</th>
										<th width="50">市级主任审核不通过率</th>
										<th width="50">财务审核不通过条数</th>
										<th width="50">财务审核不通过率</th>
									</tr>
									<tr align="center">
										<td width="10">000</td>
