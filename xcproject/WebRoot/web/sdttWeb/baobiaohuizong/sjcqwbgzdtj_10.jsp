					...
					<td>
						<div class="content01">
							<div class="content01_1">
								...
								<div class="tbtitle01">
									<b>市级长期未报账站点统计？（3个月以上）:（年度包干电费除外）</b>
								</div>
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb_list1">
									<tr align="center">
										...
										<th width="50">地市</th>
										<th width="50">区县</th>
										<th width="50">启用站点数（个）</th>
										<th width="50">长期未报账站点数量（3个月以上）</th>
										<th width="50">未报账站占比（%）</th>
										<th width="50">长期未报账站点数量（12个月以上）</th>
										<th width="50">未报账站占比（%）</th>
									</tr>
									<tr align="center">
										<td width="10">000</td>
