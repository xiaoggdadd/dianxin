...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		int count = 0,curpage = 1,pagesize = 10,nextpage = 1, prepage = 1, allpage = 1, xh = 1;
 		...
 		//数据遍历获取
		Bqyjzpuemxb stl = new Bqyjzpuemxb();//实体类
		BaoBiaoHuiZongDao dao = new BaoBiaoHuiZongDao();//DAO方法
		List<Bqyjzpuemxb> al = new ArrayList<Bqyjzpuemxb>();//泛型集合
		//获取共有几页
		allpage = dao.pagesBqyjzpuemxb(shi,xian,xiaoqu); //共有几页
		...
		al = dao.queryBqyjzpuemxb(curpage,shi,xian,xiaoqu);//根据条件获取要显示的内容 
		...
		<script type="text/javascript">
			...
			function previouspage() {
				...
				document.form1.action = path +
					"/web/sdttWeb/baobiaohuizong/bqyjzpuemxb.jsp?rgsh=" + rgsh +
			...
			function daochu(){
				...
				var xian = '<%=xian%>';
				var xiaoqu = '<%=xiaoqu%>';
				document.form1.action=path+"/servlet/CbDownload?bz=bqyjzpuemxb&shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu+"";
				document.form1.submit();
			}
			function query(){
				document.form1.action=path+"/web/sdttWeb/baobiaohuizong/bqyjzpuemxb.jsp";
				document.form1.submit();
			}
		</script>
	</head>
							...
							<div class="content01_1">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb_list1">
									...
									<%
										...
										String costtime = al.get(i).getCosttime()!= null ? al.get(i).getCosttime():"";//月度
										String yuedu = al.get(i).getYuedu()!= null ? al.get(i).getYuedu():"";	//实际电量 
