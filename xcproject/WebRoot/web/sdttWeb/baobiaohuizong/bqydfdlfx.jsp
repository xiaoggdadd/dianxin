...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//数据遍历获取
		Bqydfdlfx stl = new Bqydfdlfx();				//实体类
		BaoBiaoHuiZongDao dao = new BaoBiaoHuiZongDao();//DAO方法
		List<Bqydfdlfx> al = new ArrayList<Bqydfdlfx>();//泛型集合
		//获取共有几页
		allpage = dao.pagesBqydfdlfx(shi,xian,xiaoqu); //共有几页
		...
		al = dao.queryBqydfdlfx(curpage,shi,xian,xiaoqu);//根据条件获取要显示的内容 
		...
		<script type="text/javascript">
			...
			function daochu(){
				...
				var xian = '<%=xian%>';
				var xiaoqu = '<%=xiaoqu%>';
				document.form1.action=path+"/servlet/CbDownload?bz=bqydfdlfx&shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu+"";
				document.form1.submit();
			}
			function query(){
				document.form1.action=path+"/web/sdttWeb/baobiaohuizong/bqydfdlfx.jsp";
				document.form1.submit();
			}
		</script>
	</head>
							...
							<div class="content01_1">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb_list1">
									<tr align="center">
										...
										<th width="50">月度/季度/年度</th>
										<th width="50">总缴纳金额</th>
										<th width="50">总缴费电量</th>
										<th width="50">电量偏离度</th>
									...
									<%
										...
										//为null的话默认为空
										String stationNo = al.get(i).getStation_no()!= null ? al.get(i).getStation_no():"";
										String jzname = al.get(i).getJzname()!= null ? al.get(i).getJzname():"";
										String shi_code = al.get(i).getShi()!= null ? al.get(i).getShi():"";
										String xian_code = al.get(i).getXian()!= null ? al.get(i).getXian():"";
										String xiaoqu_code = al.get(i).getXiaoqu()!= null ? al.get(i).getXiaoqu():"";
										String issupervisor = al.get(i).getIssupervisor()!= null ? al.get(i).getIssupervisor():"";
										String housetype_name = al.get(i).getHousetype_name()!= null ? al.get(i).getHousetype_name():"";
										String rjydl = al.get(i).getRjydl()!= null ? al.get(i).getRjydl():"";
										String costtime = al.get(i).getCosttime()!= null ? al.get(i).getCosttime():"";
										String allmoney = al.get(i).getAllmoney()!= null ? al.get(i).getAllmoney():"";
										String dianliang = al.get(i).getDianliang()!= null ? al.get(i).getDianliang():"";
										String dlpls = al.get(i).getDlpls()!= null ? al.get(i).getDlpls():""; //电量偏离度
										String pjfzzdl = al.get(i).getPjfzzdl()!= null ? al.get(i).getPjfzzdl():"";
										String bzr = al.get(i).getBzr()!= null ? al.get(i).getBzr():"";
										String memo = al.get(i).getMemo()!= null ? al.get(i).getMemo():"";
										//修改是否监控显示
										...
										//将电量偏离度改为百分比显示
										double a = Double.parseDouble(dlpls);
										DecimalFormat df = new DecimalFormat("0.00"); 
										dlpls = df.format(a);  //这个是字符串，但已经是我要的两位小数了  
									 %>
									<tr align="center">
