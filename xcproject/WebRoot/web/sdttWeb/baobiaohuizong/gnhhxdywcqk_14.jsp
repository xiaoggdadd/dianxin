...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<ul class="tab">
			<li class="first"></li>
			<li>
				<a href="dfcbzdtj_11.jsp">电费超标站点统计</a>
			</li>
			<li>
				<a href="qxdffxtb_12.jsp">区县电费分析通报</a>
			</li>
			<li>
				<a href="qxdlfxtb_13.jsp">区县电量分析通报</a>
			</li>
			<li class="cur">
				<a href="gnhhxdywcqk_14.jsp">各能耗划小单元完成情况</a>
			</li>
			<li class="end"></li>
		</ul>
							...
							<div class="content01_1">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb_list1">
									<tr align="center">
										...
										<th width="50">区县</th>
										<th width="50">电表总数</th>
										<th width="50">划小电表数</th>
										<th width="50">划小单元月度能耗T0（万元）</th>
										<th width="50">划小单元月度能耗T1（万元）</th>
										<th width="50">划小单元月度能耗实际完成数（万元）</th>
										<th width="50">划小单元完成进度</th>
									</tr>
									<tr align="center">
										<td width="10">000</td>
