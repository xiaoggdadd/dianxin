...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//数据遍历获取
		Idcjljqtlxdfbb stl = new Idcjljqtlxdfbb();//实体类
		BaoBiaoHuiZongDao dao = new BaoBiaoHuiZongDao();//DAO方法
		List<Idcjljqtlxdfbb> al = new ArrayList<Idcjljqtlxdfbb>();//泛型集合
		//获取共有几页
		allpage = dao.pagesIdcjljqtlxdfbb(shi,xian,xiaoqu); //共有几页
		...
		al = dao.queryIdcjljqtlxdfbb(curpage,shi,xian,xiaoqu);//根据条件获取要显示的内容 
		...
		<script type="text/javascript">
			...
			function previouspage() {
				...
				document.form1.action = path +
					"/web/sdttWeb/baobiaohuizong/idcjljqtlxdfbb_3.jsp?rgsh=" + rgsh +
			...
			function daochu(){
				...
				var xian = '<%=xian%>';
				var xiaoqu = '<%=xiaoqu%>';
				document.form1.action=path+"/servlet/CbDownload?bz=idcjljqtlxdfbb&shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu+"";
				document.form1.submit();
			}
			function query(){
				document.form1.action=path+"/web/sdttWeb/baobiaohuizong/idcjljqtlxdfbb_3.jsp";
				document.form1.submit();
			}
		</script>
	</head>
	...
	<body>
		<ul class="tab">
			<li class="first"></li>
			<li>
				<a href="zhdjbb_1.jsp">综合单价报表</a>
			</li>
			<li>
				<a href="dfcypldbg_2.jsp">电费差异偏离度报告</a>
			</li>
			<li class="cur">
				<a href="idcjljqtlxdfbb_3.jsp">IDC机楼及其它类型电费报表</a>
			</li>
			<li>
				<a href="bdsyswcjdbb_4.jsp">本地市预算完成进度报表</a>
			</li>
			<li>
				<a href="bsdpjpuebb_5.jsp">本地市平均PUE报表</a>
			</li>
			<li class="end"></li>
		</ul>
							...
							<div class="content01_1">
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb_list1">
									...
									<%
										...
										String dbname = al.get(i).getDbname() != null ? al.get(i).getDbname():"";//站点名称
										String dianliang = al.get(i).getDianliang() != null ? al.get(i).getDianliang():"";//用电量
										String allmoney = al.get(i).getAllmoney()  != null ? al.get(i).getAllmoney():"";//电费
										String price = al.get(i).getPrice()  != null ? al.get(i).getPrice():"";//单价
										String jztype = al.get(i).getJztype()  != null ? al.get(i).getJztype():"";//局站类型
										...
										//单价精确到小数点后两位
										double d = Double.parseDouble(price);// 这个是转为double类型  
										DecimalFormat df = new DecimalFormat("0.0000");   
										price = df.format(d);  //这个是字符串，但已经是我要的两位小数了  
									 %>
									<tr align="center">
