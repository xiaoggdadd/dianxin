...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//数据遍历获取
		Bqyyswcjd stl = new Bqyyswcjd();//实体类
		BaoBiaoHuiZongDao dao = new BaoBiaoHuiZongDao();//DAO方法
		List<Bqyyswcjd> al = new ArrayList<Bqyyswcjd>();//泛型集合
		//获取共有几页
		allpage = dao.pagesBqyyswcjd(shi,xian,xiaoqu); //共有几页
		...
		al = dao.queryBqyyswcjd(curpage,shi,xian,xiaoqu);//根据条件获取要显示的内容 
		...
		<script type="text/javascript">
			...
			function previouspage() {
				...
				document.form1.action = path +
					"/web/sdttWeb/baobiaohuizong/bqyyswcjd.jsp?rgsh=" + rgsh +
			...
			function daochu(){
				...
				var xian = '<%=xian%>';
				var xiaoqu = '<%=xiaoqu%>';
				document.form1.action=path+"/servlet/CbDownload?bz=bqyyswcjd&shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu+"";
				document.form1.submit();
			}
			function query(){
				document.form1.action=path+"/web/sdttWeb/baobiaohuizong/bqyyswcjd.jsp";
				document.form1.submit();
			}
		</script>
	</head>
