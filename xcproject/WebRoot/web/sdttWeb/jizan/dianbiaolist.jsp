					...
					<div class="tbtitle01"><b>电表查询统计一览</b></div>
						<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="tb_list1" >
									...
									<tr align="center">
										...
										<th width="80">电表用途</th>
										<th width="80">电费支付类型</th>
										<th width="80">初始读数</th>
										<th width="80">初始使用时间</th>
										<th width="80">倍率</th>
										<th>操作</th>
									</tr>
      <%
       ...
       %>
									...
									<tr align="center">
										...
										<td align="left"><%=zdname%></td>
										<td align="left"><%=area%></td>
										<td align="center"><%=dbyt3%></td>
										<td align="center"><%=dfzflx2%></td>
										<td align="center"><%=csds%></td>
										<td align="center"><%=cssytime%></td>
										<td align="center"><%=beilv%></td>
										<td width="80">
											<a href="#" onclick="xiangxi('<%=id%>')"><img src="../images/lefticon3.png" width="16" height="16"  title="详细" /></a>
											<a href="#" onclick="update('<%=id%>','<%=zdid%>')"><img src="../images/accept.png" width="16" height="16"  title="修改" /></a>
...
<script>
    ...
    function xiangxi(id){
     	  window.open("../jizan/dbxxquery.jsp?id="+id, "newwindow", "height=500, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");  
     	
     }	
    function update(id,zdid){
     		//window.open("../jizan/modifydianbiao.jsp?id="+id+"&zdid="+zdid, "newwindow", "height=500, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");  
     		window.open("../jizan/UpdateDianbiao.jsp?id="+id+"&zdid="+zdid, "newwindow", "height=500, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");  
      		document.form1.submit();
    }
...
function addjz(){
	window.open("../jizan/adddianbiao.jsp", "newwindow", "height=500, width=1200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");  
}

function query(){
	document.form1.action=path+"/web/sdttWeb/jizan/dianbiaolist.jsp";
}
