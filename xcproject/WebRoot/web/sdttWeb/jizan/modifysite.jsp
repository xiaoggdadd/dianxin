...
<body  class="body" style="overflow-x:hidden;">
	<form action="" name="form1" method="POST" id="form">
      ...
      <tr class="form_label">
		...
		<% }else {%>
         	...
         	</select></span><span class="style1">&nbsp;*</span>
         	</td>
		<%} %>
		...
		<tr class="form_label">
         ...
         <td width="25%">
      	<select name="gdfs" class="selected_font" title="必填项，根据下拉值选择填写">
             ...
             <td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">站点编码：</div></td>     
       <td width="25%"><input type="text" name="jzcode" value="<%=form.getJzcode() %>" class="selected_font" /><span class="style1">&nbsp;*</span></td>
       ...
       <tr class="form_label">
       		<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">经度：</div> </td>   
       <td width="25%"><input type="text" name="jingdu" value="<%=form.getLongitude()%>" class="selected_font" /><span class="style1">&nbsp;*</span></td>
		<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">纬度：</div>     
       <td width="25%"><input type="text" name="weidu" value="<%=form.getLatitude() %>" class="selected_font" /><span class="style1">&nbsp;*</span></td>	
		 	<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">房屋类型：</div>
         </td>
      ...
      <tr class="form_label">
       <td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">原产权方：</div> </td>    
          <td width="25%">
        ...
        <td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">物理站点编码：</div></td>     
       <td width="25%"><input type="text" name="wlzdbm" value="<%=wlzdbm%>" class="selected_font" /></td>
      <td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">站址类型：</div> </td>    
          <td width="25%">
      ...
      <tr class="form_label">
	 	<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">对应联通区县：</div>     
       <td width="25%"><input type="text" name="ltqx" value="<%=ltqx%>" class="selected_font" /></td>
	 	<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">对应移动区县：</div>  </td>   
       <td width="25%"><input type="text" name="ydqx" value="<%=ydqz%>" class="selected_font" /></td>
	 	<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">联通能耗系统ID：</div> </td>    
       <td width="25%"><input type="text" name="xtid" value="<%=nhxtid%>" class="selected_font" /></td>	
     ...
     <td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">站点地址：</div>
         ...
         <%}else{ %>
       		<input readonly="readonly" type="text" name="area" value="<%=area%>" class="selected_font" title="选填项，根据站点所在地的具体面积填写 单位：平方米"/>
         <% }%>
       </td>
       <td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">负责人联系方式：</div>     
       <td width="25%"><input type="text" name="phone" value="<%=fzrphone%>" class="selected_font"/></td>
      </tr>
	...
	<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">部门：</div></td>     
       <td width="25%"><input type="text" name="bumen" value="<%=bm%>" class="selected_font"/></td>
...
alert(document.form1.shi.value);
