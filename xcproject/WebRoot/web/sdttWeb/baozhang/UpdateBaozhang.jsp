...
<%
	...
	sql.append("SELECT d.CSDS,d.ydsx,d.CSSYTIME,to_char(d.ZZSL,'fm9999999990.00') ZZSL,B.STARTTIME_C,B.EAO_C,B.ENDTIME_C, B.SQDS_C,B.BQDS_C, B.DIANLIANG_C,B.DAYNUM_C,B.RJYDL_C, B.DLPLS, B.RQPLS, B.ELECTRICFEE_ID ID,B.DIANBIAOID DIANBIAOID," +
			...
			"d.ELECTRIC_SUPPLY_WAY FANGSHI,D.DBBM,(select i.name from indexs i where i.type='ydsx' and i.code=d.ydsx) YDSX, (select t.name from indexs t where t.code=d.ELECTRIC_SUPPLY_WAY and t.type='GDFS') as FANGSHINAME,b.PUEZHI PUEZHI,b.DBIMAGEPATH1 DBIMAGEPATH1,B.BGDL BGDL ,d.hzstate hzstate,d.MAXDS MAXDS  " +
	...
	System.out.println("查看报账sql："+sql);
 	...
 	while(rs.next()){
		//2018年3月19日-gcl
 		...
 		DBBM=rs.getString("DBBM")==null?"":rs.getString("DBBM");//电表编码YDSX
					 ...
					 <tr>
						   ...
						   <td width="100px"><input type="text" name="FANGSHINAME" id="FANGSHINAME" disabled="disabled" value="<%=FANGSHINAME %>"
						    ...
						    <td align="right" width="100px">
						   	...
						   	<td width="100px"><input type="text" name="DBBM"
										id="DBBM" disabled="disabled" value="<%=DBBM %>"
					    ...
					    <tr>
					   	 <td align="right" width="100px">电费标杆</td>
					 		<td>
					 		<input type="text" name="BGDL" id="BGDL"  readonly="readonly"   value="<%=BGDL %>" style="box-sizing:border-box;width:130px" title="必填项" maxlength="30"/>
							</td>
