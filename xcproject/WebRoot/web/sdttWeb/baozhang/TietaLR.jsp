...
<%
	...
	String XIANCODE="",FTBL="",SFYZ="",BZQJ="",FTJE="",ydsx="";
	DataBase db = new DataBase();
	StringBuffer sql = new StringBuffer();
	ResultSet rs = null;
	sql.append("SELECT d.SFYZ,d.ydsx,d.FTBL,b.CREATEDATE,b.FTJE,d.CSDS,d.CSSYTIME,to_char(d.ZZSL,'fm9999999990.00') ZZSL,B.STARTTIME_C,B.EAO_C,B.ENDTIME_C, B.SQDS_C,B.BQDS_C, B.DIANLIANG_C,B.DAYNUM_C,B.RJYDL_C, B.DLPLS, B.RQPLS, B.ELECTRICFEE_ID ID,B.DIANBIAOID DIANBIAOID," +
			...
			"d.ELECTRIC_SUPPLY_WAY FANGSHI, (select t.name from indexs t where t.code=d.ELECTRIC_SUPPLY_WAY and t.type='GDFS') as FANGSHINAME,b.PUEZHI PUEZHI,b.DBIMAGEPATH1 DBIMAGEPATH1,B.BGDL BGDL " +
					...
					<table style="width: 100%;"  border="0" id="tableStr"  cellpadding="0" cellspacing="0" class="tb_select" >
					 ...
					 <tr>
						...
						value="<%=STARTTIMEStr_C%>" />
					 	...
					 	<td onclick="endtime_c()"><input type="text" onchange="changeSJ()" style="box-sizing:border-box;width:130px" class="Wdate" name="ENDTIME_C" id="ENDTIME_C" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"
						<%
				 			if(ENDTIMEStr_C!=""){
				 		 %>
				 		 disabled="disabled" 
					    ...
					    <tr>
					 	...
					 	<td>
					 		<input type="text" name="FTJE" id="FTJEFTJE" disabled="disabled"  value="<%=FTJE %>" style="box-sizing:border-box;width:130px" title="必填项" maxlength="30"/>
						</td>
						...
						<%--
					 	...
					 	<tr>
							<td align="left" colspan="6" height="60px">
							 	<font style="color: rgb(74, 210, 255);"> 
							 	※普通表(非直供电):总金额-((截止度数-起始度数)*倍率*单价)=电损金额 </font><br /><table cellspacing="0" cellpadding="0" border="0" style="width: 100%;" id="tableStr" class="tb_select"><tr><tr><td width="100" colspan="8"> 
										<br /></td></tr></tr></table><font style="color: rgb(74, 210, 255);"> 
