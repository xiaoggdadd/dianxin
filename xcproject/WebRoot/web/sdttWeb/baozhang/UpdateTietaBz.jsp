...
<%
	...
	ResultSet rs = null;
	sql.append("SELECT d.SFYZ,d.FTBL,d.ydsx,b.CREATEDATE,b.FTJE,d.CSDS,d.CSSYTIME,to_char(d.ZZSL,'fm9999999990.00') ZZSL,B.STARTTIME_C,B.EAO_C,B.ENDTIME_C, B.SQDS_C,B.BQDS_C, B.DIANLIANG_C,B.DAYNUM_C,B.RJYDL_C, B.DLPLS, B.RQPLS, B.ELECTRICFEE_ID ID,B.DIANBIAOID DIANBIAOID," +
