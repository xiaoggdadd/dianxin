		...
		function ShowHideSearchRegion(trObject,SelfObject)
{
	...
	function baocun(){
		 var flowType = document.form1.flowType.value;//流程类型
        ...
        if(flowName.length > 10){
        	alert("步骤名称长度不大于10个汉字的长度！");
                 document.form1.flowName.focus();
                 return
        }
        if(flowType==""){
         	alert("请选择流程类型！");
                 document.form1.flowType.focus();
                 return
        }
         if(confirm("你将要添加一个新流程？确定？")){
           document.form1.action=path+"/servlet/flow?action=add";
							...
							<td width="4"></td>
									...
									<table width="100%" border="0" align="right" cellpadding="1" cellspacing="1" >
										<tr>
										  <td height="49" bgcolor="#FFFFFF">										  <table width="80%" border="0" cellspacing="1" cellpadding="1" align="center">
                                            <tr>
                                              <td width="30%" bgcolor="#DDDDDD" align="center">新流程名称：</td>
                                              <td width="70%">
                                                <input type="text" name="flowName" value=""  class="form" style="width:130"/>
							 ...
							 <td width="30%" bgcolor="#DDDDDD" align="center">
										...
										<td width="100px">
                                            ...
                                            <tr>
                                              <td width="30%" bgcolor="#DDDDDD" align="center">流程说明：</td>
                                              <td width="70%">
                                                <input type="text" name="flowDesc" value=""  class="form"  style="width:130"/>
                                              </td>
