						...
						<div class="content01_1">
							<table width="800px" border="0" cellpadding="1" cellspacing="0"
								...
								<tr>
									...
									<td align="left" width="60px"><select name="shi" id="shi"
											...
											<%
																																	...
																																	String agcode =null;
																															         				for (int i = 0; i < fylist.size(); i++) {
																															         			 	agcode = fylist.get(i).getPARTYA();
											%>
											<option value="<%=agcode%>"><%=agcode%></option>
											<%
												}
											%>
									</select>
									...
									<td align="left" width="60px"><select name="xian"
										id="xian" style="width:80px;" onchange="changeCountry()"
										class="selected_font">
											<option value="0">请选择</option>
											<%
												String PARTYB=null;
																					for (int i = 0; i < fylist.size(); i++) {
																				    PARTYB=fylist.get(i).getPARTYB();
											%>
									...
									<td align="left" width="60px"><select name="xiaoqu"
										id="xiaoqu" style="width:120px;" class="selected_font">
											<option value="0">请选择</option>
											<%
												String CONTRACTNAME;
																					for (int i = 0; i < fylist.size() ; i++) {
																															         			CONTRACTNAME= 	fylist.get(i).getCONTRACTNAME();
											%>
									...
									<td align="left" width="60px"><input type="text"
										name="txtKeyword" id="txtKeyword" value="" style="width:80px" />
									</td>

								</tr>
								<tr>
									<td align="left" colspan="8">※关键字只包括：项目的金额</td>
								</tr>
								<tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									DecimalFormat df1 = new DecimalFormat("0.00");
																											...
																											if (fylist != null) {
																												...
																												for (int k = 0; k < fylist.size(); k++) {
																													int xuhao = k+1;
																													String st = fylist.get(k).getSTARTTIME();
																													String et = fylist.get(k).getENDTIME();
																													String pa = fylist.get(k).getPARTYA();
																													String pb = fylist.get(k).getPARTYB();
																													String cn = fylist.get(k).getCONTRACTNAME();
																													String je = fylist.get(k).getPROJECTAMONNT();
								...
								<tr align="center">
									...
									<td width="80"><a href="#" onclick="update('<%=id%>')"><img
											src="../images/accept.png" width="16" height="16" title="修改" />
									</a> <a href="#" onclick="delzd('<%=id%>')"><img
