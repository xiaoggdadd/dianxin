...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<![endif]-->
		...
		<link href="<%=path %>/web/sdttWeb/jizan/select2/select2-3.4.0/select2.css" rel="stylesheet" type="text/css" />
		
		
		<script src="<%=path %>/web/sdttWeb/jizan/select2/select2-3.4.0/select2.min.js"></script>
		<script src="<%=path %>/web/sdttWeb/jizan/select2/select2-3.4.0/select2_locale_zh-CN.js"></script>
		<%
			if (!"1".equals(bz)) {
		%>
		<title>新增电表信息</title>
...
function saveAccount() {
	...
	var jiaoliu_prop=document.form1.jiaoliu.value;//交流占比
	var zhiliu_prop=document.form1.zhiliu.value;//直流占比
	...
	var ssf=document.form1.ssf.value;//用电属性
	...
	checkNotSelected(document.form1.ssf,"所属方")&&
	...
	checkNotnull(document.form1.zrr,"责任人")&&
	checkNotnull(document.form1.bzr,"报账人")&&	
	...
	checkNotnull(document.form1.cbzx,"区县分公司")&&
	checkNotnull(document.form1.cbzxbm,"成本中心编码")&&
...
function saveAccountssf() {
	...
	var dan=document.form1.dj.value;
	var zz=document.form1.sl.value;
	var ssf=document.form1.ssf.value;
	var yh=document.form1.yhzh.value;
	var bur_stand_propertion=document.form1.bur_stand_propertion.value;
	var zt=document.form1.dbqyzt.value;
	var dfzflx=document.form1.dfzflx.value;
	...
	var dbyt=document.form1.dbyt.value;//电表用途
	var ydsx=document.form1.ydsx.value;//用电属性
	var ftbl=document.form1.ftbl.value;
	var sfyz=document.form1.sfyz.value;
	var sfyz=document.form1.ssf.value;//所属方
	...
	checkNotSelected(document.form1.electric_supply_way,"供电方式")&&
	checkNotSelected(document.form1.dbyt,"电表用途")&&
	checkNotnull(document.form1.ftbl,"分摊比例")&&
	checkNotnull(document.form1.sfyz,"税赋因子")
	){
	if(zt!=null&&zt!=""){
	if(zt=="0"){
	alert("请选择状态!");
									         ...
									         <span style="color: #FF0000; font-weight: bold">*</span>
									            ...
									            <td>
									           		<select name="projectCode" style="box-sizing: border-box; width: 130px">
														<option value="CW1000">能源费</option>
														<%-- <%
															ArrayList projectlist = new ArrayList();
															projectlist = commBean.getBudgetProject();
															if (projectlist != null) {
			 	...
			 	<%
									...
									<tr>
										<td align="right" colspan="8" height="60px">
												...
												%>
											<input type="button" class="btn_c1" id="" value="附件管理" onclick="fujianguanli('<%=id%>')" />
											<%
												}
											%>
											<!--<input name="button2" type="submit" class="btn_c1" id="button2" value="临时保存" />&nbsp;  -->
											<%if(ssf.equals("1")){ %>
											<input onclick="saveAccountssf()" type="button" class="btn_c1"
												id="buttonaa" value="保存" />
												<%}else if(ssf.equals("2")){ %>
...
function ssfo() {
	...
	if(ssf=="1"){
	var curObj=document.getElementById("buttonaa");  
        curObj.onclick=saveAccountssf;  
			$("#sa3").hide();
			$("#sa4").hide();
			$("#sa5").hide();
			$("#sa6").hide();
