...
<c:forEach items="${list}"  var="list" varStatus="status">
 ...
 <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.area}</td>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.payoperator}</td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num>&nbsp;${list.paydatetime}</td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.zdcode}</td>
 </tr>
</c:forEach>         
  <tr> 
  	<td colspan="10">
