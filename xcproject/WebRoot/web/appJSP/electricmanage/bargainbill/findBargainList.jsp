...
<%@ page import="com.noki.util.CTime,com.noki.electricfees.javabean.ElectricFeesBean,com.noki.mobi.common.CommonBean" %>
...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
    ...
    function queryDegree(){
                   ...
                   document.form1.action=path+"/web/appJSP/electricmanage/bargainbill/findBargainList.jsp";
                   document.form1.submit();
...
<form action="" name="form1" method="POST">
    ...
    <td valign="top">
		<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="form_label">
				...
				<tr>
                      <td>
							<div style="width:700px;height:50px">
									...
									<span style="font-size:14px;font-weight:bold;position: absolute;left:35px;top:30px;color:black">电表信息</span>	
							</div>
					   </td>
                      </tr>
                      <tr>                        
         ...
         <td height="8%" width="1000">
             城市：             
         <select name="shi" class="form" onchange="changeCity()">
         ...
         <select name="xian" class="form" onchange="changeCountry()"> 
         		<option value="0">请选择</option>
         		<%
         ...
         乡镇：      
         <select name="xiaoqu" class="form" onchange="javascript:document.form1.xiaoqu2.value=document.form1.xiaoqu.value">
         		<option value="0">请选择</option>
         		<%
        ...
        站点名称：
         <input type="text" name="zdbh" value="<%if(null!=request.getParameter("zdbh")) out.print(request.getParameter("zdbh")); %>" class="form"/>
         </td>
        <td>
      ...
      <tr bgcolor="F9F9F9">
                      <td height="19" colspan="4"><div id="parent" style="display:inline">
                          <div style="width:50px;display:inline;"><hr></div><font size="2">&nbsp;信息列表&nbsp;<div style="width:300px;display:inline;"><hr></div>
                      </div></td>
      </tr>
  </table>

  	<div style="width:99%;height:300px;overflow-x:auto;overflow-y:auto;border:1px" > 
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
                      ...
                      <tr  height = "20" class="form_label">
                        ...
                        <td width="15%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">地区</div></td>
            			...
            			<td width="10%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">电表用途</div></td>
            			<td width="8%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">初始读数</div></td>
            			<td width="10%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">初始使用时间</div></td>
                        <td width="8%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">倍率</div></td>
                        <td width="10%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">电表型号</div></td>
       ...
       <%
         ...
         String whereStr = "";
			...
			if(beginTimeQ != null && beginTimeQ != "" && !beginTimeQ.equals("0")){
				whereStr=whereStr+" and to_char(am.initialdate,'yyyy-mm-dd')>='"+beginTimeQ+"'";
			}
			if(endTimeQ != null && endTimeQ != "" && !endTimeQ.equals("0")){
				whereStr=whereStr+" and to_char(am.initialdate,'yyyy-mm-dd')<='"+endTimeQ+"'";
			}
         ...
         ElectricFeesBean bean = new ElectricFeesBean();
       	 ...
       	 fylist = bean.getPageDataAmmeter11(curpage,whereStr,loginId);
       ...
       <tr bgcolor="#ffffff" onMouseOut="this.style.backgroundColor=''" onMouseOver="this.style.backgroundColor='#BFDFFF'" >
            ...
            &nbsp;&nbsp;
						<select name="page" style="width:70px;font-family: 宋体;font-size:12px;line-height:120%;" onChange="javascript:gopagebyno(document.form1.page.value)"  >
  ...
  <tr>
    ...
    <td><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" >
         ...
         <div id="cancelBtn" style="width: 60px; height: 23px; cursor: pointer; float: right; position: relative; right: 20px">
			...
			<div id="queding"
				style="position: relative; width: 63px; height: 23px; cursor: pointer; float: right; right:25px">
				<img alt=""
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/appJSP/electricmanage/bargainbill/bargainListShow.jsp?curpage="+curpage+"<%=canshuStr%>";
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/appJSP/electricmanage/bargainbill/bargainListShow.jsp?curpage="+pageno+"<%=canshuStr%>";
      document.form1.submit();
     }
     ...
     function queding(){
       if(document.getElementById("ammeterid").value==undefined){
         ...
         window.opener.document.form1.action=path+"/web/appJSP/electricmanage/bargainbill/addBargainBillAll.jsp?ammeterid="+document.getElementById("ammeterid").value;
