...
<%
	...
	if (dbili1 == null || dbili1.equals("null") || dbili1.equals("")
			|| dbili1 == "") {
		dbili1 = "0";
	}
	if (dbili2 == null || dbili2.equals("null") || dbili2.equals("")
			|| dbili2 == "") {
		dbili2 = "0";
	}
	if (dbili3 == null || dbili3.equals("null") || dbili3.equals("")
			|| dbili3 == "") {
		dbili3 = "0";
	}
	if (dbili4 == null || dbili4.equals("null") || dbili4.equals("")
			|| dbili4 == "") {
		dbili4 = "0";
	}
	if (dbili5 == null || dbili5.equals("null") || dbili5.equals("")
			|| dbili5 == "") {
		dbili5 = "0";
	}
	if (dbili6 == null || dbili6.equals("null") || dbili6.equals("")
			|| dbili6 == "") {
		dbili6 = "0";
	}
	double hj = 0.0;
	...
	hj = Double.parseDouble(dbili1) + Double.parseDouble(dbili2)
			+ Double.parseDouble(dbili3) + Double.parseDouble(dbili4)
			+ Double.parseDouble(dbili5) + Double.parseDouble(dbili6);
	...
	if (listtxjbl != null) {
		...
		for (int kk = fycountxjbl; kk < listtxjbl.size() - 1; kk += fycountxjbl) {
			...
			if ("".equals(dbili9) || "".equals(sszy) || "".equals(kjkm)
					|| "".equals(qcb) || "".equals(zymx)
					|| "".equals(xjbl)) {
				bzw9 = "0";
			}
		}
											...
											if (isNaN(std) == false) {
												if (confirm("您将要添加信息！确认信息正确！")) {
													document.form1.action = path
															+ "/servlet/AddBargainServlet?action=add";
...
function isDate(str) {
	...
	if (reg.test(str)) {
        ...
        function fanhui(){        
               document.form1.action=path+"/web/appJSP/electricmanage/bargainbill/addBargainBill.jsp";
               document.form1.submit();
        }
											...
											<td colspan="4" width="50">
												<div style="width: 700px;">
													<img alt="" src="<%=path%>/images/btt.bmp" width="100%"
														height="100%" />
													<span
														style="font-size: 14px; font-weight: bold; position: absolute; left: 25px; top: 18px; color: black">添加合同单</span>
														...
														<td height="49" bgcolor="#FFFFFF">
															<table width="100%" border="0" cellspacing="1"
																...
																<%
																	...
																	//	bbc = bean.getCount(ammeterid);
																	//	request.setAttribute("couBean", bbc);

																		bean = bean.getAmmeterDegreeAllInfoa(ammeterid);//2014-11-13 加a
																		...
																		String area = bean.getProvinceid() + " " + bean.getCityid()
																				+ " " + bean.getCountryid();
																		area = area != null ? area : "";
																		...
																		if (dianfei == null || dianfei.equals("")
																				|| dianfei.equals("null") || dianfei.equals("o")) {
																			dianfei = "0.0000";
																		}
																...
																<tr>
																	<td>
																		<input type="hidden" name="lastad"
																			value="<%=lastad%>" class="form" />
																		<input type="hidden" name="lastadtime1"
																			value="<%=lastadtime1%>" class="form" />
																		<input type="hidden" name="stationid"
																			value="<%=bean.getStationid()%>" class="form" />
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<input type="text" name="stationtypeid"
																			readonly="readonly"
																			value="<%=bean.getStationtypeid()%>"
																			class="selected_font1" maxlength="11" />
																	</td>
																</tr>
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="area" readonly="readonly"
																			value="<%=area%>" class="selected_font1" />
																	</td>
																	<td height="19" bgcolor="#DDDDDD">
																		<div>
																			站点别名：
																	...
																	<td>
																		<input type="text" name="stationaliasname"
																			readonly="readonly"
																			value="<%=bean.getStationaliasname()%>"
																			class="selected_font1" maxlength="11" />
																	</td>
																</tr>
																<tr>
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="isbenchmarkstation"
																			readonly="readonly"
																			value="<%=bean.getIsbenchmarkstation()%>"
																			class="selected_font1" />
																	</td>
																	<td height="19" bgcolor="#DDDDDD" width="15%">
																		<div>
																	...
																	<td width="35%">
																		<input type="text" name="htbianhao" id="htbianhao"
																			class="selected_font" />
																...
																<tr>
																	...
																	<td width="35%">
																		<input type="text" name="ammeteridFk"
																			readonly="readonly" value="<%=bean.getAmmeterid()%>"
																			class="selected_font1" />
																		&nbsp;
																		<span class="style1">*</span>
																		<img id="liulan" alt="浏览"
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="dbyt" readonly="readonly"
																			value="<%=bean.getAmmeteruse()%>"
																			class="selected_font1" maxlength="11" />
																	</td>
																	<td height="8%" bgcolor="#DDDDDD" width="15%">
																		<div>
																	...
																	<td>
																		<input type="text" name="currenttype"
																			readonly="readonly"
																			value="<%=bean.getElectriccurrenttype_ammeter()%>"
																			class="selected_font1" maxlength="11" />
																	</td>
																</tr>
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="danjia" id="danjia"
																			...
																			class="selected_font2" maxlength="11" />
																	</td>
																	<td height="19" bgcolor="#DDDDDD" width="15%">
																		<div>
																			金额：
																	...
																	<td width="35%">
																		<input type="text" name="money" value=""
																			onblur="getdl(this.value,'danjia','dl');getShengDB('dl','csdb','csb','startmonth','endmonth','qsdbdl','edhdl')" onchange="getHaodianliang()"
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="ydsb" readonly="readonly"
																			value="<%=bean.getUsageofelectypeid_ammeter()%>"
																			class="selected_font1" maxlength="11" />
																	</td>
																	<td height="19" bgcolor="#DDDDDD">
																		<div>
																	...
																	<td>
																		<input type="text" name="pjje"
																			value="<%=request.getParameter("money") != null ? request
						.getParameter("pjje") : ""%>"
																			class="selected_font3" />
																		<span style="color: #FF0000; font-weight: bold">&nbsp;*</span>
																	</td>
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="dl" id="dl" onpropertychange="getCsdb()"
																			readonly="readonly" value="0" class="selected_font1"
																			maxlength="11" />
																	</td>
																	<td height="8%" bgcolor="#DDDDDD" width="15%">
																		<div>
																	...
																	<td>
																		<input type="text" name="scb1" id="scb1"
																			readonly="readonly" value="<%=scb%>"
																			class="selected_font2" maxlength="11" />
																	</td>
																</tr>
																<tr>
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="endmonth" value="" id="endmonth"
																			onchange="getShengDB('dl','csdb','csb','startmonth','endmonth','qsdbdl','edhdl')"
																			onpropertychange="getCsdb()"
																			onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM'})"
																			class="selected_font" />
																...
																<tr>
																	...
																	<td>
																	<input type="text" name="csdbdiv" id="csdbdiv"  value=""
																			readonly="readonly" class="selected_font" />
																		<input type="hidden" name="csdb" id="csdb"  value=""
																			readonly="readonly" class="selected_font" />
																	</td>
																	<td height="19" bgcolor="#DDDDDD">
																		<div>
																	...
																	<td>
																		<input type="text" name="csb" id="csb" value=""
																			readonly="readonly" class="selected_font" />
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="dfzflx"
																			value="<%=bean.getDfzflx()%>" class="selected_font"
																			readonly="readonly" />
																	</td>
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="jszq" value="0" id = "jszq"
																			readonly="readonly"
																			class="selected_font" />
																	</td>
																</tr>
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="networkdf" value=""
																			class="selected_font3" />
																	</td>
																	<td height="19" bgcolor="#DDDDDD">
																		<div>
																	...
																	<td>
																		<input type="text" name="administrativedf" value=""
																			class="selected_font3" />
																	</td>
																</tr>
																<tr>
																	...
																	<td>
																		<input type="text" name="marketdf" value=""
																			class="selected_font3" />
																	</td>
																	<td height="19" bgcolor="#DDDDDD">
																		<div>
																	...
																	<td>
																		<input type="text" name="informatizationdf" value=""
																			class="selected_font3" />
																	</td>
																...
																<tr>
																	...
																	<td>
																		<input type="text" name="builddf" value=""
																			class="selected_font3" />
																	</td>
																	<td height="19" bgcolor="#DDDDDD">
																		<div>
																	...
																	<td>
																		<input type="text" name="dddf" value=""
																			class="selected_font3" />
																	</td>
																	<td>
																...
																<tr>
																	<td colspan=4">
																		<div id="cancelBtn1"
																			style="width: 60px; height: 23px; cursor: pointer; float: right; position: relative; right: 250px; top: 10px;">
																		...
																		<div id="resetBtn"
																			style="width: 60px; height: 23px; cursor: pointer; float: right; position: relative; right: 260px; top: 10px;">
																		...
																		<div id="saveBtn"
																			style="width: 60px; height: 23px; cursor: pointer; float: right; position: relative; right: 270px; top: 10px;">
