...
function daoru(){
	...
	document.form1.action=path+"/servlet/BargainBillInputServlet";
...
function exportModel(){
            ...
            document.form1.action=path+"/servlet/download?action=downloadhtd&templetname="+encodeURIComponent("合同单批量导入模版");
            document.form1.submit();
   }
 $(function(){
