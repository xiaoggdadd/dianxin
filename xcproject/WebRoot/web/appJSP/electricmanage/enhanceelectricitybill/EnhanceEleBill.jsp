...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
    ...
    function delad(electricfeeId){
       if(confirm("您确定删除此电费信息？")){
                    document.form1.action=path+"/servlet/electricfees?action=delete1&deladfee=jiningnewdelete&degreeid="+electricfeeId
        			document.form1.submit();
        			 showdiv("请稍等..........");
       }
    }
    function modifyad(electricfeeId){
                    document.form1.action=path+"/servlet/EnhanceElecModifyServlet?action=getInfo&degreeid="+electricfeeId;
                    document.form1.submit();
                     showdiv("请稍等..........");
    ...
    function queryDegree(action){
        ...
        if(document.getElementById("shi").value==""||document.getElementById("shi").value=="0"||document.getElementById("shi").value==null){
	             alert("城市不能为空");
	   		   ...
	   		   comm.value = command;
               document.form1.action=path+"/servlet/EnhanceElecQueryServlet";
               document.form1.submit();
       		}
    ...
    //选择所有按钮
     ...
     function deletes(){
        ...
        if(bz>0){
        	if(bz<=50){
	           document.form1.action=path+"/servlet/electricfees?action=deletes&biaozhi=jining&chooseIdStr="+chooseIdStr;
	           document.form1.submit();
	           showdiv("请稍等..........");
           }else{
  ...
  function exportFData(){
          document.form1.action=path+"/web/appJSP/electricmanage/enhanceelectricitybill/EnhanceInputEleBill.jsp";
                                document.form1.submit();
  }
  $(function(){
	...
	<form action="" name="form1" method="POST">
        ...
        <%}%>
	         ...
	         %>
                     ...
                     <td>上次抄表时间：</td>
                     <td>
                       <input type="text" name="beginTimeQ" class="selected_font" value="<%if(null!=request.getParameter("beginTimeQ")) out.print(request.getParameter("beginTimeQ")); %>" onFocus="getDateString(this,oCalendarChs)"  />
                     </td>
                     <td>本次抄表时间：</td>
                     <td>
                       <input type="text" name="endTimeQ" class="selected_font" value="<%if(null!=request.getParameter("endTimeQ")) out.print(request.getParameter("endTimeQ")); %>" onFocus="getDateString(this,oCalendarChs)"  />
                     </td>
                  </tr>
                  <tr class="form_label">
                  <td>起始月份：</td>
                  <td>
                     <input type="text" name="beginTime1" class="selected_font" value="<%if (null != request.getParameter("beginTime1")) out.print(request.getParameter("beginTime1"));%>" onFocus="getDatenyString(this,oCalendarChsny)"   />
                  </td>
                  <td>结束月份：</td>
                  <td>
                     <input type="text" name="endTime1" class="selected_font" value="<%if (null != request.getParameter("endTime1")) out.print(request.getParameter("endTime1"));%>" onFocus="getDatenyString(this,oCalendarChsny)"   />
                  </td>
                   <td>报账月份：</td>
                  <td>
                     <input type="text" name="accountmonth" class="selected_font" value="<%if (null != request.getParameter("accountmonth")) out.print(request.getParameter("accountmonth"));%>" onFocus="getDatenyString(this,oCalendarChsny)"   />
                  </td>
                  </tr>
