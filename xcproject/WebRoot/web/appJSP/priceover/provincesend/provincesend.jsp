...
<%	
	...
	String xian = request.getParameter("xian")!=null?request.getParameter("xian"):"0";//区县	
  	...
  	String state=request.getParameter("state")!=null?request.getParameter("state"):"-1";//省级状态
	...
	String bl = request.getParameter("bl")!=null?request.getParameter("bl"):"20";//比例
    ...
    function queryDegree(command){
		...
		if (document.getElementById("shi").value == ""
			...
			if(isNaN(bl)){
				...
				document.form1.action=path+"/servlet/ProvSendServlet?command=" + command;
	       	...
	       	if(count!=0){
		        ...
		        for(var i = 0; i < l; i++){
		          ...
		          if(count1<=240*n||((bz+count2)>=239&&(bz+count2)<=241)){
			          ...
			          chooseIdStr=chooseIdStr.substring(0,chooseIdStr.length-1);
				      bzw=0;
			          document.form1.action=path+"/servlet/ProvSendServlet?command=paidan&chooseIdStr="+chooseIdStr;
			          document.form1.submit(); 
			       }            
		        } 
	        }else{
	...
	<form action="" name="form1" method="POST">
		<table width="100%"  border="0" cellspacing="0" cellpadding="0" height="18%">
			...
			<div style="width:700px;height:50px">
			       ...
			       <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">省派单</span>	
			 </div>
	    	</td></tr>	    	
	    	...
	    	<tr><td height="8%" width="1200">
	    		<table>
					...
					<tr class="form_label">
						<td>比例(%)：</td>
	        		 	<td><input type="text" name="bl" id="bl" value="" class="selected_font" /></td>
	 					<td>站点名称：</td>
		...
		<div style="width:100%;height:300px;overflow-x:auto;overflow-y:auto;border:1px">
			<table width="1500px" height="70%"  border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
				<tr height = "23" class="relativeTag">
            			...
            			<td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">省派单状态</div></td>
				</tr>
...
function passCheck1(chooseIdStr) {//省派单通过240
    sendRequest(path+"/servlet/ProvSendServlet?command=paidan1&chooseIdStr="+chooseIdStr, "checkpass1");
}
...
//-->
 ...
 function lookDetails(zdid,bzyf){ 
	 window.open(path+"/servlet/ProvSendServlet?command=info&zdid="+zdid+"&bzyf="+bzyf);	
 }
</script>
</html>
