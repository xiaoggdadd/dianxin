...
var path = '<%=path%>';
    ...
    function queryDegree(command){
    		var path = '<%=path%>';
			document.form1.action=path+"/servlet/DocumentQuery?command=" + command;
	...
	<form action="" name="form1" method="POST">
		<table width="100%"  border="0" cellspacing="0" cellpadding="0" height="18%">
			...
			<div style="width:700px;height:50px">
			       ...
			       <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">工单查询</span>	
			 </div>
	    	</td></tr>	    	
		...
		<div style="width:100%;height:300px;overflow-x:auto;overflow-y:auto;border:1px">
			<table width="1500px" height="70%"  border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
				<tr height = "23" class="relativeTag">
				        ...
				        <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">超标月份</div></td>
				        <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">省派单</div></td>
                        <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">市签收</div></td>
                        <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">市派单</div></td>
                        <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">区县签收</div></td>
                        <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">区县核实</div></td>
                        <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">市审核</div></td>
                        <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">省审核</div></td> 
		   ...
		   <c:forEach items="${list}" var="list" varStatus="status">
		       ...
		       <td>
		       		...
		       		<td>
		       			<div align="center" >${list.shengpd}</div>
		       		</td>
		       		<td>
		       			<div align="center">${list.shiqs}</div>
		       		</td>	
					 <td>
		       			<div align="center" >${list.shipd}</div>
		       		</td>
		       		<td>
		       			<div align="center" >${list.qxqs}</div>
		       		</td>
		       		<td>
		       			<div align="center" >${list.qxhs}</div>
		       		</td>
		       		<td>
		       			<div align="center" >${list.shish}</div>
		       		</td>
		       			<td>
