...
<%
	...
	String gdfs = request.getParameter("gdfs")!=null?request.getParameter("gdfs"):"gdfs05";//供电方式
	String sjzrsh = request.getParameter("sjzrsh")!=null?request.getParameter("sjzrsh"):"-1";//市级主任审核
	String manauditstatus = request.getParameter("manauditstatus")!=null?request.getParameter("manauditstatus"):"2";//财务审核状态
	Date date = new Date(); 
...
function queryDegree(action){
    	var command=action;
	   	document.form1.action=path+"/servlet/PowerServlet?command="+command;                       
...
<body  class="body" >	
           ...
           <td width="50" >
             <div style="width:700px;height:50px">
                <img src="<%=path%>/images/btt.bmp" width="100%" height="100%" />
			     <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">供电方式缴费统计</span>
	         </div>
	        </td>
		  </tr>
		  <tr>
  ...
  <table width="30%" align="left" CellSpacing="0" class="form_label">
		<tr>    
