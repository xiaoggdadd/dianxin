...
function queryDegree(action){
    	...
    	var command=action;
        document.form1.action=path+"/servlet/MonShareServlet?command="+command; 
           ...
           <td width="50" >
             <div style="width:700px;height:50px">
                <img src="<%=path%>/images/btt.bmp" width="100%" height="100%" />
			     <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">监测点分摊查询</span>
	         </div>
	        </td>
		  </tr>
		  <tr>
  ...
  <div style="width:100%;height:300px;overflow-x:auto;overflow-y:auto;border:1px" >  	
			    <table width="100%" height="80%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
                  <tr height = "23" class="relativeTag">
                      ...
                      <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">所属专业</div></td>
                      ...
                      <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">一级比例</div></td>
                      <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">二级比例</div></td>
                  </tr>
					<c:forEach items="${list}"  var="list" varStatus="status">
						<tr bgcolor="${(status.count)%2==0?'#DDDDDD':'#FFFFFF'}">
				       		...
				       		<td>
				       			<div align="center" >${list.dbid}</div>
				       		</td>
				       		<td>
				       			<div align="center" >${list.sszy}</div>
				       		</td>
				       		<td>
				       			<div align="center" >${list.qcb}</div>
				       		</td>          
				       		<td>
				       			<div align="center" >${list.kjkm}</div>
				       		</td>
				       		<td>
				       			<div align="center" >${list.zymx}</div>
				       		</td>
				       		<td>
				       			<div align="center" >${list.yjbl}</div>
				       		</td>          
				       		<td>
				       			<div align="center" >${list.ejbl}</div>
				       		</td>
    					</tr>
					</c:forEach>
