...
<body link=blue vlink=purple>
	...
	<col width=72 style='width:54pt'>
		<tr class=xl24 height=19 style='height:14.25pt'>  
			...
			<td class=xl25 width=72 style='border-left:none;width:54pt'>所属专业</td>
			...
			<td class=xl25 width=72 style='border-left:none;width:54pt'>一级比例</td>
			<td class=xl25 width=72 style='border-left:none;width:54pt'>二级比例</td>
 		</tr>
 		...
 		<tr height=19 style='height:14.25pt'>
			...
			<td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.xian}</td>
          	...
          	<td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.zdsx}</td>		  
   		  	<td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.zdlx}</td>
          	...
          	<td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.dbid}</td>
   		  	<td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.sszy}</td>
   		  	<td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.qcb}</td>
   		  	<td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.kjkm}</td>
   		  	<td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.zymx}</td>
   		  	<td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.yjbl}</td>
   		  	<td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.ejbl}</td>
 		</tr>
		</c:forEach>        
