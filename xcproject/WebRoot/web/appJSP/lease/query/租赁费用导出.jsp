...
<c:forEach items="${list}"  var="list" varStatus="status">
 ...
 <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.shi}${list.xian}${list.xiaoqu}</td>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.paybegintime}</td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.payendtime}</td>
