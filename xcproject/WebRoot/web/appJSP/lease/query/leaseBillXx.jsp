											...
											if(phonekg!=""){
												if(zuoji || shouji){
													if(confirm("您将要添加信息！确认信息正确！")){
															document.form1.action=path+"/servlet/LeaseBill?action=addZl";
	 			...
	 			<table width="97%" align="right" CellSpacing="1">
				     <tr>
				         <td bgcolor="#DDDDDD" class="form_label"><div>租赁合同编号：</div></td> 
				 		 <td><input type="text" id="leasenum" name="leasenum" value="" class="form1" /> 
				 		 <span style="color: #FF0000;font-weight: bold">*</span></td>
				 		 
				         <td bgcolor="#DDDDDD" class="form_label"><div>租赁合同名称：</div></td>
				         <td><input type="text" id="leasename" name="leasename" value="" class="form1"/>
				         <span style="color: #FF0000;font-weight: bold">*</span></td>
				           
				         <td bgcolor="#DDDDDD"  class="form_label"><div>合同起始时间：</div></td>
				         <td><input type="text" name="begintime" value="" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})" class="form"/>
				         <span style="color: #FF0000;font-weight: bold">*</span></td>
				     </tr>
				     <tr>
				         <td bgcolor="#DDDDDD" class="form_label"><div>合同结束时间：</div></td>
				         <td><input type="text" name="endtime" value="" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})" class="form1"/>
						 <span style="color: #FF0000;font-weight: bold">*</span></td>
						 
				         <td bgcolor="#DDDDDD" class="form_label"><div>合同金额（元）：</div></td>
				         <td><input type="text" name="money" value="" class="form1" />
						 <span style="color: #FF0000;font-weight: bold">*</span></td>
						 
				         <td height="19" bgcolor="#DDDDDD" class="form_label"><div>合同年限（年）：</div></td>
				         <td><input type="text" name="agelimit" value="" class="form1" />
						 <span style="color: #FF0000;font-weight: bold">*</span></td>
				     </tr>
				     <tr>
				          <td bgcolor="#DDDDDD" class="form_label"><div>出租方姓名：</div></td>
				          <td><input type="text" name="leasername" value="" class="form1"/>
						  <span style="color: #FF0000;font-weight: bold">*</span></td>
						  
				          <td bgcolor="#DDDDDD"   class="form_label"><div>出租方电话：</div></td>
				          <td><input type="text" name="leaserphone" value="" class="form1" /></td>
				          
				          <td bgcolor="#DDDDDD" class="form_label"><div>出租方开户行：</div></td>
				          <td><input type="text" name="leaserbank" value=""  class="form1" />
						  <span style="color: #FF0000;font-weight: bold">*</span></td>
				     </tr>
				     <tr>
				     	  <td bgcolor="#DDDDDD" class="form_label"><div>出租方账号：</div></td>
				          <td><input type="text" name="leaseraccount" value=""  class="form1" />
						  <span style="color: #FF0000;font-weight: bold">*</span></td>
				     ...
				     <tr> 
				         ...
				         <td><input type="text" name="bargainhandler" value=""  class="form1" />
						 <span style="color: #FF0000;font-weight: bold">*</span></td>
				     </tr>
				</table>
			</fieldset>
