					 ...
					 if(parseFloat(paymoney)>0){
						 if(payer != ""){
							 	 if(confirm("您将要添加信息！确认信息正确！")){
					        		document.form1.action=path+"/servlet/LeaseBargainFeesServlet?action=addLeaseFees";
  ...
  <table border="0" align="center" width="97%">
  	<tr>
  		<td width="83%">  		
				...
				<legend><img src="<%=path%>/images/v.gif" width="15" height="15" /><b><font size="2">费用信息</font></b></legend>
	 			<table width="97%" align="right" CellSpacing="1">
				     <tr>    
				        ...
				        <td width="21%"><input type="text" name="payendtime"   value="" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})" class="form1" /><span style="color: #FF0000;font-weight: bold"> *</span></td>
				        <td bgcolor="#DDDDDD"   class="form_label"><div>金额（元）：</div></td>
				        <td><input type="text" name="paymoney"   value=""  class="form1" /><span style="color: #FF0000;font-weight: bold"> *</span></td>
				     </tr>
				     <tr>
				     <td bgcolor="#DDDDDD"   class="form_label"><div>付款经办人：</div></td>
				        <td><input type="text" name="payhandler"   value=""  class="form1" /><span style="color: #FF0000;font-weight: bold"> *</span></td>
			...
			<input type="hidden" name="leaseid_fk" value="${lbf.leaseid_fk}"/>
  		</td>
