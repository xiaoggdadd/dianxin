...
function queryDegree(action){
        ...
        if(document.getElementById("shi").value==""||document.getElementById("shi").value=="0"||document.getElementById("shi").value==null){
	             alert("城市不能为空");
	   		   ...
	   		   comm.value = command;
               document.form1.action=path+"/servlet/LeaseStatServlet";
           ...
           <td width="50" >
             <div style="width:700px;height:50px">
                <img src="<%=path%>/images/btt.bmp" width="100%" height="100%" />
			     <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">租赁费统计</span>
	         </div>
	        </td>
		  </tr>
		  <tr>
							  ...
							  <td>合同名称：</td>
					 		  ...
					 		  <td>
								 <input class="selected_font" type="text" name="bztime"
										value="<%if (null != request.getParameter("bztime"))  out.print(request.getParameter("bztime"));%>"
  ...
  <div style="width:100%;height:300px;overflow-x:auto;overflow-y:auto;border:1px" >  	
			    <table width="100%" height="80%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
                  <tr height = "23" class="relativeTag">
            		  ...
            		  <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">合同开始时间</div></td>
                      ...
                      <td width="" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">缴费次数</div></td>
                  </tr>
					<c:forEach items="${list}"  var="list" varStatus="status">
						<tr bgcolor="${(status.count)%2==0?'#DDDDDD':'#FFFFFF'}">
				       		...
				       		<td>
				       			<div align="center" >${list.begintime}</div>
				       		</td>
				       		<td>
				       		...
				       		<td>
				       			<div align="center" >${list.count}</div>
				       		</td>
    					</tr>
					</c:forEach>
