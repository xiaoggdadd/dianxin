...
<script type="text/javascript" src="<%=path%>/web/appJS/pageJs/someJs/page.js"></script>
 ...
 function selectTree(command){//查询
		document.form1.action = path + "/servlet/CityRelationServlet?command="+command;
	 			...
	 			<tr>
      				<td colspan="4" width="50">
						<div style="width:700px;height:50px">
							...
							<span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">外租站点与主站点关联省级查询</span>	
						</div>
					</td>
    			</tr>
				<tr>
   ...
   <div style="width:100%;height:300px;overflow-x:auto;overflow-y:auto;border:1px" >
       <table width="100%"  border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">       
			...
			<tr bgcolor="${(status.count)%2==0?'#DDDDDD':'#FFFFFF'}">
       			...
       			<td><div align="center" >${bean.ygl}</div></td>
       			<td><div align="center" >${bean.wgl}</div></td>       			       			
			</tr>
			</c:forEach>
				<% 
						if (numcolor==0){
