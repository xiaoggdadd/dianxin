...
<%@ page
	import="com.ptac.app.statisticcollect.city.unitpricePIC.bean.*"%>
...
function daochu() {
	...
	document.form1.action = "<%=path%>/servlet/CityUnitpriceDaoChuServlet";
...
function queryDegree() {
	...
	document.form1.action = "<%=path%>/servlet/CityUnitpriceServlet";
	document.form1.submit();
	showdiv("请稍等..............");
}
...
$(function() {
	...
	<body class="body">
		<form action="" name="form1" method="POST">
				...
				<tr>
					<td width="1200px">
						...
						<div
							...
							List<CityUnitpriceBean> ls =(List<CityUnitpriceBean> )request.getAttribute("ls");
			...
			<br />
			<!-- <div id="chrt">
     			<iframe src="<%=path%>/servlet/CityPICServlet" width="100%" height="100%"  style="border-width:thin" scrolling="auto"></iframe>
    		</div>  -->
			<br />
		</form>
	</body>
