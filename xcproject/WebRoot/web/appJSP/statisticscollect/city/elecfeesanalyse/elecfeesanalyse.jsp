...
function queryDegree(command) {
	if(yue()){
		document.form1.action = path + "/servlet/ElecfeesAnalyseServlet2?command="+ command;
	 			...
	 			<tr>
      				<td colspan="4" width="50">
						<div style="width:700px;height:50px">
							...
							<span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">电费分析通报</span>	
						</div>
					</td>
    			</tr>
				<tr>
