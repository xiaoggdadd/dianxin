...
function xiangxi(cs1){
	...
	window.open(path+ "/servlet/CitySiteDetailCountServlet?command=xiangxi1&cs1="+cs1+"&shi="+shi+"&xian="+xian+"&beginyue="+beginyue+"&endyue="+endyue)
} 
				...
				<table width="100%" height="80%" border="0" cellspacing="1" cellpadding="1"
					...
					<c:forEach items="${list1}" var="list1" varStatus="status">
						<tr bgcolor="${(status.count)%2==0?'#DDDDDD':'#FFFFFF'}">
							...
							<td>
								<div align="right">
									<a href="javascript:xiangxi('zd')" >${list1.zdshts1}</a>
								</div>
							</td>
							<td>
								<div align="right">
							...
							<td>
								<div align="right">
									<a href="javascript:xiangxi('xgly')" >${list1.xglyshts1}</a>
								</div>
							</td>
							<td>
								<div align="right">
							...
							<td>
								<div align="right">
									<a href="javascript:xiangxi('qxzr')" >${list1.qxzrshts1}</a>
								</div>
							</td>
							<td>
								<div align="right">
							...
							<td>
								<div align="right">
									<a href="javascript:xiangxi('sgly')" >${list1.sglyshts1}</a>
								</div>
							</td>
							<td>
								<div align="right">
							...
							<td>
								<div align="right">
									<a href="javascript:xiangxi('szr')" >${list1.szrshts1}</a>
								</div>
							</td>
							<td>
								<div align="right">
							...
							<td>
								<div align="right">
									<a href="javascript:xiangxi('cw')" >${list1.cwshts1}</a>
								</div>
							</td>
							<td>
								<div align="right">
