...
<table x:str border=1 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>  
  ...
  <td class=xl25 width=165 style='border-left:none;width:124pt'>站点数量</td>
  <td class=xl25 width=165 style='border-left:none;width:124pt'>结算表数量</td>
  <td class=xl25 width=165 style='border-left:none;width:54pt'>管理表数量</td>
  <td class=xl25 width=152 style='border-left:none;width:114pt'>结算抄表次数</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>管理抄表次数</td>
 </tr>
<c:forEach items="${Info}"  var="list" varStatus="status">
 ...
 <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.shi}</td>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.zdsl}</td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.jsbsl}</td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.glbsl}</td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.jscbcs}</td>
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num>${list.glcbcs}</td>
 </tr>
</c:forEach>         
  <tr> 
  	<td colspan="7">
