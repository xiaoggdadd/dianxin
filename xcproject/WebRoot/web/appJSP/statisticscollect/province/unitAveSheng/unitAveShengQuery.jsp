   			...
   			function queryDegree(action){
				...
				if(bzyfstart!=""&&bzyfstart!=null&&reg.exec(bzyfstart)){//判断报账月份起
					if(bzyfend!=""&&bzyfend!=null&&reg.exec(bzyfend)&&bzyfend>=bzyfstart){//判断报账月份止
              				document.form1.action=path+"/servlet/UnitAveShengServlet?command="+command;                       
	 			...
	 			<tr>
      				<td colspan="4" width="50">
						<div style="width:700px;height:50px">
							...
							<span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">省级单价平均与平均单价</span>	
						</div>
					</td>
    			</tr>
				<tr>
						...
						<table>
							<tr class="form_label">
								...
								<td>
	         					...
	         					<td>
							    	<div id="query" style="position:relative;width:59px;height:23px;right:-43px;cursor: pointer;TOP:0PX">
								...
								<tr class="form_label">
   								...
   								<tr class="form_label">
									...
									<td title="必填项，根据下拉值选择填写">
	                                    ...
	                                    readonly="readonly" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM'})"/>至
	                                </td>
	                                <td title="必填项，根据下拉值选择填写">
