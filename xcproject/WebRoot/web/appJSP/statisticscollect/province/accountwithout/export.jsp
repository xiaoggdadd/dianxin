	...
	<body link=blue vlink=purple>
		...
		<table x:str border=1 cellpadding=0 cellspacing=0 width=705
			...
			<tr>
				...
				<td>
					<div align="center">
						<font color='#000080'>&nbsp;${sumbean.zdcountsum}</font>
					</div>
				</td>
		      	<td>
		      		<div align="center">
		      			<font color='#000080'>&nbsp;${sumbean.countlsum}</font>
		      		</div>
		      	</td>
				<td>
					<div align="center">
						<font color='#000080'>&nbsp;${sumbean.countlzbsum}%</font>
					</div>
				</td>
				<td>
		      		<div align="center">
		      			<font color='#000080'>&nbsp;${sumbean.countssum}</font>
		      		</div>
		      	</td>
				<td>
					<div align="center">
						<font color='#000080'>&nbsp;${sumbean.countszbsum}%</font>
					</div>
				</td>
			</tr>
			<![endif]>
