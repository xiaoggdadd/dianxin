<%@ page language="java" import="java.util.*,com.noki.mobi.common.Account,com.noki.mobi.common.CommonBean,com.ptac.app.statisticcollect.province.addsitequantity.bean.*,java.text.SimpleDateFormat" pageEncoding="UTF-8"%>
...
<html>
  <head>
   ...
   function lookDetailss() {//新增站点数量超链接，查看详情
	...
	var zdsx = "${zdsx}";
	var qyzt = "${qyzt}"; 
	window.open(path+"/web/query/basequery/stationPointQuery.jsp?command=chaxun&shi="+shi+"&beginyue="+beginyue+"&endyue="+endyue+"&jzproperty="+zdsx+"&caiji=0&xuni=0&zdqyzt="+qyzt);
 ...
 if(beginyue == "" || beginyue == null){
		...
		document.form1.action = path + "/servlet/ProvinceNewAddSiteQuantityServlet?command="+command;
	...
	<table  width = "1100">
 	<tr class='form_label' >
 		<td>
   	     ...
   	     <td>
   	   		 <div id="quary" style="position:relative;width:60px;height:23px;cursor: pointer;right:100px;float:right;">
           ...
           <tr class="relativeTag" >
			...
			<tr height="23">
        		...
        		<td bgcolor="#DDDDDD"></td>
      			...
      			<td bgcolor="#DDDDDD"><div align="right" class="bttcn" style="color:black;font-weight:bold;font-size: 12px">${newaddnum}</div></td>
