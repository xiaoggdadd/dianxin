	...
	<body link=blue vlink=purple>
		...
		<table x:str border=1 cellpadding=0 cellspacing=0 width=705
			...
			<tr>
				...
				<td>
					<div align="center">
						<font color='#000080'>&nbsp;${sumbean.jcdjsum}</font>
					</div>
				</td>
		      	<td>
		      		<div align="center">
		      			<font color='#000080'>&nbsp;${sumbean.pjdjsum}</font>
		      		</div>
		      	</td>
				<td>
					<div align="center">
						<font color='#000080'>&nbsp;${sumbean.pjdjpldsum}%</font>
					</div>
				</td>
				<td>
		      		<div align="center">
		      			<font color='#000080'>&nbsp;${sumbean.zgddjsum}</font>
		      		</div>
		      	</td>
				<td>
					<div align="center">
						<font color='#000080'>&nbsp;${sumbean.zgdpldsum}%</font>
					</div>
				</td>
			</tr>
			<![endif]>
