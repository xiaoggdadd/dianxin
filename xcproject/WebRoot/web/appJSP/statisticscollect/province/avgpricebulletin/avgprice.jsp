...
<%@ page
	import="java.util.*,java.util.List,java.util.Date,com.noki.mobi.common.Account,com.noki.mobi.common.CommonBean,com.ptac.app.statisticcollect.util.YearYueUtil"%>
...
<%
    ...
    String begin =util.month()[0];
    String end = util.month()[1];
	String beginbztime = request.getParameter("beginbztime") != null ? request.getParameter("beginbztime"): begin;//报账月份
	String endbztime = request.getParameter("endbztime") != null ? request.getParameter("endbztime"): end;//报账月份
...
function queryDegree(command) {
		document.form1.action = path + "/servlet/AvgPriceServlet?command="+ command;
	 			...
	 			<tr>
      				<td colspan="4" width="50">
						<div style="width:700px;height:50px">
							...
							<span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">平均单价通报</span>	
						</div>
					</td>
    			</tr>
				<tr>
						...
						<table>
							<tr class="form_label">
								...
								<td>
									...
									至
									<input class="selected_font" type="text" name="endbztime"
										value="<%=endbztime%>"
										readonly="readonly" class="Wdate"
										onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM'})" />
								</td>
			...
			<div
				...
				<table width="100%" height="80%" border="0" cellspacing="1"
					...
					<tr height="23" class="relativeTag">
						...
						<td width="" height="23" bgcolor="#DDDDDD">
							<div align="center" class="bttcn">
								${year}年${beginmonth}-${endmonth}月平均电价(元/度)
							</div>
						</td>
						<td width="" height="23" bgcolor="#DDDDDD">
							<div align="center" class="bttcn">
						...
						<td width="" height="23" bgcolor="#DDDDDD">
							<div align="center" class="bttcn">
								${year}年${beginmonth}-${endmonth}月转供电平均电价(元/度)
							</div>
						</td>
						<td width="" height="23" bgcolor="#DDDDDD">
							<div align="center" class="bttcn">
					...
					<c:forEach items="${list}" var="list" varStatus="status">
						<tr bgcolor="${(status.count)%2==0?'#DDDDDD':'#FFFFFF'}">
							...
							<td><div align="center">${list.jcdj}</div></td>
							<td><div align="center">${list.pjdj}</div></td>
							<td><div align="center">${list.pjdjpld}%</div></td>
							<td><div align="center">${list.zgddj}</div></td>
							<td><div align="center">${list.zgdpld}%</div></td>
						</tr>
					</c:forEach>
					...
					<tr height="23">
						<td bgcolor="#DDDDDD">
		      			...
		      			<td bgcolor="#DDDDDD"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px">${sumbean.jcdjsum}</div></td>
		      			<td bgcolor="#DDDDDD"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px">${sumbean.pjdjsum}</div></td>
						<td bgcolor="#DDDDDD"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px">${sumbean.pjdjpldsum}%</div></td>
		        		<td bgcolor="#DDDDDD"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px">${sumbean.zgddjsum}</div></td>
						<td bgcolor="#DDDDDD"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px">${sumbean.zgdpldsum}%</div></td>
		        	</tr>
				</table>
			</div>
...
document.form1.endbztime.value='<%=endbztime%>';
