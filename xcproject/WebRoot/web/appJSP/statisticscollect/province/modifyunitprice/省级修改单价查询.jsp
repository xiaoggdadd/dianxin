...
<table x:str border=1 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>  
  ...
  <td class=xl25 width=152 style='border-left:none;width:114pt'>电费单录入条数</td>  
  <td class=xl25 width=152 style='border-left:none;width:124pt'>修改单价条数</td>
  <td class=xl25 width=152 style='border-left:none;width:124pt'>单价调高条数</td>
   <td class=xl25 width=152 style='border-left:none;width:124pt'>调高占比</td>
...
<c:forEach items="${beanlist}"  var="list" varStatus="status">
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none'>${list.lrts}</td>
  <td class=xl26 align=right style='border-top:none;border-left:none'>${list.xgdjts}</td>
  <td class=xl26 align=right style='border-top:none;border-left:none'>${list.tgts}</td>
   <td class=xl26 align=right style='border-top:none;border-left:none'>${list.tgzb}%</td>
