	...
	<body link=blue vlink=purple>
		<table x:str border=1 cellpadding=0 cellspacing=0 width=705
			...
			<tr  class=xl24 height=19 style='height: 14.25pt' >
		   	    <td width="5%" rowspan="2" class=xl27 width=72 style='border-left: none; width: 54pt'>地市</td>  
		   	   	<td width="5%" colspan="4" class=xl27 width=72 style='border-left: none; width: 54pt'>核对信息</td>           
			    <td width="5%" colspan="6" class=xl27 width=72 style='border-left: none; width: 54pt'>业务活动</td> 
				<td width="5%" colspan="6" class=xl27 width=72 style='border-left: none; width: 54pt'>专业</td> 	
    		</tr> 
			<tr class=xl24 height=19 style='height: 14.25pt'>
