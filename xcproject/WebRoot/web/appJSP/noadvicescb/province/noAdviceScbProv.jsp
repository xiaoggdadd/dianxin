...
function chaxun(){
	    ...
	    var href = "noAdviceScbProv_iframe1.jsp?shi="+shi+"&zdsx1="+jzproperty+"&bzw=2";
	    var str = "<a id='aa' href='"+href+"' target='test'></a>";
	    $("#aa").remove();
	    $("body").append(str);
	    $("#aa")[0].click();
	    
	    var href1 = "noAdviceScbProv_iframeMap.jsp?shi="+shi+"&zdsx1="+jzproperty+"&bzw=2";
...
function exportad(){
	...
	var shi=document.form1.shi.value;
  	...
  	document.form1.action=path+"/web/appJSP/noadvicescb/province/provExportad.jsp?shi="+shi+"&jzproperty="+jzproperty;
...
<body  class="body" >
           ...
           <td width="50" >
             <div style="width:700px;height:50px">
                <img src="<%=path%>/images/btt.bmp" width="100%" height="100%" />
			     <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">省级无建议生产标</span>
	         </div>
	        </td>
		  </tr>
		  <tr>
  ...
  <table height="23">
     <tr><td height="5"  colspan="4" >
  	...
  	<iframe name="test"  width="450px" height="400px" frameborder="0" src="<%=path %>/web/appJSP/noadvicescb/province/noAdviceScbProv_iframe1.jsp"></iframe>
    <iframe name="treeNodeInfo1"  width="650px" height="400px" frameborder="0" src="<%=path %>/web/appJSP/noadvicescb/province/noAdviceScbProv_iframeMap.jsp"></iframe>
