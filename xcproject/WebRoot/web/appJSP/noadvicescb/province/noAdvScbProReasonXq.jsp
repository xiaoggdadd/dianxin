...
function exportad(){
	var shi = <%=shi%>;
  	...
  	var bzwq = <%=bzw%>;
  	document.form1.action=path+"/web/appJSP/noadvicescb/province/provReasXqExportad.jsp?shi="+shi+"&jzproperty="+jzproperty+"&bzwq="+bzwq;
...
<body  class="body" >
 ...
 <% 
		...
		String hStr = "",str = "";
		 if(fylist!=null){
			for(NoAdvScbProReason bean3:fylist ){
				city1 = bean3.getCity();
				num1 = bean3.getNum();
				hStr += num1+ ";";
	        	str += city1 + ";";
