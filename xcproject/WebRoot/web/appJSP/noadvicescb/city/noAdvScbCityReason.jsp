...
function chaxun(){
	    ...
	    var href = "noAdvScbCityReason_iframe1.jsp?shi="+shi+"&zdsx1="+zdsx1+"&bzw=2";
	    var str = "<a id='aa' href='"+href+"' target='test'></a>";
	    $("#aa").remove();
	    $("body").append(str);
	    $("#aa")[0].click();
	    
	    var href1 = "noAdvScbCityReason_iframeMap.jsp?shi="+shi+"&zdsx1="+zdsx1+"&bzw=2";
...
function exportad(){
	var shi=document.form1.shi.value;
  	var zdsx1=document.form1.jzproperty.value;
  	document.form1.action=path+"/web/appJSP/noadvicescb/city/cityReasExportad.jsp?shi="+shi+"&jzproperty="+zdsx1;
...
<body  class="body" >
  ...
  <table height="23">
     <tr><td height="5"  colspan="4" >
  	...
  	<iframe name="test" width="40%" height="400px" frameborder="0" src="<%=path %>/web/appJSP/noadvicescb/city/noAdvScbCityReason_iframe1.jsp"></iframe>
    <iframe name="treeNodeInfo1" width="60%" height="400px" frameborder="0" src="<%=path %>/web/appJSP/noadvicescb/city/noAdvScbCityReason_iframeMap.jsp"></iframe>
