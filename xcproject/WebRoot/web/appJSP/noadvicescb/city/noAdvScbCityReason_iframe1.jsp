    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="1">       
       ...
       <%
		...
		if(bzw!= null && !bzw.equals("") && !bzw.equals("0")){
			...
			bean1 = (NoAdvScbCityReason)bean1.getReason1(whereStr,loginId);
			bean2 = (NoAdvScbCityReason)bean2.getReason2(whereStr,loginId);
			bean3 = (NoAdvScbCityReason)bean3.getReason3(whereStr,loginId);
       ...
       <tr bgcolor="#FFFFFF" class="form_label">
       		...
       		<td align="center">
       			<div align="center" >
       				<a target="_Blank" href="<%=path+"/web/appJSP/noadvicescb/city/noAdvScbCityReasonXq.jsp?shi="+shi+"&zdsx="+jzproperty1+"&bzwx=1"%>" ><%=bean1.getNum()%></a>
       			</div>
       		</td>
       	</tr>
       	<tr bgcolor="#DDDDDD" class="form_label">
       		...
       		<td align="center">
       			<div align="center" >
       				<a target="_Blank" href="<%=path+"/web/appJSP/noadvicescb/city/noAdvScbCityReasonXq.jsp?shi="+shi+"&zdsx="+jzproperty1+"&bzwx=2"%>" ><%=bean2.getNum()%></a>
       			</div>
       		</td>
       	</tr>
       	<tr bgcolor="#FFFFFF" class="form_label">
       		...
       		<td align="center">
       			<div align="center" >
       				<a target="_Blank" href="<%=path+"/web/appJSP/noadvicescb/city/noAdvScbCityReasonXq.jsp?shi="+shi+"&zdsx="+jzproperty1+"&bzwx=3"%>" ><%=bean3.getNum()%></a>
       			</div>
       		</td>
       	</tr>
