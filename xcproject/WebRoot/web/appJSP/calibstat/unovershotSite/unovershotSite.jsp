...
<script language="javascript">
	...
	function queryDegree() {
		...
		if (isNaN(bl) == false && bl != null && bl != "" && bl != " ") {
			if(checkNotnull(document.form1.bzmonth,"报账月份")){
				document.form1.action = path + "/web/appJSP/calibstat/unovershotSite/unovershotSite.jsp?chaxun=1";
	...
	function passCheck(){
	   ...
	   if (count != 0) {
		...
		function daochuBtn(){
        	...
        	document.form1.action=path+"/web/appJSP/calibstat/unovershotSite/查询未超标站点.jsp?bl="+bl+"&bzmonth="+bzmonth+"&property="+property+"&shi="+shi+"&xian="+xian+"&dlcb="+dlcb+"&dfcb="+dfcb+"&command=daochu";
				...
				height="18%">
  				<tr>
					<td colspan="4" width="50" >
						...
						<span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">标杆待调整</span>												</div>					  </td>
	    	    </tr>	
				<tr>
		     	...
		     	<tr>
			   		<td align="left">
			   			<font size="2" color="red">说明： 超标比例：（电表用电量—标准值）/ 标准值*100%<br>
								       ...
								       合并电量（标准值）：合并周期*生产标<br>
								       电量超标值（度/天）算法改为：电表用电量/合并周期—生产标<br>    
						</font>                                                                  
                   	</td>
  				</tr>
			</table>
