...
<table x:str border=1 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>  
  <td class=xl25 width=100 style='border-left:none;width:114pt'>城市</td>
  <td class=xl25 width=100 style='border-left:none;width:124pt'>站点名称</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>生产标</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>建议生产标</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>相差比例</td>
...
<c:forEach items="${list}"  var="list" varStatus="status">
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 align=center style='border-top:none;border-left:none' >${list.xcbl}%</td>
