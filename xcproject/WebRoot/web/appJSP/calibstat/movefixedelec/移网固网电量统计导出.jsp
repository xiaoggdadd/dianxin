	...
	<body link=blue vlink=purple>
		...
		<table x:str border=1 cellpadding=0 cellspacing=0 width=705
			...
			<tr class=xl24 height=19 style='height: 14.25pt'>
				<td colSpan = "2" rowSpan = "2" class=xl25 width=142 height=19
					style='height: 14.25pt; width: 107pt'>
					单位(万元)
				</td>
				<td colSpan = "3" class=xl25 width=72 style='border-left: none; width: 54pt'>
					${by1}月 — ${endyue1}月累计能耗支出（万元）<br/>（比月初计划滞后1个月）
				</td>
				<td colSpan = "3" class=xl25 width=72 style='border-left: none; width: 54pt'>
					${beginyue2}月 — ${endyue2}月累计耗电量（万度）<br/>（比月初计划滞后3个月）
				</td>
			</tr>
			<tr class=xl24 height=19 style='height: 14.25pt'>
			...
			<c:forEach items="${list}" var="bean" varStatus="status">
				...
				<tr height=19 style='height: 14.25pt'>
					<td colSpan = "2" class=xl26 align=right
						style='border-top: none; border-left: none' x:num>
						小计
					</td>
					<td class=xl26 align=right
