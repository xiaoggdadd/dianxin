 ...
 function selectTree(command){//查询
  ...
  if(checkNotnull(document.form1.begintime,"起始月份")&&checkNotnull(document.form1.endtime,"结束月份")){
	  if(begintime<=endtime){
		  	  document.form1.action = path + "/servlet/MoveFixedElecServlet?command="+command;
  ...
  <body>
	 			...
	 			<tr>
      				<td colspan="4" width="50">
						<div style="width:700px;height:50px">
							...
							<span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">移网固网电量统计</span>	
						</div>
					</td>
    			</tr>
				<tr>
   ...
   <div style="width:100%;height:300px;overflow-x:auto;overflow-y:auto;border:1px" >
       <table width="100%"  border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">       
           <tr  >
             <td colSpan = "2" rowSpan = "2" bgcolor="#DDDDDD" ><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px">单位(万元)</div></td>
             <td colSpan = "3"  bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px">${by1}月 — ${endyue1}月累计能耗支出（万元）<br/>（比月初计划滞后1个月）</div></td>
             <td colSpan = "3"  bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px" >${beginyue2}月 — ${endyue2}月累计耗电量（万度）<br/>（比月初计划滞后3个月）</div></td>
         	</tr>
         	<tr  >
             <td   bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px" >固网</div></td>
             <td   bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px" >移网</div></td>
             <td   bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px" >小计</div></td>
             <td   bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px" >固网</div></td>
         	 <td   bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px" >移网</div></td>
         	 <td   bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px" >小计</div></td>
         	</tr>
			...
			<tr bgcolor="${(status.count)%2==0?'#DDDDDD':'#FFFFFF'}">
       			...
       			<td><div align="right" >${bean.accountsubject}</div></td> 
       			<td><div align="right" >${bean.fixedfees}</div></td>
       			<td><div align="right" >${bean.movefees}</div></td>
       			<td><div align="right" >${bean.sumfees}</div></td>  
       			<td><div align="right" >${bean.fixedelec}</div></td> 		
       			<td><div align="right" >${bean.moveelec}</div></td> 		
				<td><div align="right" >${bean.sumelec}</div></td>      			       			
			</tr>
			</c:forEach>
								<% 
								if (numcolor==0){
					...
					%>
				<tr bgcolor="#DDDDDD">
       			<td colSpan = "2"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px" >小计</div></td> 
       			<td><div align="right" >${fixedfee}</div></td>
       			<td><div align="right" >${movefee}</div></td>
       			<td><div align="right" >${fee}</div></td>  
       			<td><div align="right" >${fixedelec}</div></td> 		
       			<td><div align="right" >${moveelec}</div></td> 		
				<td><div align="right" >${elec}</div></td>      			       			
			</tr>
		</table>
	</div>
