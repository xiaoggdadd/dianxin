...
function chaxun() {
	...
	//} else {
		...
		var a = "<a href='<%=path %>/web/appJSP/calibstat/dateRepeat/dateRepeatleft.jsp?";
...
%>
		...
		<form action="" name="form1" method="POST">
			<table width="100%"  border="0" cellspacing="0" cellpadding="0" height="18%">
			        <tr>
							...
							<div style="width:700px;height:50px"><span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">日期重复比例分析</span>												</div>					  </td>
	    	        </tr>	    	
	    	  <tr>
	    	  ...
	    	  <tr>
				...
				<table>
					<tr class="form_label">
					 <td >起始月份:</td>
		    		 <td ><input class="selected_font" type="text" name="month"
											value="<%=dateString%>"
					...
					<td>
						<div id="query" style="position:relative;width:59px;height:23px;cursor:pointer; float: left; left: 200px;">
	...
	<iframe name="treeMap" width="450px" height="200px" frameborder="0" src="<%=path%>/web/appJSP/calibstat/dateRepeat/dateRepeatleft.jsp"></iframe>
  	<span style="width:20px"></span>
	<iframe name="treeNodeInfo" width="600px" height="200px" frameborder="0" src="<%=path%>/web/appJSP/calibstat/dateRepeat/dateRepeatright.jsp"></iframe>
    <br/>
</body>
