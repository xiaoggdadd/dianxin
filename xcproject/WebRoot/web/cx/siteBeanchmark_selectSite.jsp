...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
		document.form1.action=path+"/web/cx/siteBeanchmark_selectSite.jsp";
...
<tr>
 ...
 <tr>
         ...
         站点代码：
         <input type="text" name="szdcode" value="<%=szdcode%>" class="form"/>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
             ...
             <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn"></div>
				...
				<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">是否标杆</div>
            			...
            			<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">站点代码</div>
            			</td>
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/cx/siteBeanchmark_selectSite.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/cx/siteBeanchmark_selectSite.jsp?curpage="+pageno;
      document.form1.submit();
     }
    function delacc(){
    	var returnvalue="";
