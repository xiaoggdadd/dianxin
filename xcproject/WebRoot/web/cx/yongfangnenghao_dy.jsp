...
<input type="button" value="关闭窗口" onClick="javascript:closedy()">
...
<table width="650" align="center" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="72%" colspan="4"  align="center"><span class="STYLE1">用房类型能耗统计</span></td>
  </tr>
...
序号</span></td>
<td align="center" nowrap="nowrap"  class="kuangtitle"><span class="resizeDivClass noprint" onMouseDown="MouseDownToResize(this);" onMouseMove="MouseMoveToResize(this);" onMouseUp="MouseUpToResize(this);"><img src="images/box1.gif" width="3" height="18"></span>
	<strong>用房类型</strong></td>	
