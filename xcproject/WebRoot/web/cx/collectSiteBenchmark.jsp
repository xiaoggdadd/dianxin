...
<%
	...
	System.out.println("operName="+operName);
		...
		String xiaoqu = request.getParameter("xiaoqu")!=null?request.getParameter("xiaoqu"):"0";
         ...
         String canshuStr="";
     if((shi!=null)||(xian!=null)||(xiaoqu!=null)||((sptype!=null)&&(chanquan!=null))||(htmlsql!=null)||(zdname!=null)){
         canshuStr= "&shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu+"&sptype="+sptype+"&chanquan="+chanquan+"&htmlsql="+htmlsql+"&zdname="+zdname;
     }
...
function ShowHideSearchRegion(trObject,SelfObject)
{
    ...
    function queryDegree(){
                    if(document.getElementById("shi").value==""||document.getElementById("shi").value=="0"||document.getElementById("shi").value==null)
		          {
                   ...
                   document.form1.action=path+"/web/cx/collectSiteBenchmark.jsp";
...
<body  class="body">
    ...
    <td valign="top">
      ...
      <tr>
        <td>
        &nbsp;站点属性：         
         <select name=jzproperty style="width:110" onchange="kzinfo()">
         		<option value="0">请选择</option>
	         <%
	         ...
	         %>
         	     ...
         	     站点名称：<input type="text" name="zdname" value="<%if(null!=request.getParameter("zdname")) out.print(request.getParameter("zdname")); %>" class="form" style="width:110px"/>
         	      起始月份：<input type="text" name="beginTime" value="<%if(null!=request.getParameter("beginTime")) out.print(request.getParameter("beginTime")); %>" onFocus="getDatenyString(this,oCalendarChsny)" style="width:110px" class="form"/>
          &nbsp;结束月份：<input type="text" name="endTime" value="<%if(null!=request.getParameter("endTime")) out.print(request.getParameter("endTime")); %>" onFocus="getDatenyString(this,oCalendarChsny)" style="width:110px" class="form"/>
           &nbsp;&nbsp;&nbsp;
       ...
       <div id="JZLXKZ"  style="width:100%;height:100%;display:none;">
          ...
          <tr>
               <td>
               		基站类型：
		         		<select name="jzxlx" style="width:130px" ">
		         		<option value="0">请选择</option>
		         		<%
         ...
         <div id="JRWTYPE"  style="width:100%;height:100%;display:none;">
          <table width="100%">
            <tr>
               <td>
               		接入网类型：
		         		<select name="jrwtype" style="width:130px" ">
		         		<option value="0">请选择</option>
		         		<%
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
                ...
                <%
				   ...
				   if(beginTime != null && !beginTime.equals("")&& !beginTime.equals("0")){
						str=str+" and to_char(a.thisdatetime,'yyyy-mm-dd') >='"+beginTime+"-01"+"'";
					 }
					if(endTime != null && !endTime.equals("")&& !endTime.equals("0")){
						str=str+" and to_char(a.thisdatetime,'yyyy-mm-dd') <='"+endTime+"-31"+"'";
				   ...
				   System.out.println("str"+str);
				    ...
				    if("".equals(ydl)||" ".equals(ydl)||"null".equals(ydl)||ydl==null||ydl==""||ydl=="null"||ydl==" ")ydl="0.00";
				    if("".equals(countsite)||" ".equals(countsite)||"null".equals(countsite)||countsite==null||countsite==""||countsite=="null"||countsite==" ")countsite="0.00";
				    System.out.println("ydl"+ydl+"countsite"+countsite);
				    ydl=mat.format(Double.parseDouble(countsite)==0?0:(Double.parseDouble(ydl)/Double.parseDouble(countsite)));
					String zdsx="";
				%>
				
                      <tr  height = "20">
                         <td width="8%" height="23" ><div align="center" ></div></td>
       ...
       <%}
         ...
         System.out.println("dianliangListjsp--------------:"+sptype+chanquan);
			...
			if(sptype != null && !sptype.equals("")&& !sptype.equals("0")){
				whereStr=whereStr+" and z.property='"+sptype+"'";
			}
			if(zdname != null && !zdname.equals("")&& !zdname.equals("0")){
				whereStr=whereStr+" and z.JZNAME like '%"+zdname+"%'";
			}if(jzxlx1 != null && !jzxlx1.equals("")&& !jzxlx1.equals("0")){
				whereStr=whereStr+" and z.xlx='"+jzxlx1+"'";
			}if(jflx1 != null && !jflx1.equals("")&& !jflx1.equals("0")){
				whereStr=whereStr+" and z.jflx='"+jflx1+"'";
			}if(jrwtype1 != null && !jrwtype1.equals("")&& !jrwtype1.equals("0")){
				whereStr=whereStr+" and z.jrwtype='"+jrwtype1+"'";
			}	 
		 ...
		 if(fylist!=null)
		{
			...
			//if(dl.equals(""))dl="0";
			System.out.println("df="+df+";ydl="+ydl);
			if("".equals(dl)||" ".equals(dl)||"null".equals(dl)||dl==null||dl==""||dl=="null"||dl==" ")dl="0.00";
			if("".equals(ydl)||" ".equals(ydl)||"null".equals(ydl)||ydl==null||ydl==""||ydl=="null"||ydl==" ")ydl="0.00";
