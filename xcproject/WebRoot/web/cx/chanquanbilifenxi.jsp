...
<%@page import="com.noki.mobi.cx.ChanQuanBiLiFenXi"%>
...
function ShowHideSearchRegion(trObject,SelfObject)
{
   ...
   function chaxun(){
        ...
        document.form1.action=path+"/web/cx/chanquanbilifenxi.jsp";
...
<tr bgcolor="F9F9F9">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
                      ...
                      <tr  height = "20">
                           ...
                           <td width="20%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">产权类型</div>
                           <td width="15%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">站点数目</div>
                           <td width="15%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">所占比例</div>
                      </tr>
       <%
         ...
         ChanQuanBiLiFenXi bean = new ChanQuanBiLiFenXi();
		 ...
		 if(fylist.size()>0)
		{
		   // System.out.println(fylist.toArray().toString());
		    ...
		    zdcq1 = (String)fylist.get(k+fylist.indexOf("ZDCQ"));
		    zdcq1 = zdcq1 != null ? zdcq1 : " ";
