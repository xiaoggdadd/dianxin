   ...
   <table width="100%" border="0" cellspacing="1" cellpadding="1" class="form_label">
	<tr class='form_label'>
   	...
   	<tr bgcolor="#DDDDDD" style="color:black;font-weight:bold;" align="center">
         ...
         String jzsl1="",zcbs1="",money1="",jzname="",dianfei="",dbname="",dbid="",zdcode="",jzcode="",thisdegree="",startmonth="",endmonth="",lastdegree="",thisdatetime="",lastdatetime="";
       	 fylist = bean.getPageData24(whereStr,loginId,loginName,xlxa);
