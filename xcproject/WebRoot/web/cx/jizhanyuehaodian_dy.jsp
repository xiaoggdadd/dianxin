...
<%@ page import="com.noki.mobi.cx.JiZhanYueNengHao" %>
...
<table width="650" align="center" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="72%" colspan="4"  align="center"><span class="STYLE1">基站月耗电趋势</span></td>
  </tr>
...
<tr>
  ...
  <%
       ...
       fylist = bean.getPageData(1,beginTime,endTime,sheng,shi,xian,xiaoqu);
