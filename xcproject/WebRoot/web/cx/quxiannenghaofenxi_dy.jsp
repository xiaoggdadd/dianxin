...
<table width="650" align="center" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="72%" colspan="4"  align="center"><span class="STYLE1">区县能耗比例分析</span></td>
  </tr>
...
<tr>
             <td align="center" nowrap="nowrap" class="kuangtitle"><span class="resizeDivClass noprint" onMouseDown="MouseDownToResize(this);" onMouseMove="MouseMoveToResize(this);" onMouseUp="MouseUpToResize(this);"><img src="images/box1.gif" width="3" height="18"></span><strong class="STYLE6">序号</strong>
            			...
            			<td align="center" nowrap="nowrap" class="kuangtitle"><span class="resizeDivClass noprint" onMouseDown="MouseDownToResize(this);" onMouseMove="MouseMoveToResize(this);" onMouseUp="MouseUpToResize(this);"><img src="images/box1.gif" width="3" height="18"></span><strong class="STYLE6">所在地区</strong>
                                    ...
                                    <td align="center" nowrap="nowrap" class="kuangtitle"><span class="resizeDivClass noprint" onMouseDown="MouseDownToResize(this);" onMouseMove="MouseMoveToResize(this);" onMouseUp="MouseUpToResize(this);"><img src="images/box1.gif" width="3" height="18"></span><strong class="STYLE6">电量合计</strong>
            			</td>
            			<td align="center" nowrap="nowrap" class="kuangtitle"><span class="resizeDivClass noprint" onMouseDown="MouseDownToResize(this);" onMouseMove="MouseMoveToResize(this);" onMouseUp="MouseUpToResize(this);"><img src="images/box1.gif" width="3" height="18"></span><strong class="STYLE6">费用合计</strong>
            			</td>
		 ...
		 if(fylist!=null)
		{
			...
			for( int k = fycount;k<fylist.size()-1;k+=fycount){
		     ...
		     agname = (String)fylist.get(k+fylist.indexOf("AGNAME"));
				dlcount = (String)fylist.get(k+fylist.indexOf("DLCOUNT"));
