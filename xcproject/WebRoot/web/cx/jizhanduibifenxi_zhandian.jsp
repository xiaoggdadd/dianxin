...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
		document.form1.action=path+"/web/cx/jizhanduibifenxi_zhandian.jsp";
	...
	<form action="" name="form1" id="form1" method="POST">
		...
		<td colspan="10">
			  <div style="width:700px;height:50px">
			       ...
			       <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:40px;color:black">选择站点</span>	
			  </div>
	    </td>
		</tr>		
		<tr><td height="30" colspan="10">
        ...
        <td>站点名称：</td>
        <td> <input type="text" name="sname" value="<%=sname%>" class="form"/></td>
       <td> <div id="query" style="position:relative;width:59px;height:23px;cursor: pointer;left:60%;TOP:0PX">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
               <tr bgcolor="#DDDDDD">
                   <td nowrap height="23"><div align="center" class="bttcn"></div></td>
                   <td nowrap height="23"><div align="center" class="bttcn">站点名称</div></td>
                   <td nowrap height="23"><div align="center" class="bttcn">所在地区</div></td>
				   <td nowrap height="23"><div align="center" class="bttcn">集团报表类型</div></td>
				   <td nowrap height="23"><div align="center" class="bttcn">是否标杆</div></td>
            	   <td nowrap height="23"><div align="center" class="bttcn">站点代码</div></td>
            </tr>
       <%
       JiZhanBean bean = new JiZhanBean();
		 ...
		 if(fylist!=null)
		{
		    ...
		    jztype = (String)fylist.get(k+fylist.indexOf("JZTYPE"));
				...
				returnvalue=id+","+jzname+","+szdq+","+jztype+","+sfbg+","+bieming;
			String color=null;
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/cx/jizhanduibifenxi_zhandian.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/cx/jizhanduibifenxi_zhandian.jsp?curpage="+pageno;
      document.form1.submit();
     }
    function delacc(){
    	var returnvalue="";
    	var jj=0;
    		for(var k = 0;k < document.form1.elements.length;k++){
				...
				if(par == "a"){
					window.parent.form1.jzaname.value = jzname;
					window.parent.form1.jzacode.value = jzcode;
				}
				else if(par == "b"){
					window.parent.form1.jzbname.value = jzname;
					window.parent.form1.jzbcode.value = jzcode;
				}
				closeDiv();
	          }           
		}
