...
<body  class="body">
  ...
  <table width="2800px" height="400px"  border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
       ...
       <%
       	...
       	if("dfzflx01".equals(dfzflx)){
       		dfzflx1="月结";
       	}else if ("dfzflx03".equals(dfzflx)){
       		dfzflx1="预支";
       	}else if ("dfzflx02".equals(dfzflx)){
       		dfzflx1="合同";
       	}else if ("dfzflx04".equals(dfzflx)){
       		dfzflx1="插卡";
       	}else{
       		dfzflx1="";
       	}
       
       	String dfbzw=request.getParameter("dfbzw");
       ...
       //ElectricFeesBean beana=new ElectricFeesBean();
		// List<ElectricFeesFormBean> list=beana.getCounttt(whereStr,loginId);	 
       	// fylist = bean.getinformationdb(dbid1,dfzflx);
       	  List<ElectricFeesFormBean> list=bean.getinformationdb(dbid1,bzyf,dfzflx1,dfbzw);      	 
