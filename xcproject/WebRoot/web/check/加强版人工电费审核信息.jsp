...
<table x:str border=1 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
                         ...
                         <td class=xl25 width=72 style='border-left:none;width:54pt'>特别调整申请</td>
 ...
 <%   
         ...
         fylist = bean.getPageDataCheckjn(whereStr,loginId,"","");
         ...
         if(fylist!=null)
			{
				...
				for(ElectricFeesFormBean elecbean:fylist){
					...
					String tbtzsq = elecbean.getTbtzsq();
					if("1".equals(tbtzsq)){
						tbtzsq = "有申请，请核对";
					...
					//2014-6-26
					String lastfloatdegreeandbl = elecbean.getLastfloatdegreeandbl();//上期电量调整*倍率
					String lastactualdegree = elecbean.getLastactualdegree();//上期电表用电量
					String floatdegreeandbl = elecbean.getFloatdegreeandbl();//电量调整*倍率
					
					String cshidbdfbz = elecbean.getCshibdfbl();//超市标电费比例
					String csbdld = elecbean.getCsbdld();//超省标电量度
					String cshibdld = elecbean.getCshibdld();//超市标电量度
					String csbdfjdz = elecbean.getCsbdfjdz();//超省标电费绝对值
					String cshibdjdz = elecbean.getCshibdjdz();//超市标电费绝对值
					String lineandchangeandbl = elecbean.getLineandchangeandbl()==null?"0.00":Format.str2(elecbean.getLineandchangeandbl());//线变损电量
					String bzrj = elecbean.getBzrj()==null?"0.00":Format.str2(elecbean.getBzrj());//报账日均量
	       ...
	       %>
  					...
  					<tr height=19 style='height:14.25pt'>
                        <td class=xl25 align=right style='border-top:none;border-left:none' ><%=quxian%></td>
                        <td class=xl25 align=right style='border-top:none;border-left:none' ><%=jzname%></td>
                        <td class=xl25 align=right style='border-top:none;border-left:none' ><%=tbtzsq%></td>
                        <td class=xl25 align=right style='border-top:none;border-left:none' ><%=csbdfjdz%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=cshibdjdz%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=csbl%>%</td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=csbbl%>%</td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=csdbdfbz%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=cshidbdfbz%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=csbdld%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=cshibdld%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=qsdbdl%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=edhdl%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=accountmonth%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=gdfs%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=dbydl%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=lastdatetime%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=thisdatetime%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=blhdl%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=floatdegree%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=memo%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=unitprice%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=floatpay%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=memo1%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=actualpay%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=jszq%></td>
						<%if(manualauditstatus.equals("1")||manualauditstatus.equals("-1")||manualauditstatus.equals("2")){ %>
							<td class=xl25 align=right style='border-top:none;border-left:none' >通过</td>
		       			<%}else if(manualauditstatus.equals("-2")){%>
		       	        	<td class=xl25 align=right style='border-top:none;border-left:none' >不通过</td>   
		       			<%}else{ %>
		       	        	<td class=xl25 align=right style='border-top:none;border-left:none' >未审核</td>     
		       			<%} %>	
						<%if(sjshzt1.equals("1")){ %>
							<td class=xl25 align=right style='border-top:none;border-left:none' >通过</td>
						...
						<%if(manualauditstatus.equals("2")){ %>
		       			...
		       			<%}else{ %>
		       	        	<td class=xl25 align=right style='border-top:none;border-left:none' >未审核</td>     
		       			<%} %>		
		       			<td class=xl25 align=right style='border-top:none;border-left:none' ><%=dbname%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=dfzflx%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=pjje%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=pjlx%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=stationtype1%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=zdid%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=dbid%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=property%></td>
 						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=floatdegreeandbl%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=lastactualdegree%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=lastfloatdegreeandbl%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=lineandchangeandbl%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=bzrj%></td>
						<td class=xl25 align=right style='border-top:none;border-left:none' ><%=beilv%></td>
 				</tr>
         <%
         }}
         %>
