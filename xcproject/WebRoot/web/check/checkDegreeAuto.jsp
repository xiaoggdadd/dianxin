...
<%@ page import="com.noki.util.CTime,com.noki.ammeterdegree.javabean.AmmeterDegreeBean,com.noki.mobi.common.CommonBean" %>
...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
    ...
    function modifyad(ammeterdegreeid){
                    document.form1.action=path+"/web/check/modifyDegree.jsp?degreeid="+ammeterdegreeid;
                    document.form1.submit();
       
    }
    function queryDegree(){
                   document.form1.action=path+"/web/check/checkDegreeAuto.jsp?command=chaxun";
                   document.form1.submit();
...
<%
permissionRights=commBean.getPermissionRight(roleId,"0801");
...
<form action="" name="form1" method="POST">
	<table width="100%"  border="0" cellspacing="0" cellpadding="0" height="18%">
		...
		<td colspan="4">
			  <div style="width:700px;height:50px">
			       ...
			       <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">自动电量审核</span>	
			  </div>
	    </td>
		</tr>		
	...
	<div style="width:88%;" > 
		<p id="box3" style="display:none">
			...
			<tr class="form_label">
	         	...
	         	<td>起始月份:</td><td><input type="text" class="selected_font" name="beginTime1" value="<%if (null != request.getParameter("beginTime1"))out.print(request.getParameter("beginTime1"));%>" onFocus="getDatenyString(this,oCalendarChsny)" class="form" /></td>
	         	<td>结束月份:</td><td><input type="text" name="endTime1" class="selected_font" value="<%if (null != request.getParameter("endTime1"))out.print(request.getParameter("endTime1"));%>" onFocus="getDatenyString(this,oCalendarChsny)" class="form" /></td>
         	</tr>
         	<tr class="form_label">
         	<td>抄表起始时间：</td><td><input type="text" name="BeginTime" value="<%if(null!=request.getParameter("BeginTime")) out.print(request.getParameter("BeginTime")); %>" onFocus="getDateString(this,oCalendarChs)"  class="selected_font"/></td>
         	<td>抄表结束时间：</td><td><input type="text" name="EndTime" value="<%if(null!=request.getParameter("EndTime")) out.print(request.getParameter("EndTime")); %>" onFocus="getDateString(this,oCalendarChs)"  class="selected_font"/></td>
	...
	<%
		 ...
		 String autoauditdegree = request.getParameter("autoauditstatus");
         String whereStr = "";
		 String str = "";
         System.out.println("dianliangListjsp:"+jizhan+beginTimeQ+endTimeQ);
          //====ad.entrytime
            ...
            if(autoauditdegree != null && autoauditdegree != "" && !autoauditdegree.equals("2")){
               if(autoauditdegree.equals("0")){
				whereStr=whereStr+" and (ad.autoauditstatus='"+autoauditdegree+"' or ad.autoauditstatus is null)";
				str=str+" and (ad.autoauditstatus='"+autoauditdegree+"' or ad.autoauditstatus is null)";
				}else{
				whereStr=whereStr+" and ad.autoauditstatus='"+autoauditdegree+"' ";
				str=str+" and ad.autoauditstatus='"+autoauditdegree+"' ";
				}
			}
			String str1="";
			String str2="";
		...
		String count2="0.0";
       	if("chaxun".equals(request.getParameter("command"))||"daochu".equals(request.getParameter("command"))){
            count1=bean.getCountt(whereStr,loginId,str1);
	...
	<table  height="5%">
          <tr>
  	        ...
  	        <td><font size="2">折算后用电量</font></td><td><font size="2" color="red">&nbsp;<%=count2%></font><font size="2">度  |</font></td>
  	      </tr>
	</table>
	<%} %>
	...
	<div style="width:100%;height:300px;overflow-x:auto;overflow-y:auto;border:1px" >
		<table width="1400px" height="80%"  border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
			<tr height = "23" class="relativeTag">
                   ...
                   <td width="5%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">上次电表读数</div></td>
       			   <td width="7%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">上次抄表时间</div></td>
                   <td width="5%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">本次电表读数</div></td>
                   
                   <td width="7%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">本次抄表时间</div></td>
                   <td width="4%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">用电量调整</div></td>
                   <td width="5%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">折算后用电量</div></td>
                   <td width="5%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">站点类型</div></td>
                   <td width="5%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">站点属性</div></td>
                   
                   <td width="7%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">集团报表类型</div></td>
                   <td width="5%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">电流类型</div></td>
                   <td width="5%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">用电设备</div></td>
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/check/checkDegreeAuto.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/check/checkDegreeAuto.jsp?curpage="+pageno;
      document.form1.submit();
     }
     </script>
...
function exportad(){
            ...
            var lrrq='<%=lrrq%>';
            //alert(canshuStr);
        	document.form1.action=path+"/web/check/自动电量审核.jsp?curpage="+curpage+"&whereStr="+whereStr+"&jizhan="+jizhan+"&lrrq="+lrrq+"&command=daoru";
            document.form1.submit();
   }
		...
		document.form1.autoauditstatus.value='<%=autoauditdegree%>';
