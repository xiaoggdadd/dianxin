...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
	...
	function showDetail(degreeid){
	      alert("还在建设中！");
          //document.form1.action=path+"/web/check/showSPMDetailMain.jsp";//?degreeid="+degreeid;
          //document.form1.submit();
    }
	function adddegree(){
    ...
    function queryDegree(){
                   ...
                   var canshuStr = "?sheng="+sheng+"&shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu;
                  
                   //alert(canshuStr);
                   document.form1.action=path+"/web/check/checkStationPointManual.jsp"+canshuStr;
                   document.form1.submit();
...
<%
permissionRights=commBean.getPermissionRight(roleId,"0805");
...
<tr bgcolor="F9F9F9">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
                      ...
                      <tr  height = "20">
                      <td width="5%" height="23" bgcolor="#888888">
                        <div align="center"><input type="checkbox" name="test" onclick="chooseAll()"/>全选</div>
                      </td>
                      <td width="10%" height="23" bgcolor="#888888"><div align="center">站点名称</div>
                      <td width="12%" height="23" bgcolor="#888888"><div align="center">所在地区</div>
                      <td width="10%" height="23" bgcolor="#888888"><div align="center">代表站号</div>
                      </td>
                      ...
                      <!--<td width="10%" height="23" bgcolor="#888888"><div align="center">详细信息</div></td>-->
                      <td width="10%" height="23" bgcolor="#888888"><div align="center">人工审核状态</div></td>                    
                      </tr>
       <%
         ...
         String whereStr = "";
         //System.out.println("dianliangListjsp:");
                     			
			if(sheng != null && !sheng.equals("") && !sheng.equals("0")){
				whereStr=whereStr+" and sheng='"+sheng+"'";
			}
		 ...
		 if(fylist!=null)
		{
			...
			fzr = fzr != null ? fzr : "";
		    mdstatus = (String)fylist.get(k+fylist.indexOf("MANUALAUDITSTATUS_STATION"));
			mdstatus = mdstatus != null ? mdstatus : "";
       ...
       %>
       <%if(mdstatus!=null&&mdstatus.equals("1")){ %>
       ...
       <tr bgcolor="<%=color%>">
            <td>
              <div align="center"><input type="checkbox" name="test[]" value="<%=id %>" /></div>
       		...
       		<!-- 
            <td>
       			<div align="center" ><a href="javascript:showDetail('<%=id%>')" >查看</a></div>
       		</td>
       		 -->
       		 <%if(mdstatus!=null&&mdstatus.equals("1")){ %>
       		<td>
  ...
  <input type="hidden" name="xiaoqu2" id="xiaoqu2" value=""/>
   ...
   <tr bgcolor="F9F9F9">
     ...
     <td align="right">
                               <input type="button" name="add1" id="id1" value="通过" onclick="passCheck()"  style="color:#014F8A"/>
                               &nbsp;&nbsp;&nbsp;                               
                               <input type="button" name="exportad1" id="id1" value="不通过" onclick="passCheckNo()"  style="color:#014F8A"/>
                           </td>
</table>
</form>
</body>
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/check/checkStationPointManual.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/check/checkStationPointManual.jsp?curpage="+pageno;
      document.form1.submit();
     }
     </script>
...
function passCheckNo(){
        ...
        if(bz=="1"){
            document.form1.action=path+"/servlet/check?action=checkspno&chooseIdStr="+chooseIdStr;
            document.form1.submit();
        }else{
          alert("请选择信息！");
        }
	...
	function passCheck(){
        ...
        if(bz=="1"){
           document.form1.action=path+"/servlet/check?action=checksp&chooseIdStr="+chooseIdStr;
           document.form1.submit();
        }else{
          alert("请选择信息！");
        }
