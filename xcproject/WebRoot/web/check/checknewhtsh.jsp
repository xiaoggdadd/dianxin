  ...
  function passCheck(){
    ...
    function queryDegree(){
         if(document.getElementById("shi").value==""||document.getElementById("shi").value=="0"||document.getElementById("shi").value==null){
                   ...
                   document.form1.action=path+"/web/check/checknewhtsh.jsp?command=chaxun";
                   document.form1.submit();
       }
    }
  $(function(){
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0" height="18%">
         ...
         String whereStr = "";
			...
			if(beginTimeQ != null && beginTimeQ != "" && !beginTimeQ.equals("0")){
				whereStr=whereStr+" AND P.STARTMONTH>='"+beginTimeQ+"'";
			}
			if(endTimeQ != null && endTimeQ != "" && !endTimeQ.equals("0")){
				whereStr=whereStr+" AND P.ENDMONTH<='"+endTimeQ+"'";
			}
			if(bzyf != null && bzyf != ""){
						whereStr=whereStr+" AND P.ACCOUNTMONTH ='"+bzyf+"'"; 
					}
