		...
		if(checkNotnull(document.form1.lastdatetime,"上次抄表时间")&&checkNotnull(document.form1.thisdatetime,"本次抄表时间")
	       	&&checkNotnull(document.form1.lastdegree,"上次电表读数")&&checkNotnull(document.form1.thisdegree,"本次电表读数")&&checkNotnull(document.form1.startmonth,"起始时间")&&checkNotnull(document.form1.endmonth,"结束时间")){	
				var reg = /^(\d{4})-(0\d{1}|1[0-2])-(0\d{1}|[12]\d{1}|3[01])$/;//yyyy-mm-dd
	       		...
	       		var ipt = document.form1.inputdatetime.value;//当前时间
	       		var kpt = document.form1.kptime.value;//开票时间
	       		var ntt = document.form1.notetime.value;//票据时间
	       		var pdt = document.form1.paydatetime.value;//交费时间
	       		var reg1 = /^(\d{4})-(0\d{1}|1[0-2])$/;//yyyy-mm
				var sm = document.form1.startmonth.value;//起始时间
				var em = document.form1.endmonth.value;//结束时间
				
				var am = document.form1.accountmonth.value;//报账月份
	       		if(reg.exec(ldt)){
					if(reg.exec(tdt)){
						if(reg1.exec(sm)){
							if(reg1.exec(em)){
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td valign="top">
														...
														<td height="49" bgcolor="#FFFFFF">
															<table width="100%" border="0" cellspacing="1"
																...
																<%
																	...
																	String autoauditstatus = bean.getAutoauditstatus();
																	String autoauditdescription = bean.getAutoauditdescription();
																	
																	//电量数据处理
																	AmmeterDegreeFormBean beanad = new AmmeterDegreeFormBean();
																	beanad = beanad.getLastAmmeterModfiyDegree(bean.getAmmererid(),
																			bean.getAmmeterdegreeid());
																	String lastad = beanad.getLastdegree();
																	if (lastad.equals("")) {
																		System.out.println("上次电表读数为空！");
																		AmmeterDegreeFormBean beanada = new AmmeterDegreeFormBean();
																		beanada = beanada.getStartAmmeterModfiyDegree(bean
																				.getAmmererid());
																...
																<tr>
																	<input type="hidden" name="lastad" value="<%=lastad%>"
																		class="form" />
																</tr>
																...
																<tr>
																	...
																	<td width="35%">
																		<input type="text" name="ammeteridFk" 
																			value="<%=bean.getAmmererid()%>" class="form" readonly="readonly"/>
																...
																<tr>
																	...
																	<td width="35	%">
																		<input type="text" name="lastdegree"
																			value="<%=bean.getLastdegree()%>"
																			onChange="javascript:document.form1.actualdegree.value=(parseFloat(document.form1.thisdegree.value-document.form1.lastdegree.value)+parseFloat(document.form1.floatdegree.value))"
																			class="form" />
																	...
																	<td>
																		<input type="text" name="thisdegree"
																			value="<%=bean.getThisdegree()%>"
																			onChange="javascript:document.form1.actualdegree.value=(parseFloat(document.form1.thisdegree.value-document.form1.lastdegree.value)+parseFloat(document.form1.floatdegree.value))"
																			class="form" />
																	</td>
																	...
																	<tr>
																		...
																		<tr>
																			...
																			<td>
																				<input type="text" name="lastdatetime"
																					value="<%=bean.getLastdatetime()%>"
																			...
																			<td>
																				<input type="text" name="thisdatetime"
																					value="<%=bean.getThisdatetime()%>"
																					onFocus="getDateString(this,oCalendarChs)"
																		...
																		<tr>
																			...
																			<td>
																				<input type="text" name="floatdegree"
																					value="<%=bean.getFloatdegree()%>"
																					onChange="javascript:document.form1.actualdegree.value=(parseFloat(document.form1.thisdegree.value-document.form1.lastdegree.value)+parseFloat(document.form1.floatdegree.value))"
																					class="form" />
																			</td>
																			<td height="19" bgcolor="#DDDDDD">
																			...
																			<td>
																				<input type="text" name="actualdegree"
																					value="<%=bean.getActualdegree()%>" class="form" />
																			</td>
																		</tr>
																		...
																		<tr>
																			...
																			<td>
																				<input type="text" name="inputoperator"
																					value="<%=bean.getInputoperator()%>" class="form" />
																			</td>
																			<td height="19" bgcolor="#DDDDDD">
																				<div >
																					当前时间：
																			...
																			<td>
																				<input type="text" name="inputdatetime"
																					value="<%=bean.getInputdatetime()%>"
																					onFocus="getDateString(this,oCalendarChs)"
																					class="form" />
																			</td>
																		</tr>
																		...
																		<tr>
																			...
																			<td colspan="2">
																				<input type="text" size="20" name="memo"
																					value="<%=bean.getMemo()%>" class="form" />
																			</td>
																			<td>
																				<input type="hidden" size="50"
																					name="autoauditstatus"
																					value="<%=bean.getAutoauditstatus()%>"
																					class="form" />
																			</td>
																			<td>
																				<input type="hidden" size="50"
																					name="autoauditdescription"
																					value="<%=bean.getAutoauditdescription()%>"
																					class="form" />
																			</td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			...
																			<td width="35%">
																				<input type="text" name="ammeterdegreeidFk"
																					value="<%=bean.getAmmeterdegreeidFk()%>"
																			...
																			<td>
																				<input type="text" name="floatpay"
																					value="<%=bean.getFloatpay()%>" class="form" />
																			</td>
																		</tr>
																		...
																		<tr>
																			...
																			<td width="35	%">
																				<input type="text" name="unitprice"
																					value="<%=bean.getUnitprice()%>" class="form" />
																			...
																			<td>
																				<input type="text" name="kptime"
																					value="<%=bean.getKptime()%>"
																			...
																			<tr>
																				...
																				<tr>
																					...
																					<td>
																						<input type="text" name="actualpay"
																							value="<%=bean.getActualpay()%>" class="form"
																							maxlength="11" />
																				...
																				<tr>
																					...
																					<td>
																						<input type="text" name="noteno"
																							value="<%=bean.getNoteno()%>" class="form" />
																					</td>
																				</tr>
																				...
																				<tr>
																					...
																					<td>
																						<input type="text" name="payoperator"
																							value="<%=bean.getPayoperator()%>" class="form" />
																					</td>
																					<td height="19" bgcolor="#DDDDDD">
																						<div >
																							交费时间：
																					...
																					<td>
																						<input type="text" name="paydatetime"
																							value="<%=bean.getPaydatetime()%>"
																							onFocus="getDateString(this,oCalendarChs)"
																							class="form" />
																					</td>
																				</tr>
																				...
																				<td>&nbsp;</td>
																					...
																					<div id="cancelBtn" style="width:60px;height:23px;cursor:pointer;float:right;position:relative;right:-330px">
          																		  ...
          																		  <div id="resetBtn" style="width:60px;height:23px;cursor:pointer;float:right;position:relative;right:-328px">
          																		...
          																		<div id="saveBtn" style="width:60px;height:23px;cursor:pointer;float:right;position:relative;right:-326px">
						...
						<input type="hidden" name="blhdl" value="<%=blhdl%>" />
						<input type="hidden" name="autoauditstatus" value="<%=autoauditstatus%>" />
						<input type="hidden" name="autoauditdescription" value="<%=autoauditdescription%>" />
						</form>
	</body>
</html>
