...
<script src="<%=path%>/javascript/PopupCalendar_ny.js"></script>
	...
	<script language="javascript">
		...
		function queryDegree() {
		         //alert(111);
				document.form1.action = path+ "/web/jzcbnewfunction/xfshishenhe.jsp?command=chaxun";
...
%>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
			    	<td colspan="4" width="50" >
						 <div style="width:700px;height:50px">
						  ...
						  <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">市级整改审核</span>	
						 </div>
					</td>
				</tr>
				<tr>
				...
				<tr>
		         ...
		         %>
								...
								<td>
									<div id="chaxun"
										style="position: relative; width: 60px; height: 23px; cursor: pointer; left: 40px; float: right; top: 0px">
								...
								<td>市级审核状态：</td>
         						...
         						<td><select name="shengshenhe" class="selected_font">
									...
									<option value="3">退单</option>
         							...
         							<td>站点名称：</td>
	         		<td><input type="text" class="selected_font" name="zdnamea" value="<%if(null!=request.getParameter("zdnamea")) out.print(request.getParameter("zdnamea")); %>" /></td>
	         		<td>站点属性：
								</td>
								<td>
	 ...
	 cbzddao  bean=new cbzddao();
         ...
         String str="";
			...
			if(shenhe != null && shenhe != "" && !shenhe.equals("5")){
				whereStr=whereStr+" AND x.SJSHBZ ='"+shenhe+"'";
				
			}
			if(shengshenhe != null && shengshenhe != "" && !shengshenhe.equals("5")){
				whereStr=whereStr+" AND x.SHENGJSHBZ ='"+shengshenhe+"'";
	...
	<%
		...
		if("daochu".equals(request.getParameter("command"))||"chaxun".equals(request.getParameter("command"))){
		       list	=bean.getxfshishenhe(whereStr,loginId);
		}else{
			list=null;
		}
		String id="";
		...
		String sjyqwtdyy="";//省级要求未通过原因
		String sjshzt="";//省级审核状态
		String sjshzt1="";//"省级审核状态"
		...
		if(list!=null){
			for(Zdinfo bean2:list){
				...
				dgh=bean2.getDgpch();
				pch=bean2.getYppch();
				sjyqwcsj=bean2.getSjyqwcsj();
				sjyqwtdyy=bean2.getSjyqwtgyy();
				sjshzt=bean2.getShengjshbz();
				szdq=shi1+xian1+xiaoqu1;
				sjshzt1=bean2.getShengjshbz();
				nhbz=bean2.getNhbz();
				scb=bean2.getScb();
				
				if(null==wcsj||"".equals(wcsj)||"null".equals(wcsj)||" ".equals(wcsj)){
					wcsj="";
				}else{
					wcsj=wcsj.substring(0,10);
				}
				if(null==nhbz||"".equals(nhbz)||"null".equals(nhbz)||" ".equals(nhbz)){
					nhbz="";
				}
				if(null==scb||"".equals(scb)||"null".equals(scb)||" ".equals(scb)){
					scb="";
				}
				if(null==sjshzt1||"".equals(sjshzt1)||"null".equals(sjshzt1)){
				sjshzt1="0";
				}
				System.out.println("-----"+sjshzt);
			if(zdid==null ||zdid.equals("null")||zdid.equals("")||zdid.equals(" ")||zdid==""){
				...
				if(sjyqwcsj==null ||sjyqwcsj.equals("null")||sjyqwcsj.equals("")||sjyqwcsj.equals(" ")||sjyqwcsj==""){
					sjyqwcsj="";
				}
				if(sjyqwtdyy==null ||sjyqwtdyy.equals("null")||sjyqwtdyy.equals("")||sjyqwtdyy.equals(" ")||sjyqwtdyy==""){
					sjyqwtdyy="";
				}
				if(sjshzt==null ||sjshzt.equals("null")||sjshzt.equals("")||sjshzt.equals(" ")||sjshzt==""){
					sjshzt="0";
				}
			...
			if(sjshzt != null&& sjshzt.equals("1")){
				...
				sjshzt="未审核";
			}else if(sjshzt != null && sjshzt.equals("3")){
				sjshzt="退单";
			}
			if (intnum % 2 == 0) {
					color = "#FFFFFF";
     ...
     %>
				...
				<%} %>
						...
						<td>
							<div align="left"><%=sjyqwtdyy%></div>
						</td>
						<td>
							<div align="left"><%=sjyqwcsj%></div>
						</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<div id="butongguo"
						...
						<div id="tongguo" style="width:85px;height:23px;cursor:pointer;float:right;position: relative; right:0px; top: 0px">
						<img  src="<%=path %>/images/mmcz.png" width="100%" height="100%">
...
<script type="text/javascript">	
	function lookDetailssz(id) {
		var path = '<%=path%>';
		//alert(id);
		window.open(path + "/web/jzcbnewfunction/shishenhexx.jsp?id=" + id, '',
       		...
       		//if(cuu!=""&&cuu!=null){
		        ...
		        for(var i = 0; i < l; i++){
		         if(m[i].checked == true){
		          ...
		          document.form1.action=path+"/servlet/Cbzdsjshenhe?action=xfshish&chooseIdStr1="+chooseIdStr1+"&loginName="+loginName;
					document.form1.submit();
	        ...
	        for(var i = 0; i < l; i++){
	         if(m[i].checked == true){
	             ...
	             count1+=1;
	              ...
	              chooseIdStr1=chooseIdStr1.substring(0,chooseIdStr1.length-1);
		          document.form1.action=path+"/servlet/Cbzdsjshenhe?action=xfshishno&chooseIdStr1="+chooseIdStr1+"&loginName="+loginName;
				  document.form1.submit();
	      /*       var j = m[i].value.toString().indexOf("ssss=");
	             var chooseIdStr3 = m[i].value.toString().substring(0,j);
	             var zflx1 = m[i].value.toString().substring(j+5,m[i].value.toString().length);
	        ...
	        for(var i = 0; i < l; i++){
	         if(m[i].checked == true){
	             ...
	             count1+=1;
	              ...
	              chooseIdStr1=chooseIdStr1.substring(0,chooseIdStr1.length-1);
		          document.form1.action=path+"/servlet/Cbzdsjshenhe?action=chehui&chooseIdStr1="+chooseIdStr1+"&loginName="+loginName;
				  document.form1.submit();
