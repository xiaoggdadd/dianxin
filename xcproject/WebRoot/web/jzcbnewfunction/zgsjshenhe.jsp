...
<%@ page import="com.noki.newfunction.dao.zgsjdao" %>
<%
	...
	String sjshenhe = request.getParameter("shenhe") != null? request.getParameter("shenhe") : "0";
	  System.out.println("sjshenhe="+sjshenhe);
...
<script src="<%=path%>/javascript/PopupCalendar_ny.js"></script>
	...
	<script language="javascript">
		...
		function queryDegree() {
		         //alert(111);
				document.form1.action = path+ "/web/jzcbnewfunction/zgsjshenhe.jsp?command=chaxun";
...
%>
	<body class="body" style="overflow-x: hidden;">
				...
				<tr>
		         ...
		         %>
								...
								<td>
									...
									<div id="chaxun"
										style="position: relative; width: 70px; height: 23px; cursor: pointer; left: 50px; float: left; top: 0px">
	 ...
	 zgsjdao bean=new zgsjdao();
		...
		String strDate = accountmonth;
		Date accountmonth1=sdf.parse(strDate);
		sdf.format(accountmonth1);*/
			...
			if(shenhe!=null && shenhe!="" && !shenhe.equals("5")){
				whereStr=whereStr+" AND S.SJSHZT ='"+shenhe+"'";
			}
	...
	<%
		...
		if("daochu".equals(request.getParameter("command"))||"chaxun".equals(request.getParameter("command"))){
		       list	=bean.getZgshishenhe(whereStr,loginId);
		}else{
			list=null;
		}
		String id="";
		...
		String sjshenhezt = "";//市级审核状态
		String sjshzt="";//市级审核状态
		String sjeshzt="";//市级二审核状态
		int intnum=0;
		if(list!=null){
			for(zgsj bean2:list){
				id=bean2.getId();
		...
		if(shi2==null ||shi2.equals("null")||shi2.equals("")||shi2.equals(" ")||shi2==""){
				shi2="";
		}
		if(xian2==null ||xian2.equals("null")||xian2.equals("")||xian2.equals(" ")||xian2==""){
				xian2="";
		}
		if(xiaoqu2==null ||xiaoqu2.equals("null")||xiaoqu2.equals("")||xiaoqu2.equals(" ")||xiaoqu2==""){
				xiaoqu2="";
		}
		if(jzname==null ||jzname.equals("null")||jzname.equals("")||jzname.equals(" ")||jzname==""){
				jzname="";
		}
		if(jztype==null ||jztype.equals("null")||jztype.equals("")||jztype.equals(" ")||jztype==""){
				jztype="";
		}
		if(lastzgtime==null ||lastzgtime.equals("null")||lastzgtime.equals("")||lastzgtime.equals(" ")||lastzgtime==""){
				lastzgtime="";
		}else{
			lastzgtime= lastzgtime.substring(0,10);
		}
		if(thiszgtime==null ||thiszgtime.equals("null")||thiszgtime.equals("")||thiszgtime.equals(" ")||thiszgtime==""){
				thiszgtime="";
		}else{
			thiszgtime= thiszgtime.substring(0,10);
		}
		if(sdb==null ||sdb.equals("null")||sdb.equals("")||sdb.equals(" ")||sdb==""){
				sdb="0";
		}
		if(danjia==null ||danjia.equals("null")||danjia.equals("")||danjia.equals(" ")||danjia==""){
				danjia="0";
		}
		if(zgmonth==null ||zgmonth.equals("null")||zgmonth.equals("")||zgmonth.equals(" ")||zgmonth==""){
				zgmonth="";
		}/*else{
			zgmonth= zgmonth.substring(0,10);
		}*/
		
		if(zgdianfei==null ||zgdianfei.equals("null")||zgdianfei.equals("")||zgdianfei.equals(" ")||zgdianfei==""){
				zgdianfei="0";
		}
		if(rgshenhezt==null ||rgshenhezt.equals("null")||rgshenhezt.equals("")||rgshenhezt.equals(" ")||rgshenhezt==""){
				rgshenhezt="";
		}
		if(sjshenhezt==null ||sjshenhezt.equals("null")||sjshenhezt.equals("")||sjshenhezt.equals(" ")||sjshenhezt==""){
				sjshenhezt="";
		}
		if(sjeshzt==null ||sjeshzt.equals("null")||sjeshzt.equals("")||sjeshzt.equals(" ")||sjeshzt==""){
				sjeshzt="";
		}
		if(rgshenhezt != null&& rgshenhezt.equals("1")){
				rgshenhezt="通过";
			}else if(rgshenhezt != null	&& rgshenhezt.equals("2")){
				rgshenhezt="不通过";
			} else if(rgshenhezt != null	&& rgshenhezt.equals("0")){
				rgshenhezt="未审核";
			}
		if(sjshzt != null&& sjshzt.equals("1")){
				sjshzt="审核通过";
			}else if(sjshzt != null	&& sjshzt.equals("2")){
				sjshzt="审核不通过";
					...
					<tr bgcolor="<%=color%>">
						...
						<td>
							<div align="center">
								...
								<input type="hidden" type="checkbox"  name="test1[]" value="<%=sjeshzt%>" />
								
							</div>
						</td>
						<td>
							<div align="left"><%=shi2%></div>
						</td>
						<td>
						...
						<td>
							<div align="left"><%=jztype%></div>
						</td>
						<td>
							<div align="left"><%=lastzgtime%></div>
						</td>
						<td>
							<div align="center"><%=thiszgtime%></div>
						</td>
						<td>
							<div align="right"><%=sdb%></div>
						</td>
						...
						--%><td>
							<div align="left"><%=zgdianfei%></div>
						</td>
						<td>
							<div align="left"><%= rgshenhezt%></div>
						</td>
						<td>
				...
				<tr>
					...
					<td align="right">
						...
						<img  src="<%=path %>/images/mmcz.png" width="100%" height="100%">
						 <span style="font-size: 12px; position: absolute; left: 35px; top: 5px; color: white">同意</span>
...
<script type="text/javascript">
	...
	//审核通过
	  ...
	  var loginName='<%=loginName%>';
        ...
        var sjeshzt1 = document.getElementsByName('test1[]');
      //  var cuu=document.form1.currentmonth.value;
        ...
        var count2=0;
       	...
       	for(var i = 0; i < l; i++){
       		...
       		if(m[i].checked == true){
       			if(sjeshzt1[i].value=='1'){
       			con++;
       			}
       		}
       	}
       //	if(sjeshzt1==1){
       	//   alert("市级领导审核已经通过不允许此操作！");
       //	}else 
       	if(con!=0){
       	alert("市级领导审核已经通过不允许此操作！");
       	return;
       		...
       		//if(cuu!=""&&cuu!=null){
		        ...
		        for(var i = 0; i < l; i++){
		         if(m[i].checked == true){
		          ...
		          document.form1.action=path+"/servlet/ZGsjServlet?action=zgshtg&chooseIdStr1="+chooseIdStr1+"&loginName="+loginName;
					document.form1.submit();
	        ...
	        for(var i = 0; i < l; i++){
	         if(m[i].checked == true){
	             ...
	             count1+=1;
	              ...
	              chooseIdStr1=chooseIdStr1.substring(0,chooseIdStr1.length-1);
		          document.form1.action=path+"/servlet/ZGsjServlet?action=zgsjshenheno&chooseIdStr1="+chooseIdStr1+"&loginName="+loginName;
				  document.form1.submit();
	      /*       var j = m[i].value.toString().indexOf("ssss=");
	             var chooseIdStr3 = m[i].value.toString().substring(0,j);
	             var zflx1 = m[i].value.toString().substring(j+5,m[i].value.toString().length);
       	...
       	if(count!=0){
		        ...
		        for(var i = 0; i < l; i++){
		         if(m[i].checked == true){
		          ...
		          chooseIdStr1=chooseIdStr1.substring(0,chooseIdStr1.length-1);
		          document.form1.action=path+"/servlet/ZGsjServlet?action=zgsjquxiaosh&chooseIdStr1="+chooseIdStr1+"&loginName="+loginName;
					document.form1.submit();
...
<script type="text/javascript">
		...
		document.form1.shenhe.value = '<%=sjshenhe%>';
	</script>
</html>
