...
<table x:str border=1 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
	  ...
	  <td class=xl25 width=72 style='border-left:none;width:54pt'>本地定标(度)</td>
	  <td class=xl25 width=72 style='border-left:none;width:54pt'>电表用电量(度) </td>
	  <td class=xl25 width=152 style='border-left:none;width:54pt'>标准值(合并周期*生产标) </td>
...
if(!"".equals(bl)){
 ...
 //	str4.append(" or (ZDDL.DLCB>=ABS('"+dlcb+"') OR (ZDDL.DLCB * 0.9)>=ABS('"+dfcb+"'))");
 //}else{
 	//if(null !=dlcb&& !"".equals(dlcb)&& !" ".equals(dlcb)&& dlcb!=" " && dlcb!=""){
 	//	str4.append(" or ZDDL.DLCB>=ABS('"+dlcb+"')");
 	//}
 //	if(null !=dfcb&& !"".equals(dfcb)&& !" ".equals(dfcb)&& dfcb!=" " && dfcb!=""){
 //		str4.append(" or (ZDDL.DLCB * 0.9)>=ABS('"+dfcb+"')");
 //	}
