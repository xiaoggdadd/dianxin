					...
					<td width="83%" scope="2">
						<table width="100%" border="0" cellspacing="1" cellpadding="1">
							...
							<tr>  
								...
								<td>
									<input type="text" name="jlzfh" value="<%=jlzfh %>" onblur="getJl()" class="form1"/>
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
									<div>直流总负荷(A)(不含空调)</div>
								</td>
								<td>
									<input type="text" name="zlzfh" value="<%=zlzfh %>" onblur="getZl()" class="form1"/>
								</td>
							</tr>
							<tr>
							<td bgcolor="#DDDDDD" class="form_label">
								...
								<td>
									<input type="text" name="qsdb" value="<%=qsdb %>" class="form1"/>
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
									<div>
										找回损失电量：
								...
								<td colspan='7'>
									<input type="text" name="zhssdl" value="<%=zhssdl %>" class="form1" />
								</td>
							</tr>
							...
							<td bgcolor="#DDDDDD" class="form_label">
								...
								<td bgcolor="#DDDDDD" class="form_label">
									<div>验收省定标电量(不含空调)</div>
								</td>
								<td>
									<input type="text" name="yssdbdl" value="<%=yssdbdl %>" class="form1" />
								</td>
							</tr>
							<tr>
								<td bgcolor="#DDDDDD" class="form_label">
							...
							<tr>
								...
								<td colspan='7'>
									<input type="text" name="wcsm" value="<%=wcsm %>" class="form2" />
								</td>
							</tr>
							...
							<tr>
								...
								<td colspan='7'>
									<input type="text" name="zgfzr" value="<%=zgzrr %>" class="form2" />
								</td>
							</tr>
							<tr height="19px">
