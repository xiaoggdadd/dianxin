           ...
           <tr class="relativeTag" >
            <td width="5%" bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn">序号</div></td>
             <td width="5%" bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn">地市</div></td>
              <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">区县</div></td>
             ...
             <td width="15%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">站点名称</div></td>
              ...
              <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">电表用电量电量(度)</div></td>
              <td width="10%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">转换标准电量(度)</div></td>
              <td width="10%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">超标比例</div></td>
               <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">上月管理电表用电量(度)</div></td>
               <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">上月转换标准电量(度)</div></td>
               <td width="10%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">超标比例</div></td>
         </tr>
       <% 		 
		...
		int intnum=0;
		 int countt=1;       
        String shi="",xian="",xiaoqu="",zdid="",jzname="",property="",jsrjhdl="",jsqsdbdl="",jscbbl="",glrjhdl="",glqsdbdl="",glcbbl=""; 
        
        fylist = bean.getJsdlcbNew(shiname,bzyf,bzyf02,cbbl,cbblsyc,loginId,property1);
		  ...
		  if(fylist!=null){
         	...
         	jsrjhdl=beans.getJsrjhdl();
         	jsqsdbdl=beans.getJssdb();
			jscbbl = beans.getJscbbl();
			glrjhdl=beans.getGlrjhdl();
			glqsdbdl=beans.getGlsdb();
			glcbbl=beans.getGlcbbl();
			 
			 
			DecimalFormat mat = new DecimalFormat("0.00");
			glcbbl = mat.format(Double.parseDouble(glcbbl));
			jscbbl = mat.format(Double.parseDouble(jscbbl));
