...
function chaxun() {
	if (document.getElementById("endTime").value == ""
		...
		var a = "<a href='<%=path %>/web/tongjichaxun/dqelectricin01.jsp?";
...
if(targetObj.style.display!="none"){
   ...
   if(openTip  &&  shutTip){
		...
		<form action="" name="form1" method="POST">
                ...
                <tr >
			     <td colspan="4" width="50" >
					 <div style="width:700px;height:50px">
							...
							<span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">地区电费汇总</span>	
					</div>
				</td>
	    	   </tr>
         ...
         <td>
	         ...
	         %>
						      ...
						      <td>供电方式：</td><td>
						      <select name="gdfs" class="selected_font" onchange="javascript:document.form1.manauditstatus2.value=document.form1.manauditstatus.value">         		
	...
	<iframe name="treeMap" background-position-x ="1%" name="treeMap" width="85%" height="500px" frameborder="0" src="<%=path%>/web/tongjichaxun/dqelectricin01.jsp"></iframe>
    <br/>
