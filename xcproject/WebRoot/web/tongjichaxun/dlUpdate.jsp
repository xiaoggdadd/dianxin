...
function daoru(){
	...
	if(document.getElementById("BeginTime").value == ""){
		...
		showdiv("请稍等..............");
		document.form1.action=path+"/servlet/zhandian?action=dlUpdate";
          			...
          			<tbody>
           				 <tr id="SearchRegion">
                              ...
                              <td width="95%" >
                              	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                	<tr>
                                  		<td height="46" colspan="4"><span class="style1"> 全省定标电量更新</span></td>
                                	</tr>
                                	<tr>
                                	...
                                	<tr>
                                  		<td height="39" valign="top">月份：<input type="text" name="BeginTime" 
                                  												  value="<%if(null!=request.getParameter("BeginTime")) out.print(request.getParameter("BeginTime")); %>" 
                                  												  readonly="readonly" class="Wdate" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM'})"  class="form" style="width:130px;"/>          　
                                 　                                                       	  			<div id="import" style="position: relative; width: 59px; height: 23px; cursor: pointer; left: 35%; TOP: -23PX " >
                                	...
                                	<tr>
                                  		<td height="51" colspan="4"><div align="center"></div></td>
                                	</tr>
                              	</table>
                              </td>
