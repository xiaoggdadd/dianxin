	   ...
	   <tr><td>
	    	...
	    	<td>城市：</td>
		         ...
		         %>
		    		...
		    		<td>起始月份：</td>
		    		<td><input type="text" name="qsyf" value="<%if (null != request.getParameter("qsyf")) out.print(request.getParameter("qsyf"));%>" onFocus="getDatenyString(this,oCalendarChsny)" class="selected_font" /></td>
		    		<td>结束月份：</td>
		    		<td><input type="text" name="jsyf" value="<%if (null != request.getParameter("jsyf")) out.print(request.getParameter("jsyf"));%>" onFocus="getDatenyString(this,oCalendarChsny)" class="selected_font" /></td>
         			<td>
							<p><font size="2">
  ...
  <div style="width:88%;" > 
		<p id="box3" style="display:none">
			...
			<tr class="form_label">
         	...
         	<td>站点类型：</td>
         	<td><select name="jzlx" class="selected_font" onchange="kzinfo()">
         		<option value="0">请选择</option>
         		<%
	         ...
	         %>
         	 ...
         	 <td>站点名称：</td>
         <td><input type="text" name="zdname" class="selected_font"/></td>
        ...
        <td>归属方：</td><td><select name="gsf" class="selected_font" >
						        ...
						        <td>供电方式：</td><td><select name="gdfs" class="selected_font" onchange="javascript:document.form1.manauditstatus2.value=document.form1.manauditstatus.value">         		
