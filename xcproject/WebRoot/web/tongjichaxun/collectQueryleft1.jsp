...
var path = '<%=path%>';   
    function modifyad(id,dbid){
    	var b=path+"/web/tongjichaxun/collectQueryright1.jsp?id="+id+"&dbid="+dbid+"&";			
			...
			$("body").append(a);
			$("#tmpTree")[0].click();   
	  var c=path+"/web/tongjichaxun/collectQueryMap.jsp?id="+id+"&dbid="+dbid+"&";			
...
<body  class="body" >
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label" >
     <tr height = "20" class="relativeTag">
      <td width="3%" bgcolor="#DDDDDD"><div align="center" style="font-weight:bold;">序号</div></td>
         <td width="4%" bgcolor="#DDDDDD"><div align="center" style="font-weight:bold;">基站id</div></td>     
         <td width="4%" bgcolor="#DDDDDD"><div align="center" style="font-weight:bold;">区县</div></td>
         <td width="8%" bgcolor="#DDDDDD"><div align="center" style="font-weight:bold;">站点名称</div></td>                     
       ...
       <td>
       		...
       		-->
       		 <td>
       			...
       			<div align="center"><a href="javascript:modifyad('<%=jzid%>','<%=dbid%>','<%=jzname1%>')" /><%=jzname1%></div>
       		</td>
...
<script language="javascript">
var path = '<%=path%>';   
    function modifyad(id,dbid,jzname1){
    	var b=path+"/web/tongjichaxun/collectQueryright1.jsp?id="+id+"&dbid="+dbid+"&";			
			b = b.substring(0,b.length-1);
			 var a = " <a href="+b+" target='treeNodeInfo' id='tmpTree'></a>";
			$("#tmpTree").remove();
			$("body").append(a);
			$("#tmpTree")[0].click();   
			 var c=path+"/web/tongjichaxun/collectQueryMap.jsp?id="+id+"&dbid="+dbid+"&jzname="+jzname1+"&";			
			c = c.substring(0,b.length-1);
			 var a = " <a href="+c+" target='treeMap1' id='tmpTree'></a>";
			$("#tmpTree").remove();
			$("body").append(a);
			$("#tmpTree")[0].click();   
			 ...
			 var d=path+"/web/tongjichaxun/collectQueryMap1.jsp?id="+id+"&dbid="+dbid+"&jzname="+jzname1+"&";			
			d = d.substring(0,b.length-1);
			 var a = " <a href="+d+" target='treeMap2' id='tmpTree'></a>";
			$("#tmpTree").remove();
			$("body").append(a);
			$("#tmpTree")[0].click(); 
    } 
