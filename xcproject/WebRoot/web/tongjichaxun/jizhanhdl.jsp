...
<%
  ...
  String crym=fordate.format(currentTime);
	...
	String color="";
		...
		String bl=request.getParameter("bl")!=null?request.getParameter("bl"):"";
		String bzmonth=request.getParameter("bzmonth")!=null?request.getParameter("bl"):"";
         String canshuStr="";
  ...
  function chaxun(){
    ...
    function getValue(va,sql){
       ...
       htmlsql.value = sql;    
    	...
    	function selectTree(){
			var a = "<a href='<%=path %>/web/tongjichaxun/collectQueryleft1.jsp?";
...
<body  class="body">
		<form action="" name="form1" method="POST">
			<table width="100%"  border="0" cellspacing="0" cellpadding="0" height="18%">
			        <tr>
							...
							<div style="width:700px;height:50px"><span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">基站月耗电量趋势查询</span>												</div>					  </td>
	    	        </tr>	    	
	    	  <tr>
			...
			<tr>
				...
				<table>
					...
					<td>站点名称：</td>
						<td><input class="selected_font" type="text"name="zdname" />
						</td>
					<td colspan=4>
					<div id="query2" style="position:relative;width:59px;height:23px;cursor:pointer; float: left; left: 200px;">
  ...
  <input type="hidden" name="xiaoqu2" id="xiaoqu2" value=""/>
		...
		<iframe name="treeMap" width="450px" height="200px" frameborder="0" src="<%=path%>/web/tongjichaxun/collectQueryleft1.jsp"></iframe>
  	<span style="width:20px"></span>
<iframe name="treeNodeInfo" width="600px" height="200px" frameborder="0" src="<%=path%>/web/tongjichaxun/collectQueryright1.jsp"></iframe>
    <br/>
   <iframe name="treeMap1" width="800px" height="200px" frameborder="0" src="<%=path%>/web/tongjichaxun/collectQueryMap.jsp"></iframe>  
   <span style="width:10px"></span>
    <iframe name="treeMap2" width="800px" height="200px" frameborder="0" src="<%=path%>/web/tongjichaxun/collectQueryMap1.jsp"></iframe>  
	</body>
	<script language="javascript">
	var path = '<%=path%>';
	function gopage()
