    ...
    <% 
	     ...
	     //   }
                  ...
                  String hdl="",m="",mon="";
            		...
            		String last = "",thisd = "",id1="",rhdl="",actualdegree="",actualpay="",llhdl="",szdcode="",stationtype1="",jzproperty1="",jztype1="",lrrq="",shi1="",xian1="",xiaoqu1="";
      ...
      %>
  	 ...
  	 <% if(fylist.size()>0) {%>
  	  <div><img src="<%=path%>/servlet/Yhdl?bz=3&fylist=<%=URLEncoder.encode(paiming.toString(),"utf-8") %>"/></div>
       <%}%>
         <%}%>
  </body>
</html>
