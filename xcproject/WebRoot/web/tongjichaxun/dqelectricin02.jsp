...
<td bgcolor="#DDDDDD" colspan="8"><div align="center" style="font-weight:bold;">基站标准信息</div></td>
</tr>
     <tr height = "20" class="relativeTag">
      <td width="5%" bgcolor="#DDDDDD"><div align="center" style="font-weight:bold;">序号</div></td>
       	...
       	String whereStr = "";
             ...
             if(null!=yf&&!yf.equals("")){
                  ...
                  if(null!=sjyf&&!"".equals(sjyf)){
                 	whereStr=whereStr+" and b.accountmonth='"+sjyf+"'";
                 }
              }
              if("2".equals(yf)){
              if(null!=sjyf&&!"".equals(sjyf)){
       ...
       <td>
       		...
       		<div align="right"><a href="javascript:modifyad('<%=zp%>','<%=zs%>','<%=cj%>','<%=g2%>','<%=g3%>','<%=shi%>','<%=xian%>','<%=bla%>','<%=bd%>','<%=yf%>','<%=bzmonth%>','<%=dyt%>','<%=sjyf%>')" ><%=js%></div>
       		</td>                    		
       </tr>
				<% }}}}%>
