...
<% 
	...
	String xianname=request.getParameter("xianname")!=null?request.getParameter("xianname"):"";
    ...
    <table width="1100px" border="0" cellspacing="1" cellpadding="1" align="center">
           <tr class="relativeTag" >
            <td width="5%" bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn">序号</div></td>
             <td width="8%" bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn">地市</div></td>
              <td width="8%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">区县</div></td>
             ...
             <td width="15%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">站点名称</div></td>
              <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">站点属性</div></td>
              <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">月份</div></td>
              <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">日均耗电量</div></td>
              <td width="7%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">全省定标电量</div></td>
              <td width="7%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">超标比例</div></td>
              <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">月份</div></td>
               <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">日均耗电量</div></td>
       ...
       <% 		 
       ZhenShiXingDao bean=new ZhenShiXingDao();  
		List<cbJzBean> fylist = null;
		
		int intnum=0;
		 int countt=1;       
        String shi="",xian="",xiaoqu="",zdid="",jzname="",property="",cxyf="",cxrhdl="",cxsdb="",cxbl="",ssyyf="",ssyrhdl="",ssysdb="",ssybl=""; 
       
        fylist = bean.getWaq(shiname,xianname,bzyf,cbbl,loginId,property1);
		  ...
		  if(fylist!=null){
             ...
             property = beans.getProperty();
         	 cxyf=beans.getCxyf();
			 cxrhdl=beans.getCxrhdl();
			 cxsdb=beans.getCxsdb();
			 cxbl=beans.getCxbl();
			 ssyyf=beans.getSsyyf();
			 ssyrhdl=beans.getSsyrhdl();
			 ssysdb=beans.getSsysdb();
			 ssybl=beans.getSsybl();
