...
function chaxun() {
	...
	var shi1 = document.form1.shi1.value;
	...
	if (cbjzzg <= 40 && cbjzzg >= 0) {
		if (he == 100 || he == 100.00) {
			if (isNaN(document.form1.zdsxcw.value) == false
				...
				var href = "NewZhenShiXingIfram.jsp?bzyf=" + bzyf + "&bzmonth="
						+ bzmonth + "&property=" + property + "&shi1=" + shi1 +"&xian=" + xian +"&bzw=1&shi=" + shi + "&zdsxcw=" + zdsxcw
...
function changetime() {
	...
	document.form1.action = path + "/web/tongjichaxun/NewZhenShiXing.jsp?bzmonth="
			+ bzmonth;
...
function changemonth() {
	...
	<body class="body" style="overflow-x: hidden;" onload="waitThenDoIt()">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
							...
							<tr class="form_label">
								...
								<td class="form_label">
									<input type="text" name="bzmonth" value="<%=bzmonth%>"
										...
										onpropertychange="changemonth()" style="width: 130px;height:18px" />
								</td>
								<td class="form_label">
									报账月份：
								</td>
								...
								<td class="form_label">
									<select name="shi1" class="selected_font"
										onchange="changeCity()">
										<option value="0">
											请选择
										</option>
		         ...
		         %>
								...
								<td>
									<div id="query"
										style="position: relative; width: 59px; height: 23px; right: -50px; cursor: pointer; TOP: 0PX">
										<img alt=""
		...
		<iframe name="test" name="treeMap" width="100%" height="100%"
			frameborder="0" src="<%=path%>/web/tongjichaxun/NewZhenShiXingIfram.jsp"></iframe>
		<br />
...
function changeCity(){
		var sid = document.form1.shi1.value;
		if(sid=="0"){
			var shilist = document.all.xian;
			shilist.options.length="0";
			shilist.add(new Option("请选项","0"));
