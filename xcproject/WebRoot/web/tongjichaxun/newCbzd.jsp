   ...
   <form action="" name="form1" >
    ...
    <table width="1100px" border="0" cellspacing="1" cellpadding="1" align="center">
           <tr class="relativeTag" >
            <td width="5%" bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn">序号</div></td>
             ...
             <td width="20%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">站点名称</div></td>
              ...
              <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">实际用电量</div></td>
       ...
       ZhenShiXingDao bean=new ZhenShiXingDao();  
		...
		int intnum=0;
		 int countt=1;       
        String shi="",xian="",xiaoqu="",zdid="",jzname="",property="",sjydl="",qsdbdl="",cbbll=""; 
       
        fylist = bean.getCbzd(shiname,xianname,bzyf,cbbl,loginId,property1);
		  ...
		  if(fylist!=null){
         	...
         	sjydl= beans.getSjydl();
       		qsdbdl = beans.getQsdbdl();
       		cbbll = beans.getCbbl();
       ...
       <tr bgcolor="<%=color%>" class="form_label">
       		...
       		<td class="b"><div align="center">
       			<%=countt++%>
       			</div>
       		</td>
       		<td class="c"><div align="left">
       			<%=shi%>
       			</div>
       		</td>
       		<td><div align="left">
