   ...
   <form action="" name="form1" method="POST">
	...
	<script type="text/javascript">
		...
		function cbzd(shicode,bzyf,property,cbbl,loginId) {
			var path = '<%=path%>';
			window.open(path +  "/web/tongjichaxun/Cbzd.jsp?shiname="+shicode+"&bzyf="+bzyf+"&property="+property+"&cbbl="+cbbl+"&loginId="+loginId,'','width=1200,height=500,status=yes,scrollbars=yes,resizable=yes,left=100,top=100')
		}
		function jsdb(shicode,bzyf,property,bzyf02,cbbl,cbblsyc,loginId) {	
			var path = '<%=path%>';
			window.open(path +  "/web/tongjichaxun/Jsdb.jsp?shiname="+shicode+"&bzyf="+bzyf+"&property="+property+"&bzyf02="+bzyf02+"&cbbl="+cbbl+"&cbblsyc="+cbblsyc+"&loginId="+loginId,'','width=1200,height=500,status=yes,scrollbars=yes,resizable=yes,left=100,top=100')
		}
		function lxcb(shicode,bzyf,property,bzyf02,cbbl,cbblsyc,loginId) {	
			var path = '<%=path%>';
			window.open(path +  "/web/tongjichaxun/Lxcb.jsp?shiname="+shicode+"&bzyf="+bzyf+"&property="+property+"&bzyf02="+bzyf02+"&cbbl="+cbbl+"&cbblsyc="+cbblsyc+"&loginId="+loginId,'','width=1200,height=500,status=yes,scrollbars=yes,resizable=yes,left=100,top=100')
		}
		function lxcbzj(shicode,bzyf,property,bzyf02,cbbl,cbblsyc,loginId) {	
			var path = '<%=path%>';
			window.open(path +  "/web/tongjichaxun/Lxcbzj.jsp?shiname="+shicode+"&bzyf="+bzyf+"&property="+property+"&bzyf02="+bzyf02+"&cbbl="+cbbl+"&cbblsyc="+cbblsyc+"&loginId="+loginId,'','width=1200,height=500,status=yes,scrollbars=yes,resizable=yes,left=100,top=100')
		}
