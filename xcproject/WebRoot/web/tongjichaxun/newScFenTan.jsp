    ...
    <table width="1100px" border="0" cellspacing="1" cellpadding="1" align="center">
           ...
           <td width="5%" bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn">序号</div></td>
             <td width="10%" bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn">地市</div></td>
              <td width="15%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">区县</div></td>
             <td width="15%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">乡镇</div></td>
             <td width="10%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">站点id</div></td>
              <td width="10%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">站点名称</div></td>
               <td width="10%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">站点属性</div></td>
               <td width="10%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">站点类型</div></td>
               <!--<td width="10%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">电表id</div></td>
               <td width="10%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">电表名称</div></td>
               --><td width="10%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">分摊比例</div></td>
         </tr>
       <% 		 
       ZhenShiXingDao bean=new ZhenShiXingDao();  
		...
		int intnum=0;
		int countt=1;      
        String shi="",xian="",xiaoqu="",zdid="",jzname="",property="",dbid="",dbname="",stationtype = "",sc=""; 
       System.out.println("===============================");
        fylist = bean.getScft(shiname,xianname,loginId,bzyf);
       ...
       <tr bgcolor="<%=color%>" class="form_label">
       		...
       		<td>
       			<div align="left" ><%=xian%></div>
       		</td>
       		<td>
       			<div align="left" ><%=xiaoqu%></div>
       		</td>
       		<td>
