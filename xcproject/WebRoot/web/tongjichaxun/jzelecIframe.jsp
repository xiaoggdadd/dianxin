...
<%@ page import="com.noki.util.CTime,com.noki.query.caijipoint.javabean.haodianliangBean,com.noki.mobi.common.AccountJzqa,com.noki.mobi.common.zdbzbeanB,com.noki.tongjichaxu.javabean.jzelectriCount,com.noki.tongjichaxu.javabean.jzelebean" %>
...
<td bgcolor="#DDDDDD" colspan="4"><div align="center" style="font-weight:bold;">基站每月缴费情况</div></td>
</tr>
     <tr height = "20" class="relativeTag">
     <td  bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">序号</div></td>
     <td  bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">报账月份</div></td>
     <td  bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">已交站点数量</div></td>
     </tr>
       ...
       if(null !=beginTime&& !beginTime.equals("")){
       	...
       	String qstr ="";
              	...
              	System.out.println("---");
                   jzelectriCount  bean = new jzelectriCount();
                   List<jzelebean> fylist = null;
                   DecimalFormat pay=new DecimalFormat("0.00");
                   fylist = bean.getShiCount(whereStr);
              	   String month = "",ybzcount="";
              	   String hStr ="";
              	   String sstr ="";
              	  String ssss ="";
              		...
              		for(jzelebean bean1:fylist)
              		{  
              		   month  = bean1.getMonth();
              		   ybzcount  = bean1.getYbzcount();
              		   hStr += month+";";
              		   sstr += ybzcount+";";
              		   ssss += month+","+ybzcount+";";
       ...
       <td>
			...
			<div>
			<img src="<%=path%>/servlet/MapjzeleServlet?hStr=<%=hStr%>&sstr=<%=sstr%>"/>
			</div>
			</div>	
				<%}%>	
</form>
