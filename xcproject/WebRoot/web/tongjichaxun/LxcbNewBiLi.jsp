   ...
   <form action="" name="form1" >
    ...
    <table width="1100px" border="0" cellspacing="1" cellpadding="1" align="center">
            ...
            <td width="5%" bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn">序号</div></td>
             ...
             <td width="20%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">站点名称</div></td>
              ...
              <td width="10%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">超标比例</div></td>
               <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">上期电表用电量(度)</div></td>
               <td width="5%" bgcolor="#DDDDDD" class="form_label" ><div align="center" class="bttcn">上期转换标准电量(度)</div></td>
       ...
       <% 		 
        ...
        fylist = bean.getLxcbNew(shiname,bzyf,bzyf02,cbbl,cbblsyc,loginId,property1);
