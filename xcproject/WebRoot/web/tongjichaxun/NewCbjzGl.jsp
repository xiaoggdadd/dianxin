	...
	if (cbjzzg <= 40 && cbjzzg >= 0) {
		if (he == 100 || he == 100.00) {
			if (isNaN(document.form1.zdsxcw.value) == false
				...
				var href = "NewCbjzGlIfram.jsp?bzyf=" + bzyf  + "&property=" + property + "&bzw=1&shi=" + shi + "&zdsxcw=" + zdsxcw
...
function changetime() {
	...
	document.form1.action = path + "/web/tongjichaxun/NewCbjzGl.jsp?bzmonth="
			+ bzmonth;
...
//}
	...
	<body class="body" style="overflow-x: hidden;" onload="waitThenDoIt()">
		...
		<iframe name="test" name="treeMap" width="100%" height="100%"
			frameborder="0" src="<%=path%>/web/tongjichaxun/NewCbjzGlIfram.jsp"></iframe>
		<br />
