   ...
   <form action="" name="form1" method="POST">
    <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
          ...
          <tr class="relativeTag">
            <td bgcolor="#DDDDDD" class="form_label"><div align="center" class="bttcn" style="color:black;font-weight:bold;font-size: 12px">市</div></td>
        ...
        List<DianfeidandayinBean> listt=bean.getFentans(whereStr,loginId,str);
       ...
       <tr class="form_label">
         ...
         <tr>
     	<td>
        <div id="daochu" style="position:relative;width:59px;height:23px;cursor: pointer;left:850%;TOP:200PX">
		 <img alt="" src="<%=request.getContextPath() %>/images/chaxun.png" width="100%" height="100%" />
		 <span style="font-size:12px;position: absolute;left:25px;top:3px;color:white">导出</span>
		</div>
		  <div id="fanhui1" style="position:relative;width:59px;height:23px;cursor: pointer;left:980%;TOP:172PX">
		 <img alt="" src="<%=request.getContextPath() %>/images/chaxun.png" width="100%" height="100%" />
...
<script>
	...
	function daochu1(){
			...
			var str="<%=str%>";
			//alert(whereStr);
			document.form1.action=path+"/web/newgn/市分摊导出.jsp?str="+str+"&whereStr="+whereStr;
		    document.form1.submit();
    }
</script>
