...
<%@ page import="com.noki.util.CTime,com.noki.function.SitePueQuery,com.noki.electricfees.javabean.ElectricFeesFormBean" %>
...
<jsp:useBean id="bean" scope="page" class="com.noki.function.SitePueQuery">
</jsp:useBean>
<body  class="body">
	<table>
		<tr><td colspan="20"  height="30"><div id="parent" style="display:inline">
            <div style="width:50px;display:inline;"><hr></div><font size="2">&nbsp;详细信息列表&nbsp;</font><div style="width:300px;display:inline;"><hr></div>
       	</div></td></tr>
	</table>  	
  <table width="2800px" height="400px"  border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
       ...
       <%
       	...
       	String accountmonth1=request.getParameter("accountmonth");  	
       ...
       //ElectricFeesBean beana=new ElectricFeesBean();
		// List<ElectricFeesFormBean> list=beana.getCounttt(whereStr,loginId);	 
       	// fylist = bean.getinformationdb(dbid1,dfzflx);
       	  List<ElectricFeesFormBean> list=bean.getinformationdb(dbid1,accountmonth1);      	 
