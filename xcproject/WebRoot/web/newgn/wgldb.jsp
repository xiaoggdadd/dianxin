  ...
  function chaxun(){
    ...
    function queryDegree(){
        if(document.getElementById("shi").value==""||document.getElementById("shi").value=="0"||document.getElementById("shi").value==null)
		{
                   ...
                   document.form1.action=path+"/web/newgn/wgldb.jsp?command=chaxun";
                   document.form1.submit();
       }
    }
		...
		<tr >
	      <td colspan="4" width="50"  >
	       <div style="width:700px;height:50px">
												 ...
												 <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">无管理电表的站点查询</span>	
											</div>
											</td>
	    </tr>
	...
	<div style="width:100%;height:300px;overflow-x:auto;overflow-y:auto;border:1px" > 	
       ...
       List<ElectricFeesFormBean> list = null;
		if ( "chaxun".equals(request.getParameter("command"))) {
			...
			list = bean.getWuguanli(whereStr);
		} else {
			list = null;
		}
		int intnum = 0;
		if(list!=null){
			String shi1="",xian1="",xz="",jzname1="",jztype1="",id1="";
...
function exportad(){
            var Str ="<%=whereStr%>";
            //alert(canshuStr);
        	document.form1.action=path+"/web/newgn/无管理电表.jsp?whereStr="+Str;
            document.form1.submit();
   }
