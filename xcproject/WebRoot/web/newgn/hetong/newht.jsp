...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
    ...
    function modifyad(uuid){
                    document.form1.action=path+"/web/newgn/hetong/modifynewht.jsp?uuid="+uuid;
                    document.form1.submit();
       
    }
    
    function queryDegree(){
                   document.form1.action=path+"/web/newgn/hetong/newht.jsp?command=chaxun";
                   document.form1.submit();
    }
      //批量导入
	...
	<form action="" name="form1" method="POST">
               ...
               <tr><td height="5"  colspan="4"><div id="parent" style="display:inline">
					...
					<div style="width:100%;height:300px;overflow-x:auto;overflow-y:auto;border:1px" >
				      <table width="100%" height="70%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
                         ...
                         <td width="8%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">合同编号</div></td>
                         ...
                         <td width="6%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">起始月份</div></td>
                         <td width="6%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">结束月份</div></td>
                          <td width="7%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">报账月份</div></td>
		...
		//}		
         ...
         List<PrepaymentFormBean>  list=null;
          String pjje="",szdq="",dflx="",htbh="",uuid="",zdcode="",jzname="",accountmonth="",stationid = "",jzcode = "",htdbh,manualauditstatus = "",money="",prepayment_ammeterid="",dbname="",startmonth="",endmonth="",id="",stationtype2="";
	   double d;
        if("chaxun".equals(request.getParameter("command"))){
         list=bean.getHtd(whereStr,loginId);
       	// }
       ...
       %>
          <tr bgcolor="<%=color%>">
            ...
            <td>
       		...
       		<td>
       			<div align="center" ><a href="javascript:modifyad('<%=uuid%>')" >修改</a></div>
       		</td>
            <%}}%>
       </tr>
       <% if (intnum==0){
