...
function ShowHideSearchRegion(trObject,SelfObject)
{
 ...
 function getPublicPath(){
  ...
  var zdlx=document.form1.zdlx.value;//zdlx
	   ...
	   //var href = "fentanchaxun_iframe1.jsp?shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu+"&bzyf="+bzyf+"&zdlx="+zdlx+"&zdsx="+zdsx+"&xxft="+xxft+"&fzyx="+fzyx+"&bzw=2&zdname="+zdname;
	   var href = "fentanchaxun_iframe1.jsp?shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu+"&zdlx="+zdlx+"&zdsx="+zdsx+"&xxft="+xxft+"&fzyx="+fzyx+"&bzw=2&zdname="+zdname;
...
<body  class="body" style="overflow-x:hidden;" onload="waitThenDoIt()">
	...
	<form action="" name="form1" method="POST">
		<table  width="100%"  border="0" cellspacing="0" cellpadding="0" height="18%">
			...
			<tr>
                ...
                <img src="<%=path%>/images/btt.bmp" width="100%" height="100%" />
			     <span style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">专业分摊情况查询</span>
	              </div></td>
			</tr>
        ...
        <tr class="form_label">
         ...
         <!--去掉报账月份条件  	<td class="form_label">报账月份</td>
	       <td class="form_label"> <input type="text" name="bzyf" value="<%=bzyf%>" onFocus="getDatenyString(this,oCalendarChsny)"  style="width: 130px;"/>   </td> 
	       -->  
	     ...
	     <td class="form_label">区、县：</td>
         	...
         	<td class="form_label"><select name="xiaoqu" id="xiaoqu" style="width:130" class="selected_font">
         		...
         		<%
		         	...
		         	xiaoqulist = commBean1.getAgcode(xian,account.getAccountId());
		         	if(xiaoqulist!=null){
		         		String agcode="",agname="";
		         ...
		         %>
           		...
           		<td class="form_label"><input type="text" name="zdname" value="<%if (null != request.getParameter("zdname")) out.print(request.getParameter("zdname"));%>" style="width: 130px;"/></td>
	            
	     </tr> 
	     <tr>
	     	<td class="form_label"> 分专业线：</td>
	             <td class="form_label">
	             <select  name="fzyx" style="width:130">
                  ...
                  <td class="form_label"><select name="zdlx" class="selected_font" > 
                        <option value="0">请选择</option>
         				 <%
  ...
  <table>
  	...
  	<iframe name="test" background-position-x ="1%" name="treeMap" width="100%" height="180px" frameborder="0" src="<%=path %>/web/newgn/fentanchaxun_iframe1.jsp"></iframe>
    <br/>
   
  	<iframe name="treeNodeInfo"  background-position-x ="52%" width="100%" height="180px" frameborder="0" src="<%=path %>/web/newgn/fentanchaxun_iframe2.jsp"></iframe>
