 ...
 function fanhui(){  
  ...
  function exportad(){	  
     ...
     //alert(whereStr+"Wstr:"+Wstr+"Str:"+Str+"endzgsj"+endzgsj);
       document.form1.action=path+"/web/query/basequery/暂估电费分摊信息无.jsp?zgjssj="+zgjssj+"&Wstr="+Wstr+"&lrsj="+lrsj+"&command=daochu";         
       document.form1.submit();
}
...
<div style="width:100%;height:300px;overflow-x:auto;overflow-y:auto;border:1px" > 	   
 <table width="1000" height="60%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">                
        <tr class="relativeTag">
           <td width="5%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">市</div></td>	
           <td width="25%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">会计科目</div></td>	
           <td width="15%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">专业明细</div></td>	               
           <td width="15%" height="23" bgcolor="#DDDDDD"><div align="center" class="bttcn">全成本</div></td>	             
        ...
        if(lrsj != null && !lrsj.equals("")){
    	 ...
    	 String zymx="";
    	 String sszy="";
    	 String ftfy="",heji="",shi="";
    	 double hj=0;
    	DecimalFormat mat =new DecimalFormat("0.00");
  	    ElectricFeesBean bean = new ElectricFeesBean();
        List<DianfeidandayinBean> listt=bean.getFentan2(Wstr,Str,loginId);
