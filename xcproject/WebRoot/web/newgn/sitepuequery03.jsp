	...
	<form action="" name="form1" method="POST" id="form">
      ...
      <tr class="form_label">
		...
		<tr class="form_label">
         ...
         <td width="25%"><input type="text" name="jzname" value="<%=form.getJzname() %>" class="selected_font" title="必填项,根据站点所在建筑物名称填写 例如：软件科技园D座楼"/></td>
      ...
      <tr class="form_label">
       ...
       <tr class="form_label">
         ...
         <td width="25%"><input type="text" name="jlfh" value="" class="selected_font" /></td>
