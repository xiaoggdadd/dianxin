...
function queryDegree() {
	if (document.getElementById("shi").value == ""
		...
		if (reg1.exec(et) || et == "" || et == null || reg1.exec(et2)
			...
			if(riqi(et,et2)){
				showdiv("请稍等..........");
				document.form1.action = path + "/web/newgn/dywdf.jsp?command=chaxun";
				...
				<table width="1100px" height="80%" border="0" cellspacing="1"
					...
					<%
						...
						if ("chaxun".equals(request.getParameter("command"))) {
							...
							list = bean.getWudianfei(whereStr,zcxstr1,zcxstr2,flag_zf);
						} else {
							list = null;
						}
						int intnum = 0;
						if (list != null) {
							String shi1 = "", xian1 = "", xz = "", jzname1 = "", jztype1 = "", zhandianid = "", dianbiaoid = "",dfzf="",dbid="";
...
function exportad() {
	...
	var zcx2 = "<%=zcxstr2%>";
	var flag_zf="<%=flag_zf%>";
	document.form1.action = path + "/web/newgn/未交电费站点查询.jsp?zcxStr1=" + zcx1
