...
//得到根路径
    ...
    function updataDate(){
       ...
       var Url=getPublicPath()+"/servlet/CashinfoServlet?action=insert&roleFlg=PERMISSION_SEARCH";
...
<%--////////////////////////////////////////////////////////////////////////////////////////////////////--%>
			 <br>
			    ...
			    <tr bgcolor="F9F9F9">
			       ...
			       <td><input type="text" id="ysztz" name="ysztz" readonly class="form"></td>
			       <td bgcolor="#DDDDDD">实际总投资:</td>
			       <td><input type="text" id="sjztz" name="sjztz" readonly class="form"/></td>
			    </tr>
			    <tr  bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">预计节省电费:</td>
			       <td><input type="text" id="yjjsdf" name="yjjsdf" readonly class="form"></td>
			       <td bgcolor="#DDDDDD">实际节省电费:</td>
			       <td><input type="text" id="sjjydf" name="sjjydf" readonly class="form"/></td>

			    </tr>
			    <tr  bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">预算设备投资:</td>
			       <td><input type="text" id="yssbtz" name="yssbtz" readonly  class="form"/></td>
			       <td bgcolor="#DDDDDD">实际设备投资:</td>
			       <td><input type="text" id="sjsbtz" name="sjsbtz" readonly  class="form"></td>
			    </tr>
			    <tr  bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">预算施工投资:</td>
			       <td><input type="text" id="yssgtz" name="yssgtz" readonly class="form"/></td>
			       <td bgcolor="#DDDDDD">实际施工投资:</td>
			       <td><input type="text" id="sjsgtz" name="sjsgtz" readonly class="form"></td>
			    </tr>   
			    <tr bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">预算维护投资:</td>
			       <td><input type="text" id="yswhtz" name="yswhtz" readonly class="form"/></td>
			       <td bgcolor="#DDDDDD">实际维护投资:</td>
			       <td><input type="text" id="sjfhtz" name="sjfhtz" readonly class="form"></td>
			    </tr>  
			    <tr bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">预计投资回报率:</td>
			       <td><input type="text" id="yjtzl" name="yjtzl" readonly class="form"/></td>
			       <td bgcolor="#DDDDDD">实际投资回报率:</td>
			       <td><input type="text" id="yjtzj" name="yjtzj" readonly  class="form"></td>
			    </tr>
			    <tr>
			    <td>
