...
function getDictList(maxrow,minrow){
	...
	var params ="&key=value";
	 Url = getPublicPath()+"/servlet/ParticipateinfoServlet?action=getSelData&roleFlg=PERMISSION_SEARCH";
	 params ="&xmmch="+ document.getElementById("xmmch").value+"&cyrmch="+ document.getElementById("cyrmch").value;
...
//增加数据
 function add(){
    window.location.href=getPublicPath()+"/"+"web/participateinfo/add.jsp";
    //window.open("add.jsp", 'newwindow', 'height=350, width=630,top=0,left=190,toolbar=no,menubar=no, scrollbars=no, resizable=no,location=n o, status=no');
 } 
   function open1(url){
      window.location.href=getPublicPath()+"/"+"web/participateinfo/"+url;
      	//window.open(url, 'newwindow', 'height=350, width=630,top=0,left=190,toolbar=no,menubar=no, scrollbars=no, resizable=no,location=n o, status=no');
   }
   
   function openData(url){
      window.location.href=getPublicPath()+"/"+"web/participateinfo/"+url;
      	//window.open(url, 'newwindow', 'height=200, width=600,top=0,left=190,toolbar=no,menubar=no, scrollbars=no, resizable=no,location=n o, status=no');
   }
//
   function del(id){
     if(confirm("确定删除")){
       var params = "?&xmmch="+id;
       var Url=getPublicPath()+"/servlet/ParticipateinfoServlet?action=del&roleFlg=PERMISSION_DELETE";
	    new Ajax.Request(Url,{
	      		method : 'post',
				asynchronous: false,
			    parameters : params,
													...
													<td height="49" bgcolor="#FFFFFF">
															<table width="100%" border="0" cellspacing="1" cellpadding="1">
														            ...
														            <br>
															         ...
															         <input type="text" id="xmmch" name="xmmch"  value="">
															          参与人名称:
															         <input type="text" id="cyrmch" name="cyrmch"  value="">
													     ...
													     <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" id ="dict">
													         <tr>
													             ...
													             <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">参与人名称</div></td>
													             <td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">参与人部门或公司</div></td>
