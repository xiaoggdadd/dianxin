...
<%--////////////////////////////////////////////////////////////////////////////////////////////////////--%>
	    ...
	    <tr bgcolor="F9F9F9">
			       ...
			       <td><input type="text" id="cyrmch" name="cyrmch" readonly class="form"/></td>
			    </tr>
			    <tr bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">参与人描述:</td>
			       <td><input type="text" id="cyrms" name="cyrms" readonly class="form"></td>
			       <td bgcolor="#DDDDDD">参与人部门或公司:</td>
			       <td><input type="text" id="gsmm" name="gsmm" readonly class="form"/></td>
		
			    </tr>
			    <tr bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">职责描述:</td>
			       <td><input type="text" id="zzms" name="zzms" readonly  class="form"/></td>
			       <td bgcolor="#DDDDDD">参与时间:</td>
			       <td><input type="text" id="cysj" name="cysj" readonly class="form"></td>
			    </tr>
			    <tr>
			    <td colspan="4">
			    <div id="cancelBtn" style="width:60px;height:23px;cursor:pointer;float:right;position:relative;right:180px">
