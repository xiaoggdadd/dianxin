...
BORDER-RIGHT: #2C59AA 1px solid; PADDING-RIGHT: 2px; BORDER-TOP: #2C59AA 1px solid; PADDING-LEFT: 2px; FONT-SIZE: 12px; FILTER: progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#ffffff, EndColorStr=#D7E7FA); BORDER-LEFT: #2C59AA 1px solid; CURSOR: hand; COLOR: black; PADDING-TOP: 2px; BORDER-BOTTOM: #2C59AA 1px solid
 ...
 <script src="<%=path%>/javascript/jquery-1.4.2.js"></script>
    ...
    function updataDate(){
       ...
       var Url=getPublicPath()+"/servlet/ParticipateinfoServlet?action=insert&roleFlg=PERMISSION_SEARCH";
   ...
   function waitThenDoIt(){
	    if (window.document.readyState){//IE
		      if (window.document.readyState=='complete'){ 
		        ...
		        var Url=getPublicPath()+"/servlet/ParticipateinfoServlet?action=updateSele&roleFlg=PERMISSION_SEARCH";
			    new Ajax.Request(Url,{
			      		method : 'post',
						asynchronous: false,
					    parameters : params,
						onComplete : function (resp){//回调
			 			 ...
			 			 var msg = result.split("|");
		                   ...
		                   document.getElementById("cyrmch").value=item[1];    
		                   document.getElementById("cyrms").value=item[2];    
		                   document.getElementById("gsmm").value=item[3];  
		                   document.getElementById("zzms").value=item[4];  
		                   document.getElementById("cysj").value=item[5];      
	...
	function updata(){
       ...
       params = "&xmmch="+xmmch+"&cyrmch="+cyrmch+"&cyrms="+cyrms+"&gsmm="+gsmm+"&zzms="+zzms+
       "&cysj="+cysj;
            var Url=getPublicPath()+"/servlet/ParticipateinfoServlet?action=updata&roleFlg=PERMISSION_EDIT";
		    new Ajax.Request(Url,{
		      		method : 'post',
					asynchronous: false,
				    parameters : params,
...
<%--////////////////////////////////////////////////////////////////////////////////////////////////////--%>
		    ...
		    <tr bgcolor="F9F9F9">
		       ...
		       <td><input type="text" id="xmmch" name="xmmch"  value ="<%=xmmch%>"readonly class="form"/></td>
			       ...
			       <td><input type="text" id="cyrmch" name="cyrmch" class="form"/></td>
			    </tr>
			    <tr bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">参与人描述:</td>
			       <td><input type="text" id="cyrms" name="cyrms"class="form"></td>
			       <td bgcolor="#DDDDDD">参与人部门或公司:</td>
			       <td><input type="text" id="gsmm" name="gsmm"  class="form"/></td>
		
			    </tr>
			    <tr bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">职责描述:</td>
			       <td><input type="text" id="zzms" name="zzms"  class="form"/></td>
			       <td bgcolor="#DDDDDD">参与时间:</td>
			       <td><input type="text" id="cysj" name="cysj" onFocus="getDateString(this,oCalendarChs)" class="form"></td>
			    </tr> 
			    <td>
			    <div id="cancelBtn" style="width: 60px; height: 23px; cursor: pointer; float: right; position: relative; right: -780px">
			    ...
			    <div id="tijiao-1" style="width: 60px; height: 23px; cursor: pointer; float: right; position: relative; right: -770px">
