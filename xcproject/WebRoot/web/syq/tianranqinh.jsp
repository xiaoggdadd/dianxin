...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
					document.form1.action=path+"/web/syq/tianranqinh.jsp";
...
<div id="parent" style="display:inline">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#666666">
       ...
       SyqPageBean bean = new SyqPageBean();
       	 ...
       	 fylist = bean.getPageData(curpage,"05",s_yuef,s_xinghao,s_bzh,s_nhyt,s_zdid);
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/syq/tianranqinh.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/syq/tianranqinh.jsp?curpage="+pageno;
      document.form1.submit();
     }
     function delsj(){
     		...
     		var i = 0;
				...
				if(i>0){
					if(confirm("确定要删除这些天然气能耗数据么！")){
		                                document.form1.action=path+"/servlet/syq?action=del_ys&pagelx=05";
		                                document.form1.submit();
		                        }else{
		                                return;
		                        }
				}else{
					alert("请选择要删除的天然气能耗数据");
					return;
				}
