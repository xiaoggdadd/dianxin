...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
					document.form1.action=path+"/web/syq/qiyounh.jsp";
	...
	function addJz(){
		document.form1.action=path+"/web/syq/addyongshui.jsp?nhlx=04";
		document.form1.submit();
	}
	function daorujz(){
...
<div id="parent" style="display:inline">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#666666">
       ...
       SyqPageBean bean = new SyqPageBean();
       	 ...
       	 fylist = bean.getPageData(curpage,"04",s_yuef,s_xinghao,s_bzh,s_nhyt,s_zdid);
...
<script language="javascript">
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/syq/qiyounh.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/syq/qiyounh.jsp?curpage="+pageno;
      document.form1.submit();
     }
     function delsj(){
     		...
     		var i = 0;
				...
				if(i>0){
					if(confirm("确定要删除这些汽油能耗数据么！")){
		                                document.form1.action=path+"/servlet/syq?action=del_ys&pagelx=04";
		                                document.form1.submit();
		                        }else{
		                                return;
		                        }
    ...
    function modifyjz(id){
     		...
     		document.form1.action=path+"/web/syq/modify_yongshui.jsp?id="+id+"&pagelx=04";
      document.form1.submit();
