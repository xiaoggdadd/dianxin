...
<%
	...
	String roleId = (String)session.getAttribute("accountRole");
        String pagelx = request.getParameter("nhlx")!=null?request.getParameter("nhlx"):"0";
        String shsign = request.getParameter("shsign")!=null?request.getParameter("shsign"):"-1";
...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
					document.form1.action=path+"/web/syq/shenhe.jsp";
	...
	function addJz(){
		document.form1.action=path+"/web/syq/addyongshui.jsp?nhlx=05";
		document.form1.submit();
	}
	function daorujz(){
...
<div id="parent" style="display:inline">
         ...
         能耗类型：
         <select name="nhlx" id="nhlx" style="width:130;" >
	         ...
	         &nbsp;&nbsp;
         审核状态：
         <select name="shsign" id="shsign" style="width:130;" >
...
<div id="parent" style="display:inline">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#666666">
       ...
       SyqPageBean bean = new SyqPageBean();
       	 ...
       	 fylist = bean.getPageData_SH(curpage,pagelx,shsign);
       	 allpage=bean.getAllPage();
		String yuef = "",bzh = "",nhlx = "", nhyt= "",nhsl = "",tzsl="",sjsl="",danjia="",nhje="",tzje="",sjje="",id="",shsignxs="";
                          ...
                          <div style="width:300px;display:inline;" align="right"><hr></div>
										...
										<tr bgcolor="#FFFFFF">
											...
											<td>
												...
												<input type="button" name="shanchulogs1" id="id1" class="memo" value="审核通过" onclick="delsj(1)"  style="color:#014F8A"/>
							         	&nbsp;&nbsp;&nbsp;&nbsp;
							         <input type="button" name="shanchulogs1" id="id1" class="memo" value="审核 不 通过" onclick="delsj(2)"  style="color:#014F8A"/>
							         	&nbsp;&nbsp;&nbsp;&nbsp;
							        </div>
											</td>
										</tr>
...
<script language="javascript">
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/syq/shenhe.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/syq/shenhe.jsp?curpage="+pageno;
      document.form1.submit();
     }
     function delsj(shsign){
     		...
     		var i = 0;
		       ...
		       document.form1.action=path+"/servlet/syq?action=shenhe&shsign="+shsign;
		       document.form1.submit();
    ...
    function modifyjz(id){
     		...
     		document.form1.action=path+"/web/syq/modify_yongshui.jsp?id="+id+"&pagelx=05";
      document.form1.submit();
...
document.form1.nhlx.value='<%=pagelx%>';
document.form1.shsign.value='<%=shsign%>';
