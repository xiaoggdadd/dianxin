...
<%
	...
	String nhlx = request.getParameter("nhlx");
	String pageTitle = "";
	if(nhlx.equals("02")){
	pageTitle = "用水";
}else if(nhlx.equals("03")){
	pageTitle = "柴油";
}else if(nhlx.equals("04")){
	pageTitle = "汽油";
}else if(nhlx.equals("05")){
	pageTitle = "天然气";
	}
%>
<html>
	...
	function ShowHideSearchRegion(trObject,SelfObject)
{
	...
	function saveAccount(){
        	...
        	function addzhandian(){
        		if(confirm("您将要添加"+'<%=pageTitle%>'+"能耗数据！确认信息正确！")){
          		document.form1.action=path+"/servlet/syq?action=addyongshui";
...
<%--////////////////////////////////////////////////////////////////////////////////////////////////////--%>
			 <tr bgcolor="F9F9F9">
                      <td height="19" colspan="6">　<img src="../../images/v.gif" width="8" height="9" /></td>
                    </tr>
      <tr>
         ...
         <td width="150">
         <input type="text" name="yuef" value="" onfocus="setMonth(this);" class="form"/><span class="style1">&nbsp;*</span>
         </td>
			<td height="8%" bgcolor="#DDDDDD" width="60"><div align="left">标志号：</div>
         </td>
         <td width="150">
         <input type="text" name="bzh" value=""   class="form"/><span class="style1">&nbsp;*</span>
         </td>
         <td height="8%" bgcolor="#DDDDDD" width="60"><div align="left">型号：</div>
         </td>
         <td width="90">
         <input type="text" name="xinghao" value=""   class="form"/>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td >
         		<input type="text" name="zdname" value=""  class="form" />
      ...
      <tr>
         ...
         <td ><input type="text" name="nhsl" value=""  class="form" /><span class="style1">&nbsp;*</span>
         	
         </td>
         <td height="8%" bgcolor="#DDDDDD" ><div align="left">调整数量：</div>
         </td>
         <td ><input type="text" name="tzsl" value=""  class="form" /><span class="style1">&nbsp;*</span></td>
				<td height="8%" bgcolor="#DDDDDD" ><div align="left">实际数量：</div>
         </td>
         <td ><input type="text" name="sjsl" value=""  class="form" /><span class="style1">&nbsp;*</span></td>
      </tr>
      ...
      <tr>
         ...
         <td >
         <input type="text" name="danjia" value=""  class="form" /><span class="style1">&nbsp;*</span>
         </td>
         <td height="8%" bgcolor="#DDDDDD" ><div align="left">能耗金额：</div>
         </td>
         <td >
         	<input type="text" name="nhje" value=""  class="form" /><span class="style1">&nbsp;*</span>
         </td>
        <td height="8%" bgcolor="#DDDDDD" ><div align="left">调整金额：</div>
         </td>
         <td ><input type="text" name="tzje" value=""  class="form" /><span class="style1">&nbsp;*</span></td>
      </tr>
      ...
      <tr>
         ...
         <td >
         	<input type="text" name="sjje" value=""  class="form" /><span class="style1">&nbsp;*</span></td>
         </td>
         <td height="8%" bgcolor="#DDDDDD" ><div align="left">起始数：</div>
         </td>
         <td >
         	<input type="text" name="qss" value=""  class="form"/>
         </td>
			<td height="8%" bgcolor="#DDDDDD" ><div align="left">结束数：</div>
         </td>
         <td ><input type="text" name="jss" value=""  class="form" />
         </td>
      </tr>
      ...
      <tr>
         ...
         <td >
         	<input type="text" name="bdate" value=""  onFocus="getDateString(this,oCalendarChs)" class="form"/>
         </td>
         <td height="8%" bgcolor="#DDDDDD" ><div align="left">结束日期：</div>
         </td>
         <td >
         	<input type="text" name="edate" value="" onFocus="getDateString(this,oCalendarChs)"  class="form"/>
         </td>
         <td height="8%" bgcolor="#DDDDDD" ><div align="left">收费人：</div>
         </td>
         <td ><input type="text" name="sfr" value=""   class="form"/>
         </td>
      ...
      <tr>
         ...
         <td >
         	<input type="text" name="sfdate" value="" onFocus="getDateString(this,oCalendarChs)"  class="form"/>
         </td>
				         ...
				         <td ><input type="text" name="pjh" value=""  class="form" /></td>
				           </tr>
  
      				<tr>
								<td height="8%" bgcolor="#DDDDDD" ><div align="left">开票日期：</div>
				         </td>
				         <td ><input type="text" name="kpdate" value=""  class="form" onFocus="getDateString(this,oCalendarChs)"/>
				         	</td>
				      </tr>
				      <tr>
				         ...
				         <td colspan="5" >
				         		<input type="text" name="memo" value=""  class="form" size=100/>
				         </td>
...
<input type="hidden" name="pagelx" value="<%=nhlx%>"/>
</form>
</body>
</html>
<script type="text/javascript">
<!--
	document.form1.nhlx.value="nhlx"+'<%=nhlx%>';
