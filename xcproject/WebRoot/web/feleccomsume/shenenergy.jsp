  ...
  <head>
	...
	//得到表格数据   
     function getDate(){
          ...
          var Url=getPublicPath()+"/CShenEnergyServerlet?action=ShenEnergyServerlet";
   ...
   function getChar(energy){
        ...
        /*  var len = energy.length;
         ...
         var params = "&city="+city+"&energy="+energys+"&month="+months+"&year="+years;
          var Url=getPublicPath()+"/CShenEnergyCharServlet?action=ShenEnergyCharServlet"+params;
          Url = encodeURI(Url);
   ...
   function open1(){
    ...
    function getCity(){
        ...
        var Url=getPublicPath()+"/CShenGetCityServlet?action=ShenGetCityServlet";
        //alert(Url);
	    new Ajax.Request(Url,{
	      		method : 'post',
				asynchronous: false,
    ...
    function getYear(){
       var Url=getPublicPath()+"/CShenGetYearServlet?action=ShenGetYearServlet";
	    new Ajax.Request(Url,{
	      		method : 'post',
				asynchronous: false,
				onComplete : function (resp){
  ...
  <div id="blk1" class="blk" style="display:none;">
        ...
        <div id="blk2" class="blk" style="display:none;">
           ...
           <div class="main">
               ...
               <ul>
                   <li><input type="checkbox" name="energy"  value="producthouse" />生产用房耗电量</li>
                   <li><input type="checkbox" name="energy"  value="commadroit"/>通信机房耗电量</li>
                   <li><input type="checkbox" name="energy"  value="basestage"/>基站耗电量</li>
                   <li><input type="checkbox" name="energy"  value="datacenter"/>数据中心耗电量</li>
                   <li><input type="checkbox" name="energy"  value="connlimit"/>接入局耗电量</li>
                   <li><input type="checkbox" name="energy"  value="outroom"/>室外机柜耗电量</li>
                   <li><input type="checkbox" name="energy"  value="notproducthouse"/>非生产用户耗电量</li>
                   <li><input type="checkbox" name="energy"  value="managerhouse"/>管理用房耗电量</li>
                   <li><input type="checkbox" name="energy"  value="channelhouse"/>渠道用户耗电量</li>
                   <li><input type="checkbox" name="energy"  value="other"/>其它非生产用户耗电量</li>
