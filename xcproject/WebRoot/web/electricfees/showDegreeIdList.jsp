...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
    ...
    function queryDegree(){
                  ...
                  //alert(canshuStr);
                   document.form1.action=path+"/web/electricfees/showDegreeIdList.jsp"+canshuStr;
                   document.form1.submit();
...
<tr bgcolor="F9F9F9">
         ...
         <select name="xiaoqu" style="width:130" onchange="javascript:document.form1.xiaoqu2.value=document.form1.xiaoqu.value">
         	...
         	&nbsp;&nbsp;&nbsp;
            电表ID：<input type="text" name="ammeterid" value="<%if(null!=request.getParameter("ammeterid")) out.print(request.getParameter("ammeterid")); %>" class="form"/>        
        </td>
      </tr>
      <tr>
         <td width="1100">
          ...
          &nbsp;&nbsp;&nbsp;
        站点名称：<input type="text" name="zdname" value="<%if(null!=request.getParameter("zdname")) out.print(request.getParameter("zdname")); %>" class="form"/>        
           &nbsp;&nbsp;&nbsp;
          <!--  <img src="../../images/search.gif" width="18" height="20" />-->
           </td>
           <td>
            <div id="chaxun" style="position:relative;width:60px;height:23px;cursor: pointer;right:210px;float:right;">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
                      ...
                      <tr  height = "20">
                           ...
                           <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">电表ID</div>
                            <td width="5%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">电量ID</div>
                           	<td width="7%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">电流类型</div>
                               <td width="8%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">用电设备</div>
                                </td>
                                <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">上次电表读数</div>
            			</td>
            			<td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">上次抄表时间</div>
            			</td>
                        <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">本次电表读数</div></td>
                        <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">本次抄表时间</div></td>
                        <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">用电量调整</div></td>
                        <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">实际用电量</div></td>
                      </tr>
       <%
         ...
         System.out.println("dianliangListjsp:"+xiaoqu+beginTimeQ+endTimeQ);
			...
			if(beginTimeQ != null && beginTimeQ != "" && !beginTimeQ.equals("0")){
				whereStr=whereStr+" and ad.INPUTDATETIME>='"+beginTimeQ+"'";
			}
			if(endTimeQ != null && endTimeQ != "" && !endTimeQ.equals("0")){
				whereStr=whereStr+" and ad.INPUTDATETIME<='"+endTimeQ+"'";
			}
		...
		System.out.println("AmmeterDegreeBean-whereStr:"+whereStr);
         AmmeterDegreeBean bean = new AmmeterDegreeBean();
       	 ArrayList fylist = new ArrayList();
       	  fylist = bean.getPageDataList(curpage,whereStr,loginId);
       	 allpage=bean.getAllPage();
		String electriccurrenttype_ammeter = "",zdmc="",usageofelectypeid_ammeter = "",ammeterdegreeid = "",ammeterid = "",lastdegree = "", thisdegree = "",lastdatetime = "",thisdatetime = "",floatdegree = "",actualdegree = "";
		int intnum=xh;
		 if(fylist!=null)
		{
       ...
       <tr bgcolor="<%=color%>">
            <td  align = "center" >
       			<input type="checkbox" name="cbox" value="<%=ammeterdegreeid%>" onClick="chooseOne(this);"/>
       		</td>
       		<td>
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/electricfees/showDegreeIdList.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/electricfees/showDegreeIdList.jsp?curpage="+pageno;
      document.form1.submit();
     }
     ...
     function queding(){
       if(document.getElementsByName("degreeid").value==undefined){
         ...
         window.opener.document.form1.action=path+"/web/electricfees/addElectricFeesAll.jsp?degreeid="+document.getElementsByName("degreeid").value;
