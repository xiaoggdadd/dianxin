...
<%--////////////////////////////////////////////////////////////////////////////////////////////////////--%>
      ...
      <tr>
         ...
         <td width="35%"><input type="text" name="ammeteridFk" value=""  class="form" /><span class="style1">&nbsp;*</span>
           <input type="button" name="validateName" value="浏览" onclick="showIdList()" id="id1"  style="color:#014F8A"/>
         </td>
     ...
     <tr>
      <td height="19" bgcolor="#DDDDDD"><div align="center">起始年月</div>
         </td>
         <td><input type="text" name="startmonth" value="" onFocus="getDatenyString(this,oCalendarChsny)" class="form" />
         </td>
         <td height="19" bgcolor="#DDDDDD"><div align="center">结束年月</div>
         </td>
