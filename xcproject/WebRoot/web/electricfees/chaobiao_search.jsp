...
<%
	...
	String qrzt = request.getParameter("cbzt")!=null?request.getParameter("cbzt") : "0";
	String loginName = (String) session.getAttribute("loginName");
	String roleId = (String) session.getAttribute("accountRole");
	String color = null;
	String s_curpage = request.getParameter("curpage") != null ? request.getParameter("curpage")
			: "1";
...
<script language="javascript">
	...
	function chaxun() {
		document.form1.action = path + "/web/electricfees/chaobiao_search.jsp";
	...
	function querenjn(){
		var i = 0;
			...
			if (i > 0) {	
			alert(_id);	
		document.form1.action = path+ "/servlet/DFDLservlet?action=queren&id="+_id+"";
	    document.form1.submit();
		showdiv("请稍等..............");
	}
}
	$(function() {
		$("#xiugaiBtn").click(function(){
			...
			if (i > 0) {			
				//var cbzt = $("#cbzt").html();
				//String name = document.getElementById("stationname");
				...
				//	alert("已确认状态的不能再修改");		
				//}else{
					document.form1.action = path + "/web/electricfees/shijiupdatechaobiaonei.jsp?id="+_id+"&ftje="+ftje+"";
					document.form1.submit();
				//}
			} else {
				alert("请选择要修改的条目");
...
function nextpage() {
	...
	document.form1.action = path + "/web/electricfees/chaobiao_search.jsp?curpage="
			+ curpage;
	document.form1.submit();
}
...
function gopagebyno(pageno) {
	...
	document.form1.action = path + "/web/electricfees/chaobiao_search.jsp?curpage=" + pageno;
	document.form1.submit();
}
	function changeCity(){
			...
			<tr>
				<td colspan="4">
					<div style="width:700px;height=50px">
						...
						<span
							style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">电费单信息表</span>
					</div></td>
			</tr>
			<tr>
 ...
 %>
		...
		<table width="2000px" height="60%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
			...
			<%
				...
				List<DFDLbean> wydfftList = wyManage.searchWydfft_fy2(loginName,loginId,pageSize,curpage,sheng,shi,xian,xiaoqu,"0",qrzt);
				allpage = wyManage.searchWydfft_fy2(loginName,loginId,999999,1,sheng,shi,xian,xiaoqu,"0",qrzt).size()/pageSize+1;
			...
			<tr bgcolor="<%=color%>">
				<td>
					<div align="center" ><input type="checkbox" id="itemSelected"
...
<script type="text/javascript">
	...
	document.form1.qrzt.value='<%=qrzt%>';
</script>
