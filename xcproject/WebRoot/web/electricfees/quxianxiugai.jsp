...
<%
	...
	String qishi ="",zhongzhi="",qima="",zhima="",dliu="",dliang="",sunhao="",lastcbsj="",thiscbsj="";
	...
	if(sql3.length()>0){
		...
		while(rs.next()){
		    qishi = rs.getString("cb_jfqsrq");
			zhongzhi = rs.getString("cb_jfzzrq");
			qima = rs.getString("cb_qm");
			zhima = rs.getString("cb_zm");
			dliu = rs.getString("cb_dliu");
			dliang = rs.getString("cb_dliang");
...
// 			}
			...
			if (checkNotnull(document.form1.jfqsrq, "缴费起始日期")
					...
					&& checkNotnull(document.form1.xgr, "修改人")
					&& checkNotnull(document.form1.xgyy, "修改原因")
					...
					&& checkNotnull(document.form1.xgrq, "修改日期")){
 																...
 																//alert(document.getElementById('jfqsrq').value);
																	if (confirm("您将要修改信息！确认信息正确！")) {
																		document.form1.action = path
																				+ "/servlet/DFDLservlet?action=update";
					...
					<td width="83%" scope="2">
						...
						<tr>
							...
							<tr>
								...
								<td>
									<input type="text" readonly="true" value="<%=sunhao %>" class="form2" />
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
									<div>
										上次抄表时间：
								...
								<td>
									<input type="text" readonly="true" value="<%=lastcbsj %>" class="form2" />
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
									<div>
										本次抄表时间：
								...
								<td>
									<input type="text" readonly="true" value="<%=thiscbsj %>" class="form2" />
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<input type="text" id="dianliang" name="dianliang" value="" class="form" />
										<button onclick="document.getElementById('dianliang').value=document.getElementById('zhima').value-document.getElementById('qima').value">计算电量</button>
								</td>
							</tr>
							<tr>
							<td bgcolor="#DDDDDD" class="form_label">
							...
							<td>
							<input type="text" name="xgr" class="form" />
							</td>
							<td bgcolor="#DDDDDD" class="form_label">
							<div>修改原因</div>							
							</td>
							<td>
							<input type="text" name="xgyy" id="xgyy" class="form" />
							</td>
							<td bgcolor="#DDDDDD" class="form_label">
							<div>修改日期</div>							
							</td>
							<td>
							<input type="text" id="xgrq" name="xgrq"
										 onFocus="getDateString(this,oCalendarChs)"
										class="form" onpropertychange="endmonthzq()" align="right" />
							</td>
							</tr>							
