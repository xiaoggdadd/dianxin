...
function ShowHideSearchRegion(trObject,SelfObject)
{
 ...
 function getPublicPath(){
  ...
  var sptype=document.form1.sptype.value;
	   ...
	   // document.form1.submit();
	    var href = "zhandianfentan_iframe1.jsp?shi="+shi+"&xian="+xian+"&xiaoqu="+xiaoqu+"&zdname="+zdname+"&sptype="+sptype;
        ...
        <td >
         	...
         	<select name="xiaoqu" id="xiaoqu" style="width:130">
		         ...
		         %>
         			...
         			<br>站点名称：
         <input type="text" name="zdname" value="<%=zdname%>" style="width: 130px;"/>
          &nbsp;站点属性：         
         <select name="sptype" style="width:130" onchange="javascript:document.form1.sptype2.value=document.form1.sptype.value">
	         ...
	         %>
	             ...
	             <td>
          <div id="query" style="position:relative;width:59px;height:23px;cursor: pointer;left:-590%;TOP:14PX">
		 ...
		 <span style="font-size:12px;position: absolute;left:25px;top:3px;color:white">查询</span>
  	      ...
  	      <iframe name="test" background-position-x ="1%" width="100%" height="180px" frameborder="0" width="350px" height="400px" frameborder="0" src="<%=path %>/web/electricfees/zhandianfentan_iframe1.jsp"></iframe>
  	     
    <iframe name="treeNodeInfo" background-position-x ="55%" width="100%" height="180px" frameborder="0" width="350px" height="400px" frameborder="0" src="<%=path %>/web/electricfees/zhandianfentan_iframe2.jsp"></iframe>
