...
var path = '<%=path%>';
	...
	function delLogs(){}
	function addJz(){
		document.form1.action=path+"/web/electricfees/addftbl.jsp";
		document.form1.submit();
	}
	//新导入
	function daorujz(){
...
<tr><td height="5"  colspan="4"><div id="parent" style="display:inline">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
             <tr height="23">
                  ...
                  <td  height="23" width="10%" bgcolor="#DDDDDD" ><div align="center" class="btt">客户</div></td>
                  <td  height="23" width="10%" bgcolor="#DDDDDD" ><div align="center" class="btt">分摊比例</div></td>       
       ...
       <%
         ...
         fylist = bean.getFTBLData(curpage,loginName,loginId,whereStr);
       	 DecimalFormat df1 = new DecimalFormat("0.00");
       	 allpage=bean.getAllPage();
		String  jzname = "",kehu = "", ftbl="";
		String dlbg="",zldy="";
		 ...
		 if(fylist!=null)
		{
			...
			for( int k = fycount;k<fylist.size()-1;k+=fycount){
       			...
       			kehu = (String) fylist.get(k + fylist.indexOf("KEHU"));
       ...
       <tr>
       		...
       		<td >
       			<div align="left"  ><%=kehu%></div>
       		</td>
       		<td >
       			<div align="left"  ><%=ftbl%></div>
       		</td>
       		<td >
       			<div align="center" ><a href="#" onclick="delzd('<%=jzname%>')"><font  style="font-size: 12px;">删除</font></a></div>
       		</td>
       		<td >
...
<script language="javascript">
	...
	function gopage(){
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      else
      {
        ...
        document.form1.action=path+"/web/electricfees/ftbl_search.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage(){
     ...
     var rgsh2='<%=rgsh2%>';
      ...
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/electricfees/ftbl_search.jsp?rgsh="+rgsh+"&caiji="+rgsh2+"&curpage="+pageno;
      document.form1.submit();
     }
     function delzd(id){
    // alert(id);
     if(confirm("您确定删除此业主信息？")){
     	<%if (permissionRights.indexOf("PERMISSION_DELETE") >= 0) {%> //权限
     		document.form1.action=path+"/servlet/DFDLservlet?action=delftbl&id="+id;
      document.form1.submit();
      <%} else {%>
      alert("您没有删除站点的权限");
    <%}%>
    ...
    function modifyjz(id,intnum){
  	<%if (permissionRights.indexOf("PERMISSION_EDIT") >= 0) {%>
     		 document.form1.action=path+"/web/electricfees/updateftbl.jsp?id="+id;
     		 document.form1.submit();
      <%} else {%>
      alert("您没有编辑站点信息的权限");
    <%}%>      
