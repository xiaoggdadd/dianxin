...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
    ...
    function queryDegree(){
                   ...
                   document.form1.action=path+"/web/electricfees/showBargainList.jsp";
                   document.form1.submit();
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/electricfees/showBargainList.jsp?curpage="+curpage+"<%=canshuStr%>";
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/electricfees/showBargainList.jsp?curpage="+pageno+"<%=canshuStr%>";
      document.form1.submit();
     }
     ...
     function queding(){
       if(document.getElementById("ammeterid").value==undefined){
         ...
         window.opener.document.form1.action=path+"/web/electricfees/addBargainInputAll.jsp?ammeterid="+document.getElementById("ammeterid").value;
