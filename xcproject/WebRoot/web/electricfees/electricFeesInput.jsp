...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
	...
	function adddegree(){
          document.form1.action=path+"/web/electricfees/addElectricFeesInput.jsp";
                                document.form1.submit();
        }
    ...
    function delad(electricfeeId){
       if(confirm("您确定删除此电费信息？")){
                    document.form1.action=path+"/servlet/electricfees?action=delete&deladfee=deladfee&degreeid="+electricfeeId
        			document.form1.submit()
       }
    }
    function modifyad(electricfeeId){
                    document.form1.action=path+"/web/electricfees/modifyElectricFeesDegree.jsp?degreeid="+electricfeeId;
                    document.form1.submit();
       
    }
    
    function queryDegree(){
                   document.form1.action=path+"/web/electricfees/electricFeesInput.jsp";
                   document.form1.submit();
...
<tr bgcolor="F9F9F9">
      ...
      <tr>
         <td width="1000">
          ...
          &nbsp;&nbsp;&nbsp;
          &nbsp;起始月份：&nbsp;
				<input type="text" name="beginTime1"
  	...
  	<div style="width:99%;height:280px;overflow-x:auto;overflow-y:auto;border:1px" >  	
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#666666">

                  <tr class="relativeTag" height = "20">
                  <td width="5%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">序号</div></td>
                      <td width="7%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">站点编号</div></td>
                      <td width="14%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">站点名称</div></td>
                       <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">站点类型</div></td>
                      <td width="8%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">本次单价</div></td>
                      ...
                      <td width="6%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">票据类型</div></td>
                      <td width="8%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">票据编号</div></td>
                      <td width="8%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">交费操作员</div></td>
                      <td width="8%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">交费时间</div></td>
                      <td width="10%" height="23" bgcolor="#888888" colspan="2"><div align="center" style="color:white;font-weight:bold;">操作</div></td>
                  </tr>
       <%
		...
		String jzname = "",jzcode = "",manualauditstatus = "",df="";
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0"> 
  ...
  <input type="hidden" name="xiaoqu2" id="xiaoqu2" value=""/>
     ...
     <tr bgcolor="F9F9F9">
                    ...
                    <tr>
                           <td >           <%if(permissionRights.indexOf("PERMISSION_ADD")>=0){%> 
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/electricfees/electricFeesInput.jsp?curpage="+curpage+"<%=canshuStr%>";
            document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/electricfees/electricFeesInput.jsp?curpage="+pageno+"<%=canshuStr%>";
      document.form1.submit();
     }
     </script>
...
var path='<%=path%>';
  function checkDF(){
   ...
   function exportad(){
            ...
            var zdbh ="<%=zdbh%>";
            //alert(canshuStr);
        	document.form1.action=path+"/web/electricfees/电费单.jsp?curpage="+curpage+"&whereStr="+whereStr+"&zdbh="+zdbh;
            document.form1.submit();
   }
