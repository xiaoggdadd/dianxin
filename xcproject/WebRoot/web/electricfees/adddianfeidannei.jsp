...
<%
	...
	if (stationname != null) {
		if (stationname.contains(",")) {
			...
			System.out.println(aa + "dbid:" + dbid + "zdcode:" + zdcode);
		}
	}
	if (dbid != null) {
		// 站点信息
 																...
 																//		&& dftz1 != "") {
																	if (confirm("您将要添加信息！确认信息正确！")) {
																		document.form1.action = path
																				+ "/servlet/electricfees?action=addfd";
																		document.form1
																				.submit();
																		showdiv("请稍等..............");
																	}
					...
					<td width="83%" scope="2">
						<table width="100%" border="0" cellspacing="1" cellpadding="1">
							...
							<td bgcolor="#DDDDDD" class="form_label">
								...
								<td>
									<input type="text" name="jingdu" readonly="true"
										value="<%=jingdu%>" class="form2" />
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
									<div>
								       纬度：
								...
								<td>
									<input type="text" name="weidu" readonly="true"
										value="<%=weidu%>" class="form2" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								%>
								<td>
									<input type="text" id="jiaofeitime" name="lastdatetime"
