...
<%
	...
	sql.append("select * from yezhu where id="+id+"");
	...
	function ShowHideSearchRegion(trObject,SelfObject)
{
	...
	function saveAccount(){
          	if(   
          	        checkNotSelected(document.form1.name,"名称")
          			) 			
	     	   {
				addzhandian();
			  }                                    
        	...
        	function addzhandian(){
        		if(confirm("您将要修改信息！确认信息正确！")){
          		...
          		document.form1.action=path+"/servlet/DFDLservlet?action=updateyezhu";
...
<form action="" name="form1" method="POST">
	...
	<tr class="form_label">
	  <td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">业主名称：</div>
         ...
         <td width="25%"><input type="text" name="name" value=<%=name %>  style="width:130px" title="选填项，站点所在的具体物理位置 "/></td>
	</tr>
<tr class="form_label">
        <td colspan="6">
