...
<table x:str border=0 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
  ...
  <td class=xl25 width=174 style='border-left:none;width:131pt'>上次交费时间</td>
 ...
 <%   
		...
		String electricfeeId = "",unitprice = "",floatpay = "", actualpay = "",notetypeid = "",noteno = "",payoperator = "",paydatetime = "";
