...
<table x:str border=0 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr  height = "20">
                           <td width="10%" height="23" bgcolor="C8E1FB"><div align="center">电表ID</div>
                           	</td>
                           	<td width="10%" height="23" bgcolor="C8E1FB"><div align="center">费用类型</div>
                            </td>
                            <td width="10%" height="23" bgcolor="C8E1FB"><div align="center">金额</div>
                               </td>
            			<td width="10%" height="23" bgcolor="C8E1FB"><div align="center">电量流水号</div>
            			</td>
                        <td width="10%" height="23" bgcolor="C8E1FB"><div align="center">起始电表数</div></td>
                        <td width="10%" height="23" bgcolor="C8E1FB"><div align="center">起始时间</div></td>
                        <td width="10%" height="23" bgcolor="C8E1FB"><div align="center">预计结束时间</div></td>                         
                      </tr>
 <%   
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl26 align=right style='border-top:none;border-left:none' x:num><%=ammeterdegreeidFk%></td>
