...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
		...
		document.form1.action=path+"/web/electricfees/dingqitanxiao.jsp";
...
<tr bgcolor="F9F9F9">
 ...
 <tr>
        ...
        <td>&nbsp;</td>
        <td>
        <div id="query" style="position:relative;width:59px;height:23px;cursor: pointer;left:-58%;TOP:-0PX">
...
<div id="parent" style="display:inline"><br>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de">
             ...
             <td width="5%" height="23" bgcolor="#888888"><div align="center" class="bttcn">序号</div>
            			...
            			<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">电表</div>
            			<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">交费类型</div>
            			</td>
				<td nowrap height="23" bgcolor="#888888"><div align="center" class="bttcn">交费金额</div>
            			</td>
            </tr>
       <%
       DingqitanxiaoBean bean = new DingqitanxiaoBean();
      
       	 ArrayList fylist = new ArrayList();
       	 if(beginTime != null && !beginTime.equals("") && !beginTime.equals("0")){
       	  int startn = Integer.parseInt(beginTime.substring(0, 4));
     	int starty = Integer.parseInt(beginTime.substring(5, 7));
		...
		String jzname = "", jfcount= "",jfcs="",dbcount="",dfzflx="",jf="",yhdl="",finaldf="",m="";
		double df=0,finallydf=0;
		int months=0;
		String dianfei="";
		//int time=0;
		 ...
		 if(fylist!=null)
		{
		    ...
		    jf=(String)fylist.get(k+fylist.indexOf("JF"));
		    yhdl=(String)fylist.get(k+fylist.indexOf("YHDL"));
		   
				//if(jfcount==null||jfcount=="")jfcount=jf;
				//if(jfcount==null||jfcount=="")jfcount=yhdl;
				//if(jfcount==null||jfcount=="")jfcount="0";
			
				
				System.out.println("--"+jf);
				if(jfcount==null||jfcount==""){
				    jfcount=jf;
				    if(jf!=null&&jf!=""){
				     finallydf=Double.parseDouble(jf)*time;
				    }
				}
				if(jfcount==null||jfcount==""){
				    jfcount=yhdl;
				    if(yhdl!=null&&yhdl!=""){
				    finallydf=Double.parseDouble(yhdl)*time;
				    }
				}
			    if(jfcount==null||jfcount==""){
				    jfcount="0";
				}
				finallydf=Double.parseDouble(jfcount);
				
				   
				
		    finaldf=finallydf+"";
			DecimalFormat mat=new DecimalFormat("0.00");
			df=Double.parseDouble(finaldf);
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/electricfees/dingqitanxiao.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/electricfees/dingqitanxiao.jsp?curpage="+pageno;
      document.form1.submit();
     }
