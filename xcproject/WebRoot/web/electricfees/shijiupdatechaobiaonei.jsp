...
<%
	...
	String qishi ="",zhongzhi="",qima="",zhima="",dliu="",dliang="",xgr="",xgyy="",xgrq="",sunhao="",lastcbsj="",thiscbsj="",zdmc="" ;
	sql3.append("select * from tbl_tt_wy_dfft where id="+id+"");
	
	DataBase db = new DataBase();
	ResultSet rs = null;	
	if(sql3.length()>0){
		db.connectDb();
		rs=db.queryAll(sql3.toString());
		while(rs.next()){
		    qishi = rs.getString("xgjfqsrq");
			zhongzhi = rs.getString("xgjfzzrq");
			qima = rs.getString("xgqm");
			zhima = rs.getString("xgzm");
			dliu = rs.getString("xgdliu");
			dliang = rs.getString("xgdliang");
			xgr=rs.getString("xgr");
			xgyy=rs.getString("xgyy");
			xgrq=rs.getString("xgrq");
			sunhao = rs.getString("sunhao");
			lastcbsj=rs.getString("lastcbsj");
			thiscbsj=rs.getString("thiscbsj");
			zdmc = rs.getString("zdmc");
		}
	}
	sql.append("select id from zhandian where jzname='"+zdmc+"'");	
...
// 			}
			...
			if (checkNotnull(document.form1.jfqsrq, "缴费起始日期")
					&&checkNotnull(document.form1.jfzzrq, "缴费终止日期")
					&&checkNotnull(document.form1.qima, "起码")
					&&checkNotnull(document.form1.zhima, "止码")
					&&checkNotnull(document.form1.dianliu, "电流")
					&&checkNotnull(document.form1.sunhao, "损耗")
					&&checkNotnull(document.form1.lastcbsj, "上次抄表时间")
					&&checkNotnull(document.form1.thiscbsj, "本次抄表时间")
					&&checkNotnull(document.form1.dianliang, "电量")){
...
// 																	&& dltz1 != "") {
 																//if (isNaN(dftz) == false
 																//		&& dftz1 != "") {
 																//alert(document.getElementById('jfqsrq').value);
																	if (confirm("您将要修改信息！确认信息正确！")) {
																		document.form1.action = path
																				+ "/servlet/DFDLservlet?action=shijixiugai";
					...
					<td width="83%" scope="2">
						...
						<tr>
							...
							<tr>
								...
								<td>
									<input type="text" name="dbbm" readonly="readonly"
							...
							<tr>
								...
								<td>
									<input type="text" readonly="true" value="<%=qishi %>"
										class="form2"  align="right" />
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
									<div>
										缴费终止日期：
								...
								<td>
								<input type="text" value=<%=dliu %> readonly="true" class="form2"/>
								</td>
							</tr>
							<tr>
								<td bgcolor="#DDDDDD" class="form_label">
								...
								<td>
									<input type="text" value="<%=zhima %>" readonly="true" class="form2" />
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
									<div>
										电量：
								...
								<td>
									<input type="text" readonly="true" value="<%=dliang %>" class="form2" />
								</td>
							</tr>
							<tr>
							<td bgcolor="#DDDDDD" class="form_label">
								...
								<td>
									<input type="text" value="<%=sunhao %>" readonly="true" class="form2" />
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
									<div>
										上次抄表时间：
								...
								<td>
									<input type="text" value="<%=lastcbsj %>" readonly="true" class="form2" />
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
									<div>
										本次抄表时间：
								...
								<td>
									<input type="text" value="<%=thiscbsj %>" readonly="true" class="form2" />
								</td>
							...
							<td>
							<input type="text" name="xgr" value="<%=xgr %>" class="form" readonly="true" />
							</td>
							<td bgcolor="#DDDDDD" class="form_label">
							<div>修改原因</div>							
							</td>
							<td>
							<input type="text" name="xgyy" readonly="true" id="xgyy" value="<%=xgyy %>" class="form" />
							</td>
							<td bgcolor="#DDDDDD" class="form_label">
							<div>修改日期</div>							
							</td>
							<td>
							<input type="text" id="xgrq" name="xgrq" readonly="true"
										 value="<%=xgrq %>"
							...
							<tr>
								...
								<td>
									<input type="text" id="jfqsrq" name="jfqsrq"
								...
								<td>
									<input type="text" id="jfzzrq" name="jfzzrq"
										 onFocus="getDateString(this,oCalendarChs)"
										class="form" onpropertychange="endmonthzq()" align="right" />
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
								...
								<td>
								<input type="text" name="dianliu" class="form"/>
								</td>
							</tr>
							<tr>
								<td bgcolor="#DDDDDD" class="form_label">
								...
								<td>
									<input type="text" id="qima" name="qima" 
										value="" class="form" />
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
									<div>
								...
								<td>
									<input type="text" id="zhima" name="zhima" class="form" />
								</td>
								<td bgcolor="#DDDDDD" class="form_label">
									<div>
										修改-电量:
								...
								<td>
									<input type="text" id="dianliang" name="dianliang" value="" class="form" />
										<button class="form" onclick="document.getElementById('dianliang').value=document.getElementById('zhima').value-document.getElementById('qima').value">计算电量</button>
								</td>
							</tr>
							<tr>
							<td bgcolor="#DDDDDD" class="form_label">
								...
								<td>
									<input type="text" id="sunhao" name="sunhao" class="form" />
								</td>
							<td bgcolor="#DDDDDD" class="form_label">
									<div>
										修改-上次抄表时间:
								...
								<td>
									<input type="text" id="lastcbsj" name="lastcbsj"
										 onFocus="getDateString(this,oCalendarChs)"
										class="form" onpropertychange="endmonthzq()" align="right" />
								</td>
							<td bgcolor="#DDDDDD" class="form_label">
								...
								<td>
									<input type="text" id="thiscbsj" name="thiscbsj"
										 onFocus="getDateString(this,oCalendarChs)"
										class="form" onpropertychange="endmonthzq()" align="right" />
								</td>
