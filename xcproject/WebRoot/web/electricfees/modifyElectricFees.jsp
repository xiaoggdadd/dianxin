	...
	function ShowHideSearchRegion(trObject,SelfObject)
{
	...
	function modifyDegree(){
                        ...
                        if(isNaN(document.form1.floatpay.value)==false){
                        if(isNaN(document.form1.unitprice.value)==false){
                        if(isNaN(document.form1.actualpay.value)==false){
                        if(confirm("您将要修改电费信息！确认信息正确！")){
                    document.form1.action=path+"/servlet/electricfees?action=modify";
        			document.form1.submit();
                         }
                         }else{
                         alert("您输入有误！实际电费金额为数字！");
                         }}else{
                         alert("您输入有误！本次单价为数字！");
                         }}else{
                         alert("您输入有误！费用调整为数字！");
...
<%--////////////////////////////////////////////////////////////////////////////////////////////////////--%>
    ...
    <table width="100%" border="0" align="right" cellpadding="1" cellspacing="1">
      <tr>
         ...
         <td width="35%"><input type="text" name="ammeterdegreeidFk" value="<%=bean.getAmmeterdegreeidFk() %>" readonly="true" class="form" /><span class="style1">&nbsp;*</span>
         </td>
          <td height="19" bgcolor="#DDDDDD" width="15%"><div>费用调整：</div>
         </td>
         <td><input type="text" name="floatpay" value="<%=bean.getFloatpay() %>"  class="form" /><span class="style1">&nbsp;*</span>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td width="35	%"><input type="text" name="unitprice" value="<%=bean.getUnitprice() %>"  class="form" /><span class="style1">&nbsp;*</span>
