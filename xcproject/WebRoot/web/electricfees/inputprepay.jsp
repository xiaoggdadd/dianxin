...
<link rel="stylesheet" type="text/css" href="images/css.css"></link>
<title>无标题文档</title>
...
function daoru(){
    var path = '<%=path%>';
	document.form1.action=path+"/servlet/uploadprepay";
...
function exportModel(){
      ...
      //document.form1.action=path+"/servlet/downloadup?action=download&templetname="+encodeURIComponent("预付费批量导入模板");
      document.form1.action=path+"/servlet/download?action=downloadpp&templetname="+encodeURIComponent("预付费信息批量导入模板");            
      document.form1.submit();
}
  $(function(){
...
<form name="form1" method="post" action="/IDA/servlet/uploadprepay"  enctype="multipart/form-data" >
          ...
          <tbody>
            <tr id="SearchRegion">
                              ...
                              <td width="95%" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td height="46" colspan="4">　　　　　　　　　　　<span class="style1"> 本功能用于批量导入产品数据及批量更正产品数据。
                                ...
                                <td height="46" colspan="4"><span class="style2"> 为保证数据准确无误，请单次导入预付费信息控制在1000条以内</span></td>
                                </tr>
                                <tr>
