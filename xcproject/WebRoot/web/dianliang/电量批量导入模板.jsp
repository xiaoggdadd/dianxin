...
<table x:str border=0 cellpadding=0 cellspacing=0 width=705 style='border-collapse:
 ...
 <tr class=xl24 height=19 style='height:14.25pt'>
  <td class=xl25 width=142 height=19  style=''></td>
  <td class=xl25 width=165 style=''></td>
  <td class=xl25 width=72 style=''>站点信息</td>
  <td class=xl25 width=72 style=''></td>
  
  <td class=xl25 width=72 style='border-left:none;width:54pt'></td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'></td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>电量基本信息</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'></td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'></td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'></td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'></td>
  ...
  <td class=xl25 width=72 style='border-left:none;width:54pt'>其它信息</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'></td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>备注</td>

 </tr>
 <tr class=xl24 height=19 style='height:14.25pt'>
  <td class=xl25 width=142 height=19  style='height:14.25pt;width:107pt'>区、县</td>
  ...
  <td class=xl25 width=72 style='border-left:none;width:54pt'>上次电表读数</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>本次电表读数</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>上次抄表时间[YYYY-MM-DD]</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>本次抄表时间[YYYY-MM-DD]</td>
  ...
  <td class=xl25 width=72 style='border-left:none;width:54pt'>起始年月[YYYY-MM]</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>结束年月[YYYY-MM]</td>
  
  <td class=xl25 width=72 style='border-left:none;width:54pt'>抄表操作员</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>抄表时间[YYYY-MM-DD]</td>
  <td class=xl25 width=72 style='border-left:none;width:54pt'>备注</td>
 ...
 <%   
         ...
         //AmmeterDegreeBean bean = new AmmeterDegreeBean();
       	 ...
       	 fylist = bean.getPageDataModel(curpage,whereStr,loginId);
       	 //int allpage=bean.getAllPage();
		 String xianname = "",xiaoquname = "",jzname = "",ammeterid = "",lastdegree = "", thisdegree = "",lastdatetime = "",thisdatetime = "",floatdegree = "",actualdegree = "";
		 //int intnum=xh = pagesize*(curpage-1)+1;
		 System.out.println("AmmeterDegreeBean-whereStr:"+fylist);
		 if(fylist!=null)
		{
			...
			ammeterid = (String)fylist.get(k+fylist.indexOf("A_ID"));
