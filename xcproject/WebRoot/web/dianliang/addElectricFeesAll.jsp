	...
	function ShowHideSearchRegion(trObject,SelfObject)
{
	...
	function saveDegree(){
                    ...
                    document.form1.action=path+"/servlet/electricfees?action=add&adbz=ad"
        ...
        function vMobile(){
         ...
         function jsactualpay(){
          
       
           document.form1.actualpay.value=(parseFloat(document.form1.unitprice.value)*parseFloat(document.form1.actualdegree.value)+parseFloat(document.form1.floatpay.value)).toFixed(2)    
...
<%--////////////////////////////////////////////////////////////////////////////////////////////////////--%>
		<%
		    ...
		    beanprice = beanprice.getJizhanPrice(degreeid);//获取单价
		...
		%>
       <tr>
         <td height="19" bgcolor="#DDDDDD" width="15%"><div align="center">站点编号</div>
         </td>
         <td width="35	%"><input type="text" name="zdcode" value="<%=zdcode %>"  class="form" />

         </td>
         <td height="19" bgcolor="#DDDDDD" width="15%"><div align="center">基站名称</div>
         </td>
         <td width="35	%"><input type="text" name="stationname" value="<%=stationname %>"  class="form" />
         </td>
      ...
      <tr>
          ...
          <td height="19" bgcolor="#DDDDDD" width="15%"><div align="center">电表ID</div>
         </td>
         <td width="35	%"><input type="text" name="ammererid" value="<%=ammererid %>"  class="form" />

         </td>
         
      <td height="19" bgcolor="#DDDDDD"><div align="center">所属专业</div>
         </td>
         <td><input type="text" name="professionaltypeid" value="<%=professionaltypeid %>"  class="form" maxlength="11"/>
         </td>
     ...
     <!-- <tr>
      ...
      <tr>
         ...
         <td width="35%"><input type="text" name="ammeterdegreeid" value="<%=ammeterdegreeid %>"  class="form" />
          </td>
        
      </tr>

      <tr>
                 <td height="19" bgcolor="#DDDDDD" width="15%"><div align="center">上次电表读数</div>
         </td>
         <td width="35%"><input type="text" name="lastdegree" value="<%=lastdegree %>" onChange="javascript:document.form1.actualdegree.value=(parseFloat(document.form1.thisdegree.value-document.form1.lastdegree.value)+parseFloat(document.form1.floatdegree.value))" class="form" />

         </td>
         <td height="19" bgcolor="#DDDDDD" width="15%"><div align="center">本次电表读数</div>
         </td>
         <td><input type="text" name="thisdegree" value="<%=thisdegree %>" onChange="javascript:document.form1.actualdegree.value=(parseFloat(document.form1.thisdegree.value-document.form1.lastdegree.value)+parseFloat(document.form1.floatdegree.value))" class="form" />
         </td>
      ...
      <tr>
      <td height="19" bgcolor="#DDDDDD"><div align="center">上次抄表时间</div>
         </td>
         <td><input type="text" name="lastdatetime" value="<%=lastdatetime %>" onFocus="getDateString(this,oCalendarChs)" class="form" maxlength="11"/>

         </td>
         <td height="19" bgcolor="#DDDDDD"><div align="center">本次抄表时间</div>
         </td>
         <td><input type="text" name="thisdatetime" value="<%=thisdatetime %>" onFocus="getDateString(this,oCalendarChs)" class="form"  align="right"/>
         </td>
      ...
      <tr>
      <td height="19" bgcolor="#DDDDDD"><div align="center">用电量调整</div>
         </td>
         <td><input type="text" name="floatdegree" value="<%=floatdegree %>" 
         onChange="javascript:document.form1.actualdegree.value=(parseFloat(document.form1.thisdegree.value-document.form1.lastdegree.value)+parseFloat(document.form1.floatdegree.value))" class="form" />
         </td>
         <td height="19" bgcolor="#DDDDDD"><div align="center">实际用电量</div>
         </td>
         <td><input type="text" name="actualdegree" value="<%=actualdegree %>"  class="form" />
           </td>
      </tr>

          <tr>
      <td height="19" bgcolor="#DDDDDD"><div align="center">抄表操作员</div>
         </td>
         <td><input type="text" name="inputoperator" value="<%=inputoperatoram %>"  class="form" />
         </td>
         <td height="19" bgcolor="#DDDDDD"><div align="center">抄表时间</div>
         </td>
         <td><input type="text" name="inputdatetime" value="<%=inputdatetimeam %>" onFocus="getDateString(this,oCalendarChs)" class="form" />
           </td>
      </tr>
     <tr>
      <td height="19" bgcolor="#DDDDDD"><div align="center">起始时间</div>
         </td>
         <td><input type="text" name="startmonth" value="<%=startmonth %>" onFocus="getDatenyString(this,oCalendarChsny)" class="form" />
         </td>
         <td height="19" bgcolor="#DDDDDD"><div align="center">结束时间</div>
         </td>
      ...
      <tr>
         <td height="19" bgcolor="#DDDDDD" class="form" ><div align="center" >备注</div>
         </td>
      ...
      <tr>
         ...
         <td><input type="text" name="unitprice" value="<%=beanprice.getSysprice() %>"
          onchage="jsactualpay()" class="form" />

         </td>
      <td height="19" bgcolor="#DDDDDD" width="15%"><div align="center">费用调整</div>
         </td>
         <td><input type="text" name="floatpay" value="" 
         onchange="jsactualpay()" class="form" />
         </td>
     <tr>
      ...
      <tr>
      <td height="19" bgcolor="#DDDDDD" class="form"><div align="center" >票据类型</div>
         </td>
         <td>   
     ...
     <tr>
      ...
      <tr>
        <td>
          <input type="button" name="baocun1" value="保存" onclick="saveDegree()" id="id1"  style="color:#014F8A"/>
          &nbsp;&nbsp;
