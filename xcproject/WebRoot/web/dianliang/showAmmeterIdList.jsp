...
function ShowHideSearchRegion(trObject,SelfObject)
{
  ...
  function chaxun(){
    ...
    function queryDegree(){          
                  document.form1.action=path+"/web/dianliang/showAmmeterIdList.jsp";
                   document.form1.submit();
...
<tr bgcolor="F9F9F9">
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
                      ...
                      <tr  height = "20" >
                           ...
                           <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">电表ID</div></td>
                           	<td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">站点名称</div></td>
                               <td width="15%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">地区</div>
                                </td>
                                <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">所属专业</div>
            			</td>
            			<td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">电表用途</div>
            			</td>
            			<td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">初始读数</div>
            			</td>
            			<td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">初始使用时间</div>
            			</td>
                        <td width="10%" height="23" bgcolor="#888888"><div align="center" style="color:white;font-weight:bold;">倍率</div></td>
       ...
       <%
         ...
         AmmeterDegreeBean bean = new AmmeterDegreeBean();
       	 ...
       	 fylist = bean.getPageDataAmmeter(curpage,whereStr,loginId);
	...
	function gopage()
     ...
     function previouspage()
     {
      ...
      else
      {
        ...
        var curpage='<%=(curpage-1)%>';
      		document.form1.action=path+"/web/dianliang/showAmmeterIdList.jsp?curpage="+curpage;
        document.form1.submit();
      }
     }
     function nextpage()
     ...
     function gopagebyno(pageno)
     {
      document.form1.page.value = pageno;
      		...
      		document.form1.action=path+"/web/dianliang/showAmmeterIdList.jsp?curpage="+pageno;
      document.form1.submit();
     }
     ...
     function queding(){
       if(document.getElementById("ammeterid2").value==undefined){
         ...
         window.opener.document.form1.action=path+"/web/dianliang/addAmmeterDegreeAll.jsp?ammeterid="+document.getElementById("ammeterid2").value;
