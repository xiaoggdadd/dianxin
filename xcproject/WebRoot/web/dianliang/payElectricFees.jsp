      ...
      <tr>
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="31%" background="../../images/b_14.gif"><span class="STYLE6"><strong><a href="<%=path%>/web/electricfees/electricFeesList.jsp">｜电费管理｜</a></strong></span></td>
				...
				<td colspan="3">
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td width="169" background="../../images/a_22.gif"><span class="style1"> 添加电费</span></td>
...
<%--////////////////////////////////////////////////////////////////////////////////////////////////////--%>
      ...
      <%String ammeterid = request.getParameter("ammeterid");
        String degreeid = request.getParameter("degreeid"); %>
         <td height="19" bgcolor="C8E1FB" width="15%"><div align="center">电量流水ID</div>
         </td>
         <td width="35%"><input type="text" name="ammeterdegreeid" value="<%=degreeid%>"  class="form" />
         </td>
 
      </tr>

      <tr>
                 <td height="19" bgcolor="C8E1FB" width="15%"><div align="center">本次单价</div>
         </td>
         <td width="35	%"><input type="text" name="unitprice" value=""  class="form" />
      ...
      <tr>
      <td height="19" bgcolor="C8E1FB" width="15%"><div align="center">费用调整</div>
         </td>
         <td><input type="text" name="floatpay" value=""  class="form" />
         </td>
         
      <td height="19" bgcolor="C8E1FB"><div align="center">实际电费金额</div>
         </td>
      ...
      <tr>
      <td height="19" bgcolor="C8E1FB"><div align="center">票据类型</div>
         </td>
         <td>
      ...
      <td height="19" bgcolor="C8E1FB"><div align="center">票据编号</div>
         </td>
         <td><input type="text" name="noteno" value=""  class="form" />
          ...
          <tr>
      <td height="19" bgcolor="C8E1FB"><div align="center">交费操作员</div>
         </td>
         <td><input type="text" name="payoperator" value=""  class="form" />
         </td>
         <td height="19" bgcolor="C8E1FB"><div align="center">交费时间</div>
         </td>
         <td><input type="text" name="paydatetime" value=""  class="form" />
           </td>
      </tr>
     <tr>
      <td height="19" bgcolor="C8E1FB"><div align="center">报账月份</div>
         </td>
         <td><input type="text" name="accountmonth" value=""  class="form" />
         </td>
         <td height="19" bgcolor="C8E1FB"><div align="center">备注</div>
         </td>
