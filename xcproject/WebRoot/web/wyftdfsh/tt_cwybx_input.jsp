...
function daoru(){
    var path = '<%=path%>';
	document.form1.action=path+"/servlet/CwybxUpload";
...
function exportModel(){
	var path = '<%=path%>';
				document.form1.action = path
						+ "/servlet/ExcelModelDownload?templetname=cwybx";
				document.form1.submit();
			}
			$(function() {
												...
												<td width="95%"><table width="100%" border="0"
														...
														<tr>
															...
															<td width="66%" height="64">
																<label style="color: red;">校验内容:重复校验(结算单号,站点编码,单据编号，发票含税金额，发票不含税金额);系统中是否存在该站点</label>
															<p>
