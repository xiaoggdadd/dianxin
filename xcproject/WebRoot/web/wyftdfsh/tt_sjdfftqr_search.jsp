...
<script language="javascript">
	...
	function chaxun() {
		document.form1.action = path + "/web/wyftdfsh/tt_sjdfftqr_search.jsp";
	...
	function exportad() {
		document.form1.action = path+ "/servlet/SjdfftqrDownload";
		document.form1.submit();
	}
	$(function() {
		...
		$("#xiugaiBtn").click(function(){
			...
			if (i > 0) {
				document.form1.action = path + "/web/wyftdfsh/tt_sjdfftqr_update.jsp?id='"+_id+"'";
				document.form1.submit();
			} else {
				alert("请选择要删除的条目");
				return;
...
function nextpage() {
	...
	document.form1.action = path + "/web/wyftdfsh/tt_sjdfftqr_search.jsp?curpage="
			+ curpage;
	document.form1.submit();
}
...
function gopagebyno(pageno) {
	...
	document.form1.action = path + "/web/wyftdfsh/tt_sjdfftqr_search.jsp?curpage=" + pageno;
	document.form1.submit();
}
</script>
	...
	<form action="" name="form1" method="POST">
			...
			<tr>
				<td colspan="4">
					<div style="width:700px;height:50px">
						<span
							style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">市级电费分摊确认</span>
					</div></td>
			</tr>
			<tr>
		...
		<table width="2000px" height="60%" border="0" cellspacing="1" cellpadding="1" bgcolor="#cbd5de" class="form_label">
			...
			<%
				...
				List<WydfftBean> wydfftList = wyManage.searchWydfft_fy(loginName,loginId,pageSize,curpage,sheng,shi,xian,xiaoqu,"已核对",qrzt,pc,zdbm,null,null);
				allpage = wyManage.searchWydfft_fy(loginName,loginId,9999999,1,sheng,shi,xian,xiaoqu,"已核对",qrzt,pc,zdbm,null,null).size()/pageSize+1;
