...
function daoru(){
    var path = '<%=path%>';
	document.form1.action=path+"/servlet/WydfftUpload";
...
function exportModel(){
	var path = '<%=path%>';
		...
		document.form1.action = path+ "/servlet/ExcelModelDownload?templetname=wydfft";
		document.form1.submit();
		...
		<form name="form1" method="post" action="/servlet/ZwhdModelUpload"
												...
												<td width="95%"><table width="100%" border="0"
														...
														<tr>
															...
															<label style="color: red;">
																校验内容:重复校验(批次,单号,站点编码,客户,缴费金额,缴费日期);系统中是否存在站点编码;分摊金额是否正确.
															</label>
															<p>
																	请选择您要导入的数据文件，此文件包含您要导入的数据.请点<a
																		href="javascript:exportModel()"><此处>
																	</a>生成导入模版.
																</p></td>
														</tr>
														<tr>
															<td align="left">
																批次:<input type="text" id="pc" name="pc" value="" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM'})" class="selected_font" />
