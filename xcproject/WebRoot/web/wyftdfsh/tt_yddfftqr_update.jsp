...
<%@ page import="com.noki.zwhd.manage.DfManageYd" %>
...
DfManageYd systemManage = new DfManageYd();
ZhandianBean zd=new ZhandianBean();
   zd=systemManage.searchJzcode(idd);
_zdbm=zd.getZdbm();
String dbdja="";
dbdja=zd.getDj();
System.out.println("站点编码:"+_zdbm);
	...
	if(_zdmc!=null){
		SystemManage systemManagex = new SystemManage();
		page_zhandian = systemManagex.searchJzByCode(_zdbm);
	}
	...
	if(_yearmonth!=null&&_zdbm!=null&&zhandian!=null){
		wydfftBean = wyManage.searchWydfft(_yearmonth,_zdbm,"移动");
	}
...
function DbdsUpdate(){
	...
	if(scds!=null&&scds!=""&&bcds!=null&&bcds!=""&&sh!=null&&sh!=""){
	  a=(parseFloat(c)-parseFloat(b)+parseFloat(d));
			...
			<tr>
				<td>
					<div style="width:700px;height:50px">
						 <span
							style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">移动电费单修改</span>
					</div></td>
			</tr>
		</table>
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<table width="100%" border="0" align="right" cellpadding="1" cellspacing="1" class="form_label">
									...
									<tr class="selected_font1">
										...
										<td width="25%">
											...
											<input type="text" name="t_dw"  value='<%=zhandian.getSHI()%>' class="selected_font"  />
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">区县：</div>
										</td>
										<td width="25%">
											
											<input type="text" name="t_qx"  value='<%=zhandian.getXIAN()%>' class="selected_font"  />
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">站点名称：</div>
										</td>
										<td width="25%">
											<input type="text" name="t_zdmc" value='<%=zhandian.getJZNAME()%>'  class="selected_font"  />
										</td>
									</tr>
									...
									<tr class="selected_font">
										...
										<td width="25%">
											<input type="text" name="t_jsfs" value="<%=zhandian==null||zhandian.getJSFS()==null?"":zhandian.getJSFS() %>" class="selected_font"  />
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">电表编码：</div></td>
										<td width="25%">
											<input type="text" name="t_dbbm" value="<%=zd==null||zd.getDbbm()==null?"":zd.getDbbm() %>" class="selected_font"  />
										</td>
									</tr>
									...
									<td bgcolor="#DDDDDD" width="15%"><div align="left">批次：</div></td>
										<td width="25%">
											<input type="text" name="t_yearmonth" value="<%=zd.getPc()%>" class="selected_font" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM'})" />
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">单号：</div></td>
										<td width="25%">
											<input type="text" name="t_dh" value="<%=zd==null?"":zd.getDh() %>" class="selected_font" />
										</td>
										</tr>
										<tr class="selected_font">
										<td bgcolor="#DDDDDD" width="15%"><div align="left">上次抄表时间：</div></td>
										<td width="25%">
											<input type="text" name="t_sccbsj"  class="selected_font" value='<%=zd==null?"":zd.getLastcbsj()%>' onchange="DateUpdate()" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"/><span class="style1">&nbsp;*</span>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">本次抄表时间：</div></td>
										<td width="25%">
											<input type="text" name="t_bccbsj"  class="selected_font" value='<%=zd==null?"":zd.getThiscbsj()%>' onchange="DateUpdate()" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"/><span class="style1">&nbsp;*</span>
										</td>
										
										<td bgcolor="#DDDDDD" width="15%"><div align="left">账期：</div>
										</td>
										<td width="25%"><input type="text" name="t_jszq" value="<%=zd==null?"":zd.getJszq()%>"  class="selected_font" />
										</td>
									</tr>
									<tr>
									<td bgcolor="#DDDDDD" width="15%"><div align="left">上次抄表止码：</div></td>
										<td width="25%">
											<input type="text" name="t_sccbzm" onchange="DbdsUpdate()" value='<%=qm%>' class="selected_font" onchange="DbdsUpdate()"/><span class="style1">&nbsp;*</span>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">本次抄表止码：</div></td>
										<td width="25%">
											<input type="text" name="t_bccbzm" onchange="DbdsUpdate()"  value='<%=zm%>' class="selected_font" onchange="DbdsUpdate()"/><span class="style1">&nbsp;*</span>
										</td>
										
										<td bgcolor="#DDDDDD" width="15%"><div align="left">耗损：</div></td>
										<td width="25%">
											<input type="text" name="t_sunhao" value="<%=sh%>" class="selected_font"  onchange="DbdsUpdate()"/><span class="style1">&nbsp;*</span>
										</td>
									...
									<td bgcolor="#DDDDDD" width="15%"><div align="left">电量：</div></td>
										<td width="25%">
											<input type="text" name="t_dliang" value='<%=dl%>' onchange="DjupDate()" class="selected_font" />
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">电费单价(元/度)：</div></td>
										<td width="25%">
											<input type="text" name="t_dj" value='<%=dj%>' onchange="DjupDate()" class="selected_font" /><span class="style1">&nbsp;*</span>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">缴费金额：</div></td>
										<td width="25%">
											<input type="text"  name="t_jfje" value="<%=zd==null?"":zd.getJfje() %>" class="selected_font"/><span class="style1">&nbsp;*</span>
										</td>
									...
									<td bgcolor="#DDDDDD" width="15%"><div align="left">缴费日期：</div></td>
										<td width="25%">
											<input type="text" name="t_jfrq" value="<%=zd==null?"":zd.getJfrq() %>" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})" class="selected_font" /><span class="style1">&nbsp;*</span>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">缴费票据类型：</div></td>
										<td width="25%">
											<input type="text"  name="t_jfpjlx" value="<%=zd==null?"":zd.getJfpjlx() %>" class="selected_font"/>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">供电方/业主名称：</div></td>
										<td width="25%">
											<input type="text"  name="t_gdfmc" value="<%=zd==null?"":zd.getGdfmc() %>" class="selected_font"/>
										</td>
									...
									<tr>
										...
										<td width="25%">
											<input type="text"  name="t_ftbl" value="<%=zd==null?"":zd.getFtbl() %>" class="selected_font"/>
										</td>
										<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">税负因子(%)：</div></td>
										<td width="25%">
											<input type="text"  name="t_fsyz" value="<%=zd==null?"":zd.getFsyz() %>" class="selected_font"/>
										</td>
										<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">分摊金额：</div></td>
										<td width="25%">
											<input type="text"  name="t_ftje" value="<%=zd==null?"":zd.getFtje() %>" class="selected_font" onchange="pageRefsh();"/>
										</td>
									</tr>
									<tr>
										<td colspan="6">
