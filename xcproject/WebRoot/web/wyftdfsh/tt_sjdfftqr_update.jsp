...
<%
	...
	String _tzje = request.getParameter("t_tzje")==null||request.getParameter("t_tzje").equals("")?wydfft.getTZHJE()==null||wydfft.getTZHJE().equals("")?"":wydfft.getTZHJE():request.getParameter("t_tzje");
	String _tzr = request.getParameter("t_tzr")==null||request.getParameter("t_tzr").equals("")?wydfft.getTZR()==null||wydfft.getTZR().equals("")?"":wydfft.getTZR():request.getParameter("t_tzr");
	String _tzyy = request.getParameter("t_tzyy")==null||request.getParameter("t_tzyy").equals("")?wydfft.getTZYY()==null||wydfft.getTZYY().equals("")?"":wydfft.getTZYY():request.getParameter("t_tzyy");
	...
	//String t_bxlx = request.getParameter("t_bxlx")==null||request.getParameter("t_bxlx").equals("null")?cwybx==null||cwybx.getBXLX()==null?"":cwybx.getBXLX():request.getParameter("t_bxlx");
	...
	//String t_djzt = request.getParameter("t_djzt")==null||request.getParameter("t_djzt").equals("null")?cwybx==null||cwybx.getDJZT()==null?"":cwybx.getDJZT():request.getParameter("t_djzt");
	//String t_bm = request.getParameter("t_bm")==null||request.getParameter("t_bm").equals("null")?cwybx==null||cwybx.getBM()==null?"":cwybx.getBM():request.getParameter("t_bm");
...
<script type="text/javascript">
	...
	function save() {
		//表单前台校验
		document.form1.action = path + "/servlet/SjdfftqrUpdate";
		document.form1.submit();
	}
...
<body class="body" style="overflow-x:hidden;">
	<form action="" name="form1" method="POST">
							...
							<td>
								<table width="100%" border="0" align="right" cellpadding="1"
									...
									<tr>
										...
										<td width="25%"><input type="text" name="t_wycy" value="<%=_cy1 %>"
											class="selected_font" /></td>
									</tr>
									<tr bgcolor="F9F9F9">
										<td height="19" colspan="4"><img src="../../images/v.gif"
											width="15" height="15" />调整信息</td>
									</tr>
									<tr>
										<td height="8%" bgcolor="#DDDDDD" width="13%"><div
												align="left">调整金额：</div></td>
										<td width="25%">
											<input name="t_tzje" type="text" class="selected_font1" value="<%=_tzje%>" readonly/>
										</td>
										<td height="8%" bgcolor="#DDDDDD" width="13%"><div
												align="left">调整人：</div></td>
										<td width="25%">
											<input name="t_tzr" class="selected_font1" type="text" value="<%=_tzr%>" readonly/>
										</td>
									</tr>
									<tr>
										<td height="8%" bgcolor="#DDDDDD" width="13%"><div
												align="left">调整原因：</div></td>
										<td width="20%" colspan="6">
											<textarea rows="5" cols="80" name="t_tzyy" readonly><%=_tzyy%></textarea>
										</td>
									</tr>
									<tr>
										<td colspan="6">
		...
		<input type="hidden" name="t_tzje" value="<%=wydfft.getTZHJE()%>"/>
		<input type="hidden" name="t_tzr" value="<%=wydfft.getTZR()%>"/>
		<input type="hidden" name="t_tzyy" value="<%=wydfft.getTZYY()%>"/>
	</form>
</body>
</html>
