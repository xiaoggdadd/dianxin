...
String drtitle="",drtemplate="";
if(action.equals("upzhandian")){
	drtitle="站点数据导入";
	drtemplate="站点批量导入模板.xls";
}else if(action.equals("yddfddr")){
	drtitle="移动电费分摊导入";
	drtemplate="移动电费分摊批量导入模板.xls";
	}
String mfile = "";
...
function daoru(){
	...
	if(pc!=null&&pc!=""){
	var path='<%=path%>';
	document.form1.action=path+"/servlet/YddfftUpload";
...
alert("1");
var path='<%=path%>';
	document.form1.action=path+"/servlet/download?action=dbtemp&templetname="+encodeURIComponent("电表批量导入模板");
	document.form1.submit();
}
function exportModel(){
    var a =document.form1.pc.value;
  if(a==null||a==""){
	  alert("请先选择批次，然后下载模板！！！");
  }else{
             var path = '<%=path%>';
            document.form1.action=path+"/servlet/SjyddfftDownload?pc="+a;
            document.form1.submit();
   }}
 $(function(){
      ...
      <tr>
        <td colspan="3"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="87%" background="../../images/in_12.gif"><span class="style4"><%=drtitle%></span></td>
          ...
          <tbody>
            <tr id="SearchRegion">
                              ...
                              <td width="95%" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                ...
                                <%if(action.equals("updianbiao")){%>
                                <tr>
                                  <td height="145" colspan="3" rowspan="2"><div align="center"><img src="../../images/dao.gif" width="132" height="119" /></div></td>
                                  <td width="66%" height="64"><p> 请选择您要导入的数据文件，此文件包含您要导入的数据.请点<a href="javascript:temp()"><此处></a>生成导入模版.
 </p>                                  </td>
                                </tr>
                                <%}else{%>
                                <tr>
                                  ...
                                  <td width="66%" height="64">
                                                                 批次:<input type="text" name="pc"  onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM'})" class="selected_font" />
                                  <p> 请选择您要导入的数据文件，此文件包含您要导入的数据.请点<a href="javascript:exportModel()"><此处></a>下载导入模版.
 </p>                                  </td>
                                </tr>
                                <%}%>
                                <tr>
