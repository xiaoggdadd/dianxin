...
<%
	...
	WydfftBean lastWydfftBean = null;
	if(_yearmonth!=null&&!_yearmonth.equals("")&&_zdbm!=null&&zhandian!=null){
		System.out.println("**********"+_yearmonth);
		wydfftBean = wyManage.searchWydfft(_yearmonth,_zdbm,"联通");
		String year = _yearmonth.split("-")[0];
		int month = Integer.parseInt(_yearmonth.split("-")[1])-1;
		String _month = "";
		if(month<10){
			_month = "0" + month;
		}else{
		...
		String _lastYearMonth = year+"-"+_month;
		lastWydfftBean = wyManage.searchWydfft(_lastYearMonth,_zdbm,"联通");
	}
	
	String _zzlx = request.getParameter("t_zzlx");
	String _ycqdw = request.getParameter("t_ycqdw");
	String _jfqsrq = request.getParameter("t_jfqsrq")==null||request.getParameter("t_jfqsrq").equals("")?"":request.getParameter("t_jfqsrq");
	String _jfzzrq = request.getParameter("t_jfzzrq")==null||request.getParameter("t_jfzzrq").equals("")?"":request.getParameter("t_jfzzrq");
	String _bccbsj = request.getParameter("t_bccbsj")==null||request.getParameter("t_bccbsj").equals("")?"":request.getParameter("t_bccbsj");
	String _sccbsj = request.getParameter("t_sccbsj")==null||request.getParameter("t_sccbsj").equals("")?"":request.getParameter("t_sccbsj");
	...
	String _jfje = wydfftBean==null?"":wydfftBean.getJFJE();
	String _jfdj = "";
	if(zhandian!=null&&zhandian.getGDFS().equals("转供电")){
		_jfdj = dianbiaos!=null&&dianbiaos.size()>0?dianbiaos.get(0).getDANJIA():"0" ;
	}else if(zhandian!=null&&zhandian.getGDFS().equals("直供电")){
		if(_jfje!=null&&!_jfje.equals("")&&_dliang!=null&&!_dliang.equals("")){
			double jfje = Double.parseDouble(_jfje);
			double dliang = Double.parseDouble(_dliang);
			double jfdj = jfje/dliang;
			DecimalFormat df = new DecimalFormat("#0.0000");   
			_jfdj = df.format(jfdj);
		}
	}
	
	String _nyglxtid = request.getParameter("t_nyglxtid")==null||request.getParameter("t_nyglxtid").equals("")?"":request.getParameter("t_nyglxtid");
	String _zzs = request.getParameter("t_zzs")==null||request.getParameter("t_zzs").equals("")?"":request.getParameter("t_zzs");
	String _szs = request.getParameter("t_szs")==null||request.getParameter("t_szs").equals("")?"":request.getParameter("t_szs");
%>
<html>
<head>
<title></title>
...
function save(){
	...
	var jfqsrq = $("#t_jfqsrq").val();
	var jfzzrq = $("#t_jfzzrq").val();
	//alert(jfqsrq+"<="+jfzzrq+"?");
	if(jfqsrq!=null&&jfqsrq!=""&&jfzzrq!=null&&jfzzrq!=""){
		jfqsrq = new Date(jfqsrq.replace(/-/g,   "/"));
		jfzzrq = new Date(jfzzrq.replace(/-/g,   "/"));
		//alert(jfqsrq+"<="+jfzzrq+"?");
		if(jfqsrq<=jfzzrq){
			
		}else{
			alert("缴费起始日期应小于等于缴费终止日期！");
			return;
		}
	}else{
		alert("缴费起止日期不能为空！");
	...
	var bccbsj = $("#t_bccbsj").val();
	var sccbsj = $("#t_sccbsj").val();
	if(bccbsj!=null&&bccbsj!=""&&sccbsj!=null&&sccbsj!=""){
		bccbsj = new Date(bccbsj.replace(/-/g,   "/"));
		sccbsj = new Date(sccbsj.replace(/-/g,   "/"));
		if(sccbsj<=bccbsj){
			
		}else{
			alert("上次抄表时间应小于等于本次抄表时间！");
			return;
		}
	}else{
		alert("抄表时间不能为空！");
	...
	var dliang = $("#t_dliang").val();
	if(dliang!=null&&dliang!=""){
		dliang = parseFloat(dliang);
		if(dliang>0){
	...
	var nyglxtid = $("#t_nyglxtid").val();
	var zzs = $("#t_zzs").val();
	var szs = $("#t_szs").val();
	if(zzs!=null&&zzs!=""){
	
	}else{
		alert("增值税(17%税率)不能为空！");
		return;
	}
	...
	if(szs!=null&&szs!=""){
		...
		alert("税中税(2.64税率)不能为空！");
		return;
	}
	
	if(nyglxtid!=null&&nyglxtid!=""){
	...
	document.form1.action=path+"/servlet/LtdfftqrAdd";
				...
				<td>
					<div style="width:700px;height:50px">
						<img alt="" src="<%=path%>/images/btt.bmp" width="100%"
							height="100%" /> <span
							style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">联通电费单添加</span>
					</div></td>
			</tr>
		</table>
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<td>
								<table width="100%" border="0" align="right" cellpadding="1" cellspacing="1" class="form_label">
									...
									<tr class="selected_font">
										...
										<td width="25%"><input type="text" name="t_wlzzbm" value="<%=zhandian==null?"":zhandian.getWLZDBM()==null?"":zhandian.getWLZDBM() %>" class="selected_font" /><span class="style1">&nbsp;*</span></td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">供电方式：</div>
										</td>
										<td width="25%"><input type="text" name="t_gdfs" value="<%=zhandian==null?"":zhandian.getGDFS() %>" class="selected_font" /><span class="style1">&nbsp;*</span>
										</td>
									</tr>
									<tr>
										...
										<td width="25%">
											<input type="text" name="t_jsfs" value="<%=zhandian==null?"":zhandian.getJSFS() %>"  class="selected_font" /><span class="style1">&nbsp;*</span>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">站址类型：</div>
										</td>
										<td width="25%">
											<select name="t_zzlx" class="selected_font">
												<option value="宏站" <%if(_zzlx!=null&&_zzlx.equals("宏站")){ %>selected="selected"<%} %>>宏站</option>
												<option value="一体化电源柜" <%if(_zzlx!=null&&_zzlx.equals("一体化电源柜")){ %>selected="selected"<%} %>>一体化电源柜</option>
											</select>
											<span class="style1">&nbsp;*</span>
										</td>
										...
										<td width="25%">
											<input type="text" name="t_ycqdw" value="<%=zhandian==null?"":zhandian.getYCQ()==null?"":zhandian.getYCQ() %>"  class="selected_font" /><span class="style1">&nbsp;*</span>
										</td>
									</tr>
									<tr>
										<tr bgcolor="F9F9F9" class="selected_font1">
									...
									<tr>
										...
										<td width="25%">
											<input type="text" name="t_dh" value="<%=wydfftBean==null?"":wydfftBean.getDH() %>" class="selected_font" /><span class="style1">&nbsp;*</span>
										</td>
									...
									<tr>
										...
										<td width="25%">
											<input type="text" name="t_jfqsrq" id="t_jfqsrq" value="<%=_jfqsrq %>" class="selected_font" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"/><span class="style1">&nbsp;*</span>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">上次抄表时间：</div>
										<td width="25%">
											<input type="text" name="t_sccbsj" id="t_sccbsj" value="<%=lastWydfftBean==null||lastWydfftBean.getBccbsj()==null?_sccbsj:lastWydfftBean.getBccbsj()%>" class="selected_font" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"/><span class="style1">&nbsp;*</span>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">账期起始日期：</div>
										<td width="25%">
											<input type="text" name="t_zq_s" value="<%=wydfftBean==null?"":wydfftBean.getZQ().split(";")[0] %>" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})" class="selected_font" /><span class="style1">&nbsp;*</span>
										</td>
									</tr>
									<tr>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">缴费终止日期：</div>
										<td width="25%">
											<input type="text" name="t_jfzzrq" id="t_jfzzrq" value="<%=_jfzzrq %>" class="selected_font" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"/><span class="style1">&nbsp;*</span>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">本次抄表时间：</div>
										<td width="25%">
											<input type="text" name="t_bccbsj" id="t_bccbsj" value="<%=_bccbsj %>" class="selected_font" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"/><span class="style1">&nbsp;*</span>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">账期结束日期：</div>
										<td width="25%">
											<input type="text" name="t_zq_e" value="<%=wydfftBean==null?"":wydfftBean.getZQ().split(";")[1] %>" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})" class="selected_font" /><span class="style1">&nbsp;*</span>
										</td>
									</tr>
									<tr>
										...
										<td width="25%">
											<input type="text" name="t_sccbzm" id="qm" value="<%=lastWydfftBean==null||lastWydfftBean.getZM()==null?_sccbzm:lastWydfftBean.getZM() %>" class="selected_font" /><span class="style1">&nbsp;*</span>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">本次抄表止码：</div>
										<td width="25%">
											<input type="text" name="t_bccbzm" id="zm" value="<%=_bccbzm %>" class="selected_font"/><span class="style1">&nbsp;*</span>
										</td>
										<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">损耗：</div></td>
										<td width="25%">
											<input type="text"  name="t_sh" value="<%=_sh %>" class="selected_font" onchange="pageRefsh();"/><span class="style1">&nbsp;*</span>
										</td>
									...
									<tr>
										...
										<td width="25%">
											<input type="text"  name="t_jfje" value="<%=_jfje %>" class="selected_font"/><span class="style1">&nbsp;*</span>
										</td>
										<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">缴费日期：</div></td>
										<td width="25%">
											<input type="text"  name="t_jfrq" value="<%=wydfftBean==null?"":wydfftBean.getJFRQ()%>" class="selected_font" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"/><span class="style1">&nbsp;*</span>
										</td>
										<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">分摊比例：</div></td>
										<td width="25%">
											<input type="text"  name="t_ftbl" value="<%=wydfftBean==null?"":wydfftBean.getFTBL() %>" class="selected_font"/><span class="style1">&nbsp;*</span>
										</td>
									</tr>
									<tr>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">电量(度)：</div>
										<td width="25%">
											<input type="text" name="t_dliang" id="t_dliang" value="<%=_dliang %>" class="selected_font"/><span class="style1">&nbsp;*</span>
										</td>
										<td bgcolor="#DDDDDD" width="15%"><div align="left">电费单价(元/度)：</div>
										<td width="25%">
											<input type="text" name="t_dj" value="<%=_jfdj%>" class="selected_font" /><span class="style1">&nbsp;*</span>
										</td>
									</tr>
									...
									<tr>
										...
										<td width="25%">
											<input type="text"  name="t_ftje" value="<%=wydfftBean==null?"":wydfftBean.getFTJE() %>" class="selected_font" onchange="pageRefsh();"/><span class="style1">&nbsp;*</span>
										</td>
										<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">供电方/业主名称：</div></td>
										<td width="25%">
											<input type="text"  name="t_gdfmc" value="<%=wydfftBean==null?"":wydfftBean.getGDFMC() %>" class="selected_font"/><span class="style1">&nbsp;*</span>
										</td>
										
										<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">缴费票据类型：</div></td>
										<td width="25%">
											<input type="text"  name="t_jfpjlx" value="<%=wydfftBean==null?"":wydfftBean.getJFPJLX() %>" class="selected_font"/><span class="style1">&nbsp;*</span>
										</td>
									</tr>
									<tr>
										...
										<td width="25%">
											<input type="text"  name="t_nyglxtid" id="t_nyglxtid" value="<%=_nyglxtid %>" class="selected_font"/><span class="style1">&nbsp;*</span>
										</td>
										<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">增值税(17%税率)：</div></td>
										<td width="25%">
											<input type="text"  name="t_zzs" id="t_zzs" value="<%=_zzs %>" class="selected_font"/><span class="style1">&nbsp;*</span>
										</td>
										<td height="8%" bgcolor="#DDDDDD" width="15%"><div align="left">税中税(2.64税率)：</div></td>
										<td width="25%">
											<input type="text"  name="t_szs" id="t_szs" value="<%=_szs %>" class="selected_font"/><span class="style1">&nbsp;*</span>
										</td>
									</tr>
									<tr>
										<td colspan="6">
