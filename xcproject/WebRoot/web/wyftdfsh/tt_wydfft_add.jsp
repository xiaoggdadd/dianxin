...
<%
	...
	String _sfgs = request.getParameter("t_sfgs")==null||request.getParameter("t_sfgs").equals("0")?sheng:request.getParameter("t_sfgs");
	String _dsfgs = request.getParameter("t_dsfgs");
	String _zdbm = request.getParameter("t_zdmc");
	
	String _ftbl = request.getParameter("t_ftbl")==null||request.getParameter("t_ftbl").equals("")?"100":request.getParameter("t_ftbl");
	String _jfje = request.getParameter("t_jfje")==null||request.getParameter("t_jfje").equals("")?"0":request.getParameter("t_jfje");
	String _ftje = request.getParameter("t_ftje")==null||request.getParameter("t_ftje").equals("")?"0":request.getParameter("t_ftje");
	...
	String _fsyz = request.getParameter("t_fsyz")==null||request.getParameter("t_fsyz").equals("")?"0.00":request.getParameter("t_fsyz");
	...
	String t_dh = request.getParameter("t_dh")==null||request.getParameter("t_dh").equals("null")?"":request.getParameter("t_dh");
	String t_zq1 = request.getParameter("t_zq1")==null||request.getParameter("t_zq1").equals("null")?"":request.getParameter("t_zq1");
	String t_zq2 = request.getParameter("t_zq2")==null||request.getParameter("t_zq2").equals("null")?"":request.getParameter("t_zq2");
	String t_jfje = request.getParameter("t_jfje")==null||request.getParameter("t_jfje").equals("null")?"":request.getParameter("t_jfje");
	String t_jfrq = request.getParameter("t_jfrq")==null||request.getParameter("t_jfrq").equals("null")?"":request.getParameter("t_jfrq");
	String t_xzbs = request.getParameter("t_xzbs")==null||request.getParameter("t_xzbs").equals("null")?"":request.getParameter("t_xzbs");
	String t_jfpjlx = request.getParameter("t_jfpjlx")==null||request.getParameter("t_jfpjlx").equals("null")?"":request.getParameter("t_jfpjlx");
	String t_gdfmc = request.getParameter("t_gdfmc")==null||request.getParameter("t_gdfmc").equals("null")?"":request.getParameter("t_gdfmc");
	String t_kh = request.getParameter("t_kh")==null||request.getParameter("t_kh").equals("null")?"":request.getParameter("t_kh");
	String t_bz = request.getParameter("t_bz")==null||request.getParameter("t_bz").equals("null")?"":request.getParameter("t_bz");
	
	String t_rq = request.getParameter("t_rq")==null||request.getParameter("t_rq").equals("null")?"":request.getParameter("t_rq");
	String t_bxlx = request.getParameter("t_bxlx")==null||request.getParameter("t_bxlx").equals("null")?"":request.getParameter("t_bxlx");
	String t_djbh = request.getParameter("t_djbh")==null||request.getParameter("t_djbh").equals("null")?"":request.getParameter("t_djbh");
	String t_zy = request.getParameter("t_zy")==null||request.getParameter("t_zy").equals("null")?"":request.getParameter("t_zy");
	String t_djzt = request.getParameter("t_djzt")==null||request.getParameter("t_djzt").equals("null")?"":request.getParameter("t_djzt");
	String t_bm = request.getParameter("t_bm")==null||request.getParameter("t_bm").equals("null")?"":request.getParameter("t_bm");
	String t_sfje = request.getParameter("t_sfje")==null||request.getParameter("t_sfje").equals("null")?"":request.getParameter("t_sfje");
	String t_fphsje = request.getParameter("t_fphsje")==null||request.getParameter("t_fphsje").equals("null")?"":request.getParameter("t_fphsje");
	String t_fpbhsje = request.getParameter("t_fbphsje")==null||request.getParameter("t_fbphsje").equals("null")?"":request.getParameter("t_fbphsje");
	String t_kplx = request.getParameter("t_kplx")==null||request.getParameter("t_kplx").equals("null")?"":request.getParameter("t_kplx");
	String t_yearmonth = request.getParameter("t_yearmonth")==null||request.getParameter("t_yearmonth").equals("null")?"":request.getParameter("t_yearmonth");
%>
<html>
<head>
<title></title>
...
<script type="text/javascript">
	...
	function save() {
		//表单前台校验
		document.form1.action = path + "/servlet/WydfftAdd";
		document.form1.submit();
	}
				...
				<td>
					<div style="width:700px;height:50px">
						<img alt="" src="<%=path%>/images/btt.bmp" width="100%"
							height="100%" /> <span
							style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">物业数据财务分摊添加</span>
					</div></td>
			</tr>
		</table>
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
								...
								<table width="100%" border="0" align="right" cellpadding="1"
										...
										<td width="25%"><select name="t_sfgs"
											class="selected_font" onchange="pageRefsh();">
												...
												<option value="<%=sfgs.getAGCODE()%>"
													<%if (_sfgs.equals(sfgs.getAGCODE())) {%>
									...
									<tr class="selected_font">
										...
										<td width="25%"><input type="text" name="t_zdbm"
											value="<%=_zdbm == null||_zdbm.equals("null") ? "" : _zdbm%>"
										...
										<td width="25%">
											<input type="text" name="t_zq1" value="<%=t_zq1 %>" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})" class="selected_font" /> 
											<span class="style1">&nbsp;*</span>
										</td>
									</tr>
									<tr class="selected_font">
										...
										<td width="25%">
											<input type="text" name="t_zq2" value="<%=t_zq2 %>" id="t_zq2" onFocus="WdatePicker({skin:'default',dateFmt:'yyyy-MM-dd'})"
											class="selected_font" /> 
											<span class="style1">&nbsp;*</span>
										</td>
										...
										<td width="25%">
											<input type="text" id="t_jfrq" value="<%=t_jfrq %>"
									...
									<tr class="selected_font">
										...
										<td width="25%"><input type="text" name="t_gdfmc"
											value="<%=t_gdfmc %>" class="selected_font" /> <span class="style1">&nbsp;*</span>
										</td>
									</tr>
									<tr class="selected_font">
									...
									<tr>
										...
										<td width="25%"><input type="text" name="t_dycwbxdje"
											value="<%=gs2 %>" class="selected_font" />
										</td>
										<td height="8%" bgcolor="#DDDDDD" width="13%"><div
												align="left">对应财务核销单金额：</div></td>
										<td width="25%"><input type="text" name="t_dycwhxdje"
											value="<%=gs3 %>" class="selected_font" />
										</td>
										<td height="8%" bgcolor="#DDDDDD" width="13%"><div
												align="left">较高金额：</div></td>
										<td width="25%"><input type="text" name="t_jgje" value="<%=gs4 %>"
											class="selected_font" />
										</td>
									</tr>
									<tr>
										...
										<td width="25%"><input type="text" name="t_wycy"
											value="<%=_cy1 %>" class="selected_font" />
										</td>
									</tr>
									<tr>
										<td colspan="6">
