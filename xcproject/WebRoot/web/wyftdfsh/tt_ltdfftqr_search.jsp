...
<script language="javascript">
	...
	function querenjn(){
		...
		document.form1.action = path + "/web/wyftdfsh/tt_ltdfftqr_search.jsp?ids='"+ids+"'";
	...
	function exportad() {
		document.form1.action = path
				+ "/servlet/LtdfftDownload";
		document.form1.submit();
	}
	
	function daorujz() {
		document.form1.action = path+ "/web/wyftdfsh/tt_ltdfft_input.jsp";
		document.form1.submit();
	}
	...
	$(function() {
		...
		$("#xiugaiBtn").click(function(){
			...
			if (i > 0) {
				document.form1.action = path + "/web/wyftdfsh/tt_ltdfftqr_update.jsp?id='"+_id+"'";
				document.form1.submit();
			} else {
				alert("只能选择一条记录");
				return;
...
function nextpage() {
	...
	document.form1.action = path + "/web/wyftdfsh/tt_ltdfftqr_search.jsp?curpage="
			+ curpage;
	document.form1.submit();
}
...
function gopagebyno(pageno) {
	...
	document.form1.action = path + "/web/wyftdfsh/tt_ltdfftqr_search.jsp?curpage=" + pageno;
	document.form1.submit();
}
</script>
			...
			<tr>
				<td colspan="4">
					<div style="width:700px;height:50px">
						<span
							style="font-size:14px;font-weight:bold;position: absolute;left:25px;top:15px;color:black">联通电费分摊确认</span>
					</div>
				</td>
			</tr>
			<tr>
		...
		<div
			...
			<table width="2000px" height="60%" border="0" cellspacing="1"
				...
				<tr>
					...
					<td nowrap height="23"><div align="center" class="bttcn">序号</div>
					</td>
					<td nowrap height="23"><div align="center" class="bttcn">批次</div>
					</td>
					<td nowrap height="23"><div align="center" class="bttcn">确认状态</div>
					</td>
					<td nowrap height="23" style="background-color: #a9b79d;"><div
							align="center" class="bttcn">区域</div></td>
					<td nowrap height="23" style="background-color: #a9b79d;"><div
							align="center" class="bttcn">原产权单位</div></td>
					<td nowrap height="23" style="background-color: #a9b79d;"><div
							align="center" class="bttcn">基站名称</div></td>
					<td nowrap height="23" style="background-color: #a9b79d;"><div
							align="center" class="bttcn">站点编码</div></td>
					<td nowrap height="23" style="background-color: #a9b79d;"><div
							align="center" class="bttcn">物理地址编码</div></td>
					<td nowrap height="23" style="background-color: #a9b79d;"><div
							align="center" class="bttcn">支付单号(物业系统单号)</div></td>
					<td nowrap height="23" style="background-color: #a9b79d;"><div
							align="center" class="bttcn">供电方名称</div></td>
					<td nowrap height="23" style="background-color: #a9b79d;"><div
							align="center" class="bttcn">票据类型</div></td>
					<td nowrap height="23" style="background-color: #a9b79d;"><div
							align="center" class="bttcn">电表户号</div></td>
					<td nowrap height="23" style="background-color: #a9b79d;"><div
							align="center" class="bttcn">站址类型</div></td>
					<td nowrap height="23" style="background-color: #82898d;"><div
							align="center" class="bttcn">供电公司实际电价(*元/度)</div></td>
					<td nowrap height="23" style="background-color: #82898d;"><div
							align="center" class="bttcn">抄表/缴费开始日期(年月日)</div></td>
					<td nowrap height="23" style="background-color: #82898d;"><div
							align="center" class="bttcn">抄表/缴费终止日期(年月日)</div></td>
					<td nowrap height="23" style="background-color: #82898d;"><div
							align="center" class="bttcn">起码</div></td>
					<td nowrap height="23" style="background-color: #82898d;"><div
							align="center" class="bttcn">止码</div></td>
					<td nowrap height="23" style="background-color: #82898d;"><div
							align="center" class="bttcn">电量</div></td>
					<td width="200" height="23" style="background-color: #82898d;"><div
							align="center" class="bttcn">缴纳电费</div></td>
					<td nowrap height="23" style="background-color: #82898d;"><div
							align="center" class="bttcn">三家分摊比例%</div></td>
					<td nowrap height="23" style="background-color: #82898d;"><div
							align="center" class="bttcn">分摊金额</div></td>
					<td nowrap height="23" style="background-color: #82898d;"><div
							align="center" class="bttcn">备注</div></td>
					<td nowrap height="23" style="background-color: #82898d;"><div
							align="center" class="bttcn">能源管理系统ID</div></td>
					<td nowrap height="23" style="background-color: #ab9f98;"><div
							align="center" class="bttcn">增值税(17%)</div></td>
					<td nowrap height="23" style="background-color: #ab9f98;"><div
							align="center" class="bttcn">税中税(2.64)</div></td>
					<td nowrap height="23" style="background-color: #ab9f98;"><div
							align="center" class="bttcn">分摊金额校验</div></td>
					<td nowrap height="23" style="background-color: #ab9f98;"><div
							align="center" class="bttcn">分摊金额对比</div></td>
				</tr>
				<%
					WyManage wyManage = new WyManage();
						List<WydfftBean> wydfftList = wyManage.searchWydfft_ltdfftqr(loginName,loginId,pageSize,curpage,sheng,shi,xian,xiaoqu,yysqrzt,pc,zdbm,"已修改");
						allpage = wyManage.searchWydfft_ltdfftqr(loginName,loginId,9999999,1,sheng,shi,xian,xiaoqu,yysqrzt,pc,zdbm,"已修改").size()/pageSize+1;
				...
				<tr bgcolor="<%=color%>">
					...
					<td>
						<div align="center"><%=wydfft.getYCQ()%></div>
					</td>
					<td>
					...
					<td>
						<div align="center"><%=wydfft.getCB_WLDZBMBM()%></div>
					</td>
					<td>
					...
					<td>
						<div align="center"><%=wydfft.getCB_ZZLX()%></div>
					</td>
					<td>
						<div align="center"><%=wydfft.getBCDJ()%></div>
					</td>
					<td>
					...
					<td>
						<div align="center"><%=wydfft.getQM()%></div>
					</td>
					<td>
						<div align="center"><%=wydfft.getZM()%></div>
					</td>
					<td>
						<div align="center"><%=wydfft.getDLIANG()%></div>
					</td>
					<td>
						<div align="center"><%=wydfft.getJFJE()%></div>
					</td>
					<td>
						<div align="center"><%=wydfft.getFTBL()%></div>
					</td>
					<td>
						<div align="center"><%=wydfft.getFTJE()%></div>
					</td>
					<td>
						<div align="center"><%=wydfft.getBZ()%></div>
					</td>
					<td>
						<div align="center"><%=wydfft.getCB_NYGLXTID()%></div>
					</td>
					<td>
						<div align="center"><%=wydfft.getCB_ZZS()%></div>
					</td>
					<td>
						<div align="center"><%=wydfft.getCB_SZS()%></div>
					</td>
					<td>
