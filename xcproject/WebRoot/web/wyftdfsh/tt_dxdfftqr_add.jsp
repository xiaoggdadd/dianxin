...
<%
	...
	String sql="select * from tbl_tt_wy_dfft where yearmonth='"+pici+"' and kh='电信' and cbzt='已确认'";
...
function save(){
	...
	if(confirm("您将要添加电信电费信息！确认信息正确！")){
	document.form1.action=path+"/servlet/DxdfftqrAdd?action=dxadd";
