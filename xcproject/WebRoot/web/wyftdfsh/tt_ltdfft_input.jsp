...
function daoru(){
    var path = '<%=path%>';
	document.form1.action=path+"/servlet/LtdfftUpload";
...
function exportModel(){
	...
	document.form1.action = path+ "/servlet/LtdfftDownloadForWxg";
	document.form1.submit();
	}
	//			document.form1.action = path+ "/servlet/ExcelModelDownload?templetname=lt";
	//			document.form1.submit();
			}
$(function() {
												...
												<td width="95%"><table width="100%" border="0"
														...
														<tr>
															...
															<label style="color: red;">
																系统提示:导出模版前请先选择批次，系统会在模版内默认生成对应批次的区县已确认数据。
															</label>
															<p>
