...
<%--////////////////////////////////////////////////////////////////////////////////////////////////////--%>
    ...
    <tr bgcolor="F9F9F9">
			       ...
			       <td><input type="text" id="xmlx" name="xmlx" readonly class="form"></td>
			    </tr>
			    <tr bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">机房名称:</td>
			       <td><input type="text" id="jfmch" name="jfmch" readonly class="form"/></td>
			       <td bgcolor="#DDDDDD">项目负责人:</td>
			       <td><input type="text" id="xmfzr" name="xmfzr" readonly class="form"></td>
			    </tr>
			    <tr bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">项目描述:</td>
			       <td><input type="text" id="xmmsh" name="xmmsh" readonly class="form"/></td>
			       <td></td>
			       <td></td>
			    </tr>
			    <tr bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">开始日期:</td>
			       <td><input type="text" id="kshsj" name="kshsj" readonly onFocus="getDateString(this,oCalendarChs)"  class="form"/></td>
			       <td bgcolor="#DDDDDD">实际结束日期:</td>
			       <td><input type="text" id="shjjshshj" name="shjjshshj" readonly onFocus="getDateString(this,oCalendarChs)"  class="form"></td>
			    </tr>
			    <tr bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">施工单位:</td>
			       <td><input type="text" id="shgdw" name="shgdw" readonly class="form"/></td>
			       <td bgcolor="#DDDDDD">监理单位:</td>
			       <td><input type="text" id="jldw" name="jldw" readonly class="form"></td>
			    </tr>   
			    <tr bgcolor="F9F9F9">
			       <td bgcolor="#DDDDDD">参与总人数:</td>
			       <td><input type="text" id="cyrsh" name="cyrsh" readonly class="form"/></td>
			       <td bgcolor="#DDDDDD">预计结束日期:</td>
			       <td><input type="text" id="yjjshshj" name="yjjshshj" readonly onFocus="getDateString(this,oCalendarChs)"  class="form"></td>
			    </tr>  
			    <tr>
			    <td>
